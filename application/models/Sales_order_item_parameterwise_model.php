...
//Search Reuslt()
	public function active_record_search($table,$data,$from,$to,$company,$order_by){
		...
		$this->db->where(''.$table.'.hold_flag<>', '1');
	...
	public function active_record_search_new($table,$data,$from,$to,$approval_from,$approval_to,$delivery_from,$delivery_to,$company,$order_by,$customer_category){
		...
		if($approval_from!='' && $approval_to!=''){
			$this->db->where(''.$table.'.approval_date >=', $approval_from);
			$this->db->where(''.$table.'.approval_date <=', $approval_to);
		}
		if($delivery_from!='' && $delivery_to!=''){

			$this->db->where('order_details.delivery_date >=', $delivery_from);
			$this->db->where('order_details.delivery_date <=', $delivery_to);
		}	
	...
	// }
		...
		public function active_record_search_planning($table,$data,$from,$to,$approval_from,$approval_to,$delivery_from,$delivery_to,$company,$order_by,$customer_category){
	...
	// }
		...
		public function active_record_search_planning_springtube($table,$data,$from,$to,$approval_from,$approval_to,$delivery_from,$delivery_to,$company,$order_by,$customer_category){	
		...
		$this->db->where(''.$table.'.archive<>', '1');
		$order_f=array('1', '4');
		$this->db->where_in(''.$table.'.order_flag', $order_f);
		$this->db->where(''.$table.'.final_approval_flag', '1');
		$this->db->where(''.$table.'.order_closed<>', '1');
		$this->db->where(''.$table.'.trans_closed<>', '1');
		$this->db->where(''.$table.'.created_pr_inv<>', '1');
	...
	public function active_record_search_new_old($table,$data,$from,$to,$company,$order_by){
	...
	public function select_one_active_record($table,$company,$pkey,$edit){
		$this->db->select($table.'.*,address_master.name1 as customer_name,address_master.isdn_local,user_master.login_name as username,a.login_name as approval_username,address_master.strno,address_master.name2,address_master.street,address_master.name3,zip_code_master.state_code,zip_code_master.lang_city,address_master.dispatch_tolerance');
		$this->db->from($table);
