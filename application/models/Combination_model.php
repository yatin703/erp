...
class Combination_model extends CI_Model {
	...
	public function select_cap_type_active_record($table,$company,$pkey,$edit,$pkey2,$edit2){
		$this->db->select('distinct(shoulder_orifice_dependancy.cap_type_id),shoulder_orifice_dependancy.archive,shoulder_orifice_dependancy.company_id,cap_types_master.cap_type,cap_types_master.type');
		$this->db->from($table);
