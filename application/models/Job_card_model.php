...
class Job_card_model extends CI_Model {
	...
	public function get_available_qty($article_no){		
		...
		if(!empty($article_no)){			
		//$conerp=mysqli_connect('192.168.0.33','root','NewUser@php','neo3');;

		//$con=mysqli_connect('192.168.0.33','root','NewUser@php','tw-erp');

		$conerp=mysqli_connect('192.168.0.50','root','NewUser@php','neo');
		$con=mysqli_connect('192.168.0.33','root','NewUser@php','tw-erp');
