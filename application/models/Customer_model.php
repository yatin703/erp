...
class Customer_model extends CI_Model {
	...
	public function last_bill_days_before($table,$customer_no,$company){
		$sql="SELECT DATEDIFF(CURDATE( ), `invoice_date`) AS LAST_BILL_DAY_BEFORE
		...
		if($result==TRUE){
			...
			return $row->LAST_BILL_DAY_BEFORE ;
			}
		}else{
			return "NA";
		}
