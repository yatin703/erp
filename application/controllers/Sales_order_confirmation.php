    ...
    foreach ($data['module'] as $module_row) {
    	if($module_row->module_name==='Sales'){
          ...
          if($formrights_row->view==1){
            ...
            $data['order_master']=$this->sales_order_book_model->active_record_oc('order_master',$search,$from="",$to="",$this->session->userdata['logged_in']['company_id'],$order_closed_arr="",'2022-02-01',date('Y-m-d'),$cancelled_from_date="",$cancelled_to_date="");
