      ...
      if($module_row->module_name==='Sales'){
        ...
        foreach ($data['formrights'] as $formrights_row) {
          if($formrights_row->view==1){
            ...
            $data['sales_apr_march_yearwise']=$this->sales_invoice_book_model->sales_five_year_apr_march_monthwise($table,'2015-04-01','2021-03-31');

            $data['sales_jan_dec_yearwise']=$this->sales_invoice_book_model->sales_five_year_jan_dec_monthwise($table,'2016-01-01','2021-12-31');
      ...
      if($module_row->module_name==='Sales'){
        ...
        foreach ($data['formrights'] as $formrights_row) {
          if($formrights_row->view==1){
            ...
            $data['sales_five_year_print_type_wise']=$this->sales_invoice_book_model->sales_five_year_print_type_wise($table,'2016-01-01','2021-12-31');

            $data['sales_five_year_print_type_apr_mar_wise']=$this->sales_invoice_book_model->sales_five_year_print_type_apr_mar_wise($table,'2015-04-01','2022-03-31');
      ...
      if($module_row->module_name==='Sales'){
        ...
        foreach ($data['formrights'] as $formrights_row) {
          if($formrights_row->view==1){
            ...
            $data['pending_sales_order']=$this->sales_order_book_model->pending_sales_order_on_delivery_date('order_master',$new_from_date,date('Y-m-d'),'');
            //echo $this->db->last_query();
