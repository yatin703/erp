                  ...
                  foreach($data['film_specs'] as $film_specs){
                    ...
                    if($film_specs_result){
                      ...
                      if($result_spring_width_calculation){
                        ...
                        echo $film_width=$spring_width_calculation_row->slit_width+($spring_width_calculation_row->distance_each_side*$spring_width_calculation_row->ups);
                        echo "<br/>";
                         $qty_to_be_printed=$this->input->post('job_card_quantity')/$spring_width_calculation_row->ups;
                        echo  $film_length=$qty_to_be_printed*($length+2.5);
                        echo "<br/>";
                        echo  $total_film_guagee=$total_film_guage/1000;
                        echo "<br/>";
                        echo  $total_film_volume=$total_film_guagee*$film_length*$film_width;
                         $density=0.00098;
                         echo "<br/>";
                         echo $total_film_material=($total_film_volume*$density)/1000;
                          }
                        }
                      }
                    }
