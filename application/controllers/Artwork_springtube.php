...
class Artwork_springtube extends CI_Controller {
      ...
      if($module_row->module_name==='Sales'){
        ...
        foreach ($data['formrights'] as $formrights_row) {
          if($formrights_row->new==1){
            ...
            $this->form_validation->set_rules('sleeve_type','Sleeve Type' ,'required|trim|xss_clean');         
            ...
            $this->form_validation->set_rules('pre_lacquer_1_perc','Pre Lacquer 1 %' ,'required|trim|xss_clean|numeric|less_than_equal_to[100]');
            }

            $this->form_validation->set_rules('pre_lacquer_2','Pre Lacquer 2' ,'trim|xss_clean');
            if(!empty($this->input->post('pre_lacquer_2'))){
            $this->form_validation->set_rules('pre_lacquer_2_perc','Pre Lacquer 2  %' ,'required|trim|xss_clean|numeric|less_than_equal_to[100]');
            }

            $this->form_validation->set_rules('post_lacquer_1','Post Lacquer 1' ,'trim|xss_clean');
            if(!empty($this->input->post('post_lacquer_1'))){
            $this->form_validation->set_rules('post_lacquer_1_perc','Post Lacquer 1 %' ,'required|trim|xss_clean|numeric|less_than_equal_to[100]');
            }

            $this->form_validation->set_rules('post_lacquer_2','Post Lacquer 2' ,'trim|xss_clean');
            if(!empty($this->input->post('post_lacquer_2'))){
            $this->form_validation->set_rules('post_lacquer_2_perc','Post Lacquer 2  %' ,'required|trim|xss_clean|numeric|less_than_equal_to[100]');
            }
            ...
            if($this->form_validation->run()==FALSE){
              ...
              $data=array('company_id'=>$this->session->userdata['logged_in']['company_id'],
                    ...
                    'sleeve_type'=>$this->input->post('sleeve_type'),
                    'ad_date'=>date('Y-m-d'),
      ...
      if($module_row->module_name==='Sales'){
        ...
        foreach ($data['formrights'] as $formrights_row) {
          if($formrights_row->copy==1){
            ...
            $data['approval_authority']=$this->common_model->select_one_active_approval_authority_record('authority_master',$this->session->userdata['logged_in']['company_id'],'authority_master.form_id','1508');
           ...
           // $this->form_validation->set_rules('cold_foil_2_length','Cold Foil 1' ,'trim|xss_clean');
            ...
            if($this->form_validation->run()==FALSE){
               ...
               // $data['cold_foil']=$this->article_model->spec_all_active_record_search('article','304',$this->session->userdata['logged_in']['company_id']);
                ...
                if(!empty($this->input->post('sleeve_type'))){
                  $data['sleeve_type']=$this->input->post('sleeve_type');
                }
  ...
  public function pre_lcq_perc_check($str){
    ...
    if($this->input->post('pre_lacquer_1')!=''){
  ...
  public function post_lcq_perc_check($str){
    ...
    if($this->input->post('post_lacquer_1')!=''){
              ...
              if(empty($_FILES['userfile1']['name'])){ 
                ...
                //$this->load->view('Home/footer');
                  ...
                  if($this->upload->do_upload('userfile1')){
                      ...
                      $artwork_row=$this->artwork_springtube_model->select_details_record_print($artwork_no,$version_no);
                      ...
                      if($data['employee']==FALSE){
                        ...
                        foreach($data['employee'] as $employee_row) {
                          ...
                          $this->email->to('graphic@3d-neopac.com');
                          ...
                          $html = '<!DOCTYPE>
                                  ...
                                  <table cellpadding="5" cellspacing="0" style="border:1px solid #D9d9d9;">
                                    ...
                                    <tr class="item last">
                                      ...
                                      <td style="border-right:1px solid #D9d9d9;">'.$artwork_row['ARTWORK_PARA_3'].'</td>
                                      <td><b>PRINT TYPE</b></td>
                                      <td>'.$artwork_row['ARTWORK_PARA_18'].'</td>
                                    </tr>
                                    ...
                                    <tr class="item last">
                                      ...
                                      <td>'.$artwork_row['sleeve_type'].'</td>
                                    </tr>
                      
                      
                                    <tr class="item last">
                                      <td><b>NON LACQUER LENGTH</b></td>
                                      <td>'.$artwork_row['ARTWORK_PARA_16'].'</td>
                                      <td><b>BODY MAKING TYPE</b></td>
                                      <td style="border-right:1px solid #D9d9d9;">'.$artwork_row['ARTWORK_PARA_17'].'</td>
                                    </tr>
                                    
                                    <tr class="item last">
                                      <td><b>FOIL ONE</b></td>
                                      <td style="border-right:1px solid #D9d9d9;">'.$artwork_row['ARTWORK_PARA_4'].'</td>
                                      <td><b>FOIL ONE (L X W)</b></td>
                                      <td>'.$artwork_row['foil_one'].'</td>           
                                    </tr>
                                    
                                    <tr class="item last">
                                      <td><b>FOIL TWO</b></td>
                                      <td style="border-right:1px solid #D9d9d9;">'.$artwork_row['ARTWORK_PARA_6'].'</td>
                                      <td><b>FOIL TWO (L X W)</b></td>
                                      <td>'.$artwork_row['foil_two'].'</td>
                                    </tr>
                                    
                                    <tr class="item last">
                                      <td><b>PRE LACQUER ONE</b></td>
                                      <td style="border-right:1px solid #D9d9d9;">'.$artwork_row['ARTWORK_PARA_8'].'</td>
                                      <td><b>PRE LACQUER ONE %</b></td>
                                      <td>'.$artwork_row['ARTWORK_PARA_9'].'</td>
                                    </tr>
                                    
                                    <tr class="item last">
                                      <td><b>PRE LACQUER TWO</b></td>
                                      <td style="border-right:1px solid #D9d9d9;">'.$artwork_row['ARTWORK_PARA_10'].'</td>
                                      <td><b>PRE LACQUER TWO %</b></td>
                                      <td>'.$artwork_row['ARTWORK_PARA_11'].'</td>
                                    </tr>
                                    ...
                                    <tr class="item last">
                                      ...
                                      <td><b>POST LACQUER ONE %</b></td>
                                      <td>'.$artwork_row['ARTWORK_PARA_13'].'</td>
                                    </tr>
                                    ...
                                    <tr class="item last">
                                      ...
                                      <td><b>POST LACQUER TWO %</b></td>
                                      <td>'.$artwork_row['ARTWORK_PARA_15'].'</td>
                                    </tr>    
...
public function csv()
{
 $data['artwork'] = $this->artwork_model->active_record_search_csv($this->uri->segment(3), $this->uri->segment(4));

 // Set the filename for the downloaded CSV file
 $fileName ='artwork_springtube';
 ...
 foreach ($data['artwork'] as $artwork_row) {
  ...
  $artwork_ad_id = $artwork_row->ad_id;
  $artwork_version_no = $artwork_row->version_no;
  $fileName1 = $artwork_ad_id.'_R'.$artwork_version_no.'.csv';
  $varnish = ($artwork_row->vornish==0 ?   'FULL VARNISH':$artwork_row->vornish );
  $sleeve_dia = chop($artwork_row->sleeve_dia,"MM");
  $date_down = date('d-M-Y');
 ...
 fputcsv($output, array(
                         ...
                         $artwork_row->sleeve_length+2.5,
                         $varnish,
                         $artwork_row->print_type,
                         $date_down,
                         $artwork_row->bleedwidth,
                         $artwork_row->tubecircumference,
                         $artwork_row->sleeve_type
                      )
                    );
}
