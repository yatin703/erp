          ...
          if($formrights_row->new==1){
            ...
            if($jobcard_type=='1'){
              ...
              if($sum_amount!=0){
                ...
                $plan_cost_per_meter=$sum_amount/$total_meters;
                $production_cost_per_meter=$sum_amount/$production_ok_meters;              
              
                $data=array('jobcard_status'=>'1','extrusion_job_cost_per_meter'=>$plan_cost_per_meter,'extrusion_prod_cost_per_meter'=>$production_cost_per_meter);
                ...
                $data['error']='Extrusion Jobcard material issue cost is 0';
              }
