...
class Screen_consumption_master extends CI_Controller {
  ...
  function __construct(){
    ...
    if($this->session->userdata('logged_in')){
      ...
      $this->load->model('screen_consumption_model');
  ...
  public function index(){
    ...
    foreach ($data['module'] as $module_row) {
      if($module_row->module_name==='Sales'){
        $data['formrights']=$this->common_model->select_active_formrights_of_form($this->session->userdata['logged_in']['user_id'],$this->session->userdata['logged_in']['company_id'],1,'screen_consumption_master');

        foreach ($data['formrights'] as $formrights_row) {
          if($formrights_row->view==1){

   
    $table='screen_consumption_master';

    include('pagination-screen.php');

    $data['screen_consumption_master']=$this->screen_consumption_model->select_active_records($config["per_page"], $this->uri->segment(3),$table,$this->session->userdata['logged_in']['company_id']);
  ...
  public function save(){
   ...
   /* if(is_array($arr)){
    ...
    $this->form_validation->set_rules('consumption_quantity','Consumption Quantity','required|xss_clean');
    $this->form_validation->set_rules('consumption_unit_rate','Consumption Unit Rate','required|xss_clean');
    ...
    if($this->form_validation->run()==FALSE){
     ...
     $print_type='';
        ...
        $result_lacquer_type=$this->common_model->select_one_active_record('lacquer_types_master',$this->session->userdata['logged_in']['company_id'],'lacquer_type_id',$this->input->post('lacquer_type'));
        foreach($result_lacquer_type as  $result_lacquer_type_row){
          $print_type=$result_lacquer_type_row->lacquer_type ;
        }

        
        $rm= strtoupper($month_from).' '.$year_from.' '.($month_from!=$month_to?' TO '.strtoupper($month_to).' '.$year_to :'').' '.$print_type.'  CONSUMPTION';

        $data=array('from_date'=>$this->input->post('from_date'),
                  'to_date'=>$this->input->post('to_date'),
                  'lacquer_type_id'=>$this->input->post('lacquer_type'),
                  'rm'=>strtoupper($rm),
                  'consumption_value'=>$this->input->post('consumption_value'),
                  'consumption_quantity'=>$this->input->post('consumption_quantity'),
                  'consumption_unit_rate'=>round($this->input->post('consumption_value')/$this->input->post('consumption_quantity'),4),
        ...
        $result=$this->common_model->save('screen_consumption_master',$data);
  ...
  function modify(){
    ...
    $data['screen_consumption_master']=$this->common_model->select_one_active_record('screen_consumption_master',$this->session->userdata['logged_in']['company_id'],'scm_id',$this->uri->segment(3));
    $data['lacquer_types_master']=$this->common_model->select_active_drop_down('lacquer_types_master',$this->session->userdata['logged_in']['company_id']); 
  ...
  public function update(){
    ...
    if($this->form_validation->run()==FALSE){
      ...
      $data['screen_consumption_master']=$this->common_model->select_one_active_record('screen_consumption_master',$this->session->userdata['logged_in']['company_id'],'scm_id',$this->input->post('scm_id'));
      $data['lacquer_types_master']=$this->common_model->select_active_drop_down('lacquer_types_master',$this->session->userdata['logged_in']['company_id']); 
      ...
      $this->load->view('Home/footer');
          ...
          foreach($this->input->post('lacquer_type_id') as $lacquer_type){
            ...
            $rm= strtoupper($month_from).' '.$year_from.' '.($month_from!=$month_to?' TO '.strtoupper($month_to).' '.$year_to :'').' '.$print_type.' UV CONSUMPTION';
          ...
          $result=$this->common_model->update_one_active_record('screen_consumption_master',$data,'scm_id',$this->input->post('scm_id'),$this->session->userdata['logged_in']['company_id']);
        }
  ...
  public function delete(){
    ...
    $result=$this->common_model->update_one_active_record('screen_consumption_master',$data,'scm_id',$this->uri->segment(3),$this->session->userdata['logged_in']['company_id']);
    ...
    if($result){
      ...
      $data['screen_consumption_master']=$this->common_model->select_one_inactive_record('screen_consumption_master',$this->session->userdata['logged_in']['company_id'],'scm_id',$this->uri->segment(3)); 
      $data['lacquer_types_master']=$this->common_model->select_active_drop_down('lacquer_types_master',$this->session->userdata['logged_in']['company_id']); 
  ...
  function archive_records(){
    ...
    $data['screen_consumption_master']=$this->screen_consumption_model->select_archive_records($config["per_page"],$this->uri->segment(3),$table,$this->session->userdata['logged_in']['company_id']);
  ...
  public function search(){
   ...
   $data['lacquer_types_master']=$this->common_model->select_active_drop_down('lacquer_types_master',$this->session->userdata['logged_in']['company_id']); 
    ...
    $this->form_validation->set_rules('consumption_quantity','Consumption Quantity','xss_clean');
    $this->form_validation->set_rules('consumption_unit_rate','Consumption Unit Rate','xss_clean');
    ...
    if($this->form_validation->run()==FALSE){
      ...
      $data=array('from_date'=>$this->input->post('from_date'),
                  ...
                  'consumption_value'=>$this->input->post('consumption_value'),
                  'consumption_quantity'=>$this->input->post('consumption_quantity'),
                  'consumption_unit_rate'=>$this->input->post('consumption_unit_rate'),                  
                  'screen_consumption_master.company_id'=>$this->session->userdata['logged_in']['company_id']);


          $data['screen_consumption_master']=$this->screen_consumption_model->active_record_search('screen_consumption_master',$data,$search);
  ...
  function check_data($str) {
    ...
    $lacquer_type_id = $str;
    $this->db->select('*');
    $this->db->from('screen_consumption_master');
