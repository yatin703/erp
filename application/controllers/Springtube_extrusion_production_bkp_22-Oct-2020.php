        ...
        foreach ($data['formrights'] as $formrights_row) {
          if($formrights_row->new==1){
            ...
            foreach($this->input->post('sr_no') as $sr_no => $sr_no_value){
              ...
              $this->form_validation->set_rules('jobcard_no_'.$sr_no_value.'','Jobcard No '.$sr_no_value.'' ,'required|trim|xss_clean|max_length[50]|callback_jobcard_close_check');
  ...
  public function article_check($str){
   ...
   public function shift_check(){
    ...
    public function jobcard_close_check($jobcard_no){
      ...
      $result=$this->job_card_model->open_jobcard_active_record_search_extrusion('production_master',$jobcard_no,$this->session->userdata['logged_in']['company_id']);
