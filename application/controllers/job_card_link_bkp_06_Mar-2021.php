          ...
          if($formrights_row->new==1){
            ...
            if($this->form_validation->run()==FALSE){
              ...
              if($result){
                ...
                $con=mysqli_connect('192.168.0.33','root','NewUser@php','twerp');
                //---Extrusion
                ...
                if(mysqli_num_rows($result_extrusion)>0){
                  $sql_ext_update="update extrusion set so_no='".$new_so."' WHERE job_card_no='".$jobcard_no."'";
                ...
                if(mysqli_num_rows($result_heading)>0){
                  $sql_hed_update="update heading set so_no='".$new_so."' WHERE job_card_no='".$jobcard_no."'";
                ...
                if(mysqli_num_rows($result_printing)>0){
                  $sql_pri_update="update printing set so_no='".$new_so."' WHERE job_card_no='".$jobcard_no."'";
                ...
                if(mysqli_num_rows($result_labeling)>0){
                  $sql_lab_update="update labeling set so_no='".$new_so."' WHERE job_card_no='".$jobcard_no."'";
                ...
                if(mysqli_num_rows($result_capping)>0){
                  $sql_cap_update="update capping set so_no='".$new_so."' WHERE job_card_no='".$jobcard_no."'";
                ...
                if(mysqli_num_rows($result_foiling)>0){
                  $sql_foil_update="update foiling set so_no='".$new_so."' WHERE job_card_no='".$jobcard_no."'";
