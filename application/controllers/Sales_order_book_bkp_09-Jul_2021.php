              ...
              */ 
              ...
              if(in_array($this->input->post('trans_closed_reason'),$order_closed_arr)){
                ...
                if($this->input->post('trans_closed_reason')=='12'){
                  ...
                  if(!empty($this->input->post('approval_authority_factory'))){
                      
                    $folloup_search=array('form_id' =>'6','record_no'=>$this->input->post('order_no') );

                    $data['followup']=$this->common_model->select_active_records_where('followup',$this->session->userdata['logged_in']['company_id'],$folloup_search);
                    if($data['followup']==FALSE){
                      $transaction_no=1;
                      $status=1;
                    }else{
                    ...
                    $data=array(
                      'company_id'=>$this->session->userdata['logged_in']['company_id'],
                      'user_id'=>$this->input->post('approval_authority_factory'),
                      'form_id'=>'6',
                      'transaction_no'=>$transaction_no,
                      'status'=>$status,
                      'followup_date'=>date('Y-m-d'),
