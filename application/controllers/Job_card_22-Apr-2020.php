      ...
      if($module_row->module_name==='Sales'){
        ...
        foreach ($data['formrights'] as $formrights_row) {
          if($formrights_row->new==1){
                ...
                foreach ($spring_extrusion_production_details_result as  $spring_extrusion_production_details_row) {
                  ...
                  if($setup_jobcard_no!=''){
                    ...
                    if($setup_amount!=0){
                      ...
                      $production_cost_per_meter=$setup_amount/$production_ok_meters;       
                    
                      $data=array('jobcard_status'=>'1','setup_prod_cost_per_meter'=>round($production_cost_per_meter,2));
                  ...
                  if($purging_jobcard!=''){
                    ...
                    if($purging_amount!=0){
                      //$plan_cost_per_meter=$setup_amount/$total_meters;
                      $production_cost_per_meter=$purging_amount/$production_ok_meters;       
                    
                      $data=array('jobcard_status'=>'1','purging_prod_cost_per_meter'=>round($production_cost_per_meter,2));
            ...
            //   $data=array('setup_jobcard_no'=>$this->uri->segment(3),'archive'=>0);
            //   $spring_extrusion_production_details_result=$this->springtube_extrusion_production_model->active_details_records('springtube_extrusion_production_details',$data);
            ...
            //     $demand_qty=$this->common_model->read_number($material_manufacturing_row->demand_qty,$this->session->userdata['logged_in']['company_id']);
            //     $calculated_purchase_price=$this->common_model->read_number($material_manufacturing_row->calculated_purchase_price,$this->session->userdata['logged_in']['company_id']);
            //     $sum_amount+=$demand_qty*$calculated_purchase_price;

            //   }
            //   //echo $sum_amount;
            //   if($sum_amount!=0){
            //     $plan_cost_per_meter=0;//$sum_amount/$total_meters;
            //     $production_cost_per_meter=$sum_amount/$production_ok_meters;             
           

            //     $data=array('jobcard_status'=>'1','setup_job_cost_per_meter'=>$plan_cost_per_meter,'setup_prod_cost_per_meter'=>$production_cost_per_meter);
            //     $result=$this->common_model->update_one_active_record('production_master',$data,'mp_pos_no',$this->uri->segment(3),$this->session->userdata['logged_in']['company_id']);

            //     $data['note']='Setup Jobcard closed successfully';

            //   }
            //   else{

            //     $data['error']='Setup Jobcard material issue cost is 0';
            //   }

            // }

            // FOR PURGING JOBCARDS 
            // if($jobcard_type=='5'){

            //   $production_ok_meters=0;

            //   $data=array('purging_jobcard'=>$this->uri->segment(3),'archive'=>0);
            //   $spring_extrusion_production_details_result=$this->springtube_extrusion_production_model->active_details_records('springtube_extrusion_production_details',$data);
            ...
            //     $data=array('jobcard_status'=>'1','purging_prod_cost_per_meter'=>$production_cost_per_meter);
            //     $result=$this->common_model->update_one_active_record('production_master',$data,'mp_pos_no',$this->uri->segment(3),$this->session->userdata['logged_in']['company_id']);

            //     $data['note']='Purging Jobcard closed successfully';

            //   }
            //   else{

            //     $data['error']='Purging Jobcard material issue cost is 0';
            //   }
