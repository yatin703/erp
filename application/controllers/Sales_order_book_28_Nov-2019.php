            ...
            if($this->form_validation->run()==FALSE){
              ...
              if(!empty($this->input->post('adr_company_id'))){
               ...
               $data['user_master']=$this->common_model->select_active_drop_down('user_master',$this->session->userdata['logged_in']['company_id']);
                ...
                $data['order_master']=$this->sales_order_book_model->active_record_search('order_master',$search,$from,$to,$this->session->userdata['logged_in']['company_id'],$order_closed_arr);
