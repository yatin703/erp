...
class Coex_extrusion_heading_production extends CI_Controller {
          ...
          if($module_row->module_name==='Production'){
            ...
            foreach ($data['formrights'] as $formrights_row) {
              if($formrights_row->view==1){
                ...
                $data['coex_extrusion_heading']=$this->coex_extrusion_heading_model->select_active_records($config["per_page"],$this->uri->segment(3),$table,$this->session->userdata['logged_in']['company_id']);
      ...
      if($module_row->module_name==='Production'){
        ...
        foreach ($data['formrights'] as $formrights_row) {
          if($formrights_row->new==1){
            ...
            $data['coex_extrusion']=$this->coex_extrusion_heading_model->select_one_active_record_heading('coex_extrusion_heading',$this->session->userdata['logged_in']['company_id'],'coex_extrusion_heading.heading_id',$this->uri->segment(3));
