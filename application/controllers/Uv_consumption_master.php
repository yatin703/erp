...
class Uv_consumption_master extends CI_Controller {
  ...
  function __construct(){
    ...
    if($this->session->userdata('logged_in')){
      ...
      $this->load->model('uv_consumption_model');
  ...
  public function index(){
    ...
    foreach ($data['module'] as $module_row) {
      if($module_row->module_name==='Sales'){
        ...
        $data['formrights']=$this->common_model->select_active_formrights_of_form($this->session->userdata['logged_in']['user_id'],$this->session->userdata['logged_in']['company_id'],1,'uv_consumption_master');

        foreach ($data['formrights'] as $formrights_row) {
          if($formrights_row->view==1){

   
    $table='uv_consumption_master';

    include('pagination.php');

    $data['uv_consumption_master']=$this->uv_consumption_model->select_active_records($config["per_page"], $this->uri->segment(3),$table,$this->session->userdata['logged_in']['company_id']);
    ...
    if($this->form_validation->run()==FALSE){
      ...
      foreach($this->input->post('lacquer_type_id') as $lacquer_type){
        ...
        $data=array('from_date'=>$this->input->post('from_date'),
                  ...
                  'cost_per_tube'=>($this->input->post('cost_per_tube')!=0?round($this->input->post('consumption_value')/$this->input->post('sale_of_tubes'),4):0),                 
       ...
       $result=$this->common_model->save('uv_consumption_master',$data);
  ...
  function modify(){
    ...
    $data['uv_consumption_master']=$this->common_model->select_one_active_record('uv_consumption_master',$this->session->userdata['logged_in']['company_id'],'uvc_id',$this->uri->segment(3));
  ...
  public function update(){
   ...
   // $this->form_validation->set_rules('apply_from_date','Apply From Date','required|xss_clean');
    ...
    if($this->form_validation->run()==FALSE){
      ...
      $data['uv_consumption_master']=$this->common_model->select_one_active_record('uv_consumption_master',$this->session->userdata['logged_in']['company_id'],'uvc_id',$this->input->post('uvc_id'));
      ...
      $this->load->view('Home/footer');
        ...
        $result=$this->common_model->update_one_active_record('uv_consumption_master',$data,'uvc_id',$this->input->post('uvc_id'),$this->session->userdata['logged_in']['company_id']);
      }
  ...
  public function delete(){
    ...
    $result=$this->common_model->update_one_active_record('uv_consumption_master',$data,'uvc_id',$this->uri->segment(3),$this->session->userdata['logged_in']['company_id']);
    ...
    if($result){
      ...
      $data['uv_consumption_master']=$this->common_model->select_one_inactive_record('uv_consumption_master',$this->session->userdata['logged_in']['company_id'],'uvc_id',$this->uri->segment(3)); 
  ...
  function archive_records(){
    ...
    $data['uv_consumption_master']=$this->uv_consumption_model->select_archive_records($config["per_page"],$this->uri->segment(3),$table,$this->session->userdata['logged_in']['company_id']);
      ...
      $this->load->view('Home/footer');
        ...
        if(!empty($this->input->post('lacquer_type_id[]'))){
          ...
          $data=array('from_date'=>$this->input->post('from_date'),
                  ...
                  'uv_consumption_master.company_id'=>$this->session->userdata['logged_in']['company_id']
                  
                );

          $data['uv_consumption_master']=$this->uv_consumption_model->active_record_search('uv_consumption_master',$data,$search);
  ...
  function check_data($str) {
    ...
    $lacquer_type_id = $str;
    $this->db->select('*');
    $this->db->from('uv_consumption_master');
