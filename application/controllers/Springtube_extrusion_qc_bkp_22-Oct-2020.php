        ...
        if($module_row->module_name==='Production'){
          ...
          foreach ($data['formrights'] as $formrights_row) {
            if($formrights_row->view==1){
              ...
              $data['springtube_extrusion_scrap_master']=$this->springtube_extrusion_qc_model->scrap_active_record_search('springtube_extrusion_scrap_master',$this->session->userdata['logged_in']['company_id'],$data_search=array(),$this->input->get('from_date'),$this->input->get('to_date'));
