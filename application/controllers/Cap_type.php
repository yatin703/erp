...
class Cap_type extends CI_Controller {
  ...
  public function index(){
    ...
    $data['cap_types_master']=$this->common_model->select_active_records($config["per_page"], $this->uri->segment(3),$table,$this->session->userdata['logged_in']['company_id']);
  ...
  public function save(){
    ...
    $this->form_validation->set_rules('cap_type','Cap Type' ,'required|xss_clean|max_length[30]|strtoupper|is_unique[cap_types_master.cap_type]');
    ...
    if($this->form_validation->run()==FALSE){
      ...
      $this->load->view('Home/footer');
          ...
          $result=$this->common_model->select_max_pkey_numeric('cap_types_master','cap_type_id',$this->session->userdata['logged_in']['company_id']); 
          //echo $this->db->last_query();
          
          foreach($result as $row){

            $max_pkey=$row->cap_type_id;
          }

          $cap_type_id=$max_pkey+1;
          ...
          $result=$this->common_model->save('cap_types_master',$data);
  ...
  public function update(){
    ...
    $this->form_validation->set_rules('cap_type','Cap Type' ,'xss_clean|max_length[30]|strtoupper');
