...
class Bill_of_material extends CI_Controller {
      ...
      if($module_row->module_name==='Sales'){
        ...
        foreach ($data['formrights'] as $formrights_row) {
          if($formrights_row->new==1){
            ...
            $this->form_validation->set_rules('article_no','Product Code' ,'required|trim|xss_clean|is_unique[bill_of_material.article_no]|callback_article_check');
            $this->form_validation->set_rules('sleeve_code','Sleeve Code' ,'required|trim|xss_clean|callback_article_code_check');
            $this->form_validation->set_rules('shoulder_code','Shoulder Code' ,'required|trim|xss_clean|callback_article_code_check');
            $this->form_validation->set_rules('cap_code','Cap Code' ,'required|trim|xss_clean|callback_article_code_check');
            $this->form_validation->set_rules('label_code','Label Code' ,'trim|xss_clean|callback_article_code_check');
            ...
            if($this->form_validation->run()){
              ...
              //--SLEEVE----------------------------------
              if(!empty($this->input->post('sleeve_code'))){
                $sleeve_specification_sheet=$this->common_model->select_one_active_record('specification_sheet',$this->session->userdata['logged_in']['company_id'],'article_no',$this->input->post('sleeve_code'));
                $spec_id='';
                $spec_version_no='';
              ...
              //--SHOULDER--------------------------
              if(!empty($this->input->post('shoulder_code'))){
                $shoulder_specification_sheet=$this->common_model->select_one_active_record('specification_sheet',$this->session->userdata['logged_in']['company_id'],'article_no',$this->input->post('shoulder_code'));
                $spec_id='';
                $spec_version_no='';
              ...
              if(!empty($this->input->post('cap_code'))){
                ...
                $cap_specification_sheet=$this->common_model->select_one_active_record('specification_sheet',$this->session->userdata['logged_in']['company_id'],'article_no',$this->input->post('cap_code'));
                $spec_id='';
                $spec_version_no='';
              ...
              if($this->shoulder_orifice_dependancy_model->select_one_active_combination_record('shoulder_orifice_dependancy',$this->session->userdata['logged_in']['company_id'],$combination_data)>0){
                ...
                if(count($bill_of_material)==0){
                  ...
                  $data= array('company_id' =>$this->session->userdata['logged_in']['company_id'],
                               ...
                               'shoulder_code'=>$this->input->post('shoulder_code'),
                  ...
                  if(!empty($this->input->post('approval_authority'))){
                    ...
                    $data['followup']=$this->common_model->select_one_active_record_nonlanguage_without_archive('followup',$this->session->userdata['logged_in']['company_id'],'record_no',$bom_no.'@@@1');
      ...
      if($module_row->module_name==='Sales'){
        ...
        foreach ($data['formrights'] as $formrights_row) {
          if($formrights_row->modify==1){
            ...
            $this->form_validation->set_rules('article_no','Product Code' ,'required|trim|xss_clean|callback_article_check');
            $this->form_validation->set_rules('sleeve_code','Sleeve Code' ,'required|trim|xss_clean|callback_article_code_check');
            $this->form_validation->set_rules('shoulder_code','Shoulder Code' ,'required|trim|xss_clean|callback_article_code_check');
            $this->form_validation->set_rules('cap_code','Cap Code' ,'required|trim|xss_clean|callback_article_code_check');
            $this->form_validation->set_rules('label_code','Label Code' ,'trim|xss_clean|callback_article_code_check');
      ...
      if($module_row->module_name==='Sales'){
        ...
        foreach ($data['formrights'] as $formrights_row) {
          if($formrights_row->view==1){
              ...
              $this->form_validation->set_rules('article_no','Product Code' ,'trim|xss_clean');
              ...
              if($this->form_validation->run()){
                ...
                $arr= array( 'article_no'=>$article_no[1],
                ...
                $search_arr = array('sleeve_dia' =>$this->input->post('sleeve_dia'),
                ...
                // $table='bill_of_material';                
                // $data['bill_of_material']=$this->bill_of_material_model->active_records_search($table,$this->session->userdata['logged_in']['company_id'],$data);

                 $table='bill_of_material';                
                 $data['bill_of_material']=$this->bill_of_material_model->active_records_search_new($table,$this->session->userdata['logged_in']['company_id'],$from,$to,$data,$search);
  ...
  public function article_code_check($article_no){
      if(!empty($article_no)){ 
        
        $data['item']=$this->common_model->select_one_active_record_nonlanguage_without_archive('article_name_info',$this->session->userdata['logged_in']['company_id'],'article_no',$article_no);
        //echo $this->db->last_query();
        if($data['item']){
          foreach ($data['item'] as $item_row) {
              if ($item_row->article_no == $article_no){
                return TRUE;
              }else{
                $this->form_validation->set_message('article_code_check', 'The {field} field is incorrect');
                return FALSE;
              }
          } 
        }else{
