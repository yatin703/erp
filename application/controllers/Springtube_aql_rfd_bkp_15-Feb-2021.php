        ...
        if($module_row->module_name==='Production'){
          ...
          foreach ($data['formrights'] as $formrights_row) {
            if($formrights_row->new==1){
              ...
              $this->form_validation->set_rules('short_fall','Short Fall Qty' ,'trim|xss_clean');
              ...
              if($this->form_validation->run()==FALSE){
                ...
                if(!empty($this->input->post('short_fall'))){

                    $short_fall=$this->input->post('short_fall');
                }
                ...
                $total_rejected=$total_rejected_bodymaking_issue+$total_rejected_printing_issue+ $short_fall;
