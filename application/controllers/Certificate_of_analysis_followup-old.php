      ...
      if($module_row->module_name==='Followup'){
        ...
        foreach ($data['formrights'] as $formrights_row) {
          if($formrights_row->new==1){
            ...
            $result=$this->common_model->update_one_active_record('certificate_of_analysis',$data,'certificate_no',$this->uri->segment(3),$this->session->userdata['logged_in']['company_id']);
