...
class Ce_before_printing extends CI_Controller {
        ...
        if($module_row->module_name==='Production'){
          ...
          foreach ($data['formrights'] as $formrights_row) {
            if($formrights_row->view==1){
              ...
              include('coex_extrusion_pagination/pagination_before_printing.php');
              $data['coex_extrusion_printing']=$this->coex_extrusion_printing_model->select_active_record($config["per_page"],$this->uri->segment(3),$table,$this->session->userdata['logged_in']['company_id']);
