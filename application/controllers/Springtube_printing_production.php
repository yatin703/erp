...
class Springtube_printing_production extends CI_Controller {
          ...
          foreach ($data['formrights'] as $formrights_row) {
            if($formrights_row->new==1){
             ...
             //echo $this->db->last_query();
              ...
              $data_shift_issue=array('archive'=>0,'process_id'=>3);
      ...
      if($module_row->module_name==='Production'){
        ...
        foreach ($data['formrights'] as $formrights_row) {
          ...
          if($formrights_row->new==1){
            ...
            // $this->form_validation->set_rules('job_speed','Job Speed' ,'required|trim|xss_clean');
             
            // echo $this->input->post('production_date');          
           
            // if($this->form_validation->run()==FALSE){

            //   echo 'validation_false';
            //   echo $this->input->post('production_date'); 
              
            // }else{ 
 
            //     echo 'validation_true';
            //     echo $this->input->post('production_date'); 
            // }
            ...
            if(empty($this->input->post('production_date')) && empty($this->input->post('shift')) && empty($this->input->post('jobcard_no')) && empty($this->input->post('machine')) && empty($this->input->post('job_type')) && empty($this->input->post('job_category')) && empty($this->input->post('job_speed'))){

              $output=array('status'=>false,'message'=>'Please enter the fields');
              ...
              // $result_shift_check=$this->common_model->select_active_records_where('springtube_printing_production_master',$this->session->userdata['logged_in']['company_id'],$shift_data);
              // if($result_shift_check){

              //   $validation_error=1;

              //   $output=array('status'=>false,'message'=>'Shift entry for Jobcard no. '.$this->input->post('jobcard_no').' is already exist.');

              // }

              
              $data_prev_job_check=array('production_date'=>$postData['production_date']);
      
              $result_prev_job_check=$this->springtube_printing_production_model->select_top_one_active_record('springtube_printing_production_master',$this->session->userdata['logged_in']['company_id'],$data_arr=array(),'created_date','desc');

              foreach ($result_prev_job_check as $key => $result_prev_job_check_row) {

                if($result_prev_job_check_row->job_ended_flag!=1){

                    $validation_error=1;
                   
                   $output=array('status'=>false,'message'=>'Production entry for Jobcard no. '.$result_prev_job_check_row->jobcard_no.' is not ended');
              ...
              if($validation_error==0){
                ...
                $data=array(
                  ...
                  'job_speed'=>$this->input->post('job_speed'),                                                  
                  ...
                  $output=array('status'=>true,'message'=>'Job Started successfully!','production_id'=>$production_id);                  
      ...
      if($module_row->module_name==='Production'){
        ...
        foreach ($data['formrights'] as $formrights_row) {
          ...
          if($formrights_row->new==1){
            ...
            if(empty($this->input->post('production_id')) && empty($this->input->post('jobcard_no')) && empty($this->input->post('counter')) && empty($this->input->post('stop_reason'))){
              ...
              $pending_counter=round($jobcard_qty/$ups)-$total_counter;

              $data=array('status'=>false,'message'=>'Enter the fields','pending_counter'=>0,'data'=>null);
              ...
              echo  json_encode($data);         
                ...
                //if($result){
                  ...
                  // Total Counter available for this jobcard
                  ...
                  if($this->input->post('counter')<=$pending_counter){
                    ...
                    $result=$this->common_model->save('springtube_printing_production_details',$data_save);
                    ...
                    $result_counter=$this->springtube_printing_production_model->active_details_records('springtube_printing_production_details',$data_1);
                    //-------------------------------------------------------

                    
                    //--TOTAL COUNTER OF THIS JOB--------------------
                    $data_total_counter=array(                  
                    'jobcard_no'=>$this->input->post('jobcard_no')                        
                    );
                    ...
                    echo  json_encode($data);
                      ...
                      $data=array('status'=>false,'message'=>'Counter '.$this->input->post('counter').' not allowed.','pending_counter'=>0,'data'=>null);
      ...
      if($module_row->module_name==='Production'){
        ...
        foreach ($data['formrights'] as $formrights_row) {
          ...
          if($formrights_row->modify==1){
            ...
            if(empty($this->input->post('production_id')) && empty($this->input->post('editId'))){             

              $data=array('status'=>false,'message'=>'Enter the fields');
              echo  json_encode($data);         
            
              
            }else{                 
                 
              $data=array('details_id'=>$this->input->post('editId'));
              $result_counter=$this->springtube_printing_production_model->active_details_records('springtube_printing_production_details',$data);
              //print_r($result_counter);                   

              echo  json_encode($result_counter[0]);
      ...
      if($module_row->module_name==='Production'){
        ...
        foreach ($data['formrights'] as $formrights_row) {
          ...
          if($formrights_row->new==1){
            ...
            $this->form_validation->set_rules('production_id','Production Id' ,'required|trim|xss_clean');
            $this->form_validation->set_rules('shift_issues','Job End reason' ,'required|trim|xss_clean');            

            $this->form_validation->set_rules('extrusion_scrap','Extrusion Scrap MTRS' ,'trim|xss_clean');

            if($this->input->post('shift_issues')=='14'){
            ...
            if($this->form_validation->run()==FALSE){
             ...
             // echo $this->db->last_query();          
              ...
              $data=array(
                'job_ended_flag'=>'1',
                'job_ended_on'=>date('Y-m-d H:i:s'),
                'shift_issues'=>$this->input->post('shift_issues'),
                'remarks'=>$this->input->post('remarks'),
                'extrusion_scrap'=>$this->input->post('extrusion_scrap')
          ...
          foreach ($data['formrights'] as $formrights_row) {
            if($formrights_row->modify==1){
             ...
             // echo $this->db->last_query();
              ...
              $this->load->view(ucwords($this->router->fetch_class()).'/active-title',$data);
              $this->load->view(ucwords($this->router->fetch_class()).'/modify-form',$data);
              //$this->load->view(ucwords($this->router->fetch_class()).'/modify-form-test',$data);
              $this->load->view('Home/footer');
            }else{
              $data['note']='No rights Thanks';
              $this->load->view('Home/header');
      ...
      if($module_row->module_name==='Production'){
        ...
        foreach ($data['formrights'] as $formrights_row) {
          if($formrights_row->view==1){
            ...
            $dataa= array('shift' =>$this->uri->segment(4) );
            $data['springtube_printing_production_master_shiftwise']=$this->springtube_printing_production_model->select_active_records_search_shiftwise('springtube_printing_production_master',$this->session->userdata['logged_in']['company_id'],$dataa,$this->uri->segment(3),$this->uri->segment(3));
            //echo $this->db->last_query();
            ...
            $this->load->view('Print/header',$data);
            $this->load->view(ucwords($this->router->fetch_class()).'/view-form-shiftwise',$data);
            //$this->load->view('Home/footer');
          }else{
            $data['note']='No rights Thanks';
            $this->load->view('Home/header');
        ...
        if($module_row->module_name==='Production'){
          ...
          foreach ($data['formrights'] as $formrights_row) {
            if($formrights_row->view==1){
             ...
             $data['springtube_printing_color']=$this->springtube_printing_production_model->select_active_color_for_dropdown('springtube_printing_production_master',$this->session->userdata['logged_in']['company_id']); 

             $data['springtube_printing_printtype']=$this->springtube_printing_production_model->select_active_printtype_for_dropdown('springtube_printing_production_master',$this->session->userdata['logged_in']['company_id']); 
        ...
        foreach ($data['formrights'] as $formrights_row) {
          if($formrights_row->view==1){
            ...
            if($this->form_validation->run()==FALSE){
              ...
              $data['springtube_printing_production_master']=$this->springtube_printing_production_model->select_active_records_search_shiftwise('springtube_printing_production_master',$this->session->userdata['logged_in']['company_id'],$dataa,$this->input->post('from_date'),$this->input->post('to_date'));
      ...
      if($jobcard_no!='' && $total_meters!='' && $total_meters!='0'){
        ...
        if($specs_result){                      
          ...
          foreach($specs_result as $specs_row){
              ...
              $micron_6=$specs_row->FILM_GUAGE_5;       
  ...
  public function prev_job_end_check(){    
          
    $data=array('production_date'=>$this->input->post('production_date'));
      
    $result=$this->springtube_printing_production_model->select_top_one_active_record('springtube_printing_production_master',$this->session->userdata['logged_in']['company_id'],$data,'production_date','desc');

    foreach ($result as $key => $row) {

      if($row->job_ended_flag!=1){
        $this->form_validation->set_message('prev_job_end_check', 'Previous Job is not ended on this {field} ');
        return FALSE;
      }else{
        return TRUE;
      } 
