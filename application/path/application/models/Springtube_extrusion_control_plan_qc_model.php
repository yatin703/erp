...
class Springtube_extrusion_control_plan_qc_model extends CI_Model {	

	public function select_active_records($limit,$start,$table,$company){
		$this->db->select($table.'.*, right(time_stamp,8) as shift_time, springtube_machine_master.machine_name');
		$this->db->from($table);
