...
//Sales Order Create form
	...
	$query=$this->db->query("SELECT ANI.article_no,ANI.lang_article_description,A.main_group_id,ANI.lang_sub_description FROM article A, article_name_info ANI WHERE A.article_no = ANI.article_no AND A.archive <>1 AND A.company_id =  '$company' AND A.main_group_id IN('1','5','6','8','13','9','26','43','25','23','39','16','20','21','26','24','49','41','47','42')   AND  ANI.company_id =  '$company' AND ( ANI.lang_article_description LIKE '%$edit%' OR ANI.article_no like  '%$edit%' OR ANI.lang_sub_description like  '%$edit%') ORDER BY ANI.lang_article_description");
