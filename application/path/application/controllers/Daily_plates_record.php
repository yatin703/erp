...
class Daily_plates_record extends CI_Controller {
      ...
      if($module_row->module_name==='Sales'){
        ...
        foreach ($data['formrights'] as $formrights_row) {
          if($formrights_row->view==1){
            $table='graphics_daily_plates_master';
            include('pagination.php');
            $data['graphics_daily_plates_master']=$this->daily_plates_record_model->select_active_records($config["per_page"],$this->uri->segment(3),$table,$this->session->userdata['logged_in']['company_id']);
        ...
        foreach ($data['formrights'] as $formrights_row) {
          if($formrights_row->new==1){
            ...
            if($this->form_validation->run()==FALSE){
              ...
              $dpr_id=$this->common_model->save_return_pkey('graphics_daily_plates_master',$data);
              //$dpr_id=0;  
              ...
              if($dpr_id!='' || $dpr_id!=0){
                    ...
                    if(is_array($arr1)){
                        for($i=0;$i<count($arr1);$i++){
                            ...
                            $result=$this->common_model->save('graphics_daily_plates_details',$data);
      ...
      if($module_row->module_name==='Sales'){
        ...
        foreach ($data['formrights'] as $formrights_row) {
          if($formrights_row->modify==1){
            ...
            $data['graphics_daily_plates_master']=$this->daily_plates_record_model->select_one_active_record('graphics_daily_plates_master',$this->session->userdata['logged_in']['company_id'],'graphics_daily_plates_master.dpr_id',$this->uri->segment(3));
          ...
          foreach ($data['formrights'] as $formrights_row) {
            if($formrights_row->modify==1){
              ...
              if($this->form_validation->run()==FALSE){
                ...
                $data['graphics_daily_plates_master']=$this->daily_plates_record_model->select_one_active_record('graphics_daily_plates_master',$this->session->userdata['logged_in']['company_id'],'graphics_daily_plates_master.dpr_id',$this->input->post('dpr_id'));
                ...
                $result=$this->common_model->update_one_active_record('graphics_daily_plates_master',$data,'dpr_id',$this->input->post('dpr_id'),$this->session->userdata['logged_in']['company_id']);

                // Removing Old Plate details and inserting new
                $result=$this->common_model->delete_one_active_record_noncompany('graphics_daily_plates_details','dpr_id',$this->input->post('dpr_id'));
        ...
        if($module_row->module_name==='Sales'){
          ...
          foreach ($data['formrights'] as $formrights_row) {
            if($formrights_row->delete==1){
                  ...
                  $result=$this->common_model->update_one_active_record('graphics_daily_plates_master',$data,'dpr_id',$this->uri->segment(3),$this->session->userdata['logged_in']['company_id']);

                  $data['graphics_daily_plates_master']=$this->daily_plates_record_model->select_one_inactive_record('graphics_daily_plates_master',$this->session->userdata['logged_in']['company_id'],'graphics_daily_plates_master.dpr_id',$this->uri->segment(3));
      ...
      if($module_row->module_name==='Sales'){
        ...
        foreach ($data['formrights'] as $formrights_row) {
          if($formrights_row->delete==1){
             ...
             $table='graphics_daily_plates_master';
            include('pagination.php');
            $data['graphics_daily_plates_master']=$this->daily_plates_record_model->select_archive_records($config["per_page"],$this->uri->segment(3),$table,$this->session->userdata['logged_in']['company_id']);
      ...
      if($module_row->module_name==='Sales'){
        ...
        foreach ($data['formrights'] as $formrights_row) {
          if($formrights_row->view==1){
            ...
            $data['graphics_daily_plates_details']=$this->common_model->select_one_details_record_noncompany('graphics_daily_plates_details','dpr_id',$this->uri->segment(3));
