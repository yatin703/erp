        ...
        foreach ($data['formrights'] as $formrights_row) {
          if($formrights_row->new==1){
            ...
            foreach($this->input->post('mm_id') as $mm_id => $mm_id_value){
              ...
              $this->form_validation->set_rules('quantity_'.$mm_id_value.'','Quantity '.$mm_id_value.'' ,'required|trim|xss_clean|max_length[15]');
            ...
            //-------------------------------------------------------------------    
              ...
              //Jobcard to tally_material_issue_master sql intigration 9th April 2019---
                ...
                $jobcard_tally=$this->input->post('jobcard_no').'/'.date('Y-m-d h:i');
        ...
        foreach ($data['formrights'] as $formrights_row) {
          if($formrights_row->new==1){
            ...
            foreach($this->input->post('sr_no') as $sr_no => $sr_no_value){
              ...
              $this->form_validation->set_rules('issue_quantity_'.$sr_no_value.'','Issue Quantity.'.$sr_no_value.'' ,'required|trim|xss_clean|max_length[15]');
