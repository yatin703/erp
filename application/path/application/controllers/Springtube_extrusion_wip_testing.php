...
class Springtube_extrusion_wip_testing extends CI_Controller {
                  ...
                  if($this->input->post('release_to')=='1'){                    
                    ...
                    if($pending_meters>0){
                      ...
                      $data_wip_insert=array(
                        ...
                        $result=$this->springtube_extrusion_wip_model->wip_release_partially($data_wip_before_insert,$data_wip_insert,$data_wip_update,$wip_id);
