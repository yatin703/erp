      ...
      if($module_row->module_name==='Sales'){
        ...
        foreach ($data['formrights'] as $formrights_row) {
          if($formrights_row->new==1){
            ...
            $this->form_validation->set_rules('name2','Society/Building' ,'trim|xss_clean|max_length[100]|strtoupper|required');
            $this->form_validation->set_rules('street','Street' ,'trim|xss_clean|max_length[150]|strtoupper|required');
           ...
           // $this->form_validation->set_rules('isdn_local','Gst No' ,'required|trim|xss_clean|exact_length[15]|alpha_numeric|strtoupper');
            ...
            $this->form_validation->set_rules('max_lead_time','Max Lead Time' ,'trim|xss_clean|max_length[2]|is_natural');
            ...
            $data['bank']=$this->customer_model->select_active_bank_drop_down('bank_master');
              ...
              $data=array('company_id'=>$this->session->userdata['logged_in']['company_id'],
                    ...
                    'max_lead_time'=>$this->input->post('max_lead_time')
                  );
              ...
              //tally Customer Master to Ledger master SQl Integration---------
                  ...
                  $mailing_name=strtoupper($this->input->post('name1'));
                    ...
                    $address_1=$this->input->post('name2');
                    $address_2=$this->input->post('street');
                    $address_3=$this->input->post('name3');
