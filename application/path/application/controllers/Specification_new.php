...
class Specification_new extends CI_Controller {

  function __construct(){
    parent::__construct();
    if($this->session->userdata('logged_in')){
      $this->load->model('common_model');
      $this->load->model('specification_new_model');
      ...
      if($module_row->module_name==='Sales'){
        ...
        foreach ($data['formrights'] as $formrights_row) {
          if($formrights_row->view==1){
            ...
            $data['specification']=$this->specification_new_model->select_active_records($config["per_page"],$this->uri->segment(3),$table,$this->session->userdata['logged_in']['company_id']);
  ...
  function view(){
    ...
    foreach ($data['module'] as $module_row) {
      if($module_row->module_name==='Sales'){
        ...
        foreach ($data['formrights'] as $formrights_row) {
          if($formrights_row->view==1){
            $data['specification']=$this->specification_new_model->select_one_active_record('specification_sheet',$this->session->userdata['logged_in']['company_id'],'specification_sheet.spec_id',$this->uri->segment(3),'specification_sheet.spec_version_no',$this->uri->segment(4));
      ...
      if($module_row->module_name==='Sales'){
        ...
        foreach ($data['formrights'] as $formrights_row) {
          if($formrights_row->new==1){
            ...
            $data['purg_rm']=$this->article_model->spec_active_record_search('article','186',$this->session->userdata['logged_in']['company_id']);
        ...
        foreach ($data['formrights'] as $formrights_row) {
          if($formrights_row->new==1){
            ...
            $data['masterbatch']=$this->article_model->spec_all_active_record_search('article','12',$this->session->userdata['logged_in']['company_id']);
              ...
              $data['spec_version']=$this->specification_new_model->select_specification_verion_no('specification_sheet',$this->session->userdata['logged_in']['company_id'],'article_no',$article_no_arr[1]);
      ...
      if($module_row->module_name==='Sales'){
        ...
        foreach ($data['formrights'] as $formrights_row) {
          if($formrights_row->delete==1){
            ...
            $data['specification']=$this->specification_new_model->select_archive_records($config["per_page"],$this->uri->segment(3),$table,$this->session->userdata['logged_in']['company_id']);
            $this->load->view('Home/header');
            $this->load->view('Home/nav',$data);
            $this->load->view('Home/subnav');
          ...
          foreach ($data['formrights'] as $formrights_row) {
            ...
            $this->form_validation->set_rules('cap_foil_dist_frm_bottom','Cap Foil Distance From Bottom' ,'trim|xss_clean|strtoupper');
              ...
              $result=$this->common_model->update_one_active_record('article_name_info',$data,'article_no',$this->input->post('article_no'),$this->session->userdata['logged_in']['company_id']);
                  ...
                  $result=$this->specification_new_model->update_details_record_where('specification_sheet_details',$data,'spec_id',$this->input->post('spec_id'),'spec_version_no',$this->input->post('spec_version_no'),'srd_id','3_2',$this->session->userdata['logged_in']['company_id']);

                  $data=array('relating_master_value'=>$cap_finish[0]);

                  $result=$this->specification_new_model->update_details_record_where('specification_sheet_details',$data,'spec_id',$this->input->post('spec_id'),'spec_version_no',$this->input->post('spec_version_no'),'srd_id','3_3',$this->session->userdata['logged_in']['company_id']);

                  $data=array('relating_master_value'=>$cap_dia[0]);

                  $result=$this->specification_new_model->update_details_record_where('specification_sheet_details',$data,'spec_id',$this->input->post('spec_id'),'spec_version_no',$this->input->post('spec_version_no'),'srd_id','3_4',$this->session->userdata['logged_in']['company_id']);

                  $data=array('relating_master_value'=>$cap_orifice[0]);

                  $result=$this->specification_new_model->update_details_record_where('specification_sheet_details',$data,'spec_id',$this->input->post('spec_id'),'spec_version_no',$this->input->post('spec_version_no'),'srd_id','3_6',$this->session->userdata['logged_in']['company_id']);


                  $data=array('mat_article_no'=>$cap_masterbatch[0],'mat_info'=>$this->input->post('cap_mb_per').'%','supplier_no'=>$cap_mb_supplier[1]);

                  $result=$this->specification_new_model->update_details_record_where('specification_sheet_details',$data,'spec_id',$this->input->post('spec_id'),'spec_version_no',$this->input->post('spec_version_no'),'srd_id','3_7_0',$this->session->userdata['logged_in']['company_id']);

                  $data=array('mat_article_no'=>$cap_shrink_sleeve[0],'parameter_value'=>$cap_shrink_sleeve[1]);

                  $result=$this->specification_new_model->update_details_record_where('specification_sheet_details',$data,'spec_id',$this->input->post('spec_id'),'spec_version_no',$this->input->post('spec_version_no'),'srd_id','3_5',$this->session->userdata['logged_in']['company_id']);

                  $data=array('mat_article_no'=>$cap_foil_color[0],'parameter_value'=>$cap_foil_color[1]);

                  $result=$this->specification_new_model->update_details_record_where('specification_sheet_details',$data,'spec_id',$this->input->post('spec_id'),'spec_version_no',$this->input->post('spec_version_no'),'srd_id','3_9',$this->session->userdata['logged_in']['company_id']);

                  $data=array('parameter_value'=>$this->input->post('cap_foil_width'));

                  $result=$this->specification_new_model->update_details_record_where('specification_sheet_details',$data,'spec_id',$this->input->post('spec_id'),'spec_version_no',$this->input->post('spec_version_no'),'srd_id','3_10',$this->session->userdata['logged_in']['company_id']);

                  $data=array('parameter_value'=>$this->input->post('cap_foil_dist_frm_bottom'));

                  $result=$this->specification_new_model->update_details_record_where('specification_sheet_details',$data,'spec_id',$this->input->post('spec_id'),'spec_version_no',$this->input->post('spec_version_no'),'srd_id','3_11',$this->session->userdata['logged_in']['company_id']);

                  $data=array('mat_article_no'=>$this->input->post('cap_pp'),'mat_info'=>$this->input->post('pp_per').'%');

                  $result=$this->specification_new_model->update_details_record_where('specification_sheet_details',$data,'spec_id',$this->input->post('spec_id'),'spec_version_no',$this->input->post('spec_version_no'),'srd_id','3_8_1',$this->session->userdata['logged_in']['company_id']);

                  if(!empty($this->input->post('approval_authority'))){

                    $data=array('pending_flag'=>'1');

                    $result=$this->specification_new_model->update_one_active_record('specification_sheet',$data,'spec_id',$this->input->post('spec_id'),'spec_version_no',$this->input->post('spec_version_no'),$this->session->userdata['logged_in']['company_id']);
                ...
                /*}else{
                  ...
                  $data['specification']=$this->specification_new_model->select_one_active_record('specification_sheet',$this->session->userdata['logged_in']['company_id'],'specification_sheet.spec_id',$this->input->post('spec_id'),'specification_sheet.spec_version_no',$this->input->post('spec_version_no'),'specification_sheet.user_id',$this->session->userdata['logged_in']['user_id']);
            ...
            $this->form_validation->set_rules('cap_article_no','Cap Article No' ,'trim|xss_clean|callback_article_check');
              ...
              if($this->form_validation->run()==FALSE){
                ...
                if($data['specs_details']==FALSE){
                  ...
                  $result=$this->specification_new_model->update_one_active_record('specification_sheet_lang',$data,'spec_id',$this->input->post('spec_id'),'spec_version_no',$this->input->post('spec_version_no'),$this->session->userdata['logged_in']['company_id']);

                  $data=array('relating_master_value'=>$sleeve_dia[0]);

                  $result=$this->specification_new_model->update_details_record_where('specification_sheet_details',$data,'spec_id',$this->input->post('spec_id'),'spec_version_no',$this->input->post('spec_version_no'),'srd_id','1_1',$this->session->userdata['logged_in']['company_id']);

                  $data=array('parameter_value'=>$this->input->post('sleeve_length').' MM');

                  $result=$this->specification_new_model->update_details_record_where('specification_sheet_details',$data,'spec_id',$this->input->post('spec_id'),'spec_version_no',$this->input->post('spec_version_no'),'srd_id','1_2',$this->session->userdata['logged_in']['company_id']);

                  $data=array('parameter_value'=>$this->input->post('gauge').' MIC');

                  $result=$this->specification_new_model->update_details_record_where('specification_sheet_details',$data,'spec_id',$this->input->post('spec_id'),'spec_version_no',$this->input->post('spec_version_no'),'srd_id','1_4',$this->session->userdata['logged_in']['company_id']);

                  $data=array('relating_master_value'=>$this->input->post('print_type'));

                  $result=$this->specification_new_model->update_details_record_where('specification_sheet_details',$data,'spec_id',$this->input->post('spec_id'),'spec_version_no',$this->input->post('spec_version_no'),'srd_id','1_7',$this->session->userdata['logged_in']['company_id']);

                  $data=array('mat_article_no'=>$this->input->post('sl_masterbatch'),'mat_info'=>$this->input->post('sl_mb_per').'%','supplier_no'=>$sl_mb_supplier[1]);

                  $result=$this->specification_new_model->update_details_record_where('specification_sheet_details',$data,'spec_id',$this->input->post('spec_id'),'spec_version_no',$this->input->post('spec_version_no'),'srd_id','1_5_0',$this->session->userdata['logged_in']['company_id']);

                  $data=array('mat_article_no'=>$this->input->post('sl_ldpe'),'mat_info'=>$this->input->post('sl_ldpe_per').'%');

                  $result=$this->specification_new_model->update_details_record_where('specification_sheet_details',$data,'spec_id',$this->input->post('spec_id'),'spec_version_no',$this->input->post('spec_version_no'),'srd_id','1_6_0',$this->session->userdata['logged_in']['company_id']);

                  $data=array('mat_article_no'=>$this->input->post('sl_lldpe'),'mat_info'=>$this->input->post('sl_lldpe_per').'%');

                  $result=$this->specification_new_model->update_details_record_where('specification_sheet_details',$data,'spec_id',$this->input->post('spec_id'),'spec_version_no',$this->input->post('spec_version_no'),'srd_id','1_6_1',$this->session->userdata['logged_in']['company_id']);

                  $data=array('mat_article_no'=>$this->input->post('sl_hdpe'),'mat_info'=>$this->input->post('sl_hdpe_per').'%');

                  $result=$this->specification_new_model->update_details_record_where('specification_sheet_details',$data,'spec_id',$this->input->post('spec_id'),'spec_version_no',$this->input->post('spec_version_no'),'srd_id','1_6_2',$this->session->userdata['logged_in']['company_id']);

                  $data=array('relating_master_value'=>$shoulder[0]);

                  $result=$this->specification_new_model->update_details_record_where('specification_sheet_details',$data,'spec_id',$this->input->post('spec_id'),'spec_version_no',$this->input->post('spec_version_no'),'srd_id','2_2',$this->session->userdata['logged_in']['company_id']);

                  $data=array('relating_master_value'=>$shoulder[0]);

                  $result=$this->specification_new_model->update_details_record_where('specification_sheet_details',$data,'spec_id',$this->input->post('spec_id'),'spec_version_no',$this->input->post('spec_version_no'),'srd_id','2_3',$this->session->userdata['logged_in']['company_id']);

                  $data=array('relating_master_value'=>$shoulder_orifice[0]);

                  $result=$this->specification_new_model->update_details_record_where('specification_sheet_details',$data,'spec_id',$this->input->post('spec_id'),'spec_version_no',$this->input->post('spec_version_no'),'srd_id','2_4',$this->session->userdata['logged_in']['company_id']);

                  $data=array('parameter_value'=>$this->input->post('shoulder_foil_tag'));

                  $result=$this->specification_new_model->update_details_record_where('specification_sheet_details',$data,'spec_id',$this->input->post('spec_id'),'spec_version_no',$this->input->post('spec_version_no'),'srd_id','2_8',$this->session->userdata['logged_in']['company_id']);


                  $data=array('mat_article_no'=>$this->input->post('sh_masterbatch'),'mat_info'=>$this->input->post('sh_mb_per').'%','supplier_no'=>$sh_mb_supplier[1]);

                  $result=$this->specification_new_model->update_details_record_where('specification_sheet_details',$data,'spec_id',$this->input->post('spec_id'),'spec_version_no',$this->input->post('spec_version_no'),'srd_id','2_6_0',$this->session->userdata['logged_in']['company_id']);

                  $data=array('mat_article_no'=>$this->input->post('sh_hdpe_one'),'mat_info'=>$this->input->post('sh_hdpe_one_per').'%');

                  $result=$this->specification_new_model->update_details_record_where('specification_sheet_details',$data,'spec_id',$this->input->post('spec_id'),'spec_version_no',$this->input->post('spec_version_no'),'srd_id','2_7_0',$this->session->userdata['logged_in']['company_id']);

                  $data=array('mat_article_no'=>$this->input->post('sh_hdpe_two'),'mat_info'=>$this->input->post('sh_hdpe_two_per').'%');

                  $result=$this->specification_new_model->update_details_record_where('specification_sheet_details',$data,'spec_id',$this->input->post('spec_id'),'spec_version_no',$this->input->post('spec_version_no'),'srd_id','2_7_1',$this->session->userdata['logged_in']['company_id']);

                  $data=array('parameter_value'=>$cap_article_no_arr[2]."//".$cap_article_no_arr[3]);

                  $result=$this->specification_new_model->update_details_record_where('specification_sheet_details',$data,'spec_id',$this->input->post('spec_id'),'spec_version_no',$this->input->post('spec_version_no'),'srd_id','3_1',$this->session->userdata['logged_in']['company_id']);
      ...
      if($module_row->module_name==='Sales'){
        ...
        foreach ($data['formrights'] as $formrights_row) {
          if($formrights_row->copy==1){
            ...
            $data['specification']=$this->specification_new_model->select_one_active_record('specification_sheet',$this->session->userdata['logged_in']['company_id'],'specification_sheet.spec_id',$this->uri->segment(3),'specification_sheet.spec_version_no',$this->uri->segment(4),'specification_sheet.user_id',$this->session->userdata['logged_in']['user_id']);
      ...
      if($module_row->module_name==='Sales'){
        ...
        foreach ($data['formrights'] as $formrights_row) {
          if($formrights_row->copy==1){
            ...
            $data['specification']=$this->specification_new_model->select_one_active_record('specification_sheet',$this->session->userdata['logged_in']['company_id'],'specification_sheet.spec_id',$this->input->post('spec_id'),'specification_sheet.spec_version_no',$this->input->post('copy_version_no'));
            ...
            $result=$this->common_model->save('specification_sheet_lang',$data);
              ...
              header("refresh:1;url=".base_url()."index.php/".$this->router->fetch_class());
                  ...
                  $data['specification']=$this->specification_new_model->select_one_active_record('specification_sheet',$this->session->userdata['logged_in']['company_id'],'specification_sheet.spec_id',$spec_no,'specification_sheet.spec_version_no',$spec_version_no);
        ...
        if($module_row->module_name==='Sales'){
          ...
          foreach ($data['formrights'] as $formrights_row) {
            if($formrights_row->delete==1){
                  ...
                  $result=$this->specification_new_model->update_one_active_record('specification_sheet',$data,'spec_id',$this->uri->segment(3),'spec_version_no',$this->uri->segment(4),$this->session->userdata['logged_in']['company_id']);

                  $data['specification']=$this->specification_new_model->select_one_inactive_record('specification_sheet',$this->session->userdata['logged_in']['company_id'],'specification_sheet.spec_id',$this->uri->segment(3),'specification_sheet.spec_version_no',$this->input->post('spec_version_no'));
            ...
            if($this->input->post('cap_type')){
              ...
              if($this->form_validation->run()==FALSE){
                ...
                $this->load->view('Home/footer');
                  ...
                  $result=$this->specification_new_model->update_details_record_where('specification_sheet_details',$data,'spec_id',$this->input->post('spec_id'),'spec_version_no',$this->input->post('spec_version_no'),'srd_id','2_1',$this->session->userdata['logged_in']['company_id']);
                  ...
                  $result=$this->specification_new_model->update_details_record_where('specification_sheet_details',$data,'spec_id',$this->input->post('spec_id'),'spec_version_no',$this->input->post('spec_version_no'),'srd_id','2_7',$this->session->userdata['logged_in']['company_id']);
                  ...
                  $result=$this->specification_new_model->update_details_record_where('specification_sheet_details',$data,'spec_id',$this->input->post('spec_id'),'spec_version_no',$this->input->post('spec_version_no'),'srd_id','2_5_0',$this->session->userdata['logged_in']['company_id']);
                  ...
                  $result=$this->specification_new_model->update_details_record_where('specification_sheet_details',$data,'spec_id',$this->input->post('spec_id'),'spec_version_no',$this->input->post('spec_version_no'),'srd_id','2_6_1',$this->session->userdata['logged_in']['company_id']);

                  $data=array('mat_article_no'=>$this->input->post('sl_hdpe_two'),'mat_info'=>$this->input->post('sl_hdpe_per_two').'%');

                  $result=$this->specification_new_model->update_details_record_where('specification_sheet_details',$data,'spec_id',$this->input->post('spec_id'),'spec_version_no',$this->input->post('spec_version_no'),'srd_id','2_6_2',$this->session->userdata['logged_in']['company_id']);
                  ...
                  $result=$this->specification_new_model->update_details_record_where('specification_sheet_details',$data,'spec_id',$this->input->post('spec_id'),'spec_version_no',$this->input->post('spec_version_no'),'srd_id','3_8',$this->session->userdata['logged_in']['company_id']);


                  $data=array('mat_article_no'=>$this->input->post('sh_masterbatch'),'mat_info'=>$this->input->post('sh_mb_per').'%','supplier_no'=>$sh_mb_supplier[1]);

                  $result=$this->specification_new_model->update_details_record_where('specification_sheet_details',$data,'spec_id',$this->input->post('spec_id'),'spec_version_no',$this->input->post('spec_version_no'),'srd_id','3_6_0',$this->session->userdata['logged_in']['company_id']);
                  ...
                  $result=$this->specification_new_model->update_details_record_where('specification_sheet_details',$data,'spec_id',$this->input->post('spec_id'),'spec_version_no',$this->input->post('spec_version_no'),'srd_id','3_7_1',$this->session->userdata['logged_in']['company_id']);

                  //Cap

                  $data=array('relating_master_value'=>$cap_type[0]);

                  $result=$this->specification_new_model->update_details_record_where('specification_sheet_details',$data,'spec_id',$this->input->post('spec_id'),'spec_version_no',$this->input->post('spec_version_no'),'srd_id','4_2',$this->session->userdata['logged_in']['company_id']);

                  $data=array('relating_master_value'=>$cap_finish[0]);

                  $result=$this->specification_new_model->update_details_record_where('specification_sheet_details',$data,'spec_id',$this->input->post('spec_id'),'spec_version_no',$this->input->post('spec_version_no'),'srd_id','4_3',$this->session->userdata['logged_in']['company_id']);

                  $data=array('relating_master_value'=>$cap_dia[0]);

                  $result=$this->specification_new_model->update_details_record_where('specification_sheet_details',$data,'spec_id',$this->input->post('spec_id'),'spec_version_no',$this->input->post('spec_version_no'),'srd_id','4_4',$this->session->userdata['logged_in']['company_id']);

                  $data=array('relating_master_value'=>$cap_orifice[0]);

                  $result=$this->specification_new_model->update_details_record_where('specification_sheet_details',$data,'spec_id',$this->input->post('spec_id'),'spec_version_no',$this->input->post('spec_version_no'),'srd_id','4_6',$this->session->userdata['logged_in']['company_id']);


                  $data=array('mat_article_no'=>$this->input->post('cap_masterbatch'),'mat_info'=>$this->input->post('cap_mb_per').'%','supplier_no'=>$cap_mb_supplier[1]);

                  $result=$this->specification_new_model->update_details_record_where('specification_sheet_details',$data,'spec_id',$this->input->post('spec_id'),'spec_version_no',$this->input->post('spec_version_no'),'srd_id','4_7_0',$this->session->userdata['logged_in']['company_id']);

                  $data=array('mat_article_no'=>$this->input->post('cap_pp'),'mat_info'=>$this->input->post('pp_per').'%');

                  $result=$this->specification_new_model->update_details_record_where('specification_sheet_details',$data,'spec_id',$this->input->post('spec_id'),'spec_version_no',$this->input->post('spec_version_no'),'srd_id','4_8_1',$this->session->userdata['logged_in']['company_id']);


                  $data=array('parameter_value'=>$this->input->post('cap_foil_color'));

                  $result=$this->specification_new_model->update_details_record_where('specification_sheet_details',$data,'spec_id',$this->input->post('spec_id'),'spec_version_no',$this->input->post('spec_version_no'),'srd_id','4_9',$this->session->userdata['logged_in']['company_id']);

                  $data=array('parameter_value'=>$this->input->post('cap_foil_width'));

                  $result=$this->specification_new_model->update_details_record_where('specification_sheet_details',$data,'spec_id',$this->input->post('spec_id'),'spec_version_no',$this->input->post('spec_version_no'),'srd_id','4_10',$this->session->userdata['logged_in']['company_id']);

                  $data=array('parameter_value'=>$this->input->post('cap_foil_dist_frm_bottom'));

                  $result=$this->specification_new_model->update_details_record_where('specification_sheet_details',$data,'spec_id',$this->input->post('spec_id'),'spec_version_no',$this->input->post('spec_version_no'),'srd_id','4_11',$this->session->userdata['logged_in']['company_id']);
            ...
            if($this->input->post('cap_type')){
              ...
              if($this->form_validation->run()==FALSE){
                ...
                $this->load->view('Home/footer');
                  ...
                  $result=$this->specification_new_model->update_details_record_where('specification_sheet_details',$data,'spec_id',$this->input->post('spec_id'),'spec_version_no',$this->input->post('spec_version_no'),'srd_id','3_7',$this->session->userdata['logged_in']['company_id']);
                  ...
                  $result=$this->specification_new_model->update_details_record_where('specification_sheet_details',$data,'spec_id',$this->input->post('spec_id'),'spec_version_no',$this->input->post('spec_version_no'),'srd_id','3_5_0',$this->session->userdata['logged_in']['company_id']);
                  ...
                  $result=$this->specification_new_model->update_details_record_where('specification_sheet_details',$data,'spec_id',$this->input->post('spec_id'),'spec_version_no',$this->input->post('spec_version_no'),'srd_id','3_6_1',$this->session->userdata['logged_in']['company_id']);

                  $data=array('mat_article_no'=>$this->input->post('sl_hdpe_three'),'mat_info'=>$this->input->post('sl_hdpe_per_three').'%');

                  $result=$this->specification_new_model->update_details_record_where('specification_sheet_details',$data,'spec_id',$this->input->post('spec_id'),'spec_version_no',$this->input->post('spec_version_no'),'srd_id','3_6_2',$this->session->userdata['logged_in']['company_id']);
                  ...
                  $result=$this->specification_new_model->update_details_record_where('specification_sheet_details',$data,'spec_id',$this->input->post('spec_id'),'spec_version_no',$this->input->post('spec_version_no'),'srd_id','4_8',$this->session->userdata['logged_in']['company_id']);


                  $data=array('mat_article_no'=>$this->input->post('sh_masterbatch'),'mat_info'=>$this->input->post('sh_mb_per').'%','supplier_no'=>$sh_mb_supplier[1]);

                  $result=$this->specification_new_model->update_details_record_where('specification_sheet_details',$data,'spec_id',$this->input->post('spec_id'),'spec_version_no',$this->input->post('spec_version_no'),'srd_id','4_6_0',$this->session->userdata['logged_in']['company_id']);
                  ...
                  $result=$this->specification_new_model->update_details_record_where('specification_sheet_details',$data,'spec_id',$this->input->post('spec_id'),'spec_version_no',$this->input->post('spec_version_no'),'srd_id','4_7_1',$this->session->userdata['logged_in']['company_id']);

                  //Cap

                  $data=array('relating_master_value'=>$cap_type[0]);

                  $result=$this->specification_new_model->update_details_record_where('specification_sheet_details',$data,'spec_id',$this->input->post('spec_id'),'spec_version_no',$this->input->post('spec_version_no'),'srd_id','5_2',$this->session->userdata['logged_in']['company_id']);

                  $data=array('relating_master_value'=>$cap_finish[0]);

                  $result=$this->specification_new_model->update_details_record_where('specification_sheet_details',$data,'spec_id',$this->input->post('spec_id'),'spec_version_no',$this->input->post('spec_version_no'),'srd_id','5_3',$this->session->userdata['logged_in']['company_id']);

                  $data=array('relating_master_value'=>$cap_dia[0]);

                  $result=$this->specification_new_model->update_details_record_where('specification_sheet_details',$data,'spec_id',$this->input->post('spec_id'),'spec_version_no',$this->input->post('spec_version_no'),'srd_id','5_4',$this->session->userdata['logged_in']['company_id']);

                  $data=array('relating_master_value'=>$cap_orifice[0]);

                  $result=$this->specification_new_model->update_details_record_where('specification_sheet_details',$data,'spec_id',$this->input->post('spec_id'),'spec_version_no',$this->input->post('spec_version_no'),'srd_id','5_6',$this->session->userdata['logged_in']['company_id']);


                  $data=array('mat_article_no'=>$this->input->post('cap_masterbatch'),'mat_info'=>$this->input->post('cap_mb_per').'%','supplier_no'=>$cap_mb_supplier[1]);

                  $result=$this->specification_new_model->update_details_record_where('specification_sheet_details',$data,'spec_id',$this->input->post('spec_id'),'spec_version_no',$this->input->post('spec_version_no'),'srd_id','5_7_0',$this->session->userdata['logged_in']['company_id']);

                  $data=array('mat_article_no'=>$this->input->post('cap_pp'),'mat_info'=>$this->input->post('pp_per').'%');

                  $result=$this->specification_new_model->update_details_record_where('specification_sheet_details',$data,'spec_id',$this->input->post('spec_id'),'spec_version_no',$this->input->post('spec_version_no'),'srd_id','5_8_1',$this->session->userdata['logged_in']['company_id']);


                  $data=array('parameter_value'=>$this->input->post('cap_foil_color'));

                  $result=$this->specification_new_model->update_details_record_where('specification_sheet_details',$data,'spec_id',$this->input->post('spec_id'),'spec_version_no',$this->input->post('spec_version_no'),'srd_id','5_9',$this->session->userdata['logged_in']['company_id']);

                  $data=array('parameter_value'=>$this->input->post('cap_foil_width'));

                  $result=$this->specification_new_model->update_details_record_where('specification_sheet_details',$data,'spec_id',$this->input->post('spec_id'),'spec_version_no',$this->input->post('spec_version_no'),'srd_id','5_10',$this->session->userdata['logged_in']['company_id']);

                  $data=array('parameter_value'=>$this->input->post('cap_foil_dist_frm_bottom'));

                  $result=$this->specification_new_model->update_details_record_where('specification_sheet_details',$data,'spec_id',$this->input->post('spec_id'),'spec_version_no',$this->input->post('spec_version_no'),'srd_id','5_11',$this->session->userdata['logged_in']['company_id']);
            ...
            if($this->input->post('cap_type')){
              ...
              if($this->form_validation->run()==FALSE){
                ...
                $this->load->view('Home/footer');
                  ...
                  $result=$this->specification_new_model->update_details_record_where('specification_sheet_details',$data,'spec_id',$this->input->post('spec_id'),'spec_version_no',$this->input->post('spec_version_no'),'srd_id','2_6_4',$this->session->userdata['logged_in']['company_id']);
                  ...
                  $result=$this->specification_new_model->update_details_record_where('specification_sheet_details',$data,'spec_id',$this->input->post('spec_id'),'spec_version_no',$this->input->post('spec_version_no'),'srd_id','3_6_3',$this->session->userdata['logged_in']['company_id']);
                  ...
                  $result=$this->specification_new_model->update_details_record_where('specification_sheet_details',$data,'spec_id',$this->input->post('spec_id'),'spec_version_no',$this->input->post('spec_version_no'),'srd_id','4_1',$this->session->userdata['logged_in']['company_id']);
                  ...
                  $result=$this->specification_new_model->update_details_record_where('specification_sheet_details',$data,'spec_id',$this->input->post('spec_id'),'spec_version_no',$this->input->post('spec_version_no'),'srd_id','4_7',$this->session->userdata['logged_in']['company_id']);

                  $data=array('mat_article_no'=>$this->input->post('sl_admer_four'),'mat_info'=>$this->input->post('sl_admer_per_four').'%');

                  $result=$this->specification_new_model->update_details_record_where('specification_sheet_details',$data,'spec_id',$this->input->post('spec_id'),'spec_version_no',$this->input->post('spec_version_no'),'srd_id','4_6_4',$this->session->userdata['logged_in']['company_id']);


                  //Layer 5
                  $data=array('relating_master_value'=>$sleeve_dia[0]);

                  $result=$this->specification_new_model->update_details_record_where('specification_sheet_details',$data,'spec_id',$this->input->post('spec_id'),'spec_version_no',$this->input->post('spec_version_no'),'srd_id','5_1',$this->session->userdata['logged_in']['company_id']);
                  ...
                  $result=$this->specification_new_model->update_details_record_where('specification_sheet_details',$data,'spec_id',$this->input->post('spec_id'),'spec_version_no',$this->input->post('spec_version_no'),'srd_id','5_7',$this->session->userdata['logged_in']['company_id']);
                  ...
                  $result=$this->specification_new_model->update_details_record_where('specification_sheet_details',$data,'spec_id',$this->input->post('spec_id'),'spec_version_no',$this->input->post('spec_version_no'),'srd_id','5_5_0',$this->session->userdata['logged_in']['company_id']);

                  $data=array('mat_article_no'=>$this->input->post('sl_ldpe_five'),'mat_info'=>$this->input->post('sl_ldpe_per_five').'%');

                  $result=$this->specification_new_model->update_details_record_where('specification_sheet_details',$data,'spec_id',$this->input->post('spec_id'),'spec_version_no',$this->input->post('spec_version_no'),'srd_id','5_6_0',$this->session->userdata['logged_in']['company_id']);

                  $data=array('mat_article_no'=>$this->input->post('sl_lldpe_five'),'mat_info'=>$this->input->post('sl_lldpe_per_five').'%');

                  $result=$this->specification_new_model->update_details_record_where('specification_sheet_details',$data,'spec_id',$this->input->post('spec_id'),'spec_version_no',$this->input->post('spec_version_no'),'srd_id','5_6_1',$this->session->userdata['logged_in']['company_id']);

                  $data=array('mat_article_no'=>$this->input->post('sl_hdpe_five'),'mat_info'=>$this->input->post('sl_hdpe_per_five').'%');

                  $result=$this->specification_new_model->update_details_record_where('specification_sheet_details',$data,'spec_id',$this->input->post('spec_id'),'spec_version_no',$this->input->post('spec_version_no'),'srd_id','5_6_2',$this->session->userdata['logged_in']['company_id']);
                  
                  //Shoulder

                  $data=array('relating_master_value'=>$shoulder[0]);

                  $result=$this->specification_new_model->update_details_record_where('specification_sheet_details',$data,'spec_id',$this->input->post('spec_id'),'spec_version_no',$this->input->post('spec_version_no'),'srd_id','6_2',$this->session->userdata['logged_in']['company_id']);

                  $data=array('relating_master_value'=>$shoulder[0]);

                  $result=$this->specification_new_model->update_details_record_where('specification_sheet_details',$data,'spec_id',$this->input->post('spec_id'),'spec_version_no',$this->input->post('spec_version_no'),'srd_id','6_3',$this->session->userdata['logged_in']['company_id']);

                  $data=array('relating_master_value'=>$shoulder_orifice[0]);

                  $result=$this->specification_new_model->update_details_record_where('specification_sheet_details',$data,'spec_id',$this->input->post('spec_id'),'spec_version_no',$this->input->post('spec_version_no'),'srd_id','6_4',$this->session->userdata['logged_in']['company_id']);

                  $data=array('parameter_value'=>$this->input->post('shoulder_foil_tag'));

                  $result=$this->specification_new_model->update_details_record_where('specification_sheet_details',$data,'spec_id',$this->input->post('spec_id'),'spec_version_no',$this->input->post('spec_version_no'),'srd_id','6_8',$this->session->userdata['logged_in']['company_id']);


                  $data=array('mat_article_no'=>$this->input->post('sh_masterbatch'),'mat_info'=>$this->input->post('sh_mb_per').'%','supplier_no'=>$sh_mb_supplier[1]);

                  $result=$this->specification_new_model->update_details_record_where('specification_sheet_details',$data,'spec_id',$this->input->post('spec_id'),'spec_version_no',$this->input->post('spec_version_no'),'srd_id','6_6_0',$this->session->userdata['logged_in']['company_id']);

                  $data=array('mat_article_no'=>$this->input->post('sh_hdpe_one'),'mat_info'=>$this->input->post('sh_hdpe_one_per').'%');

                  $result=$this->specification_new_model->update_details_record_where('specification_sheet_details',$data,'spec_id',$this->input->post('spec_id'),'spec_version_no',$this->input->post('spec_version_no'),'srd_id','6_7_0',$this->session->userdata['logged_in']['company_id']);

                  $data=array('mat_article_no'=>$this->input->post('sh_hdpe_two'),'mat_info'=>$this->input->post('sh_hdpe_two_per').'%');

                  $result=$this->specification_new_model->update_details_record_where('specification_sheet_details',$data,'spec_id',$this->input->post('spec_id'),'spec_version_no',$this->input->post('spec_version_no'),'srd_id','6_7_1',$this->session->userdata['logged_in']['company_id']);

                  //Cap

                  $data=array('relating_master_value'=>$cap_type[0]);

                  $result=$this->specification_new_model->update_details_record_where('specification_sheet_details',$data,'spec_id',$this->input->post('spec_id'),'spec_version_no',$this->input->post('spec_version_no'),'srd_id','7_2',$this->session->userdata['logged_in']['company_id']);

                  $data=array('relating_master_value'=>$cap_finish[0]);

                  $result=$this->specification_new_model->update_details_record_where('specification_sheet_details',$data,'spec_id',$this->input->post('spec_id'),'spec_version_no',$this->input->post('spec_version_no'),'srd_id','7_3',$this->session->userdata['logged_in']['company_id']);

                  $data=array('relating_master_value'=>$cap_dia[0]);

                  $result=$this->specification_new_model->update_details_record_where('specification_sheet_details',$data,'spec_id',$this->input->post('spec_id'),'spec_version_no',$this->input->post('spec_version_no'),'srd_id','7_4',$this->session->userdata['logged_in']['company_id']);

                  $data=array('relating_master_value'=>$cap_orifice[0]);

                  $result=$this->specification_new_model->update_details_record_where('specification_sheet_details',$data,'spec_id',$this->input->post('spec_id'),'spec_version_no',$this->input->post('spec_version_no'),'srd_id','7_6',$this->session->userdata['logged_in']['company_id']);


                  $data=array('mat_article_no'=>$this->input->post('cap_masterbatch'),'mat_info'=>$this->input->post('cap_mb_per').'%','supplier_no'=>$cap_mb_supplier[1]);

                  $result=$this->specification_new_model->update_details_record_where('specification_sheet_details',$data,'spec_id',$this->input->post('spec_id'),'spec_version_no',$this->input->post('spec_version_no'),'srd_id','7_7_0',$this->session->userdata['logged_in']['company_id']);

                  $data=array('mat_article_no'=>$this->input->post('cap_pp'),'mat_info'=>$this->input->post('pp_per').'%');

                  $result=$this->specification_new_model->update_details_record_where('specification_sheet_details',$data,'spec_id',$this->input->post('spec_id'),'spec_version_no',$this->input->post('spec_version_no'),'srd_id','7_8_1',$this->session->userdata['logged_in']['company_id']);


                  $data=array('parameter_value'=>$this->input->post('cap_foil_color'));

                  $result=$this->specification_new_model->update_details_record_where('specification_sheet_details',$data,'spec_id',$this->input->post('spec_id'),'spec_version_no',$this->input->post('spec_version_no'),'srd_id','7_9',$this->session->userdata['logged_in']['company_id']);

                  $data=array('parameter_value'=>$this->input->post('cap_foil_width'));

                  $result=$this->specification_new_model->update_details_record_where('specification_sheet_details',$data,'spec_id',$this->input->post('spec_id'),'spec_version_no',$this->input->post('spec_version_no'),'srd_id','7_10',$this->session->userdata['logged_in']['company_id']);

                  $data=array('parameter_value'=>$this->input->post('cap_foil_dist_frm_bottom'));

                  $result=$this->specification_new_model->update_details_record_where('specification_sheet_details',$data,'spec_id',$this->input->post('spec_id'),'spec_version_no',$this->input->post('spec_version_no'),'srd_id','7_11',$this->session->userdata['logged_in']['company_id']);
