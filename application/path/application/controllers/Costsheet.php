          ...
          if($formrights_row->view==1){
            ...
            if($this->form_validation->run()==FALSE){
              ...
              $data['cap_type']=$this->common_model->select_active_drop_down('cap_types_master',$this->session->userdata['logged_in']['company_id']);            
                ...
                $data['costsheet_master']=$this->costsheet_model->active_record_search_costsheet('costsheet_master',$search,$from,$to,$length_from,$length_to,$print,$customer_category,$status,$sort_by,$this->session->userdata['logged_in']['company_id']);
                //echo $this->db->last_query();
