      ...
      if($module_row->module_name==='Sales'){
        ...
        foreach ($data['formrights'] as $formrights_row) {
          if($formrights_row->new==1){
            ...
            $this->form_validation->set_rules('gauge','Gauge' ,'required|trim|xss_clean|exact_length[3]|in_list[400,500,550]');
            ...
            $sleeve_dia=explode('//',$this->input->post('sleeve_dia'));
              if($sleeve_dia[0]=="19 MM" || $sleeve_dia[0]=="22 MM" || $sleeve_dia[0]=="22.6 MM"){
                ...
                $this->form_validation->set_rules('gauge','Gauge' ,'required|trim|xss_clean|in_list[550]');
              }
            }
      ...
      if($module_row->module_name==='Sales'){
        ...
        foreach ($data['formrights'] as $formrights_row) {
          if($formrights_row->new==1){
            ...
            $this->form_validation->set_rules('sleeve_dia','Sleeve Dia' ,'required|trim|xss_clean');
            $this->form_validation->set_rules('sleeve_length','Sleeve Length' ,'required|trim|xss_clean|max_length[5]');
            $this->form_validation->set_rules('gauge','Gauge' ,'required|trim|xss_clean|exact_length[3]|in_list[175,225,250]');
            $this->form_validation->set_rules('sl_masterbatch','Sleeve Masterbatch' ,'required|trim|xss_clean');
            //$this->form_validation->set_rules('sl_mb_supplier','Sleeve Masterbatch Supplier','trim|xss_clean|callback_supplier_check');
            $this->form_validation->set_rules('sl_mb_per','Sleeve Masterbatch %' ,'required|trim|xss_clean|numeric|less_than_equal_to[25]|max_length[4]');
            ...
            $sleeve_dia=explode('//',$this->input->post('sleeve_dia'));
              if($sleeve_dia[0]=="19 MM"){
                $this->form_validation->set_rules('gauge','Gauge' ,'required|trim|xss_clean|exact_length[3]');
                $this->form_validation->set_rules('gauge_two','Gauge Layer Two' ,'required|trim|xss_clean|in_list[50]|exact_length[2]');
                $this->form_validation->set_rules('gauge_three','Gauge Layer Three' ,'required|trim|xss_clean|exact_length[3]|in_list[175]');
              }else if($sleeve_dia[0]=="25 MM" || $sleeve_dia[0]=="30 MM" ||  $sleeve_dia[0]=="35 MM" || $sleeve_dia[0]=="40 MM"){
                $this->form_validation->set_rules('gauge','Gauge' ,'required|trim|xss_clean|in_list[225]');
                $this->form_validation->set_rules('gauge_two','Gauge Layer Two' ,'required|trim|xss_clean|in_list[50]|exact_length[2]');
                $this->form_validation->set_rules('gauge_three','Gauge Layer Three' ,'required|trim|xss_clean|exact_length[3]|in_list[225]');
              }else{
                $this->form_validation->set_rules('gauge','Gauge' ,'required|trim|xss_clean|in_list[225,250]');
                $this->form_validation->set_rules('gauge_two','Gauge Layer Two' ,'required|trim|xss_clean|in_list[50,100]|max_length[3]');
                $this->form_validation->set_rules('gauge_three','Gauge Layer Three' ,'required|trim|xss_clean|exact_length[3]|in_list[225,250]');
              }
            }
            ...
            $this->form_validation->set_rules('gauge_three','Gauge Layer Three' ,'required|trim|xss_clean|exact_length[3]|in_list[175,225,250]');
      ...
      foreach ($data['module'] as $module_row) {
        if($module_row->module_name==='Sales'){
          ...
          foreach ($data['formrights'] as $formrights_row) {
            ...
            $sleeve_dia=explode('//',$this->input->post('sleeve_dia'));
              if($sleeve_dia[0]=="19 MM"){
                $this->form_validation->set_rules('gauge','Gauge' ,'required|trim|xss_clean|exact_length[3]|in_list[175]');
                $this->form_validation->set_rules('gauge_two','Gauge Layer Two' ,'required|trim|xss_clean|in_list[50]|exact_length[2]');
                $this->form_validation->set_rules('gauge_three','Gauge Layer Three' ,'required|trim|xss_clean|exact_length[3]|in_list[175]');
              }else if($sleeve_dia[0]=="25 MM" || $sleeve_dia[0]=="30 MM" ||  $sleeve_dia[0]=="35 MM" || $sleeve_dia[0]=="40 MM"){
                $this->form_validation->set_rules('gauge','Gauge' ,'required|trim|xss_clean|in_list[225]');
                ...
                $this->form_validation->set_rules('gauge','Gauge' ,'required|trim|xss_clean|in_list[250]');
                $this->form_validation->set_rules('gauge_two','Gauge Layer Two' ,'required|trim|xss_clean|in_list[50,100]|max_length[3]');
                $this->form_validation->set_rules('gauge_three','Gauge Layer Three' ,'required|trim|xss_clean|exact_length[3]|in_list[250]');
              }
            }

            $this->form_validation->set_rules('gauge_two','Gauge Layer Two' ,'required|trim|xss_clean|max_length[3]|in_list[50]');
            $this->form_validation->set_rules('sl_hdpe_two','Sleeve Hdpe  Layer two' ,'required|trim|xss_clean');
            $this->form_validation->set_rules('sl_hdpe_per_two','Sleeve Hdpe % Layer two' ,'required|trim|xss_clean|is_natural|max_length[3]|callback_sleeve_per_two_check');
