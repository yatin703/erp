    ...
    if($order_no!='' && $article_no!=''){    
      ...
      echo'<tr id="tr_2">
          ...
          <tr id="tr_10">
            ...
            <td><input type="text"  name="printing_rejection" id="printing_rejection" value="'.set_value('printing_rejection','25').'" readonly/>
            </td>
          </tr>
          <tr id="tr_11">
            <td class="label">Bodymaking Rejection % :</td>
            <td><input type="text"  name="bodymaking_rejection" id="bodymaking_rejection" value="'.set_value('bodymaking_rejection','25').'" readonly/>
            </td>
          </tr>
