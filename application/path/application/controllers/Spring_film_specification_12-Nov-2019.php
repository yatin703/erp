...
class Spring_film_specification extends CI_Controller {
      ...
      if($module_row->module_name==='Sales'){
        ...
        foreach ($data['formrights'] as $formrights_row) {
          if($formrights_row->new==1){
            ...
            $this->form_validation->set_rules('film_admer_three','Film Admer Layer Three' ,'required|trim|xss_clean');
            $this->form_validation->set_rules('film_admer_per_three','Film Admer % Layer Three' ,'required|trim|xss_clean|is_natural|exact_length[3]');

            //Layer Four

            $this->form_validation->set_rules('film_evoh_four','Film Evoh Layer Four' ,'required|trim|xss_clean');
            $this->form_validation->set_rules('film_evoh_per_four','Film Evoh % Layer Four' ,'required|trim|xss_clean|is_natural|exact_length[3]');


            //Layer Five

            $this->form_validation->set_rules('gauge_five','Gauge Layer Five' ,'required|trim|xss_clean|exact_length[2]|is_natural');
            $this->form_validation->set_rules('film_admer_five','Film Admer Layer Five' ,'required|trim|xss_clean');
            $this->form_validation->set_rules('film_admer_per_five','Film Admer % Layer Five' ,'required|trim|xss_clean|is_natural|exact_length[3]');
            ...
            $data['approval_authority']=$this->common_model->select_one_active_approval_authority_record('authority_master',$this->session->userdata['logged_in']['company_id'],'authority_master.form_id','985');
             ...
             if(!empty($this->input->post('sl_admer_four')) && !empty($this->input->post('sl_admer_per_four'))){
              ...
              $article_description=$sleeve_dia[0]."".$sleeve_length." ".$gauge_one." ".$film_ldpe_one." ".$film_ldpe_per_one." ".$film_lldpe_one." ".$film_lldpe_per_one." ".$gauge_two." ".$film_masterbatch_two." ".$film_mb_per_two." ".$film_ldpe_two." ".$film_ldpe_per_two." ".$film_lldpe_two." ".$film_lldpe_per_two." ".$film_hdpe_two." ".$film_hdpe_per_two." ".$gauge_three." ".$film_admer_three." ".$film_admer_per_three." ".$gauge_four." ".$film_evoh_four." ".$film_evoh_per_four." ".$gauge_five." ".$film_admer_five." ".$film_admer_per_five." ".$gauge_six." ".$film_masterbatch_six." ".$film_mb_per_six." ".$film_ldpe_six." ".$film_ldpe_per_six." ".$film_lldpe_six." ".$film_lldpe_per_six." ".$film_hdpe_six." ".$film_hdpe_per_six." ".$gauge_seven." ".$film_ldpe_seven." ".$film_ldpe_per_seven." ".$film_lldpe_seven." ".$film_lldpe_per_seven;
  ...
  public function film_per_one_check($str){
    $film_ldpe_per_one=$this->input->post('film_ldpe_per_one');
    $film_lldpe_per_one=$this->input->post('film_lldpe_per_one');
    $total_per=$film_ldpe_per_one+$film_lldpe_per_one;
  ...
  public function film_per_seven_check($str){
    $film_ldpe_per_seven=$this->input->post('film_ldpe_per_seven');
    $film_lldpe_per_seven=$this->input->post('film_lldpe_per_seven');
    $total_per_seven=$film_ldpe_per_seven+$film_lldpe_per_seven;
