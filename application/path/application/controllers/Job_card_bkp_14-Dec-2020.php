            ...
            if($jobcard_type=='1'){
              ...
              if($sum_extrusion_amount!=0 && $extrusion_tally_cost_error==0 ){
                ...
                foreach ($spring_extrusion_production_details_result as  $spring_extrusion_production_details_row) {
                  ...
                  if($setup_jobcard_no!=''){
                    ...
                    foreach ($material_manufacturing_setup_result as $material_manufacturing_row) {
                  ...
                  if($purging_jobcard!=''){
                    ...
                    foreach ($material_manufacturing_purging_result as $material_manufacturing_row) {
                      ...
                      if($calculated_purchase_price==0 || $calculated_purchase_price==''){
                        ...
                        array_push($error_1,'For Purging Jobcard '.$setup_jobcard_no.', material issued cost need to check from Tally');
                        break;
             ...
             // print_r($error_1);
              ...
              if(empty($error_1)){
                ...
                $result=$this->common_model->update_one_active_record_where('springtube_extrusion_wip_master',$data_wip,'jobcard_no',$this->uri->segment(3),'status','0',$this->session->userdata['logged_in']['company_id']);
