          ...
          if($formrights_row->new==1){
            ...
            if($this->form_validation->run()==FALSE){
              ...
              foreach($this->input->post('mm_id') as $mm_id => $mm_id_value){
                ...
                // Export to Excel For Tally-------------Eknath
                  $quantity_decimal=($quantity!=0?$quantity/100:0);
                  $export_array=array('article_no'=>$article_no,
                                      'quantity'=>$quantity_decimal);
                  $multi_array=array();
                  array_push($multi_array,$export_array);
               ...
               //--Eknath-----
               // $flag=0;
               // if($this->excel_jobcard($multi_array,$this->input->post('jobcard_no'))){
               //  $flag=1;
               // }
               // else{
               //   $flag=0;
...
//--Eknath--
public function excel_jobcard($export_array=array(),$jobcard_no){
  ...
  // Export to Excel File--------
    ...
    //   $file_name='Jobcard_'.$jobcard_no.'_'.date('Y-m-d_his').'.xlsx';
    ...
    //     $ObjPHPExcel->getActiveSheet()->SetCellValue('A'.$row,$export_array[$k][0]);
    //     $ObjPHPExcel->getActiveSheet()->SetCellValue('B'.$row,$export_array[$k][1]);
    //     $row++;
    //   }
