      ...
      if($module_row->module_name==='Sales'){
        ...
        foreach ($data['formrights'] as $formrights_row) {
          if($formrights_row->view==1){
            ...
            $data_printing_input=array('manu_order_no'=>$this->uri->segment(3),'work_proc_no'=>'1','from_job_card'=>'1','sfg_flag'=>'1');
            ...
            $data_heading=array('manu_order_no'=>$this->uri->segment(3),'work_proc_no'=>'2','from_job_card'=>'1');
      ...
      if($module_row->module_name==='Sales'){
        ...
        foreach ($data['formrights'] as $formrights_row) {
          if($formrights_row->view==1){
            ...
            $this->form_validation->set_rules('trans_closed','Transaction Status' ,'trim|xss_clean');
            $this->form_validation->set_rules('order_by','Sort Order By' ,'trim|xss_clean');
            $this->form_validation->set_rules('approval_date','Approval Date' ,'trim|xss_clean');
