        ...
        foreach ($data['formrights'] as $formrights_row) {
          ...
          if($formrights_row->new==1){
            ...
            if($this->input->post('abg2_ink_id_1')!=''){
                ...
                $this->form_validation->set_rules('abg2_carona_1', $str.'Corona' ,'required|trim|xss_clean');
            ...
            if($this->form_validation->run()==FALSE){
              ...
              $result_jobsetup=$this->common_model->save('springtube_printing_jobsetup_master',$data);             
              if($result_jobsetup){
