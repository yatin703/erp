        ...
        foreach ($data['formrights'] as $formrights_row) {
          ...
          if($formrights_row->new==1){
            ...
            if($this->form_validation->run()==FALSE){
              ...
              $ink_desc=strtoupper($this->input->post('ink_manufacturer')).', '.strtoupper($this->input->post('ink_category')).', '.strtoupper($this->input->post('ink_migration')).', SUB-'.strtoupper($this->input->post('substrate')).', '.strtoupper($this->input->post('ink_name')).', '.strtoupper($this->input->post('ink_code'));
      ...
      if($module_row->module_name==='Production'){
        ...
        foreach ($data['formrights'] as $formrights_row) {
          if($formrights_row->view==1){
              ...
              $this->form_validation->set_rules('mixing_status','Mixing Status' ,'trim|xss_clean');
            ...
            if($this->form_validation->run()==FALSE){
              ...
              if($this->input->post('article_no')!=''){
                $search['article_no']=$this->input->post('article_no');
              }
              if(!empty($this->input->post('substrate'))){
                $search['substrate']=$this->input->post('substrate');
              }
              if(!empty($this->input->post('ink_manufacturer'))){
                $search['ink_manufacturer']=$this->input->post('ink_manufacturer');
              }
              if(!empty($this->input->post('ink_name'))){
                $search['ink_name']=$this->input->post('ink_name');
              }
              if(!empty($this->input->post('ink_code'))){
                $search['ink_code']=$this->input->post('ink_code');
              }
              if(!empty($this->input->post('ink_category'))){
                $search['ink_category']=$this->input->post('ink_category');
              }
              if(!empty($this->input->post('ink_migration'))){
                $search['ink_migration']=$this->input->post('ink_migration');
              }
              if(!empty($this->input->post('ink_composition'))){
                $search['ink_composition']=$this->input->post('ink_composition');
              }
              if($this->input->post('mixing_status')!=''){
                $search['mixing_status']=$this->input->post('mixing_status');
              }
             ...
             /*  
              $data=array(                    
                ...
                'ink_composition'=>$this->input->post('ink_composition'),
                'article_no'=>$article_no,
                'mixing_status'=>$this->input->post('mixing_status')                
                //'comment'=>strtoupper($this->input->post('comment'))
