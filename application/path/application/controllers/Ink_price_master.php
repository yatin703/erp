...
class Ink_price_master extends CI_Controller {
  ...
  function __construct(){
    ...
    if($this->session->userdata('logged_in')){
      ...
      $this->load->model('ink_price_master_model');
  ...
  public function index(){
    ...
    $table='ink_price_master';

    include('pagination.php');

    $data['ink_price_master']=$this->ink_price_master_model->select_active_records($config["per_page"], $this->uri->segment(3),$table,$this->session->userdata['logged_in']['company_id']);
  ...
  public function save(){
    ...
    $this->form_validation->set_rules('ink_type','Ink Type','required|xss_clean');
    ...
    $this->form_validation->set_rules('cost_per_kg','Cost Per Kg','required|xss_clean');
    ...
    if($this->form_validation->run()==FALSE){
      ...
      if($this->input->post('ink_type')==1){
          $print="FLEXO";
        }else if($this->input->post('ink_type')==2){
          $print="OFFSET";
        }else if($this->input->post('ink_type')==3){
          $print="SCREEN";
        }else{
          echo "SPECIAL INK";
        }
      ...
      $rm= strtoupper($month_from).' '.$year_from.' '.($month_from!=$month_to?' TO '.strtoupper($month_to).' '.$year_to :'').' '.$print.' INK AVG COST';


      $data=array('from_date'=>$this->input->post('from_date'),
                  'to_date'=>$this->input->post('to_date'),
                  'ink_id'=>$this->input->post('ink_type'),
                  'rm'=>$rm,
                  'consumption_value'=>$this->input->post('consumption_value'),
                  'consumption_quantity'=>$this->input->post('consumption_quantity'),
                  'cost_per_kg'=>round($this->input->post('consumption_value')/$this->input->post('consumption_quantity'),4),
          ...
          $result=$this->common_model->save('ink_price_master',$data);
  ...
  function modify(){
    ...
    foreach ($data['module'] as $module_row) {
      if($module_row->module_name==='Sales'){
        $data['formrights']=$this->common_model->select_active_formrights_of_form($this->session->userdata['logged_in']['user_id'],$this->session->userdata['logged_in']['company_id'],1,'ink_price_master');

  foreach ($data['formrights'] as $formrights_row) {
    
    if($formrights_row->modify==1){
   
    $data['ink_price_master']=$this->common_model->select_one_active_record('ink_price_master',$this->session->userdata['logged_in']['company_id'],'ipm_id',$this->uri->segment(3));
  ...
  public function update(){
    ...
    $this->form_validation->set_rules('ink_type','Ink Type','required|xss_clean');
    //$this->form_validation->set_rules('rm','RM','required|xss_clean');
    $this->form_validation->set_rules('consumption_quantity','Consumption Quantity','required|xss_clean');
    $this->form_validation->set_rules('consumption_value','Consumption Value','required|xss_clean');
    $this->form_validation->set_rules('cost_per_kg','Cost Per Kg','required|xss_clean');
    ...
    if($this->form_validation->run()==FALSE){
      ...
      $data['ink_price_master']=$this->common_model->select_one_active_record('ink_price_master',$this->session->userdata['logged_in']['company_id'],'ipm_id',$this->input->post('ipm_id'));
      ...
      $rm= strtoupper($month_from).' '.$year_from.' '.($month_from!=$month_to?' TO '.strtoupper($month_to).' '.$year_to :'').' '.$print.' INK AVG COST';
        ...
        $result=$this->common_model->update_one_active_record('ink_price_master',$data,'ipm_id',$this->input->post('ipm_id'),$this->session->userdata['logged_in']['company_id']);
  ...
  public function delete(){
    ...
    $result=$this->common_model->update_one_active_record('ink_price_master',$data,'ipm_id',$this->uri->segment(3),$this->session->userdata['logged_in']['company_id']);
    ...
    if($result){
      ...
      $data['ink_price_master']=$this->common_model->select_one_inactive_record('ink_price_master',$this->session->userdata['logged_in']['company_id'],'ipm_id',$this->uri->segment(3)); 
  ...
  function archive_records(){
    ...
    $data['ink_price_master']=$this->common_model->select_archive_records($config["per_page"],$this->uri->segment(3),$table,$this->session->userdata['logged_in']['company_id']);
  ...
  public function search_result(){  
    ...
    $this->form_validation->set_rules('ink_type','Ink Type','xss_clean');
    ...
    $this->form_validation->set_rules('cost_per_kg','Cost Per Kg','xss_clean');
    ...
    if($this->form_validation->run()==FALSE){
      ...
      $data=array('from_date'=>$this->input->post('from_date'),
                  ...
                  //'ink_price_master.company_id'=>$this->session->userdata['logged_in']['company_id']
                );

          $data['ink_price_master']=$this->common_model->active_record_search('ink_price_master',$data,$this->session->userdata['logged_in']['company_id']);
  ...
  function check_data($str) {
    ...
    $this->db->select('*');
    $this->db->from('ink_price_master');

    $this->db->where('ink_type', $ink_id);
