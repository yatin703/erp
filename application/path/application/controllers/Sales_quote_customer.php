          ...
          foreach ($data['formrights'] as $formrights_row) {
            if($formrights_row->new==1){
              ...
              $this->form_validation->set_rules('adr_company_id','Bill To' ,'required|trim|xss_clean|callback_c_check');
                ...
                //new customer
               $this->form_validation->set_rules('customer_category','Customer','required|trim|xss_clean|is_unique[address_category_master.category_name]|callback_customer_check'); 
              ...
              if($this->form_validation->run()==FALSE){
               ...
               // print_r($this->input->post('sr_no[]'));
                ...
                if(!empty($this->input->post('customer_category'))){
                  ...
                  $data=array('company_id'=>$this->session->userdata['logged_in']['company_id'],'category_name'=>$this->input->post('customer_category')
                  );
                ...
                if($file_upload_flag){
                  ...
                  'address'=>($this->input->post('new')==1 ? strtoupper($this->input->post('address')) : $address),
                  'city'=>($this->input->post('new')==1 ? strtoupper($this->input->post('city')) : $city),
                  'pincode'=>($this->input->post('new')==1 ? $this->input->post('pincode') : $pin),
                  'company_type'=>$this->input->post('company_type'),
                  'country'=>($this->input->post('new')==1 ? $this->input->post('country') : $country),
                  'state'=>($this->input->post('new')==1 ? $this->input->post('state') : $state),
                  'ownership'=>$ownership,
