        ...
        foreach ($data['formrights'] as $formrights_row) {
          if($formrights_row->new==1){
            ...
            if($jobcard_type=='1'){              
              ...
              $data=array('jobcard_no'=>$this->uri->segment(3),'status'=>0);
             ...
             // print_r($error_1);
              ...
              if(empty($error_1)){
                ...
                $total_extrusion_cost=round($purging_prod_cost_per_meter,2)+round($setup_prod_cost_per_meter,2)+round($production_cost_per_meter,2);
