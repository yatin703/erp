...
class Coex_extrusion_rm_mixing extends CI_Controller {
        ...
        if($module_row->module_name==='Production'){
          ...
          foreach ($data['formrights'] as $formrights_row) {
            if($formrights_row->view==1){
             $table='coex_extrusion_rm_mixing';
             include('pagination.php');
             $data['coex_extrusion_rm_mixing']=$this->coex_extrusion_rm_mixing_model->select_active_records($config["per_page"],$this->uri->segment(3),$table,$this->session->userdata['logged_in']['company_id']);
...
function save(){
    ...
    foreach ($data['module'] as $module_row) {
      if($module_row->module_name==='Production'){
        ...
        foreach ($data['formrights'] as $formrights_row) {
          if($formrights_row->new==1){
            ...
            $this->form_validation->set_rules('mixing_date','Mixing Date' ,'required|trim|xss_clean');
            ...
            $data['shift_master']=$this->common_model->select_active_drop_down('springtube_shift_master',$this->session->userdata['logged_in']['company_id']);
              ...
              $data=array('company_id'=>$this->session->userdata['logged_in']['company_id'],
                'mixing_date'=>date('Y-m-d'),
                'mixing_time'=>date('h:i:s'),
                ...
                'sleeve_weight'=>$this->common_model->save_number($this->input->post('sleeve_weight'),$this->session->userdata['logged_in']['company_id']),
                'initial_counter_reading'=>$this->common_model->save_number($this->input->post('initial_counter_reading'),$this->session->userdata['logged_in']['company_id']),
                'final_counter_reading'=>$this->common_model->save_number($this->input->post('final_counter_reading'),$this->session->userdata['logged_in']['company_id']),
                'number_of_sleeves'=>$this->common_model->save_number($this->input->post('number_of_sleeves'),$this->session->userdata['logged_in']['company_id']),
                'sleeves_weight'=>$this->common_model->save_number($this->input->post('sleeves_weight'),$this->session->userdata['logged_in']['company_id']),
                'scrap_weight'=>$this->common_model->save_number($this->input->post('scrap_weight'),$this->session->userdata['logged_in']['company_id']),
                'lumps_weight'=>$this->common_model->save_number($this->input->post('lumps_weight'),$this->session->userdata['logged_in']['company_id']),
                'output_weight'=>$this->common_model->save_number($this->input->post('output_weight'),$this->session->userdata['logged_in']['company_id']),
                'prepared_by'=>$this->input->post('prepared_by'),
                'checked_by'=>$this->input->post('checked_by'),
                'final_approval_flag'=>'0'
                 );

              $result=$this->common_model->save('coex_extrusion_rm_mixing',$data);

              $cerm_id=$this->db->insert_id();
              ...
              for($i=1;$i<=count($this->input->post('sr_no[]'));$i++){ 
                ...
                'sr_no'=>$i,
                'jobcard_no'=>$this->input->post('jobcard_no'),
                'material_code'=>$this->input->post('article_no_'.$i.''),
                'qty_issued'=>$this->common_model->save_number($this->input->post('issued_qty_'.$i.''),$this->session->userdata['logged_in']['company_id']),
                'qty_mixed'=>$this->common_model->save_number($this->input->post('mixing_qty_'.$i.''),$this->session->userdata['logged_in']['company_id']),
                'batch_no'=>$this->input->post('batch_no_'.$i.''));

                $result=$this->common_model->save('coex_extrusion_rm_mixing_details',$dat);
      ...
      $data['note']='No Creation rights Thanks';
      $data['page_name']='home';
      $data['module']=$this->common_model->select_active_module($this->session->userdata['logged_in']['user_id'],$this->session->userdata['logged_in']['company_id']);
      $this->load->view('Home/header');
      $this->load->view('Home/nav',$data);
      ...
      if($module_row->module_name==='Production'){
        ...
        foreach ($data['formrights'] as $formrights_row) {
          if($formrights_row->view==1){
            ...
            $data['coex_extrusion_rm_mixing_details']=$this->common_model->select_one_active_record('coex_extrusion_rm_mixing_details',$this->session->userdata['logged_in']['company_id'],'coex_extrusion_rm_mixing_details.cerm_id',$this->uri->segment(3));
        ...
        if($module_row->module_name==='Production'){
          ...
          foreach ($data['formrights'] as $formrights_row) {
            ...
            if($this->form_validation->run()==FALSE){
                ...
                $data['coex_extrusion_rm_mixing']=$this->coex_extrusion_rm_mixing_model->select_one_active_record('coex_extrusion_rm_mixing',$this->session->userdata['logged_in']['company_id'],'coex_extrusion_rm_mixing.cerm_id',$this->input->post('cerm_id'));

                $data['coex_extrusion_rm_mixing_details']=$this->common_model->select_one_active_record('coex_extrusion_rm_mixing_details',$this->session->userdata['logged_in']['company_id'],'coex_extrusion_rm_mixing_details.cerm_id',$this->input->post('cerm_id'));
                ...
                $data=array('company_id'=>$this->session->userdata['logged_in']['company_id'],
                'mixing_date'=>$this->input->post('mixing_date'),
                'mixing_time'=>$this->input->post('mixing_time'),
                'machine_id'=>$this->input->post('machine'),
                'shift_id'=>$this->input->post('shift'),
                'operator'=>$this->input->post('operator'),
                'jobcard_no'=>$this->input->post('jobcard_no'),
                ...
                $result=$this->common_model->update_one_active_record('coex_extrusion_rm_mixing',$data,'cerm_id',$this->input->post('cerm_id'),$this->session->userdata['logged_in']['company_id']);
                ...
                for($i=1;$i<=count($this->input->post('sr_no[]'));$i++){ 
                  ...
                  $result=$this->common_model->update_one_active_record('coex_extrusion_rm_mixing_details',$dat,'cerm_id',$this->input->post('cerm_id'),$this->session->userdata['logged_in']['company_id']);
              ...
              foreach ($data['formrights'] as $formrights_row) {
                if($formrights_row->view==1){
                    ...
                    if($this->form_validation->run()==FALSE){
                        ...
                        $master_array= array('coex_extrusion_rm_mixing.product_no'=>$this->input->post('product_no'),
                                             'coex_extrusion_rm_mixing.order_no'=>$this->input->post('order_no'),
                                             'coex_extrusion_rm_mixing.jobcard_no'=>$this->input->post('jobcard_no'),
                                             'coex_extrusion_rm_mixing.shift_id'=>$this->input->post('shift'),
                                             'coex_extrusion_rm_mixing.machine_id'=>$this->input->post('machine'),
                                             'coex_extrusion_rm_mixing.operator'=>$this->input->post('operator'));
                          
                          $data1=array_filter($master_array);                      
                          $data['coex_extrusion_rm_mixing']=$this->coex_extrusion_rm_mixing_model->active_record_search('coex_extrusion_rm_mixing',$data1,$from,$to,$this->session->userdata['logged_in']['company_id']);
