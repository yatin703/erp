                      ...
                      $data['employee']=$this->common_model->select_one_active_record('employee_master',$this->session->userdata['logged_in']['company_id'],'employee_id',$this->session->userdata['logged_in']['user_id']);
                        if($data['employee']==FALSE){
                          ...
                          foreach($data['employee'] as $employee_row) {
                                  ...
                                  $this->email->message("
                                    Followup Link
                                    http://192.168.0.9/erp/index.php/Sales_order_followup/");
              ...
              */ 
              ...
              if(in_array($this->input->post('trans_closed_reason'),$order_closed_arr)){
                ...
                if($this->input->post('trans_closed_reason')=='12'){
                  ...
                  if($result){
                    $cc_arr=array("erp@3d-neopac.com","mayur.joshi@3d-neopac.com","anant.gadre@3d-neopac.com","prasad.sathe@3d-neopac.com");
                  ...
                  $body='CANCEL ORDER';
                  if($result){
                    $cc_arr=array("erp@3d-neopac.com","mayur.joshi@3d-neopac.com","anant.gadre@3d-neopac.com","suryanarayan.swain@3d-neopac.com","manish.thalia@3d-neopac.com","ramakant.swami@3d-neopac.com","mukesh.patel@3d-neopac.com","rohit.patil@3d-neopac.com ");
                    $email_send=$this->on_order_closed_send_email($order_no,$to,$subject,$body,$cc_arr);
                  }
