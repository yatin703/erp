...
class Springtube_extrusion_production extends CI_Controller {
              ...
              $this->load->view('Home/footer');
                ...
                if($production_id!=''){
                  ...
                  foreach($this->input->post('sr_no') as $sr_no => $sr_no_value){
                    ...
                    if($this->input->post('total_setup_meters_'.$sr_no_value)!='' || $this->input->post('total_setup_meters_'.$sr_no_value)!='0'){

                      $setup_jobcard_no=$this->create_setup_jobcard($jobcard_no,$this->input->post('total_setup_meters_'.$sr_no_value));
                    }

                    //Purging Jobcard creation------                  
                    if($this->input->post('total_purging_weight_'.$sr_no_value)!='' || $this->input->post('total_purging_weight_'.$sr_no_value)!='0'){
  ...
  function create_setup_jobcard($jobcard_no,$total_setup_meters){
    $setup_jobcard_no='';
