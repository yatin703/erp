...
<script type="text/javascript">
	$(document).ready(function(){
		...
		// $("#tablePanton").find('input[name="plate_count[]"]').each(function(e){
		// 	alert($(this).val());
				...
				<td width="50%">
					<table class="form_table_inner">									
						<tr>
							...
							<td><input type="number" name="ups" id="ups"  size="20" value="<?php echo set_value('ups',2);?>" min="1" max="3" steps="1"  required/></td>
							<td class="label">Repeat  <span style="color:red;">*</span> :</td>
							<td><input type="number" name="repeat" id="repeat"  size="20" value="<?php echo set_value('repeat');?>" min="1" max="10" steps="1" requird /></td>
						</tr>
						<tr>
