					...
					$i=1;
							foreach($followup_rejected as $followup_rejected_row){
								...
								echo "<tr>
									...
									<td>".str_replace('@@@', '_', $followup_rejected_row->record_no)."</td>
									<td>".($followup_rejected_row->status==1 ? 'PENDING' : '')."</td>
									<td>";
									foreach($formrights as $formrights_row){ 
										echo ($formrights_row->view==1 ? '<a href="'.base_url('index.php/specification/view/'.str_replace('@@@','/', $followup_rejected_row->record_no)).'" target="_blank"><i class="print icon"></i></a> ' : '');
