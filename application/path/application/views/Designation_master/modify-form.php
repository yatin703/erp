			...
			<tr>
				<td>
					<table class="form_table_inner">
							...
							<?php foreach($sales_quotes_designation_master as $row):
								...
								?>
									<tr>
										...
										<td>
											...
											<input type="text" name="designation" id="designation" step="any" value="<?php echo set_value('designation',$row->designation);?>" ></td>
									</tr>
