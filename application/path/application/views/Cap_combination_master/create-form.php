				...
				<td width="50%">
					<table class="form_table_inner">
						<tr>
							...
							<td><input type="text" name="article_no" id="article_no"  size="60" value="<?php echo set_value('article_no');?>" required placeholder="Cap Article No"/></td>
							<td class="label">Cap Metalization Charges. * :</td>
							<td>
								<input type="text" name="ref_article_no" id="ref_article_no"  size="60" value="<?php echo set_value('ref_article_no');?>" required placeholder="Cap Metalization Charges"/>
							</td>
						</tr>						
