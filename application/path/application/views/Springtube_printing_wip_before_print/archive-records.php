	...
	<div class="record_inner_design" style="overflow: scroll;">
			<table class="record_table_design_without_fixed">
				...
				<?php if($springtube_printing_wip_master_before==FALSE){
							...
							echo"<tr>
									...
									<td>";
										...
										foreach ($formrights as $formrights_row) {
											...
											echo ($formrights_row->new==1 && $master_row->status==0 ? '<a href="'.base_url('index.php/'.$this->router->fetch_class().'/view/'.$master_row->bprint_wip_id.'').'" target="_blank" title="print"><i class="print icon"></i></a>' : '');
					...
					echo"<tr><td colspan='18' style='text-align:right;'><b>TOTAL</b></td><td>".$sum_bprint_wip_meters."</td><td></td><td></td</tr>";	
