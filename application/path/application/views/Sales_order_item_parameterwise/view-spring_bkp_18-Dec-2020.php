...
?>
                ...
                <table cellpadding="0" cellspacing="0" style="border:1px solid #D9d9d9;">
                    ...
                    <tr class="item">
                        ...
                        <td style="border-bottom:1px solid #D9d9d9;border-right:1px solid #D9d9d9;"><?php echo ($total_meters!=''?number_format($total_meters,0,'.',','). ' <i>MTRS, '.($production_row->jobcard_type==2?' FROM ORDER NO. <a href="'.base_url('index.php/sales_order_book/view/'.$from_wip_order_no).'" target="_blank"><b>'.$from_wip_order_no.'</b></a>':''):''); ?></td>
                    </tr>
                    <tr class="item">
                ...
                if($heading==FALSE){
                    ...
                    echo '
                        <tr class="item">
                            <td width="10%"></td>
                            <td width="5%"></td>
                            <td style="border:1px solid #D9d9d9;">'.$completed=($heading_row->completed_flag==1 ? "<i class='check green circle icon'></i>" : "").' '.$article_desc.'= <b>'.($shoulder_issue_qty!=0?$shoulder_issue_qty:$this->common_model->read_number($heading_row->demand_qty,$this->session->userdata['logged_in']['company_id'])).'</b> '.$uom.'</td>
                        </tr>';
