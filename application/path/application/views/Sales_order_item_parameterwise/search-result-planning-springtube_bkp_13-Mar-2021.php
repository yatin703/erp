				...
				<?php if($order_master==FALSE){
					...
					foreach ($order_master as $order_master_row) {
	                	...
	                	echo"<tr>
								...
								<td>".($order_master_row->final_approval_flag==1 ? "<i class='check circle icon'></i>" : "")."<a href='http://123.252.171.218:3030/erp/index.php/sales_order_book/view/$order_master_row->order_no'   target='_blank'>".$order_master_row->order_no."</a>
								</td>
