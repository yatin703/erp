...
?>
                ...
                <table cellpadding="0" cellspacing="0" style="border:1px solid #D9d9d9;">
                    ...
                    <tr class="item">
                        <td style="border-bottom:1px solid #D9d9d9 "><b>JOB CARD QUANTITY</b></td>
                        <td style="border-bottom:1px solid #D9d9d9;border-right:1px solid #D9d9d9;"></td>
                ...
                <table cellpadding="0" cellspacing="0" style="border:1px solid #D9d9d9;">
                <tr class="item last">
                        <td width="15%" style="border-bottom:1px solid #D9d9d9;"><b>COMMENT</b></td>
        ...
        <?php
                ...
                <?php
                    ...
                    foreach($foiling as $foiling_row){
                        ...
                        <td width="10%"></td>
                        <td width="4%"style="border-right:1px solid #D9d9d9;"></td>
                        <td width="55%">'.$completed=($foiling_row->completed_flag==1 ? "<i class='check green circle icon'></i>" : "").' '.$this->common_model->get_article_name($foiling_row->article_no,$this->session->userdata['logged_in']['company_id']).' = <b>'.$this->common_model->read_number($foiling_row->demand_qty,$this->session->userdata['logged_in']['company_id']).'</b></td>
                        <!--<td width="10%"></td>
                        <td width="5%"></td>
                        <td width="55%"></td>
                        -->
                ...
                if($capping==FALSE){
                    ...
                    echo '
                        <tr class="item">
                            <td width="10%"></td>
                            <td width="5%"></td>
                            <td style="border:1px solid #D9d9d9;">'.$completed=($capping_row->completed_flag==1 && $error=='' ? "<i class='check green circle icon'></i>" : "").' '.$article_desc.'= <b>'.($cap_issue_qty!=0?$cap_issue_qty:$this->common_model->read_number($capping_row->demand_qty,$this->session->userdata['logged_in']['company_id'])).'</b> '.$uom.($error!=''? ' (<b><i>'.$error.'</i></b>)':'').'</td>
                        </tr>';
                ...
                if($heading==FALSE){
                    ...
                    echo '
                        <tr class="item">
                            <td width="10%"></td>
                            <td width="5%"></td>
                            <td style="border:1px solid #D9d9d9;">'.$completed=($heading_row->completed_flag==1 && $error=='' ? "<i class='check green circle icon'></i>" : "").' '.$article_desc.'= <b>'.($shoulder_issue_qty!=0?$shoulder_issue_qty:$this->common_model->read_number($heading_row->demand_qty,$this->session->userdata['logged_in']['company_id'])).'</b> '.$uom.($error!=''? ' (<b><i>'.$error.'</i></b>)':'').'</td>
                        </tr>';
                ...
                if($box==FALSE){
                    ...
                    echo '
                        <tr>
                            <td width="10%"></td>
                            <td width="5%"></td>
                            <td style="border:1px solid #D9d9d9;">'.$completed=($box_row->completed_flag==1 && $error=='' ? "<i class='check green circle icon'></i>" : "").' '.$article_desc.' '.$article_sub_description.'= <b>'.$this->common_model->read_number($box_row->demand_qty,$this->session->userdata['logged_in']['company_id']).'</b> '.$uom.($error!=''? ' (<b><i>'.$error.'</i></b>)':'').'</td>
                        </tr>';
                        $j++;
