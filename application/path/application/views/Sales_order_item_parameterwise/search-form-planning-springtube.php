...
<form name="<?php echo $this->router->fetch_class();?>" action="<?php echo base_url('index.php/'.$this->router->fetch_class().'/search_result_planning_springtube');?>" method="POST" >
					...
					<table class="form_table_inner">
								...
								-->
									...
									<tr>
										...
										<td ><input type="text" name="order_no" id="order_no" size="17" value="<?php echo set_value('order_no');?>"/></td>
