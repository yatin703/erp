	                	...
	                	echo"<tr>
								...
								echo "</td>
									...
									foreach($formrights as $formrights_row){ 
										...
										echo ($formrights_row->new==1 && $order_master_row->order_flag==1 && $order_master_row->final_approval_flag==1 && $order_master_row->order_closed<>1 && $order_master_row->trans_closed<>1 && $order_master_row->hold_flag<>1 && $sum_aprint_wip_qty>0 ? '<a target="_blank" href="'.base_url('index.php/springtube_printing_wip_after_print/create_bodymaking_jobcard/'.$order_master_row->order_no.'/'.$order_master_row->article_no).'">Create Spring Bodymaking Job Card</a> ' : '');
