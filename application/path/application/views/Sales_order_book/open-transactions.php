	 ...
	 <div class="record_inner_design" style="overflow: scroll;">
				...
				else 
				{
					...
					foreach($order_master as $mrow){
						...
						$result=$ci->sales_order_book_model->active_details_records_new('order_details',$details_data,$this->session->userdata['logged_in']['company_id'],'','');
					    				...
					    				echo"
											...
											foreach($formrights as $formrights_row){ 												
												...
												if($formrights_row->modify==1){
													...
													}else if($this->session->userdata['logged_in']['admin']==1){
