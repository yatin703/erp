        ...
        <table cellpadding="5" cellspacing="0" style="border:1px solid #D9d9d9;">
            ...
            foreach ($order_details as $order_details_row) {
                ...
                echo "<tr class='item' >
                        ...
                        echo "<br/>
                        <b><a href='".base_url()."/index.php/artwork_new/view/".$order_details_row->ad_id."/".$order_details_row->version_no." ' target='blank'>".($order_details_row->ad_id!=""? $order_details_row->ad_id."_".$order_details_row->version_no:"")."</a></b>
                        <br/><br/>";
