...
<form name="<?php echo $this->router->fetch_class();?>" action="<?php echo base_url('index.php/'.$this->router->fetch_class().'/save_three_layer_with_cap');?>" method="POST" >
				...
				<td>
					<table class="form_table_inner">
									...
									<tr>
										...
										}?></select>Length <span style="color:red;">*</span> : <input type="text" name="sleeve_length" size="10" value="<?php echo set_value('sleeve_length');?>"></td>
									</tr>
									...
									<tr>
										...
										<td>
										<input type="text" name="sl_mb_per_three" maxlength="3" size="3" value="<?php echo set_value('sl_mb_per_three');?>" placeholder="%">
										<input type="text" name="sl_mb_supplier_three" class="supplier" size="60"  value="<?php echo set_value('sl_mb_supplier_three');?>" placeholder="MB Supplier">
										</td>
										</tr>
										...
										<td>
										<input type="text" name="sl_ldpe_per_three" maxlength="3" size="3" value="<?php echo set_value('sl_ldpe_per_three');?>" placeholder="%"></td>
										</tr>
										...
										<td>
										<input type="text" name="sl_lldpe_per_three" maxlength="3" size="3" value="<?php echo set_value('sl_lldpe_per_three');?>" placeholder="%"></td>
										</tr>
										...
										<td>
										<input type="text" name="sl_hdpe_per_three" maxlength="3" size="3" value="<?php echo set_value('sl_hdpe_per_three');?>" placeholder="%"></td>
										</tr>
