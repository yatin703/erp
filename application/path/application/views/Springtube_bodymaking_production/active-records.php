	...
	<div class="record_inner_design" style="overflow: scroll; white-space: nowrap;">
			...
			<thead>	
				<tr>
					...
					<th>QC Remarks</th>-->
					<th>QC Status</th>
					<th style="text-align:right">QC Hold</th>
			...
			<tbody>	
				...
				if($springtube_bodymaking_production_master==FALSE){
					echo "<tr><td colspan='30'>No Active Records Found</td></tr>";
					    	...
					    	if($rowspan>0){					    		
								...
								echo"<tr>
									...
									foreach ($result as $details_row){
										...
										<td class='right aligned'><b>".number_format($jobcard_qty,0,'.',',')."</b> <i>NOS</i>

										<td class='right aligned'><b>".number_format($details_row->total_sleeve_produced,0,'.',',')."</b> <i>NOS</i>
										</td>
										<td class='right aligned'><b>".number_format($details_row->sleeve_with_heading,0,'.',',')."</b> <i>NOS</i>
										</td>
										<td class='right aligned'><b>".number_format($details_row->sleeve_with_cap,0,'.',',')."</b> <i>NOS</i>
										</td>
										<td class='positive right aligned'><b>".($details_row->qc_ok_qty!=0?number_format($details_row->qc_ok_qty,0,'.',',')."</b> <i>NOS</i>":"")."</td>
										...
										<td class='negative right aligned'><b>".($details_row->qc_hold_qty!=0?number_format($details_row->qc_hold_qty,0,'.',',')."</b> <i>NOS</i>":"")."
										</td>
						...
						echo"<tr style='font-weight:bold;'><td colspan='10' style='text-align:right;'><b>TOTAL</b></td>
						<td></td>
						<td><b>".number_format($sum_total_sleeve_produced,0,'.',',')."</b> <i>NOS</i></td>
						<td><b>".number_format($sum_sleeve_with_heading,0,'.',',')."</b> <i>NOS</i></td>
						<td><b>".number_format($sum_sleeve_with_cap,0,'.',',')."</b> <i>NOS</i></td>
						<td class='positive right aligned'><b>".($sum_qc_ok_qty!=0?number_format($sum_qc_ok_qty,0,'.',',')."</b> <i>NOS</i>":"")."</td>
						<td></td>
						<td class='negative right aligned'>".($sum_qc_hold_qty!=0?number_format($sum_qc_hold_qty,0,'.',',')."</b> <i>NOS</i>":"")."</td>
