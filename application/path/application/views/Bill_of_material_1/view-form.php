    ...
    <table cellpadding="0" cellspacing="0" style="border:1px solid #D9d9d9;">
        ...
        <tr class="heading">
            ...
            <td width="5%"></td>
            <td width="35%"><?php echo $bill_of_material_row->bom_no;?></b></td>
                ...
                <table cellpadding="0" cellspacing="0" style="border:1px solid #ddd;">
                    <?php foreach($specification_label_details as $specification_label_details_row):?>
                        <tr>
                            ...
                            <td width="15%">
                                <?php 
                                    echo (empty($specification_label_details_row->parameter_value)  ? $specification_label_details_row->relating_master_value : $specification_label_details_row->parameter_value);
                                ?>
                                
                            </td>
                            <td width="10%"><?php echo $specification_label_details_row->mat_info;?></td>
                            <td width="40%">
                                <?php 
...
?>
    ...
    <?php foreach($cap_specification as $cap_specification_row):?>
    <table cellpadding="0" cellspacing="0" style="border:1px solid #D9d9d9;">
        <tr class="heading">
