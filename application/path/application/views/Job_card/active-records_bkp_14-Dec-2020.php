							...
							foreach($job_card as $row){
								...
								echo "<tr>
									...
									foreach($formrights as $formrights_row){ 
										...
										if($order_flag=='1' && $row->jobcard_status==0 && $row->jobcard_type==1){
          								...
          								//echo $this->db->last_query();	
          									...
          									if( $qc_done==1 && $total_qc_hold_meters==0  && $material_issue_flag==1 || 1){
									...
									<?php   }
										...
										if($order_flag=='1' && $row->jobcard_status==0 && $row->jobcard_type==2){
											...
											if($order_flag=='1' && $row->jobcard_status==0 && $row->jobcard_type==2 && $row->printing_done==1 && $row->inspection_done==1 && $material_issue_flag==1){
											?>	
