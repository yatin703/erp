...
<script>
	$(document).ready(function(){
		...
		$("#add").live('click',function () {
			...
			var mark_up='<tr id="tr_'+ counter +'"><td><input type="hidden" name="sr_no[]" value="'+counter+'"/>'+counter+'</td><td><input type="text" name="document_no_'+counter+'"  id="document_no_'+counter+'" class="quantity" value="<?php echo set_value('document_no_"+counter+"');?>" maxlength="50" size="20" /></td><td><input type="date" name="date_required_'+counter+'"  id="date_required_'+counter+'" class="quantity" value="<?php echo set_value('date_required_"+counter+"',date('Y-m-d'));?>" maxlength="10" size="20" /></td><td><input type="text" name="product_name_'+counter+'" id="product_name_'+counter+'" value="<?php echo set_value('product_name_"+counter+"');?>"size="80" placeholder="Goods Information"/></td><td><input type="text" name="availabel_quantity_'+counter+'" id="availabel_quantity_'+counter+'"  value="<?php echo set_value('availabel_quantity_"+counter+"');?>" maxlength="15" size="20" class="quantity" /></td><td><input type="text" name="issue_quantity_'+counter+'"  id="issue_quantity_'+counter+'" class="quantity" value="<?php echo set_value('issue_quantity_"+counter+"');?>" maxlength="15" size="20" /></td><td><input type="text" name="calculated_purchase_price_'+counter+'"  id="calculated_purchase_price_'+counter+'" class="quantity" value="<?php echo set_value('calculated_purchase_price_"+counter+"');?>" maxlength="15" size="20" /></td><td><input type="text" name="amt_manual_'+counter+'"  id="amt_manual_'+counter+'" class="quantity" value="<?php echo set_value('amt_manual_"+counter+"');?>" maxlength="15" size="20" /></td></tr>';
	...
	<?php if(isset($error)){ echo "<p class='alert alert-error'>$error</p>";}?>	
		...
		<table class="middle_form_table_design" id="table_article">
						...
						if($this->input->post('sr_no')){
							...
							<td>
								<input type="text" name="issue_quantity_<?php echo $i;?>"  id="issue_quantity_<?php echo $i;?>" class="quantity" value="<?php echo set_value('issue_quantity_'.$i.'');?>" maxlength="15" size="20" />
							</td>
							<td>
						...
						<tr id="tr_1">
							...
							<td>
								<input type="text" name="issue_quantity_1"  id="issue_quantity_1" class="quantity" value="<?php echo set_value('issue_quantity_1');?>" maxlength="15" size="20" />
							</td>
							<td>
