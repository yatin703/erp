			...
			<tr>
				<td>
					<table class="form_table_inner">
									<tr>
										<td class="label">Bank Id <span style="color:red;">*</span> :</td>
										<td><input type="text" name="Bank_id"  value="[Auto Increment]" readonly/></td>
									</tr>
									<tr>
										<td class="label">Bank Code <span style="color:red;">*</span>  :</td>
