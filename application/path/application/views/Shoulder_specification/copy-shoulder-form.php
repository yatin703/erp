					...
					<table class="form_table_inner">
								...
								<input type="hidden" name="spec_version_no"  value="<?php echo set_value('spec_version_no',$specification_row->spec_version_no);?>" readonly/>
									...
									<tr>
										...
										<td><input type="number" name="sh_hdpe_one_per" id="sh_hdpe_one_per" maxlength="3" size="3" min="0" max="100" step="1" value="<?php echo set_value('sh_hdpe_one_per','30',$shoulder_hdpe_one_per);?>" placeholder="%" readonly></td>
										</tr>
										...
										<td>
										<input type="number" name="sh_hdpe_two_per" id="sh_hdpe_two_per" maxlength="3" size="3"  min="0" max="100" step="1"  value="<?php echo set_value('sh_hdpe_two_per','70',$shoulder_hdpe_two_per);?>" placeholder="%" readonly></td>
										</tr>
