				...
				<td>
					<table class="form_table_inner">
									...
									<tr id="hot_foil_1">
										...
										</select><input type="number" name='hot_foil_1_per_tube' min="0" max="1" step="0.00001" value='<?php echo set_value('hot_foil_1_per_tube',$hot_foil_one_per_tube);?>' placeholder="SQM/Tube" size="7"></td>
									</tr>
									...
									<tr id="hot_foil_2">
										...
										</select><input type="number" name='hot_foil_2_per_tube' min="0" max="1" step="0.00001" value='<?php echo set_value('hot_foil_2_per_tube',$hot_foil_two_per_tube);?>' placeholder="SQM/Tube" size="7"></td>
									</tr>
									...
									<tr>
										...
										<td><input type="number" min="0" max="50" step="0.5" name="sealing_non_lacquering_area" value="<?php echo set_value('sealing_non_lacquering_area',$sealing);?>" required></td>
									</tr>
									...
									<tr id="lacquer_type_1">
										...
										}?></select><input type="number" name='lacquer_mixing_pc_1' min="1" max="100" step="1" size="3" value='<?php echo set_value('lacquer_mixing_pc_1',$lacquer_type_one_mixing_pc);?>'  placeholder="%"></td>
									</tr>
									...
									<tr id="lacquer_type_2">
										...
										}?></select><input type="number" name='lacquer_mixing_pc_2' min="1" max="100" step="1" size="3" value='<?php echo set_value('lacquer_mixing_pc_2',$lacquer_type_two_mixing_pc);?>'  placeholder="%"></td>
									</tr>
