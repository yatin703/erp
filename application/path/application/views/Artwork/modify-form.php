					...
					<table class="form_table_inner">
								...
								<?php
									...
									<tr id="hot_foil_<?php echo $i;?>">
										...
										<td><select name="hot_foil_<?php echo $i;?>" value="<?php echo set_value('hot_foil_'.$i.'',$hot_foil_arr[$p]);?>"><option value=''>--Select Hot Foil--</option><?php if($hot_foilss==FALSE){
														echo "<option value=''>--Setup Required--</option>";}
											else{
												foreach($hot_foilss as $hot_foils_row){
													$selected=($hot_foils_row->lang_article_description==$hot_foil_arr[$p] ? 'selected' :'');
													echo "<option value='".$hot_foils_row->lang_article_description."' $selected ".set_select('hot_foil_'.$i.'',$hot_foils_row->lang_article_description).">".$hot_foils_row->lang_article_description."</option>";
												}
										}?></select></td>
									</tr>
									...
									<tr id="lacquer_type_<?php echo $i;?>">
										...
										<td><select name="lacquer_type_<?php echo $i;?>" value="<?php echo set_value('lacquer_type_'.$i.'',$lacquer_arr[$p]);?>"><option value=''>--Select Lacquer--</option><?php if($lacquerss==FALSE){
														echo "<option value=''>--Setup Required--</option>";}
											else{
												foreach($lacquerss as $lacquers_row){
													$selected=($lacquers_row->lang_article_description==$lacquer_arr[$p] ? 'selected' :'');
													echo "<option value='".$lacquers_row->lang_article_description."' $selected  ".set_select('lacquer_type_'.$i.'',$lacquers_row->lang_article_description).">".$lacquers_row->lang_article_description."</option>";
												}
										}?></td>
									</tr>
									<?php 
