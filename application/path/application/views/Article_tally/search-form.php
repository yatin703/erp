...
<script>
	$(document).ready(function(){
		...
		$("#part_no").autocomplete("<?php echo base_url('index.php/ajax/any_article_no');?>", {selectFirst: true});
	});
				...
				<td>
					<table class="form_table_inner">
									...
									<tr>
										...
										<td colspan="3"><input type="text" name="part_no" id="part_no" maxlength="50" size="60" value="<?php echo set_value('part_no');?>" /></td>
