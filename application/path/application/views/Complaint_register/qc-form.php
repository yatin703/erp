		...
		<table class="form_table_design">
				...
				<td width="50%">
					<table class="form_table_inner" >
						...
						<tr id="tr_invoice">
							...
							<td><input type="text" name="invoice_no" id="invoice_no" value="<?php echo set_value('invoice_no',($row->complaint_source=='1'?$row->reference_no:''));?>" readonly/>
							</td>
						</tr>

						<tr id="tr_order">
							<td class="label">Order No.<span style="color:red;">*</span> :</td>
							<td><input type="text" name="order_no" id="order_no" value="<?php echo set_value('order_no',($row->complaint_source=='0'?$row->reference_no:''));?>" readonly/>
							</td>
						</tr>
					...
					<tr id="tr_invoice_tubes_checked">
						...
						<td><input type="number" name="invoice_tubes_checked" id="invoice_tubes_checked" value="<?php echo set_value('invoice_tubes_checked',($row->complaint_source==1?$row->tubes_hold_checked:''));?>" readonly/>
						</td>
						 	
					</tr>
					<tr id="tr_order_tubes_hold">
						<td class="label">No.Of Tubes Hold<span style="color:red;">*</span> :</td>
						<td><input type="number" name="order_tubes_hold" id="order_tubes_hold" value="<?php echo set_value('order_tubes_hold',($row->complaint_source==0?$row->tubes_hold_checked:''));?>"  readonly/>
						</td>										 
						
					</tr>
					<tr>
						<td class="label">Defective Tubes<span style="color:red;">*</span> :</td>
						<td><input type="number" name="defective_tubes" name="defective_tubes" value="<?php echo set_value('defective_tubes', $row->defective_tubes);?>" min="1" max="1000000" step="1" readonly/>		
						</td>							
					</tr>
					<tr>
			...
			<table class="form_table_inner">
				...
				<tr>
					...
					<td><textarea name="investigation" rows="10" cols="50" value="<?php echo set_value('investigation');?>" required><?php echo set_value('investigation');?></textarea></td>
				</tr>
				<tr>
					<td class="label">Investigation/Root Cause <span style="color:red;">*</span> :</td>
					<td><textarea name="root_cause"  rows="10" cols="50" value="<?php echo set_value('root_cause');?>" required><?php echo set_value('root_cause');?></textarea></td>
				</tr>
				<tr>
					<td class="label">Corrective Action <span style="color:red;">*</span> :</td>
					<td><textarea name="corrective_action"  rows="10" cols="50" value="<?php echo set_value('corrective_action');?>" required><?php echo set_value('corrective_action');?></textarea></td>
				</tr>
				<tr>
					<td class="label" >
				...
				<tr>
					...
					<td><textarea name="preventive_action"  rows="10" cols="50" value="<?php echo set_value('preventive_action');?>" required><?php echo set_value('preventive_action');?></textarea></td>
				</tr>
				<tr>
					<td class="label" >
				...
				<tr>
					...
					<td><input type="checkbox" name="is_training_provided" value="1" <?php echo set_checkbox('is_training_provided',1,false);?> >
					&nbsp;&nbsp;&nbsp;Training Date : &nbsp;&nbsp; <input type="date" name="training_date" id="training_date"   value="<?php echo set_value('training_date');?>"/>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						<textarea name="verification_of_effectiveness" maxlength="512" rows="5" cols="50" value="<?php echo set_value('verification_of_effectiveness');?>"  ><?php echo set_value('verification_of_effectiveness');?>
						</textarea>
					</td>
				</tr>
				<tr>
					...
					<td>
						<textarea name="effectiveness_action_taken" maxlength="512" rows="5" cols="50" value="<?php echo set_value('effectiveness_action_taken');?>"  ><?php echo set_value('effectiveness_action_taken');?></textarea>
					</td>
				</tr>
				<tr>
