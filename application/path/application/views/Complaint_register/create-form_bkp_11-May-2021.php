...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$("#complaint_source").change(function() {  	    
	   	...
	   	$("#order_no").bind('blur keyup',function() {
			$("#loading").hide(); $("#cover").hide();
   		...
   		$("#invoice_no").bind('blur keyup',function() {
			$("#loading").hide(); $("#cover").hide();
									...
									<td >
										...
										<table class="form_table_inner" >
											...
											<tr>
												...
												<td><select name="complaint_nature[]" id="complaint_nature[]" multiple="true"><option value=''>--Select Nature Of Complaint--</option>
											...
											<tr><td class="label" >
												<b>Pallets Checked</b> &nbsp; <input type="checkbox" name="is_pallet_checked"  id="is_pallet_checked" value="1" <?php echo set_checkbox('is_pallet_checked',1,false);?> /> </td>
												<td>
											...
											<tr><td class="label" >
												<b>Box Checked</b> &nbsp; <input type="checkbox" name="is_box_checked" id="is_box_checked" value="1" <?php echo set_checkbox('is_box_checked',1,false);?> /> 
											</td>
