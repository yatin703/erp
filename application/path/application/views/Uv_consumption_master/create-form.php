...
<script>
	$(document).ready(function(){
		...
		$("#sale_of_tubes").blur(function(){
			...
			var value=$("#sale_of_tubes").val().replace(",","");
			$("#sale_of_tubes").val(value);
								
			if($("#sale_of_tubes").val()!='' && $("#consumption_value").val()!='0'){		
					
				var cost_per_tube=	($("#consumption_value").val()!='0' && $("#consumption_value").val()!='0' ? $("#consumption_value").val() / $("#sale_of_tubes").val():0);
		...
		$("#consumption_value").blur(function(){
									...
									<tr>
										...
										<?php
											...
											foreach ($lacquer_types_master as $row) {
												...
												// 	$check_box.="checked";
												// } 
												$check_box.=">".($row->printing_group!=''?"<span style='color:red;'>(".$row->printing_group.")</span>":"")." ".$row->lacquer_type."&nbsp;&nbsp;&nbsp;"."</br>";
												echo $check_box;		
											}
										?>
										</td>
