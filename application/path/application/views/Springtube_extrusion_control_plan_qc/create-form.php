			...
			<tr>
				<td width="50%">
					<table class="form_table_inner">
						...
						<tr>
							...
							<td><input type="date" name="inspection_date"   value="<?php echo set_value('inspection_date',date('Y-m-d'));?>" />
						...
						<tr>	
							...
							<td>
								<a href="" id="jobcard_view" target="_blank"></a>
							</td>
						...
						<tr>	
							...
							<td>
								<input type="text" name="order_no" id="order_no"  size="20" value="<?php echo set_value('order_no');?>" readonly/>
							</td>
							<td class="label">Article No. :</td>
							<td>
								<input type="text" name="article_no" id="article_no"  size="20" value="<?php echo set_value('order_no');?>" readonly/>
							</td>							
						</tr>
						<!-- <tr>	
							<td class="label">Article No. :</td>
				...
				<td>
					<table>						
						...
						<tr>
							<td class="label">Reel Width (MM)+/-2 :</td>
						...
						<tr>
							<td class="label">Reel Thickness (MM)+/-12 :</td>
							<td><input type="text" name="thickness_std" id="thickness_std" value="<?php echo set_value('thickness_std');?>" readonly required /></td>
						...
						<tr>
							<td class="label">Reel Length (MM)+/-10 :</td>
							<td><input type="text" name="reel_length_std"  value="<?php echo set_value('reel_length_std');?>" required readonly/></td>
						...
						<tr>
							...
							<td><input type="text" name="first_layer_micron_std"   value="<?php echo set_value('first_layer_micron_std');?>" required readonly/></td>
						...
						<tr>
							...
							<td><input type="text" name="second_layer_micron_std"   value="<?php echo set_value('second_layer_micron_std');?>" required readonly /></td>
						...
						<tr>
							...
							<td><input type="text" name="third_layer_micron_std"   value="<?php echo set_value('third_layer_micron_std');?>" required readonly /></td>
						...
						<tr>
							...
							<td><input type="text" name="fourth_layer_micron_std"   value="<?php echo set_value('fourth_layer_micron_std');?>" required readonly /></td>
						...
						<tr>
							...
							<td><input type="text" name="fifth_layer_micron_std"   value="<?php echo set_value('fifth_layer_micron_std');?>" required readonly/></td>
						...
						<tr>
							...
							<td><input type="text" name="sixth_layer_micron_std"   value="<?php echo set_value('sixth_layer_micron_std');?>" required readonly/></td>
						...
						<tr>
							...
							<td><input type="text" name="seventh_layer_micron_std"  value="<?php echo set_value('seventh_layer_micron_std');?>" required readonly /></td>
