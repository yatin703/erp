...
<form name="<?php echo $this->router->fetch_class();?>" action="<?php echo base_url('index.php/'.$this->router->fetch_class().'/save_roll_thickness');?>" method="POST" >
				...
				?>
				   ...
				   ?>
						...
						<tr id="tr_1">
							...
							<td>
								<input type="hidden" name="sr_no[]" value="1"/>ROLL 1
							</td>					
							<td>
								<input type="number" name="top_pos_1_roll_1"  id="top_pos_1_roll_1" value="<?php echo set_value('top_pos_1_roll_1');?>" maxlength="6" required style="width:60px;" />
							</td>
							<td>
								<input type="number" name="top_pos_2_roll_1"  id="top_pos_2_roll_1" value="<?php echo set_value('top_pos_2_roll_1');?>" maxlength="6" required style="width:60px;"/>
							</td>
							<td>
								<input type="number" name="top_pos_3_roll_1"  id="top_pos_3_roll_1"value="<?php echo set_value('top_pos_3_roll_1');?>" maxlength="6" required style="width:60px;"/>
							</td>
							<td>
								<input type="number" name="top_pos_4_roll_1"  id="top_pos_4_roll_1"value="<?php echo set_value('top_pos_4_roll_1');?>" maxlength="6" required style="width:60px;" />
							</td>
							<td>
								<input type="number" name="top_pos_5_roll_1"  id="top_pos_5_roll_1"  value="<?php echo set_value('top_pos_5_roll_1');?>" maxlength="6" required style="width:60px;" />
							</td>
							<td>
								<input type="number" name="top_pos_6_roll_1"  id="top_pos_6_roll_1" value="<?php echo set_value('top_pos_6_roll_1');?>" maxlength="6" required style="width:60px;" />
							</td>
							<td>
								<input type="number" name="top_pos_7_roll_1"  id="top_pos_7_roll_1"  value="<?php echo set_value('top_pos_7_roll_1');?>" maxlength="6" required style="width:60px;"/>
							</td>
							<td>
								<input type="number" name="top_pos_8_roll_1"  id="top_pos_8_roll_1" value="<?php echo set_value('top_pos_8_roll_1');?>" maxlength="6" required style="width:60px;"/>
							</td>
							<td>
								<input type="number" name="top_pos_9_roll_1"  id="top_pos_9_roll_1"  value="<?php echo set_value('top_pos_9_roll_1');?>" maxlength="6" required  style="width:60px;"/>
							</td>
							<td>
								<input type="number" name="top_pos_10_roll_1"  id="top_pos_10_roll_1"  value="<?php echo set_value('top_pos_10_roll_1');?>"  maxlength="6" required style="width:60px;"/>
							</td>

							<!----------BOTTOM POSITION------------------->

							<td>
								<input type="number" name="bot_pos_1_roll_1"  id="bot_pos_1_roll_1" value="<?php echo set_value('bot_pos_1_roll_1');?>" maxlength="6" required style="width:60px;" />
							</td>
							<td>
								<input type="number" name="bot_pos_2_roll_1"  id="bot_pos_2_roll_1" value="<?php echo set_value('bot_pos_2_roll_1');?>" maxlength="6" required style="width:60px;"/>
							</td>
							<td>
								<input type="number" name="bot_pos_3_roll_1"  id="bot_pos_3_roll_1"value="<?php echo set_value('bot_pos_3_roll_1');?>" maxlength="6" required style="width:60px;"/>
							</td>
							<td>
								<input type="number" name="bot_pos_4_roll_1"  id="bot_pos_4_roll_1"value="<?php echo set_value('bot_pos_4_roll_1');?>" maxlength="6" required style="width:60px;" />
							</td>
							<td>
								<input type="number" name="bot_pos_5_roll_1"  id="bot_pos_5_roll_1"  value="<?php echo set_value('bot_pos_5_roll_1');?>" maxlength="6" required style="width:60px;" />
							</td>
							<td>
								<input type="number" name="bot_pos_6_roll_1"  id="bot_pos_6_roll_1" value="<?php echo set_value('bot_pos_6_roll_1');?>" maxlength="6" required style="width:60px;" />
							</td>
							<td>
								<input type="number" name="bot_pos_7_roll_1"  id="bot_pos_7_roll_1"  value="<?php echo set_value('bot_pos_7_roll_1');?>" maxlength="6" required style="width:60px;"/>
							</td>
							<td>
								<input type="number" name="bot_pos_8_roll_1"  id="bot_pos_8_roll_1" value="<?php echo set_value('bot_pos_8_roll_1');?>" maxlength="6" required style="width:60px;"/>
							</td>
							<td>
								<input type="number" name="bot_pos_9_roll_1"  id="bot_pos_9_roll_1"  value="<?php echo set_value('bot_pos_9_roll_1');?>" maxlength="6" required  style="width:60px;"/>
							</td>
							<td>
								<input type="number" name="bot_pos_10_roll_1"  id="bot_pos_10_roll_1"  value="<?php echo set_value('bot_pos_10_roll_1');?>"  maxlength="6" required style="width:60px;"/>
							</td>											
