			...
			<tr>
				<td>
					<table class="form_table_inner">
							...
							<?php foreach($cap_diameter_master as $row):?>
									<tr>
										<td class="label">Cap Diameter <span style="color:red;">*</span> :</td>
										<td>
											<input type="hidden" name="cap_dia_id"  value="<?php echo set_value('cap_dia_id',$row->cap_dia_id);?>" />
											<input type="text" name="cap_dia"  value="<?php echo set_value('cap_dia',$row->cap_dia);?>" />
										</td>
									</tr>
