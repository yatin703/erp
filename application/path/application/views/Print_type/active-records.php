					...
					echo "<tr><td colspan='9'>No Active Records Found</td></tr>";
							...
							foreach($lacquer_types_master as $row){
								echo "<tr>
									...
									<td><a href=".base_url('index.php/'.$this->router->fetch_class().'/modify/'.$row->lacquer_type_id.'').">Modify</a><a href=".base_url('index.php/'.$this->router->fetch_class().'/delete/'.$row->lacquer_type_id.'')."> | Delete</a>
