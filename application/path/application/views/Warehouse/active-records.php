					...
					echo "<tr><td colspan='9'>No Active Records Found</td></tr>";
							...
							foreach($warehouse_design_lang as $row){
								echo "<tr>
									...
									<td><a href=".base_url('index.php/'.$this->router->fetch_class().'/modify/'.$row->room_no.'').">Modify</a><a href=".base_url('index.php/'.$this->router->fetch_class().'/delete/'.$row->room_no.'')."> | Delete</a>
