						 ...
						 <tr>
							...
							<?php if($springtube_operator_master==FALSE){
									...
									foreach($springtube_operator_master as $springtube_operator_master_row){
										echo "<option value='".$springtube_operator_master_row->operator_id."'  ".set_select('operator',''.$springtube_operator_master_row->operator_id.'').">".$springtube_operator_master_row->operator_name."</option>";
									}
							}?>
							</select></td>
						</tr>
			...
			<td>
					<table class="form_table_inner">
						...
						<tr>
							...
							<td><input type="text" name="order_no" id="order_no" size="20" value="<?php echo set_value('order_no');?>"/></td>
						</tr>

						<tr>
							<td class="label">SPSM/SPSP No. <span style="color:red;">*</span> :</td>
							<td><select name="article_no" id="article_no"><option value=''>--Select SPSM/SPSP--</option>
							</select></td>
						</tr>

						<tr>
							<td class="label">Job card No. <span style="color:red;">*</span> :</td>
							<td><select name="jobcard_no" id="jobcard_no"><option value=''>--Select Jobcard No.--</option>
							</select></td>
						</tr>
						<tr>
							<td class="label">Job Qty. <span style="color:red;">*</span> :</td>
							<td><input type="text" name="actual_qty_manufactured" id="actual_qty_manufactured" size="20" value="<?php echo set_value('actual_qty_manufactured');?>" readonly/></td>
						</tr>

						<tr>
							<td class="label">No. Of Reels Planned <span style="color:red;">*</span>:</td>
							<td><input type="text" name="reels_planned" id="reels_planned" size="20" value="<?php echo set_value('reels_planned');?>"/></td>
						</tr>

						<tr>
							<td class="label">No. Of Reels Produced <span style="color:red;">*</span>:</td>
							<td><input type="text" name="reels_produced" id="reels_produced" size="20" value="<?php echo set_value('reels_produced');?>"/></td>
						</tr>
						<tr>
							<td class="label">Expected tubes <span style="color:red;">*</span>:</td>
							<td><input type="text" name="expected_tubes" id="expected_tubes" size="20" value="<?php echo set_value('expected_tubes');?>"/></td>
						</tr>
...
<?php if(!empty($this->input->post('order_no'))):?>
