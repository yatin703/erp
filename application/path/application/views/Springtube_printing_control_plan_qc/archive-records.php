							...
							echo"<tr>
									<td>";
										...
										foreach ($formrights as $formrights_row) {
											...
											echo ($formrights_row->dearchive==1 ? '<a href="'.base_url('index.php/'.$this->router->fetch_class().'/dearchive/'.$master_row->cp_id.'').'" target="_blank" title="Dearchive"><i class="edit icon"></i></a> ' : '');
