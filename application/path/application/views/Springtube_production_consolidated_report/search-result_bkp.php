	                	...
	                	echo"<tr>
								...
								echo "</td>";
									...
									foreach($formrights as $formrights_row){ 
										echo"<td>";
										echo ($formrights_row->new==1 && $order_master_row->final_approval_flag==1 && $order_master_row->order_closed<>1 && $order_master_row->trans_closed<>1 && $order_master_row->ref_order_no=='' ? '<a target="_blank" href="'.base_url('index.php/'.$this->router->fetch_class().'/job_card/'.$order_master_row->order_no.'/'.$order_master_row->article_no).'">Create Job Card</a> ' : '');
										...
										$data_search=array('order_no'=>$order_master_row->order_no,
													'article_no'=>$order_master_row->article_no
													);
										...
										echo ($formrights_row->new==1 && $order_master_row->order_flag==1 && $order_master_row->final_approval_flag==1 && $order_master_row->order_closed<>1 && $order_master_row->trans_closed<>1 && $order_master_row->ref_order_no=='' ? '<a target="_blank" href="'.base_url('index.php/springtube_printing_wip_before_print/create_printing_jobcard/'.$order_master_row->order_no.'/'.$order_master_row->article_no).'">Create Printing Job Card</a> ' : '');
