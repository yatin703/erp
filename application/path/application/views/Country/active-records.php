					...
					$i=($this->uri->segment(3)=="" ? 1 : $this->uri->segment(3)+1);
							foreach($country as $row){
								echo "<tr>
									...
									<td><a href=".base_url('index.php/'.$this->router->fetch_class().'/modify/'.$row->country_id.'').">Modify</a><a href=".base_url('index.php/'.$this->router->fetch_class().'/delete/'.$row->country_id.'')."> | Delete</a>
