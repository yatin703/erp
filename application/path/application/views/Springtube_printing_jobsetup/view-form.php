...
<?php foreach ($springtube_printing_jobsetup_master as $row):?>
        ...
        <tr >
            ...
            <td width="25%">
                <table cellpadding="5" cellspacing="0" style="border:1px solid #D9d9d9;">
                    ...
                    <tr><td style="border:1px solid #D9d9d9; height:300px;">COLOUR</td>
                        <td style="border:1px solid #D9d9d9;"><?php
                            ...
                            if($ink_1!=''|| $ink_1!='0'){
                                ...
                                $ink_1_result=$this->springtube_ink_master_model->select_one_record_for_view('springtube_ink_master',$this->session->userdata['logged_in']['company_id'],'ink_id',$ink_1);
                    ...
                    <tr><td style="border:1px solid #D9d9d9;line-height:50px">COMMENT</td>
                        <td style="border:1px solid #D9d9d9; "><?php echo $row->abg1_unit_1_comment;?></td>
                    </tr>
                </table>
           </td>
           ...
           <td width="25%">
                <table cellpadding="5" cellspacing="0" style="border:1px solid #D9d9d9;">
                    ...
                    <tr><td style="border:1px solid #D9d9d9; height:300px;">COLOUR</td>
                        <td style="border:1px solid #D9d9d9;"><?php
                            ...
                            if($ink_2!=''|| $ink_2!='0'){
                                ...
                                $ink_2_result=$this->springtube_ink_master_model->select_one_record_for_view('springtube_ink_master',$this->session->userdata['logged_in']['company_id'],'ink_id',$ink_2);
                    ...
                    <tr><td style="border:1px solid #D9d9d9;line-height:50px;">COMMENT</td>
                        <td style="border:1px solid #D9d9d9;"><?php echo $row->abg1_unit_2_comment;?></td>
                    </tr>
                </table>
           </td>
           ...
           <td width="25%">
                <table cellpadding="5" cellspacing="0" style="border:1px solid #D9d9d9;">
                    ...
                    <tr><td style="border:1px solid #D9d9d9; height:300px;">COLOUR</td>
                        <td style="border:1px solid #D9d9d9;"><?php
                            ...
                            if($ink_3!=''|| $ink_3!='0'){
                                ...
                                $ink_3_result=$this->springtube_ink_master_model->select_one_record_for_view('springtube_ink_master',$this->session->userdata['logged_in']['company_id'],'ink_id',$ink_3);
                    ...
                    <tr><td style="border:1px solid #D9d9d9;line-height:50px;">COMMENT</td>
                        <td style="border:1px solid #D9d9d9;"><?php echo $row->abg1_unit_3_comment;?></td>
                    </tr>
                </table>
           </td>
            ...
            <td width="25%">
                <table cellpadding="5" cellspacing="0" style="border:1px solid #D9d9d9;">
                    ...
                    <tr><td style="border:1px solid #D9d9d9; height:300px;">COLOUR</td>
                        <td style="border:1px solid #D9d9d9;"><?php
                            ...
                            if($ink_4!=''|| $ink_4!='0'){
                                ...
                                $ink_4_result=$this->springtube_ink_master_model->select_one_record_for_view('springtube_ink_master',$this->session->userdata['logged_in']['company_id'],'ink_id',$ink_4);
                    ...
                    <tr><td style="border:1px solid #D9d9d9;line-height:50px;">COMMENT</td>
                        <td style="border:1px solid #D9d9d9;"><?php echo $row->abg1_unit_4_comment;?></td>
                    </tr>
    ...
    <table cellpadding="5" cellspacing="0" style="border:1px solid #D9d9d9;">
        <tr class="heading" style="border:1px solid #D9d9d9;"><td colspan="17">DURST</td></tr>            
        <tr class="heading" >
            <td width="5%" style="border-bottom:1px solid #D9d9d9;">CORONA DOSE</td>
            <td width="1%" style="border-bottom:1px solid #D9d9d9;"></td>             
            <td width="3%" style="border:1px solid #D9d9d9;">PRINT CONFIG</td>                
            <td width="3%" style="border:1px solid #D9d9d9;">DIGITAL WHITE</td>
            <td width="10%" style="border:1px solid #D9d9d9;">COLOUR POLICY</td>
            <td width="5%" style="border:1px solid #D9d9d9;">SUBSTARTE PROFILE</td>
            ...
            <td width="5%" style="border:1px solid #D9d9d9;">PINNING W/K</td>
            ...
            <td width="5%" style="border:1px solid #D9d9d9;">DIGITAL COST (EURO) / <?php echo (1000*$row->digital_cost_per_qty);?> </td>
            <td width="5%" style="border:1px solid #D9d9d9;">TRACK (UPS)</td>
        </tr>
        <tr >
           ...
           // echo $row->colour_policy;
            ...
            <td style="border:1px solid #D9d9d9;"><?php echo $row->pinning_w.($row->pinning_w!=''?'% / ':'').$row->pinning_k.($row->pinning_k!=''?'%':'');?></td>
            <!-- <td style="border:1px solid #D9d9d9;"><?php echo $row->pinning_k.($row->pinning_k!=''?' %':'');?></td> -->
            <td style="border:1px solid #D9d9d9;"><?php echo $row->durst_uv_curing_1.($row->durst_uv_curing_1!=''?'% / '.$row->durst_uv_lamp_hrs_1:'');?></td>
            <!-- <td style="border:1px solid #D9d9d9;"><?php echo $row->durst_uv_lamp_hrs_1;?></td> -->
            <td style="border:1px solid #D9d9d9;"><?php echo $row->durst_uv_curing_2.($row->durst_uv_curing_2!=''?'% / '.$row->durst_uv_lamp_hrs_2:'');?></td>
            ...
            <td style="border:1px solid #D9d9d9;"><?php echo $row->digital_cost_in_euro.' /'.(1000*$row->digital_cost_per_qty);?></td>
            <td style="border:1px solid #D9d9d9;"><?php echo $row->digital_cost_per_qty;?></td>
        </tr>
        ...
        <tr>
                    ...
                    <tr><td style="border:1px solid #D9d9d9; height:300px;">COLOUR</td>
                        <td style="border:1px solid #D9d9d9;"><?php
                            ...
                            if($ink_5!=''|| $ink_5!='0'){
                                ...
                                $ink_5_result=$this->springtube_ink_master_model->select_one_record_for_view('springtube_ink_master',$this->session->userdata['logged_in']['company_id'],'ink_id',$ink_5);
           ...
           <td width="25%">
                <table cellpadding="5" cellspacing="0" style="border:1px solid #D9d9d9">
                    ...
                    <tr><td style="border:1px solid #D9d9d9; height:300px;">COLOUR</td>
                        <td style="border:1px solid #D9d9d9;"><?php
                            ...
                            if($ink_6!=''|| $ink_6!='0'){
                                ...
                                $ink_6_result=$this->springtube_ink_master_model->select_one_record_for_view('springtube_ink_master',$this->session->userdata['logged_in']['company_id'],'ink_id',$ink_6);
                    ...
                    <tr><td style="border:1px solid #D9d9d9;line-height:30px;">COMMENT</td>
                        <td style="border:1px solid #D9d9d9;"><?php echo $row->abg2_unit_2_comment;?></td>
                    </tr>
                    <tr><td style="border:1px solid #D9d9d9;line-height:20px">EXT.WEBPATH</td>
           ...
           <td width="25%">
                <table cellpadding="5" cellspacing="0" style="border:1px solid #D9d9d9">
                    <tr class="heading">
                        <td colspan="2"><b>COLD FOIL 1</b></td>
                        
                    </tr>
                    <tr><td style="border:1px solid #D9d9d9;width: 25%;"></td>
                        <td style="border:1px solid #D9d9d9;">&nbsp;</td>
                    </tr>
                    <tr><td style="border:1px solid #D9d9d9; height:300px;">NAME</td>
                        <td style="border:1px solid #D9d9d9;"><?php echo $this->common_model->get_article_name($cold_foil_1,$this->session->userdata['logged_in']['company_id']);?></td>
                    </tr>
                    <tr><td style="border:1px solid #D9d9d9;">AREA</td>
                        <td style="border:1px solid #D9d9d9;"><?php echo ($cold_foil_1!=''?$cold_foil_1_area.' SQMTR':'');?></td>
                    </tr>
                    <tr><td style="border:1px solid #D9d9d9;">WIDTH</td>
                        <td style="border:1px solid #D9d9d9;"><?php echo ($cold_foil_1!=''?$cold_foil_1_width.' MM':'');?></td>
                    </tr>
                    <tr><td style="border:1px solid #D9d9d9;">LENGTH</td>
                        <td style="border:1px solid #D9d9d9;"><?php echo ($cold_foil_1!=''?$cold_foil_1_length.' MTRS':'');?></td>
                    </tr>
                    <tr><td style="border:1px solid #D9d9d9;">&nbsp;</td>
                        <td style="border:1px solid #D9d9d9;">&nbsp;</td>
                    </tr>
                    <tr><td style="border:1px solid #D9d9d9;">&nbsp;</td>
                        <td style="border:1px solid #D9d9d9;">&nbsp;</td>
                    ...
                    <tr><td style="border:1px solid #D9d9d9;line-height:50px">&nbsp;</td>
                        <td style="border:1px solid #D9d9d9;">&nbsp;</td>
                    </tr>
           ...
           <td width="25%">
                <table cellpadding="5" cellspacing="0" style="border:1px solid #D9d9d9">
                    <tr class="heading">
                        <td colspan="2"><b>COLD FOIL 2</b></td>                        
                    </tr>
                    <tr><td style="border:1px solid #D9d9d9;width: 25%;"></td>
                        <td style="border:1px solid #D9d9d9;">&nbsp;</td>
                    </tr>
                    <tr><td style="border:1px solid #D9d9d9; height:300px;">NAME</td>
                        <td style="border:1px solid #D9d9d9;"><?php echo $this->common_model->get_article_name($cold_foil_2,$this->session->userdata['logged_in']['company_id']);?>
                            
                        </td>
                    </tr>
                    <tr><td style="border:1px solid #D9d9d9;">AREA</td>
                        <td style="border:1px solid #D9d9d9;"><?php echo ($cold_foil_2!=''?$cold_foil_2_area.' SQMTR':'');?></td>
                    </tr>
                    <tr><td style="border:1px solid #D9d9d9;">WIDTH</td>
                        <td style="border:1px solid #D9d9d9;"><?php echo ($cold_foil_2!=''?$cold_foil_2_width.' MM':'');?></td>
                    </tr>
                    <tr><td style="border:1px solid #D9d9d9;">LENGTH</td>
                        <td style="border:1px solid #D9d9d9;"><?php echo ($cold_foil_2!=''?$cold_foil_2_length.' MTRS':'');?></td>
                    </tr>
                    <tr><td style="border:1px solid #D9d9d9;">&nbsp;</td>
                        <td style="border:1px solid #D9d9d9;">&nbsp;</td>
                    </tr>
