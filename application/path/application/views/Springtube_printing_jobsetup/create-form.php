									...
									<td width="60%">
										...
										<table class="form_table_inner" >
											<tr>
												...
												<td>
													Width=
													<input type="text" name="cold_foil_1_width" id="cold_foil_1_width" readonly placeholder="Width" size="10" value="<?php echo set_value('cold_foil_1_width');?>">
													MM, Length=
											...
											<tr>
												...
												<td>
													Width=
													<input type="text" name="cold_foil_2_width" id="cold_foil_2_width" readonly placeholder="Width" size="10" value="<?php echo set_value('cold_foil_2_width');?>">
													MM,	Length=
