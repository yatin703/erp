        ...
        <tr>
           ...
           <td width="25%">
                <table cellpadding="5" cellspacing="0" style="border:1px solid #D9d9d9">
                    ...
                    <tr><td style="border:1px solid #D9d9d9; height:300px;">NAME</td>
                        <td style="border:1px solid #D9d9d9;"><?php echo $this->common_model->get_article_name($row->cold_foil_1,$this->session->userdata['logged_in']['company_id']);?></td>
                    </tr>
                    <tr><td style="border:1px solid #D9d9d9;">AREA</td>
                        <td style="border:1px solid #D9d9d9;"><?php echo ($row->cold_foil_1_area!=''?$row->cold_foil_1_area.' SQMTR':'');?></td>
                    </tr>
                    <tr><td style="border:1px solid #D9d9d9;">WIDTH</td>
                        <td style="border:1px solid #D9d9d9;"><?php echo ($row->cold_foil_1_width!=''?$row->cold_foil_1_width.' MM':'');?></td>
                    </tr>
                    <tr><td style="border:1px solid #D9d9d9;">LENGTH</td>
                        <td style="border:1px solid #D9d9d9;"><?php echo ($row->cold_foil_1_length!=''?$row->cold_foil_1_length.' MTRS':'');?></td>
                    </tr>
           ...
           <td width="25%">
                <table cellpadding="5" cellspacing="0" style="border:1px solid #D9d9d9">
                    ...
                    <tr><td style="border:1px solid #D9d9d9; height:300px;">NAME</td>
                        <td style="border:1px solid #D9d9d9;"><?php echo $this->common_model->get_article_name($row->cold_foil_2,$this->session->userdata['logged_in']['company_id']);?>
                            
                        </td>
                    </tr>
                    <tr><td style="border:1px solid #D9d9d9;">AREA</td>
                        <td style="border:1px solid #D9d9d9;"><?php echo ($row->cold_foil_2_area!=''?$row->cold_foil_2_area.' SQMTR':'');?></td>
                    </tr>
                    <tr><td style="border:1px solid #D9d9d9;">WIDTH</td>
                        <td style="border:1px solid #D9d9d9;"><?php echo ($row->cold_foil_2_width!=''?$row->cold_foil_2_width.' MM':'');?></td>
                    </tr>
                    <tr><td style="border:1px solid #D9d9d9;">LENGTH</td>
                        <td style="border:1px solid #D9d9d9;"><?php echo ($row->cold_foil_2_length!=''?$row->cold_foil_2_length.' MTRS':'');?></td>
                    </tr>
                    <tr><td style="border:1px solid #D9d9d9;">&nbsp;</td>
                        <td style="border:1px solid #D9d9d9;">&nbsp;</td>
                    </tr>
