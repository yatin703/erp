									...
									<td width="50%">
										...
										<table class="form_table_inner">
											...
											<tr>
												...
												<td><input type="number" name="abg1_carona_1" id="abg1_carona_1" min="30" max="200" step="1"  value="<?php echo set_value('abg1_carona_1',$master_row->abg1_carona_1);?>" /></td>
									...
									<td width="50%">
										<table>
											...
											<tr>
												...
												<td><input type="number" name="digital_cost_in_euro" id="digital_cost_in_euro" min="0" max="1000"  size="20" step="any" value="<?php echo set_value('digital_cost_in_euro',$master_row->digital_cost_in_euro);?>" /></td>
											</tr>
											<tr>
												<td class="label">Comment  <span style="color:red;">*</span> :</td>
								...
								<tr>
									<td width="50%">
										<table class="form_table_inner">
											...
											<tr>
												<td class="label">Carona. <span style="color:red;">*</span> :</td>
												<td><input type="number" name="abg2_carona_1" id="abg2_carona_1" min="30" max="200" step="1"  value="<?php echo set_value('abg2_carona_1',$master_row->abg2_carona_1);?>" /></td>
