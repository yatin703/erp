										...
										<table class="form_table_inner">
											...
											<tr>
												...
												<td><select name="abg1_rotary_2" id="abg1_rotary_2">
													<option value="">--Please Select--</option>
													<option value="1" <?php echo set_select('abg1_rotary_2',1);?> <?php echo ($master_row->abg1_rotary_1==1?"selected":"");?> >[SR]-Semi Rotary</option>
													<option value="2" <?php echo set_select('abg1_rotary_2',2);?> 
													<?php echo ($master_row->abg1_rotary_1==2?"selected":"");?> >[FR]-Full Rotary </option>
												</select>
											</tr>
								...
								<tr>
									<td width="50%">
										<table class="form_table_inner">
											...
											<tr>
												<td class="label">Carona. <span style="color:red;">*</span> :</td>
												<td><input type="number" name="durst_corona" id="durst_corona" min="30" max="200" step="1"  value="<?php echo set_value('durst_corona',$master_row->durst_corona);?>"   /></td>
