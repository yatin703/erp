			...
			<tr>
				<td>
					<table class="form_table_inner">
							...
							<?php foreach($digital_ink_price_master as $row):

								?>
									<tr>
										<td class="label" >Apply date <span style="color:red;">* </span> :</td>
										<td>
											<input type="hidden" name="dipm_id" value="<?php echo $row->dipm_id;?>" readonly>
									...
									<tr>
										...
										<td><input type="number" name="ink_id" id="ink_id" step="any" value="<?php echo set_value('ink_id',$row->ink_id);?>" ></td>
									</tr>

									<tr>
										<td class="label">Rm <span style="color:red;">* </span> :</td>
										<td><input type="text" name="rm" id="rm" step="any" value="<?php echo set_value('rm',$row->rm);?>" size="60" ></td>
									</tr>

									<tr>
										<td class="label">Other Charges PC <span style="color:red;">* </span> :</td>
										<td><input type="number" name="other_charges_pc" id="other_charges_pc" step="any" value="<?php echo set_value('other_charges_pc',$row->other_charges_pc);?>" ></td>
									</tr>


									<tr>
										<td class="label">Rate of Exchange <span style="color:red;">* </span> :</td>
										<td><input type="number" name="rate_of_exchange" id="rate_of_exchange" step="any" value="<?php echo set_value('rate_of_exchange',$row->rate_of_exchange);?>" ></td>
									</tr>
