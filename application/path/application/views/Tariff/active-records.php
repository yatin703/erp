					...
					echo "<tr><td colspan='9'>No Active Records Found</td></tr>";
							...
							foreach($excise_rates_master as $row){
								echo "<tr>
									...
									<td><a href=".base_url('index.php/'.$this->router->fetch_class().'/modify/'.$row->erm_id.'').">Modify</a><a href=".base_url('index.php/'.$this->router->fetch_class().'/delete/'.$row->erm_id.'')."> | Delete</a>
