					...
					echo "<tr><td colspan='12'>No Active Records Found</td></tr>";
							...
							foreach($workprocedure_types_master as $row){
								echo "<tr>
									...
									<td><a href=".base_url('index.php/'.$this->router->fetch_class().'/modify/'.$row->work_proc_type_id.'').">Modify</a><a href=".base_url('index.php/'.$this->router->fetch_class().'/delete/'.$row->work_proc_type_id.'')."> | Delete</a>
