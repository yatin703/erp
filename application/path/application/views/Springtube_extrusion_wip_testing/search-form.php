								...
								<?php if($springtube_process_master==TRUE){
									...
									foreach($springtube_process_master as $springtube_process_master_row){
										if(!empty($this->input->post('springtube_process[]'))){
											...
											echo'<input type="checkbox" name="springtube_process[]" value="'.$springtube_process_master_row->process_id.'" '.(in_array($springtube_process_master_row->process_id,$this->input->post('springtube_process[]'))?"checked":"").' >&nbsp;'.$springtube_process_master_row->process_name.'&nbsp;';
										}else{
										echo'<input type="checkbox" name="springtube_process[]" value="'.$springtube_process_master_row->process_id.'" >&nbsp;'.$springtube_process_master_row->process_name.'&nbsp;';
										}
									}
							}?>
