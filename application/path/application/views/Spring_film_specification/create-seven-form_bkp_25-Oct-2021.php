				...
				<td width="50%">
					<table class="form_table_inner">
                           ...
                           <tr><td class="label"><b>2 Layer</b></td></tr>
                                 ...
                                 <tr>
                                 <td class="label">Gauge <span style="color:red;">*</span> :</td>
                                 <td><input type="number" name="gauge_two" min="100" max="175" step="1" maxlength="5" size="5" value="<?php echo set_value('gauge_two','155');?>" required></td>
                                 </tr>
                           ...
                           <tr><td class="label"><b>&nbsp;</b></td><td class="label"><b>&nbsp;</b></td></tr>
                              ...
                              <tr>
                                 <td class="label">Gauge <span style="color:red;">*</span> :</td>
                                 <td><input type="number" name="gauge_four" min="15"  max="25" step="1" maxlength="2" size="2" value="<?php echo set_value('gauge_four','25');?>" required></td>
                              </tr>
                           ...
                           if($hdpe_row->article_no=='RM-HDPE-000-0008'){ 
                            ...
                            <tr>
                                 <td class="label">Gauge <span style="color:red;">*</span> :</td>
                                 <td><input type="number" name="gauge_six" id="gauge_six" min="155" max="240" step="1" maxlength="5" size="5" value="<?php echo set_value('gauge_six','210');?>" required></td>
                              </tr>
