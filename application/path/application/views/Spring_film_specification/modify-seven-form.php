				...
				<td width="40%">
					<table class="form_table_inner">
									...
									<tr>
										...
										<td><input type="number"  name="gauge_one" maxlength="5" size="5" value="<?php echo set_value('gauge',$gauge_one);?>" required></td>
									</tr>
                           ...
                           <tr><td class="label">&nbsp;</td><td class="label">&nbsp;</td></tr>
									...
									<tr>
										<td class="label">Gauge <span style="color:red;">*</span> :</td>
										<td><input type="number" name="gauge_two"    id="gauge_two" maxlength="2" size="2" value="<?php echo set_value('gauge_two',$this->common_model->select_number_from_string($gauge_two));?>" required></td>
									</tr>
                           ...
                           <tr><td class="label">&nbsp;</td><td class="label">&nbsp;</td></tr>
									...
									<tr>
										<td class="label">Gauge <span style="color:red;">*</span> :</td>
										<td><input type="number" name="gauge_three" id="gauge_three" maxlength="2" size="2" value="<?php echo set_value('gauge_three',$this->common_model->select_number_from_string($gauge_three));?>"></td>
									</tr>
									...
									<tr>
										...
										<td>
										<input type="number" name="film_admer_per_three"  id="film_admer_per_three" maxlength="3" size="3" value="<?php echo set_value('film_admer_per_three',$this->common_model->select_percentage_from_string($film_admer_per_three));?>" placeholder="%" ></td>
									</tr>
                           ...
                           <tr><td class="label">&nbsp;</td><td class="label">&nbsp;</td></tr>
									...
									<tr>
										<td class="label">Gauge <span style="color:red;">*</span> :</td>
										<td><input type="number" name="gauge_four"  value="<?php echo set_value('gauge_four',$this->common_model->select_number_from_string($gauge_four));?>" required></td>
									</tr>
                           ...
                           <tr><td class="label">&nbsp;</td><td class="label">&nbsp;</td></tr>
									...
									<tr>
										<td class="label">Gauge <span style="color:red;">*</span> :</td>
										<td><input type="number" name="gauge_five"  size="2" value="<?php echo set_value('gauge_five',$gauge_five);?>" required></td>
									</tr>
									...
									<tr>
										<td class="label">Gauge <span style="color:red;">*</span> :</td>
										<td><input type="number" name="gauge_six"  maxlength="5" size="5" value="<?php echo set_value('gauge_six',$gauge_six);?>" required></td>
									</tr>
									...
									<tr>
										<td class="label">Gauge <span style="color:red;">*</span> :</td>
										<td><input type="number" name="gauge_seven" maxlength="5" size="5" value="<?php echo set_value('gauge_seven',$gauge_seven);?>" required></td>
									</tr>
