...
<?php foreach($specification as $specification_row):?>
   ...
   $result_hdpe_one=$this->sleeve_specification_model->select_details_record_where('specification_sheet_details',$this->session->userdata['logged_in']['company_id'],'spec_id',$specification_row->spec_id,'spec_version_no',$specification_row->spec_version_no,'srd_id','1_6_2','srd_id','asc');
   if($result_hdpe_one==FALSE){
      $film_hdpe_one='';
      $film_hdpe_per_one='';
   }else{
      foreach($result_hdpe_one as $film_hdpe_one_row){ $film_hdpe_one=$film_hdpe_one_row->mat_article_no; $film_hdpe_per_one=$film_hdpe_one_row->mat_info;}
   }
...
//Layer Six
		...
		if($result_film_ldpe_six==FALSE){
				...
				foreach($result_film_ldpe_six as $film_ldpe_six_row){ $film_ldpe_six=$film_ldpe_six_row->mat_article_no; $film_ldpe_per_six=$film_ldpe_six_row->mat_info;}
			}
		...
		if($result_film_lldpe_six==FALSE){
				...
				foreach($result_film_lldpe_six as $film_lldpe_six_row){ $film_lldpe_six=$film_lldpe_six_row->mat_article_no; $film_lldpe_per_six=$film_lldpe_six_row->mat_info;}
			}
		...
		if($result_film_hdpe_six==FALSE){
			...
			foreach($result_film_hdpe_six as $film_hdpe_six_row){ $film_hdpe_six=$film_hdpe_six_row->mat_article_no; $film_hdpe_per_six=$film_hdpe_six_row->mat_info;}
		}
...
//Layer Seven
		...
		$result_film_hdpe_seven=$this->sleeve_specification_model->select_details_record_where('specification_sheet_details',$this->session->userdata['logged_in']['company_id'],'spec_id',$specification_row->spec_id,'spec_version_no',$specification_row->spec_version_no,'srd_id','7_6_2','srd_id','asc');
		if($result_film_hdpe_seven==FALSE){
				$film_hdpe_seven='';
				$film_hdpe_per_seven='';
			}else{
				foreach($result_film_hdpe_seven as $film_hdpe_seven_row){ $film_hdpe_seven=$film_hdpe_seven_row->mat_article_no; $film_hdpe_per_seven=$film_hdpe_seven_row->mat_info;}
			}
					...
					<table class="form_table_inner">
									...
									<tr>
										...
										<?php if($sleeve_dia==FALSE){
											...
											<input type="text" name="sleeve_length" id="sleeve_length" size="5" value="<?php echo set_value('sleeve_length',$length);?>" required>
										</td>
									</tr>
									...
									<tr>
										...
										<td><input type="number"  min="10" max="20" step="1" name="gauge_one" maxlength="5" size="5" value="<?php echo set_value('gauge',$gauge_one);?>" required></td>
									</tr>
									...
									<tr>
										...
										foreach ($hdpe as $hdpe_row) {
											$selected=($hdpe_row->article_no==$film_hdpe_one ? 'selected' : '');
											echo "<option value='".$hdpe_row->article_no."' $selected ".set_select('film_hdpe_one',$hdpe_row->article_no).">".$hdpe_row->lang_article_description."</option>";
										}
										?>
										</select></td>
										<td>
										<input type="number" name="film_hdpe_per_one"  min="0"  max="100" step="1"  maxlength="3" size="3" value="<?php echo set_value('film_hdpe_per_one',$this->common_model->select_percentage_from_string($film_hdpe_per_one));?>" placeholder="%"></td>
										</tr>
                           ...
                           <tr><td class="label">&nbsp;</td><td class="label">&nbsp;</td></tr>
                                    ...
                                    <td><input type="number" name="film_mb_per_two" min="0"  max="25" step="0.1" maxlength="4" size="4" value="<?php echo set_value('film_mb_per_two',$this->common_model->select_percentage_from_string($film_mb_per_two));?>" placeholder="%" required></td>
	                                 </tr>
                           ...
                           <tr><td class="label">&nbsp;</td><td class="label">&nbsp;</td></tr>
									...
									<tr>
										<td class="label">Gauge <span style="color:red;">*</span> :</td>
										<td><input type="number" name="gauge_three" min="10"  max="20" step="1" id="gauge_three" maxlength="2" size="2" value="<?php echo set_value('gauge_three',$this->common_model->select_number_from_string($gauge_three));?>"></td>
									</tr>
                           ...
                           <tr><td class="label">&nbsp;</td><td class="label">&nbsp;</td></tr>
									...
									<tr>
										<td class="label">Gauge <span style="color:red;">*</span> :</td>
										<td><input type="number" name="gauge_five" min="10"  max="10" step="1" maxlength="2" size="2" value="<?php echo set_value('gauge_five',$gauge_five);?>" required></td>
									</tr>
									...
									<tr>
										<td class="label">Gauge <span style="color:red;">*</span> :</td>
										<td><input type="number" name="gauge_six"  min="100" max="240" step="1" maxlength="5" size="5" value="<?php echo set_value('gauge_six',$gauge_six);?>" required></td>
									</tr>
                                    ...
                                    <td><input type="number" name="film_mb_per_six" min="0"  max="25" step="0.1" maxlength="4" size="4" value="<?php echo set_value('film_mb_per_six',$this->common_model->select_percentage_from_string($film_mb_per_six));?>" placeholder="%" required></td>
	                                 </tr>
									...
									<tr>
										<td class="label">Gauge <span style="color:red;">*</span> :</td>
										<td><input type="number" name="gauge_seven"  min="20" max="20" step="1" maxlength="5" size="5" value="<?php echo set_value('gauge_seven',$gauge_seven);?>" required></td>
									</tr>
									...
									<tr>
	                                 ...
	                                 <td>
	                                 <input type="number" name="film_ldpe_per_seven" min="0"  max="100" step="1" maxlength="3" size="3" value="<?php echo set_value('film_ldpe_per_seven',$this->common_model->select_percentage_from_string($film_ldpe_per_seven));?>" placeholder="%"></td>
	                                 </tr>
	                                 ...
	                                 <td>
	                                 <input type="number" name="film_lldpe_per_seven" min="0"  max="100" step="1" maxlength="3" size="3" value="<?php echo set_value('film_lldpe_per_seven',$this->common_model->select_percentage_from_string($film_lldpe_per_seven));?>" placeholder="%"></td>
	                                 </tr>
	                                 ...
	                                 <?php
	                                 foreach ($hdpe as $hdpe_row) {
	                                 	$selected=($hdpe_row->article_no==$film_hdpe_seven ? 'selected' : '');
	                                    echo "<option value='".$hdpe_row->article_no."' $selected ".set_select('film_hdpe_seven',$hdpe_row->article_no).">".$hdpe_row->lang_article_description."</option>";
	                                 }
	                                 ?>
	                                 </select></td>
	                                 <td>
	                                 <input type="number" name="film_hdpe_per_seven" min="0"  max="100" step="1" maxlength="3" size="3" value="<?php echo set_value('film_hdpe_per_seven',$this->common_model->select_percentage_from_string($film_hdpe_per_seven));?>" placeholder="%"></td>
	                                 </tr>
