						...
						<input type="hidden" name="spec_version_no" value="<?php echo $specification_row->spec_version_no;?>">
                              ...
                              <?php if($this->input->post('article_no')){
                                 ...
                                 echo '<option value="">--Select Article Code--</option>';
									...
									<tr>
										...
										}?></select>&nbsp;Length <span style="color:red;">*</span> : <input type="number" name="sleeve_length" min="10"  max="300" step="0.5" id="sleeve_length" size="6" maxlength="5" value="<?php echo set_value('sleeve_length',$length);?>" required></td>
									</tr>
                           ...
                           <tr><td class="label">&nbsp;</td><td class="label">&nbsp;</td></tr>
									...
									<tr>
										...
										<td>
										<input type="number" name="sl_mb_per" id="sl_mb_per" min="0"  max="25" step="0.5" maxlength="3" size="3" value="<?php echo set_value('sl_mb_per',$this->common_model->select_percentage_from_string($sl_mb_per));?>" placeholder="%">
                              ...
                              <tr><td class="label">&nbsp;</td><td class="label">&nbsp;</td></tr>
									...
									<tr>
										<td class="label">Gauge <span style="color:red;">*</span> :</td>
										<td><input type="number" name="gauge_two" id="gauge_two"  maxlength="3" size="3" value="<?php echo set_value('gauge_two',$this->common_model->select_number_from_string($gauge_two));?>" required></td>
									</tr>
                           ...
                           <tr>
                              <td class="label">Gauge <span style="color:red;">*</span> :</td>
                              <td><input type="number" name="gauge_three" id="gauge_three"  maxlength="3" size="3" value="<?php echo set_value('gauge_three',$this->common_model->select_number_from_string($gauge_three));?>"></td>
                           </tr>

                           <tr>
                              <td class="label">MB :</td>
                              <td><select name="sl_masterbatch_three" id="sl_masterbatch_three"><option value=''>--Select MB--</option>
                              <?php foreach ($masterbatch as $masterbatch_row) {
                              ...
                              <td>
                              <input type="number" name="sl_mb_per_three" min="0"  max="25" step="0.5"  id="sl_mb_per_three" maxlength="3" size="3" value="<?php echo set_value('sl_mb_per_three',$this->common_model->select_percentage_from_string($sl_mb_per_three));?>" placeholder="%">
                              </td>
                              </tr>
                              ...
                              <td>
                              <input type="number" name="sl_ldpe_per_three" min="0"  max="100" step="1"  id="sl_ldpe_per_three" maxlength="3" size="3" value="<?php echo set_value('sl_ldpe_per_three',$this->common_model->select_percentage_from_string($sl_ldpe_per_three));?>" placeholder="%"></td>
                              </tr>
