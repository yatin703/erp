					...
					<table class="form_table_inner">
                                 ...
                                 <option value="45">SLEEVE-45</option>
									...
									<tr>
										...
										<td><input type="number" min="175" max="250" step="25" name="gauge" id="gauge" maxlength="3" size="3" value="<?php echo set_value('gauge');?>" required></td>
									</tr>
									...
									<tr>
										...
										<tr>
											<td class="label">Gauge <span style="color:red;">*</span> :</td>
											<td><input type="number" name="gauge_two" id="gauge_two" min="50" max="100" step="50" maxlength="3" size="3" value="<?php echo set_value('gauge_two');?>" required></td>
										</tr>
								    ...
								    <tr><td class="label"><b>Inner Layer</b></td></tr>
										...
										<tr>
											<td class="label">Gauge <span style="color:red;">*</span> :</td>
											<td><input type="number" name="gauge_three" min="175" max="250" step="25" id="gauge_three" maxlength="3" size="3" value="<?php echo set_value('gauge_three');?>" required></td>
										</tr>
