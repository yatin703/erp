...
<?php foreach($specification as $specification_row):?>
	...
	?>
<form name="<?php echo $this->router->fetch_class();?>" action="<?php echo base_url('index.php/'.$this->router->fetch_class().'/update_two_layer');?>" method="POST" >
						...
						<input type="hidden" name="spec_version_no" value="<?php echo $specification_row->spec_version_no;?>">
                           ...
                           <tr><td>&nbsp;</td><td>&nbsp;</td></tr>
									...
									<tr>
										...
										<td><input type="number" name="gauge" id="gauge" min="0" max="550" step="1" maxlength="3" size="3" value="<?php echo set_value('gauge_one',$this->common_model->select_number_from_string($gauge));?>" required></td>
									</tr>
									...
									<tr>
										...
										<td>
										<input type="number" name="sl_mb_per" min="0"  max="25" step="0.25" id="sl_mb_per"  size="3" value="<?php echo set_value('sl_mb_per',$this->common_model->select_percentage_from_string($sl_mb_per));?>" placeholder="%" required>
                              ...
                              <tr><td>&nbsp;</td><td>&nbsp;</td></tr>
									...
									<tr>
										<td class="label">Gauge <span style="color:red;">*</span> :</td>
										<td><input type="number" name="gauge_two" id="gauge_two" min="0" max="550" step="1" maxlength="3" size="3" value="<?php echo set_value('gauge_two',$this->common_model->select_number_from_string($gauge_two));?>"></td>
									</tr>
									...
									<tr>
										...
										<td>
										<input type="number" name="sl_mb_per_two" id="sl_mb_per_two" min="0"  max="25" step="0.25"  size="3" value="<?php echo set_value('sl_mb_per_two',$this->common_model->select_percentage_from_string($sl_mb_per_two));?>" placeholder="%" required>
