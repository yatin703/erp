					...
					<table class="form_table_inner">
                                 ...
                                 <option value="45">SLEEVE</option>
									...
									<tr>
										...
										}?></select>&nbsp;Length <span style="color:red;">*</span> : <input type="number" name="sleeve_length" min="10"  max="300"  id="sleeve_length" size="5" maxlength="5" value="<?php echo set_value('sleeve_length');?>" required></td>
									</tr>
									...
									<tr>
										...
										<td><input type="number" name="gauge" id="gauge" maxlength="5" size="5" value="<?php echo set_value('gauge');?>" required></td>
									</tr>
                            ...
                            <tr>
                                 <td class="label">Gauge <span style="color:red;">*</span> :</td>
                                 <td><input type="number" name="gauge_five" id="gauge_five" maxlength="5" size="5" value="<?php echo set_value('gauge_five');?>" required></td>
                              </tr>
