						...
						<input type="hidden" name="spec_version_no" value="<?php echo $specification_row->spec_version_no;?>">
								<!--
									...
									<tr>
										...
										}?></select>&nbsp;Length <span style="color:red;">*</span> : <input type="number" name="sleeve_length" id="sleeve_length" min="10"  max="300" step="0.5" size="5" maxlength="5" value="<?php echo set_value('sleeve_length',$length);?>"></td>
									</tr>

									<tr>
										<td class="label">Gauge <span style="color:red;">*</span> :</td>
										<td><input type="number" name="gauge" id="gauge" name="gauge" min="400" max="550" step="50" value="<?php echo set_value('gauge',$this->common_model->select_number_from_string($gauge));?>">MIC</td>
									</tr>
									...
									<tr>
										...
										<td>
										<input type="number" name="sl_mb_per" maxlength="3" min="0"  max="25" step="0.5" id="sl_mb_per" value="<?php echo set_value('sl_mb_per',$this->common_model->select_number_from_string($sl_mb_per));?>" placeholder="%">
										...
										<td>
										<input type="number" name="sl_ldpe_per" min="0"  max="100" step="1"  id="sl_ldpe_per" value="<?php echo set_value('sl_ldpe_per',$this->common_model->select_number_from_string($sl_ldpe_per));?>" placeholder="%"></td>
										</tr>
										...
										<td>
										<input type="number" name="sl_lldpe_per" id="sl_lldpe_per" min="0"  max="100" step="1"  value="<?php echo set_value('sl_lldpe_per',$this->common_model->select_number_from_string($sl_lldpe_per));?>" placeholder="%"></td>
										</tr>
										...
										<td>
										<input type="number" name="sl_hdpe_per" id="sl_hdpe_per" min="0"  max="100" step="1"  value="<?php echo set_value('sl_hdpe_per',$this->common_model->select_number_from_string($sl_hdpe_per));?>" placeholder="%"></td>
										</tr>
