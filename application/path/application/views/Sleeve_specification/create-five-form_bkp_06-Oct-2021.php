					...
					<table class="form_table_inner">
                                 ...
                                 <option value="45">SLEEVE</option>
									...
									<tr>
										...
										}?></select>&nbsp;Length <span style="color:red;">*</span> : <input type="number" name="sleeve_length" min="10"  max="300" step="0.1"  id="sleeve_length" size="5" maxlength="5" value="<?php echo set_value('sleeve_length');?>" required></td>
									</tr>
									...
									<tr>
										...
										<td><input type="number" min="172" max="300" step="0.5" name="gauge" id="gauge" maxlength="5" size="5" value="<?php echo set_value('gauge');?>" required></td>
									</tr>
									...
									<tr>
										...
										<tr>
											<td class="label">Gauge <span style="color:red;">*</span> :</td>
											<td><input type="number" name="gauge_two" min="0"  max="100" step="1" id="gauge_two" maxlength="2" size="2" value="<?php echo set_value('gauge_two');?>" required></td>
										</tr>
                              ...
                              <tr>
                                 <td class="label">Gauge <span style="color:red;">*</span> :</td>
                                 <td><input type="number" name="gauge_three" min="0"  max="100" step="1" id="gauge_three" maxlength="2" size="2" value="<?php echo set_value('gauge_three');?>" required></td>
                              </tr>
                              ...
                              <tr>
                                 <td class="label">Gauge <span style="color:red;">*</span> :</td>
                                 <td><input type="number" name="gauge_four" min="0"  max="100" step="1" id="gauge_four" maxlength="2" size="2" value="<?php echo set_value('gauge_four');?>" required></td>
                              </tr>
                            ...
                            <tr>
                                 <td class="label">Gauge <span style="color:red;">*</span> :</td>
                                 <td><input type="number" name="gauge_five" id="gauge_five" min="172" max="256" step="0.5" maxlength="5" size="5" value="<?php echo set_value('gauge_five');?>" required></td>
                              </tr>
