				...
				<td width="40%">
					<table class="form_table_inner">
                                 ...
                                 echo '<option value="">--Select Article Code--</option>';
									...
									<tr>
										...
										<?php if($sleeve_dia==FALSE){
											...
											<input type="number" name="sleeve_length" id="sleeve_length" min="10"  max="300" step="0.5" size="5" value="<?php echo set_value('sleeve_length',$this->common_model->select_number_from_string($length));?>" required>
										</td>
									</tr>
                           ...
                           <tr><td class="label">&nbsp;</td><td class="label">&nbsp;</td></tr>
									...
									<tr>
										<td class="label">Gauge <span style="color:red;">*</span> :</td>
										<td><input type="number" name="gauge_two" id="gauge_two" maxlength="2" size="2" value="<?php echo set_value('gauge_two',$this->common_model->select_number_from_string($gauge_two));?>"></td>
									</tr>
                           ...
                           <tr><td class="label">&nbsp;</td><td class="label">&nbsp;</td></tr>
									...
									<tr>
										<td class="label">Gauge <span style="color:red;">*</span> :</td>
										<td><input type="number" name="gauge_three"  id="gauge_three" maxlength="2" size="2" value="<?php echo set_value('gauge_three',$this->common_model->select_number_from_string($gauge_three));?>" required></td>
									</tr>
									...
									<tr>
										...
										<td>
										<input type="number" name="sl_evoh_per_three"  min="100" max="100" step="any" id="sl_evoh_per_three" maxlength="3" size="3" value="<?php echo set_value('sl_evoh_per_three',$this->common_model->select_percentage_from_string($sl_evoh_per_three));?>" placeholder="%"  min="100" max="100" step="any"></td>
									</tr>
                           ...
                           <tr><td class="label">&nbsp;</td><td class="label">&nbsp;</td></tr>
									...
									<tr>
										<td class="label">Gauge <span style="color:red;">*</span> :</td>
										<td><input type="number" name="gauge_four" id="gauge_four"  maxlength="2" size="2" value="<?php echo set_value('gauge_four',$this->common_model->select_number_from_string($gauge_four));?>"></td>
									</tr>
									...
									<tr>
										...
										<td>
										<input type="number" name="sl_admer_per_four" min="100" max="100" step="any" id="sl_admer_per_four" maxlength="3" size="3" value="<?php echo set_value('sl_admer_per_four',$this->common_model->select_percentage_from_string($sl_admer_per_four));?>" placeholder="%"></td>
									</tr>
									...
									<tr>
										<td class="label">Gauge <span style="color:red;">*</span> :</td>
										<td><input type="number" name="gauge_five" id="gauge_five" maxlength="5" size="5" value="<?php echo set_value('gauge_five',$gauge_five);?>"></td>
									</tr>
									...
									<tr>
										...
										<td>
										<input type="number" name="sl_mb_per_five" min="0"  max="25" step="0.5"  id="sl_mb_per_five" maxlength="4" size="4" value="<?php echo set_value('sl_mb_per_five',$this->common_model->select_percentage_from_string($sl_mb_per_five));?>" placeholder="%" required>
										</td>
										</tr>
										...
										<td>
										<input type="number" name="sl_lldpe_per_five" min="0"  max="100" step="1"  id="sl_lldpe_per_five" maxlength="3" size="3" value="<?php echo set_value('sl_lldpe_per_five',$this->common_model->select_percentage_from_string($sl_lldpe_per_five));?>" placeholder="%"></td>
										</tr>
									...
									<tr>
										...
										<td>
										<input type="number" name="sl_hdpe_per_five" min="0"  max="100" step="1"  id="sl_hdpe_per_five"  maxlength="3" size="3" value="<?php echo set_value('sl_hdpe_per_five',$this->common_model->select_percentage_from_string($sl_hdpe_per_five));?>" placeholder="%"></td>
									</tr>
								...
								<table>
									<tr>
                                      ...
                                      if(!empty($this->input->post('sl_masterbatch_five')) || !empty($this->input->post('sl_mb_per_five'))!=0){
	                                     ...
	                                     echo "+<span class='ui teal label'>$sl_mb_per_fivee $sl_mb_per_fivee</span>";
