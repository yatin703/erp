					...
					<table class="form_table_inner">
                           ...
                           <tr><td>&nbsp;</td><td>&nbsp;</td></tr>
									...
									<tr>
										...
										<td><input type="number" name="gauge" id="gauge" min="0" max="550" step="1" maxlength="3" size="3" value="<?php echo set_value('gauge');?>" required></td>
									</tr>
									...
									<tr>
										...
										<td>
										<input type="number" name="sl_mb_per" id="sl_mb_per" min="0"  max="25" step="0.25" value="<?php echo set_value('sl_mb_per');?>" placeholder="%" required>
										<!--
										...
										<td>
										<input type="number" name="sl_ldpe_per" id="sl_ldpe_per" min="0"  max="100" step="1" value="<?php echo set_value('sl_ldpe_per');?>" placeholder="%"></td>
										</tr>
										...
										<td>
										<input type="number" name="sl_lldpe_per" id="sl_lldpe_per" min="0"  max="100" step="1"  value="<?php echo set_value('sl_lldpe_per');?>" placeholder="%"></td>
										</tr>
										...
										<td>
										<input type="number" name="sl_hdpe_per"  id="sl_hdpe_per" min="0"  max="100" step="1"  maxlength="3" size="3" value="<?php echo set_value('sl_hdpe_per');?>" placeholder="%"></td>
										</tr>
                              ...
                              <tr><td>&nbsp;</td><td>&nbsp;</td></tr>
										...
										<tr>
											<td class="label">Gauge <span style="color:red;">*</span> :</td>
											<td><input type="number" name="gauge_two" id="gauge_two" min="0" max="550" step="1" maxlength="3" size="3" value="<?php echo set_value('gauge_two');?>" required></td>
										</tr>

										<tr>
											<td class="label">MB <span style="color:red;">*</span> :</td>
											<td><select name="sl_masterbatch_two" id="sl_masterbatch_two" required><option value=''>--Select MB--</option>
											<?php foreach ($masterbatch as $masterbatch_row) {
												echo "<option value='".$masterbatch_row->article_no."' ".set_select('sl_masterbatch_two',$masterbatch_row->article_no).">".$masterbatch_row->lang_article_description."</option>";
											}?></select></td>

											<td><input type="number" name="sl_mb_per_two" id="sl_mb_per_two" min="0"  max="25" step="0.25"  size="3" value="<?php echo set_value('sl_mb_per_two');?>" placeholder="%" required>
											</td>
										</tr>
										...
										<?php
										foreach ($ldpe as $ldpe_row) {
											echo "<option value='".$ldpe_row->article_no."' ".set_select('sl_ldpe_two',$ldpe_row->article_no).">".$ldpe_row->lang_article_description."</option>";
										}
										?>
										</select></td>
										<td>
										<input type="number" name="sl_ldpe_per_two" id="sl_ldpe_per_two" min="0"  max="100" step="1"  maxlength="3" size="3" value="<?php echo set_value('sl_ldpe_per_two');?>" placeholder="%"></td>
										</tr>
										...
										<?php
										foreach ($lldpe as $lldpe_row) {
											echo "<option value='".$lldpe_row->article_no."' ".set_select('sl_lldpe_two',$lldpe_row->article_no).">".$lldpe_row->lang_article_description."</option>";
										}
										?>
										</select></td>
										<td>
										<input type="number" name="sl_lldpe_per_two" id="sl_lldpe_per_two" min="0"  max="100" step="1"  maxlength="3" size="3" value="<?php echo set_value('sl_lldpe_per_two');?>" placeholder="%"></td>
										</tr>
										...
										<td>
										<input type="number" name="sl_hdpe_per_two" id="sl_hdpe_per_two" min="0"  max="100" step="1"  maxlength="3" size="3" value="<?php echo set_value('sl_hdpe_per_two');?>" placeholder="%"></td>
										</tr>
							...
							<td rowspan="8">
								<table>
									<tr>
                                      ...
                                      if(!empty($this->input->post('sl_masterbatch_two')) || !empty($this->input->post('sl_mb_per_two'))!=0){
                                      $data['sl_masterbatch_two']=$this->article_model->select_one_active_record('article',$this->session->userdata['logged_in']['company_id'],'article.article_no',$this->input->post('sl_masterbatch_two'));
                                        ...
                                        if(!empty($this->input->post('sl_mb_per_two')) && $this->input->post('sl_mb_per_two')!=0){
                                          $sl_mb_per_two=$this->input->post('sl_mb_per_two')."%";
                                        }else{
                                          $sl_mb_per_two="";
                                        }

                                        echo "<br/>+<br/><span class='ui teal label'>".$sl_masterbatch_two." ".$sl_mb_per_two."</span>";
                                      ...
                                      if(!empty($this->input->post('sl_ldpe_two')) && !empty($this->input->post('sl_ldpe_per_two'))){
                                        ...
                                        echo "<br/>+<br/><span class='ui teal label'>".$sl_ldpe_two." ".$sl_ldpe_per_two."</span>";
                                      ...
                                      if(!empty($this->input->post('sl_lldpe_two')) && !empty($this->input->post('sl_lldpe_per_two'))){
                                        ...
                                        echo "<br/>+<br/><span class='ui teal label'>".$sl_lldpe_two." ".$sl_lldpe_per_two."</span>";
