...
<script>
	$(document).ready(function(){
		...
		//$("#part_no").autocomplete("http://192.168.0.9/erp/index.php/ajax/purchase_article_no", {selectFirst: true});
		$("#part_no").autocomplete("<?php echo base_url('index.php/ajax/purchase_article_no');?>", {selectFirst: true});

		//$("#jobcard_no").autocomplete("http://192.168.0.9/erp/index.php/ajax/jobcard_autocomplete", {selectFirst: true});
