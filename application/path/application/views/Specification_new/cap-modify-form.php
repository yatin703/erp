...
<?php foreach($specification as $specification_row):?>
	...
	$result_cap_foil=$this->specification_model->select_details_record_where('specification_sheet_details',$this->session->userdata['logged_in']['company_id'],'spec_id',$specification_row->spec_id,'spec_version_no',$specification_row->spec_version_no,'srd_id','3_9','srd_id','asc');

	foreach($result_cap_foil as $cap_foil_row){ $cap_foils=$cap_foil_row->mat_article_no;}

	$result_cap_shrink_sleeve=$this->specification_model->select_details_record_where('specification_sheet_details',$this->session->userdata['logged_in']['company_id'],'spec_id',$specification_row->spec_id,'spec_version_no',$specification_row->spec_version_no,'srd_id','3_5','srd_id','asc');
