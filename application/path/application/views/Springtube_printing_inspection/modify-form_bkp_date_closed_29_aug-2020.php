...
<script>
	...
	$(document).ready(function(){
		...
		$("#add").live('click',function () {
			...
			var mark_up='<tr id="tr_'+ counter +'"><td><input type="hidden" name="sr_no[]" value="'+counter+'"/>JOB '+counter+'</td><td><input type="text" name="jobcard_no_'+counter+'"  id="jobcard_no_'+counter+'" class="quantity" value="<?php echo set_value('jobcard_no_"+counter+"');?>" maxlength="50" size="20" required/></td><td><input type="text" name="printing_outout_qty_'+counter+'"  id="printing_outout_qty_'+counter+'" class="quantity" value="<?php echo set_value('printing_outout_qty_"+counter+"');?>" maxlength="50" size="20" readonly/></td><td><input type="number" name="inspection_input_qty_'+counter+'"  id="inspection_input_qty_'+counter+'" class="quantity" value="<?php echo set_value('inspection_input_qty_"+counter+"');?>" min="1" max="10000000" step="1" size="20" required maxlength="10"/></td><!--<td><input type="number" name="inspected_output_meters_'+counter+'"  id="inspected_output_meters_'+counter+'" class="quantity" value="<?php echo set_value('inspected_output_meters_"+counter+"');?>" min="1" max="10000000" step="1" size="20" required maxlength="10"/></td>--><td><input type="number" name="inspected_output_qty_'+counter+'"  id="inspected_output_qty_'+counter+'" class="quantity" value="<?php echo set_value('inspected_output_qty_"+counter+"');?>" min="1" max="10000000" step="1" size="20" required maxlength="10"/></td><td><input type="number" name="side_trim_waste_'+counter+'"  id="side_trim_waste_'+counter+'" class="quantity" value="<?php echo set_value('side_trim_waste_"+counter+"');?>" min="0" max="50000" step="1" size="20" required maxlength="10"/></td><td><input type="checkbox" name="inspection_done_'+counter+'" value="1" <?php echo set_checkbox('inspection_done_"+counter+"',0,false);?> title="Is complete inspection done for this Jobcard?"/></td></tr>';
	...
	<div class="middle_form_design">
		<div class="middle_form_inner_design">
				...
				if(!empty($this->input->post('sr_no'))){
					...
					for($i=1;$i<=count($this->input->post('sr_no[]'));$i++){?>
						...
						<tr id="tr_<?php echo $i;?>">
							...
							<td>
								<input type="number" name="inspection_input_qty_<?php echo $i;?>"  id="inspection_input_qty_<?php echo $i;?>" class="quantity" value="<?php echo set_value('inspection_input_qty_'.$i.'');?>" min="1" max="10000000" step="1" size="20" maxlength="10" />
							</td>							
							<td>
								<input type="number" name="inspected_output_qty_<?php echo $i;?>"  id="inspected_output_qty_<?php echo $i;?>" class="quantity" value="<?php echo set_value('inspected_output_qty_'.$i.'');?>" min="1" max="10000000" step="1" size="20"  maxlength="10" />
							</td>
							<td>
								<input type="number" name="side_trim_waste_<?php echo $i;?>"  id="side_trim_waste_<?php echo $i;?>" class="quantity" value="<?php echo set_value('side_trim_waste_'.$i.'');?>" min="0" max="50000" maxlength="10" step="1" size="40" required/>
							</td>
			...
			<?php foreach ($springtube_printing_inspection_details as $detail_row):
				...
				$data_total_counter=array( 'jobcard_no'=>$detail_row->jobcard_no);
			...
			?>
					...
					<tr id="tr_<?php echo $detail_row->job_pos_no;?>">
						...
						<td>
							<input type="text" name="printing_outout_qty_<?php echo $detail_row->job_pos_no;?>"  id="printing_outout_qty_<?php echo $detail_row->job_pos_no;?>" class="quantity" value="<?php echo set_value('printing_outout_qty_<?php echo $detail_row->job_pos_no;?>',$printing_output_qty);?>" maxlength="50" size="20" readonly />
						</td>
						<td>
							<input type="number" name="inspection_input_qty_<?php echo $detail_row->job_pos_no;?>"  id="inspection_input_qty_<?php echo $detail_row->job_pos_no;?>" class="quantity" value="<?php echo set_value('inspection_input_qty_<?php echo $detail_row->job_pos_no;?>',$detail_row->inspection_input_qty);?>" min="1" max="10000000" step="1" size="30"  required maxlength="10" />
						</td>						
						<td>
							<input type="number" name="inspected_output_qty_<?php echo $detail_row->job_pos_no;?>"  id="inspected_output_qty_<?php echo $detail_row->job_pos_no;?>" class="quantity" value="<?php echo set_value('inspected_output_qty_<?php echo $detail_row->job_pos_no;?>',$detail_row->inspected_output_qty);?>" size="30" min="1" max="10000000" step="1" required maxlength="10" />
						</td>
						<td>
							<input type="number" name="side_trim_waste_<?php echo $detail_row->job_pos_no;?>"  id="side_trim_waste_<?php echo $detail_row->job_pos_no;?>" class="quantity" value="<?php echo set_value('side_trim_waste_<?php echo $detail_row->job_pos_no;?>'.'',$detail_row->side_trim_waste);?>" min="0" max="50000" maxlength="10" step="1" size="40" required/>
						</td>
						<td>
									...
									//if(!$("#jobcard_no_1").attr('readonly')){
									   ...
									   $.ajax({
										   	...
										   	success: function(html){
										    		...
										    		if(html!='0' || html!='' ){
										    			$("#printing_outout_qty_<?php echo $detail_row->job_pos_no;?>").val(html);
										       			
										    		}else{

										    			$("#printing_outout_qty_<?php echo $detail_row->job_pos_no;?>").val('');
										    		}
