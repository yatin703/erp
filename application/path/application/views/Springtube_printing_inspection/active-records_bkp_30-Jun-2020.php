			...
			<table class="record_table_design_without_fixed">
				...
				if($springtube_printing_inspection_master==FALSE){
					echo "<tr><td colspan='30'>No Active Records Found</td></tr>";
					    	...
					    	if($rowspan>0){					    		
								...
								echo"<tr>
									...
									foreach ($result as $details_row){
										...
										<td>".($details_row->inspection_input_qty-$details_row->inspected_output_qty)."</td>
										...
										$sum_waste_qty+=($details_row->inspection_input_qty-$details_row->inspected_output_qty);
						...
						echo"<tr><td colspan='15' style='text-align:right;'><b>TOTAL</b></td><td>".$sum_printing_output_qty."</td><td>".$sum_inspection_input_qty."</td> <td>".$sum_inspected_output_qty."</td><td>".$sum_waste_qty."</td><td></td><td></td><td></td><td></td></tr>";
