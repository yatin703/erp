	...
	<div class="record_inner_design" style="overflow: scroll;white-space: nowrap;">
			<table class="record_table_design_without_fixed">
				<tr>
					...
					<th>Inspection Complete Status</th>					
					<th>Job No.</th>
					<th>Jobcard No.</th>
					<th>Jobcard Qty</th>
				...
				if($springtube_printing_inspection_master==FALSE){
					echo "<tr><td colspan='30'>No Active Records Found</td></tr>";
						...
						echo"<tr style='font-weight:bold;'><td colspan='17' style='text-align:right;'><b>TOTAL</b></td><td>".$sum_jobcard_qty."</td><td>".$sum_printing_output_qty."</td><td>".$sum_inspection_input_qty."</td> <td>".$sum_inspected_output_qty."</td><td>".$sum_waste_qty."</td><td>".$sum_side_trim_waste."</td><td></td><td></td><td></td><td></td</tr>";
