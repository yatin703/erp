					...
					for($i=1;$i<=count($this->input->post('sr_no[]'));$i++){?>
						...
						<script>
							...
							$(document).ready(function(){
								...
								$("#jobcard_no_<?php echo $i;?>").autocomplete("<?php echo base_url('index.php/ajax_springtube/jobcard_printing_inspection_production_autocomplete');?>", {selectFirst: true});
