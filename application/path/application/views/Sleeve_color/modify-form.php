			...
			<tr>
				<td>
					<table class="form_table_inner">
							...
							<?php foreach($cap_types_master as $row):?>
									<tr>
										<td class="label">Cap Type <span style="color:red;">*</span> :</td>
										<td>
											<input type="hidden" name="cap_type_id"  value="<?php echo set_value('cap_type_id',$row->cap_type_id);?>" />
											<input type="text" name="cap_type"  value="<?php echo set_value('cap_type',$row->cap_type);?>" />
										</td>
									</tr>
