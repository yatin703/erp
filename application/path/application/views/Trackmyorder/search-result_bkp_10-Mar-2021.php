			...
			<table class="ui very basic collapsing celled table"  style="font-size:9px;">
				<tr>
					<thead>
						...
						<th style="text-align:center" colspan="4">Printing</th>
						<th style="text-align:center" colspan="7">Inspection</th>
						<th style="text-align:center" colspan="8">Bodymaking</th>
						<th style="text-align:center" colspan="4">AQL</th>
					...
					echo "<tr><td colspan='14'>No Active Records Found</td></tr>";
						...
						foreach($springtube_printing_production_master as $master_row){
					       ...
					       // Printing Section-----------
							...
							$total_bodymaking_jobcard_qty=0;
							$total_bodymaking_ok_qty=0;
							$total_bodymaking_qchold_qty=0;
							$total_bodymaking_sleeve=0;	
							$total_bodymaking_heading=0;
							$total_bodymaking_capping=0;
							$total_bodymaking_qc_pending=0;	
							$total_bodymaking_scrap=0;				
							

							$total_bodymaking_wip=0;
							
							$total_aql_input=0;
							$total_aql_output=0;
							$total_aql_rejection=0;
							...
							echo"<tr>
									...
									<td>".$sleeve_length."</td>
									<td class='positive right aligned'><b>".number_format($order_qty,0,'.',',')."</b> <i>NOS</i></td>
									...
									<!--Inspection-->									
									<td class='positive right aligned'><b>".number_format($total_inspection_input,0,'.',',')."</b> <i>NOS</i></td>
									<td class='positive right aligned'><b>".number_format($total_inspection_qty,0,'.',',')."</b> <i>NOS</i></td>
									<td class='positive right aligned'><b>".number_format($total_inspection_pending,0,'.',',')."</b> <i>NOS</i></td>
									<td class='negative right aligned'><b>".number_format($total_inspection_scrap_qty,0,'.',',')."</b> <i>NOS</i></td>
									<td class='positive right aligned'><b>".number_format($total_printing_wip,0,'.',',')."</b> <i>NOS</i></td>
									<td></td>
									<td>".($inspection_done==1?"<i style='color:#06c806;' class='check circle icon'></i>":"<i style='color: #f10606;' class='times circle icon'></i>")."</td>

									<!--Bodymaking -->
									<td class='positive right aligned'><b>".number_format($total_bodymaking_jobcard_qty,0,'.',',')."</b> <i>NOS</i></td>
									<td class='positive right aligned'><b>".number_format($total_bodymaking_ok_qty,0,'.',',')."</b> <i>NOS</i></td>
									<td class='positive right aligned'><b>".number_format($total_bodymaking_qc_pending,0,'.',',')."</b> <i>NOS</i></td>
									<td class='negative right aligned'><b>".number_format($total_bodymaking_qchold_qty,0,'.',',')."</b> <i>NOS</i></td>
									<td class='negative right aligned'><b>".number_format($total_bodymaking_scrap,0,'.',',')."</b> <i>NOS</i></td>
									<td class='positive right aligned'><b>".number_format($total_bodymaking_wip,0,'.',',')."</b> <i>NOS</i></td>
									<td></td>
									<td>Status</td>
									<!-- Spring AQL--->
									<td class='positive right aligned'><b>".number_format($total_aql_input,0,'.',',')."</b> <i>NOS</i></td>
									<td class='positive right aligned'><b>".number_format($total_aql_output,0,'.',',')."</b> <i>NOS</i></td>
									<td class='positive right aligned'><b>".number_format($total_aql_rejection,0,'.',',')."</b> <i>NOS</i></td>
									<td></td>
									<td class='positive right aligned'><b>".number_format($total_rfd_qty,0,'.',',')."</b> <i>NOS</i></td>
									<td class='positive right aligned'><b>".number_format($total_dispatch_qty,0,'.',',')."</b> <i>NOS</i></td>
									";								
