				...
				<td width="53%">
					<table class="form_table_inner">
						...
						<tr>
							...
							<td><select name="inspection_done">
								<option value="">--Select Inspection Status--</option>
								<option value="1" <?php echo set_select('inspection_done','1');?>>Done</option>
								<option value="0" <?php echo set_select('inspection_done','0');?>>Pending</option>
								</select>
							</td>
							<td class="label">Job setup? :</td>
							<td><select name="job_setup">
								<option value="">--Select Job setup Status--</option>
								<option value="1" <?php echo set_select('job_setup','1');?>>Done</option>
								<option value="0" <?php echo set_select('job_setup','0');?>>Pending</option>
							</select>
						</tr>	
