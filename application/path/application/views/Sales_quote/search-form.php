							...
							<td colspan="4" width="100%">
								...
								<table class="form_table_inner">
									...
									<tr>
										...
										<td ><input type="text" class="number1" name="less_than_10k_freight" id="less_than_10k_freight"  value="<?php echo set_value('less_than_10k_freight');?>" />
										</td>

										<td ><input type="text" class="number1" name="less_than_10k_packing" id="less_than_10k_packing"  value="<?php echo set_value('less_than_10k_packing');?>" />
										</td>
									...
									<tr>
										...
										<td ><input type="text" class="number1" name="_10k_to_25k_freight" id="_10k_to_25k_freight"  value="<?php echo set_value('_10k_to_25k_freight');?>" />
										</td>

										<td ><input type="text" class="number1" name="_10k_to_25k_packing" id="_10k_to_25k_packing"  value="<?php echo set_value('_10k_to_25k_packing');?>" />
										</td>
									...
									<tr>
										...
										<td ><input type="text" class="number1" name="_25k_to_50k_freight" id="_25k_to_50k_freight"  value="<?php echo set_value('_25k_to_50k_freight');?>" />
										</td>

										<td ><input type="text" class="number1" name="_25k_to_50k_packing" id="_25k_to_50k_packing"  value="<?php echo set_value('_25k_to_50k_packing');?>" />
										</td>
									...
									<tr>
										...
										<td ><input type="text" class="number1" name="_50k_to_100k_freight" id="_50k_to_100k_freight"  value="<?php echo set_value('_50k_to_100k_freight');?>" />
										</td>

										<td ><input type="text" class="number1" name="_50k_to_100k_packing" id="_50k_to_100k_packing"  value="<?php echo set_value('_50k_to_100k_packing');?>" />
										</td>
									...
									<tr>
										...
										<td ><input type="text" class="number1" name="_100k_to_250k_freight" id="_100k_to_250k_freight"  value="<?php echo set_value('_100k_to_250k_freight');?>" />
										</td>

										<td ><input type="text" class="number1" name="_100k_to_250k_packing" id="_100k_to_250k_packing"  value="<?php echo set_value('_100k_to_250k_packing');?>" />
										</td>
									...
									<tr>
										...
										<td ><input type="text" class="number1" name="greater_than_250k_freight" id="greater_than_250k_freight"  value="<?php echo set_value('greater_than_250k_freight');?>" />
										</td>

										<td ><input type="text" class="number1" name="greater_than_250k_packing" id="greater_than_250k_packing"  value="<?php echo set_value('greater_than_250k_packing');?>" />
										</td>
