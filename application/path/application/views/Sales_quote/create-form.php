...
//------------------------Layer 1 Check button---------------
		$("#layer1_sleevecost").click(function(event) {
			...
			if($('#sleeve_dia').val()=="" || $('#sleeve_length').val()==""){
			...
			}else if($('#micron').val()=="" || $('#layer1_ld_percentage').val()=="" || $('#layer1_lld_percentage').val()=="" || $('#layer1_hd_percentage').val()=="" || $('#sl_ldpe').val()=="" || $('#sl_lldpe').val()=="" ){
				...
				var sleeveweight= (((parseInt($('#sleeve_dia').val()) * parseInt($('#sleeve_length').val()) * parseInt($('#micron').val()) * 3.14 * 0.92/1000000)/1000)*parseInt($('#quantity').val()))+ ((((parseInt($('#sleeve_dia').val()) * parseInt($('#sleeve_length').val()) * parseInt($('#micron').val()) * 3.14 * 0.92/1000000)/1000)* parseInt($('#quantity').val()))*parseInt($('#rejection').val()))/100 ;
				...
				var ldcost_per_tube = 	(ldvalue / parseInt($('#quantity').val()));	
				var lldcost_per_tube = 	(lldvalue / parseInt($('#quantity').val()));
				var hdcost_per_tube = 	(hdvalue / parseInt($('#quantity').val()));

				var sleeve_cost = (ldcost_per_tube + lldcost_per_tube + hdcost_per_tube )
				$('#sleeve_cost').html(sleeve_cost.toFixed(2));
    ...
    <span class="close">&times;</span>
		...
		<tbody>
			<tr>
				...
				<td rowspan="3"><input type="text" style="width: 7em;" name="micron" id="micron" class="number3" value="<?php echo set_value('micron');?>"  />
				</td>
				<td><input type="number" name="layer1_ld_percentage" id="layer1_ld_percentage" placeholder="%" class="number3"  min="0" max="100" value="<?php echo set_value('layer1_ld_percentage');?>" />
				</td>			
			</tr>
			<tr>				
				...
				<td ><input type="number" size="3" name="layer1_lld_percentage" id="layer1_lld_percentage" placeholder="%" maxlength="3" id="" min="0" max="100" value="<?php echo set_value('layer1_lld_percentage');?>" />
				</td>			
			</tr>
			...
			<tr>
				...
				<td ><input type="number" size="3" name="layer1_hd_percentage" id="layer1_hd_percentage" placeholder="%" maxlength="3" id="" min="0" max="100"  value="<?php echo set_value('layer1_hd_percentage');?>" />
				</td>			
			</tr>
			...
			<tr>
				...
				<td> <input type="number" size="3" name="quantity" id="quantity" maxlength="3" id="" min="0" max="100"  value="<?php echo set_value('quantity');?>" />	</td>			
			</tr>
			...
			<tr>
				...
				<td> <input type="number" size="3" name="rejection" id="rejection" placeholder="%" maxlength="3" id="" min="0" max="100"  value="<?php echo set_value('rejection');?>" />	</td>			
			</tr>

			<tr>
				<td colspan="4"><button id="layer1_sleevecost"> Check </button></td>

				<td><b><span style="color:red;" id="sleeve_cost"></span></b></td>
