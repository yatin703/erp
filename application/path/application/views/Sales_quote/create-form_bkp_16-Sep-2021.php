								...
								<fieldset>
									...
									<table>						 
										<tr>							
											...
											<td colspan="3"><input type="text" name="customer_category" id="customer_category"  size="55" value="<?php echo set_value('customer_category');?>" required /></td>								
										</tr>
										<tr>							
											<td class="label">Purchase Manager 1 <span style="color:red;">*</span> :</td>
											<td colspan="3"><input type="text" name="pm_1" id="pm_1"  size="30" value="<?php echo set_value('pm_1');?>" maxlength="100" required/></td>								
										</tr>
										<tr>							
