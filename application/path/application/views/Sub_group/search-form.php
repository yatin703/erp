			...
			<tr>
				<td>
					<table class="form_table_inner">
									...
									<tr> 
										<td class="label">Sub Group Desc  :</td>
										<td><input type="text" name="sub_group" maxlength="50" size="50" value="<?php echo set_value('sub_group');?>" /></td>
									</tr>

									<tr>
										<td class="label">Short Desc  :</td>
										<td><input type="text" name="short_desc" maxlength="20" size="20" value="<?php echo set_value('short_desc');?>" /></td>
									</tr>
