				...
				<td>
					<table class="form_table_inner">
									...
									<tr>
										...
										<td><select name="main_group"><option value=''>--Select Main Group--</option>
									...
									<tr> 
										<td class="label">Sub Group Desc <span style="color:red;">*</span> :</td>
										<td><input type="text" name="sub_group" maxlength="50" size="50" value="<?php echo set_value('sub_group',$row->sub_group);?>" />
										<input type="hidden" name="article_group_id" value="<?php echo $row->article_group_id;?>" /></td>
									</tr>

									<tr>
										<td class="label">Short Desc <span style="color:red;">*</span> :</td>
										<td><input type="text" name="short_desc" maxlength="20" size="20" value="<?php echo set_value('short_desc',$row->sub_group_short_id);?>" /></td>
									</tr>
