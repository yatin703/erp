<form name="<?php echo $this->router->fetch_class();?>" action="<?php echo base_url('index.php/'.$this->router->fetch_class().'/runtime_search_result');?>" method="POST" >
				...
				<td width="50%">
					<table class="form_table_inner">
						...
						<tr>
							...
							<td><input type="text" name="sales_ord_no" size="10" value="<?php echo set_value('sales_ord_no');?>"/></td>
						</tr>
						<tr>
							<td class="label"><b>JOB NO</b><span style="color:red;">*</span> :</td>
							<td><input type="text" name="mp_pos_no" size="10" value="<?php echo set_value('mp_pos_no');?>"/></td>
						</tr>
					</table>
				</td>
				<td>
