...
<form name="<?php echo $this->router->fetch_class();?>" action="<?php echo base_url('index.php/'.$this->router->fetch_class().'/new_report_result');?>" method="POST" >

	<div class="form_design">

	<div class="ui teal labels" style="text-align: center;">
      <div class="ui label">New Report</div>
    </div>
    <br/>
