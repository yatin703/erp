    ...
    ?>
        ...
        <table cellpadding="5" cellspacing="0" style="border:1px solid #D9d9d9;">
            ...
            <tr class="item">
                ...
                <td width="5%" style="border-right:1px solid #D9d9d9;"></td>
                <td width="35%" style="border-right:1px solid #D9d9d9;"><?php echo $dia."X".$length;?></td>
            ...
            <tr class="item">
                ...
                <td width="5%" style="border-right:1px solid #D9d9d9;"></td>
                <td width="35%">&#8377; <?php echo $unit_rate_in_rupees;?></td>
            </tr>
        ...
        <table cellpadding='5' cellspacing='0' style='border:1px solid #D9d9d9;'>
            <tr class="heading">
                <td colspan="8" style='border-bottom:1px solid #D9d9d9;'><b>EXTRUSION PROCESS :  <b><?php echo ($order_flag==1 ? "FILM " : "SLEEVE "); echo "MATERIAL";?>: <?php echo ($order_flag!=1 ? '<a href="'.base_url('index.php/sales_order_item_parameterwise/view_new/').$coex_jobcard_no.'/'.$bom_no.'/'.$bom_version_no.'" target="_blank">'.$coex_jobcard_no.'</a>':"");?> </td>
            </tr>
...
<!-- Purging Start -->
        ...
        <table cellpadding='5' cellspacing='0' style='border:1px solid #D9d9d9;'>
            ...
            <tr class="heading">
                <td colspan="8" style='border-bottom:1px solid #D9d9d9;'><b>HEADING PROCESS : SHOULDER MATERIAL</td>
            </tr>
        ...
        <table cellpadding='5' cellspacing='0' style='border:1px solid #D9d9d9;'>
            <tr class="heading">
                <td colspan="8" style='border-bottom:1px solid #D9d9d9;'><b>PRINTING PROCESS</td>
            </tr>
            ...
            foreach($result_screen_ink_value as $result_screen_ink_value_row){
                ...
                if($result_screen_ink_value==TRUE){
                   foreach($result_screen_ink_value as $result_screen_ink_value_row){
                        ...
                        echo "<tr><td colspan='8'>SCREEN INK MASTER FOR PRODUCT IS NOT ENTERED</td></tr>";
                        ...
                        <td class='label' width='35%' style='border-right:1px solid #D9d9d9;'>".$result_screen_ink_value_row->rm."</td>
                        <td class='label' width='10%' style='border-right:1px solid #D9d9d9;text-align:right'></td>
                        <td width='5%' style='border-right:1px solid #D9d9d9;text-align:right'>".round($screen_ink_value_cost_per_kg,2)."</td>
                        <td width='10%' style='border-right:1px solid #D9d9d9;text-align:right'>&#8377; ".round($screen_ink_value_row+$s_screen_ink_value_row,2)."</td>
                        <td width='10%' style='border-right:1px solid #D9d9d9;text-align:right'>&#8377; ".round(($screen_ink_value_row+$s_screen_ink_value_row)/$this->common_model->read_number($ar_invoice_details_row->arid_qty,$this->session->userdata['logged_in']['company_id']),2)."</td>
                        <td width='10%' style='text-align:right'></td>
                        </tr>";
            ...
            foreach($result_offset_ink_value as $result_offset_ink_value_row){
                ...
                foreach($result_offset_ink_value as $result_offset_ink_value_row){
                    ...
                    if($result_offset_ink_gm_tube_result==FALSE){
                        ...
                        echo "<tr><td colspan='8'>OFFSET INK MASTER FOR PRODUCT IS NOT ENTERED</td></tr>";
                                ...
                                if($result_digital_ink_pc_value==TRUE){
                                    ...
                                    if($result_digital_ink_pc<>0){
                                        ...
                                        echo "<tr class='item'><td class='label' width='10%' >DIGITAL INK</td>
                                                ...
                                                <td class='label' width='10%' style='border-right:1px solid #D9d9d9;text-align:right'></td>
                                                <td width='5%' style='border-right:1px solid #D9d9d9;text-align:right'>&euro; ".$digital_ink_euro_price."/2000 Tubes</td>
                                                <td width='10%' style='border-right:1px solid #D9d9d9;text-align:right'>&#8377; ".round($digital_ink_value,2)."</td>
                                                <td width='10%' style='border-right:1px solid #D9d9d9;text-align:right'>&#8377; ".round($digital_ink_value/$this->common_model->read_number($ar_invoice_details_row->arid_qty,$this->session->userdata['logged_in']['company_id']),2)."</td>
                                                <td width='10%' style='text-align:right'></td>
                                            </tr>";

                                            $total_ink_cost+=$digital_ink_value;

                                    }

                                }else{

                                    echo "<tr><td colspan='8'>DIGITAL INK IS NOT ENTERED</td></tr>";
        ...
        <table cellpadding='5' cellspacing='0' style='border:1px solid #D9d9d9;'>
            ...
            foreach($result_other_screen_consumable_value as $result_other_screen_consumable_value_row){
                ...
                echo "<tr class='item'><td class='label' width='10%' >SCREEN</td>
                        <td class='label' width='5%' style='border-right:1px solid #D9d9d9;'></td>
                        <td class='label' width='35%' style='border-right:1px solid #D9d9d9;'>".$result_other_screen_consumable_value_row->consumable."</td>
                        <td class='label' width='10%' style='border-right:1px solid #D9d9d9;text-align:right'></td>
                        <td width='5%' style='border-right:1px solid #D9d9d9;text-align:right'></td>
            ...
            foreach($result_other_offset_consumable_value as $result_other_offset_consumable_value_row){
                ...
                echo "<tr class='item'><td class='label' width='10%' >OFFSET</td>
                        <td class='label' width='5%' style='border-right:1px solid #D9d9d9;'></td>
                        <td class='label' width='35%' style='border-right:1px solid #D9d9d9;'>".$result_other_offset_consumable_value_row->consumable."</td>
                        <td class='label' width='10%' style='border-right:1px solid #D9d9d9;text-align:right'></td>
                        <td width='5%' style='border-right:1px solid #D9d9d9;text-align:right'></td>
            ...
            foreach($result_other_flexo_consumable_value as $result_other_flexo_consumable_value_row){
                ...
                echo "<tr class='item'><td class='label' width='10%' >FLEXO</td>
                        <td class='label' width='5%' style='border-right:1px solid #D9d9d9;'></td>
                        <td class='label' width='35%' style='border-right:1px solid #D9d9d9;'>".$result_other_flexo_consumable_value_row->consumable."</td>
                        <td class='label' width='10%' style='border-right:1px solid #D9d9d9;text-align:right'></td>
                        <td width='5%' style='border-right:1px solid #D9d9d9;text-align:right'></td>
       ...
       /* echo "<tr class='heading'>
            ...
            if($data['daily_plate_master']==TRUE){
                ...
                $result_screen_value=$query->result();
                        if($result_screen_value==TRUE){
                            ...
                            $total_screen_and_plate_cost+=$invoice_wise_screen_value;
                    ...
                    if(strpos($print_type_artwork, 'OFFSET') !== false || strpos($print_type_artwork, 'OFFSET SCREEN') !== false){
                        ...
                        $query=$this->db->query("SELECT * from screen_consumption_master where lacquer_type_id='2' and apply_from_date<='$ar_invoice_master_row->invoice_date' and apply_to_date>='$ar_invoice_master_row->invoice_date' and archive<>1");
                            ...
                            if($result_offset_value==TRUE){
                                ...
                                $total_screen_and_plate_cost+=$invoice_wise_offset_plates_value;
                        ...
                        //$total_flexo_plates=0;
                            if(strpos($print_type_artwork, 'FLEXO') !== false || strpos($print_type_artwork, 'SCREEN+FLEXO') !== false || strpos($print_type_artwork, 'FLEXO+SCREEN') !== false){
                                $query=$this->db->query("SELECT * from screen_consumption_master where lacquer_type_id='8' and apply_from_date<='$ar_invoice_master_row->invoice_date' and apply_to_date>='$ar_invoice_master_row->invoice_date' and archive<>1");
                                ...
                                if($result_flexo_value==TRUE){
                                    ...
                                    $total_screen_and_plate_cost+=$invoice_wise_flexo_plates_value;
                        ...
                        echo "<tr class='item'><td class='label' width='10%' >PLATES/SCREENS</td>
                        <td class='label' width='5%' style='border-right:1px solid #D9d9d9;'></td>
        ...
        foreach($data2['job_card'] as $job_card_row){
            ...
            $labeling_quantity=($this->common_model->read_number($job_card_row->demand_qty,$this->session->userdata['logged_in']['company_id'])/$total_dispatch)*$this->common_model->read_number($ar_invoice_details_row->arid_qty,$this->session->userdata['logged_in']['company_id']);
            ...
            endforeach;
                ...
                echo "<tr>
                        <td colspan='6'>NO LABELING FOR THIS JOB</td></tr>";
            }
        }
            echo "<tr class='heading'>
                <td><b>TOTAL</td>
        ...
        <table cellpadding='5' cellspacing='0' style='border:1px solid #D9d9d9;'>
            ...
            echo "<tr class='item'><td class='label' width='10%' >SHRINK SLEEVE</td>
                    ...
                    <td class='label' width='10%' style='border-right:1px solid #D9d9d9;text-align:right'>".round($capping_s_quantity)."</td>
                    <td width='5%' style='border-right:1px solid #D9d9d9;text-align:right'>".$cap_s_price."</td>
...
<!--
    ...
    -->
        ...
        foreach($data2['job_card'] as $job_card_row){
            ...
            $query=$this->db->query("SELECT sum(total_qty) as total_qty,calculated_purchase_price from reserved_quantity_manu where manu_order_no='$job_card_row->manu_order_no' and article_no='$job_card_row->article_no' and type_flag='4' and article_no NOT LIKE '%LBL-' and article_no NOT LIKE '%CAP%'");
