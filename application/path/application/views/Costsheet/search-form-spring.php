...
<form name="<?php echo $this->router->fetch_class();?>" action="<?php echo base_url('index.php/'.$this->router->fetch_class().'/search_result_spring');?>" method="POST" >

	<div class="form_design">

	<div class="ui red labels" style="text-align: center;">
      <div class="ui label">Spring Report</div>
    </div>
    <br/>
