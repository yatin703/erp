...
<script>
	$(document).ready(function(){
		...
		$("#supplier_no").autocomplete("<?php echo base_url('index.php/ajax/supplier');?>", {selectFirst: true});
				...
				<td width="50%">
					<table class="form_table_inner">
									...
									<tr>
										...
										<td colspan="3"><input type="text" name="supplier_no" id="supplier_no"  size="60" value="<?php echo set_value('supplier_no');?>" /></td>
									</tr>									
									<tr>
				...
				<td width="50%">
					<table class="form_table_inner">
									...
									<tr>
										...
										<td>
											<select name="po_grir_completed" id="po_grir_completed" >
												<option value="">--Please Select--</option>
												<option value="0" <?php echo set_select('po_grir_completed','0'); ?> >Pending</option>
									...
									<tr>
										...
										<td>
											<select name="inv_created_flag" id="inv_created_flag" >

												<option value="">--Please Select--</option>
												<option value="0" <?php echo set_select('inv_created_flag','0');?>>Open</option>
												<option value="1" <?php echo set_select('inv_created_flag','1');?> >Closed</option>
