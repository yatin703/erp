			...
			<table class="ui very basic collapsing celled table"  style="font-size:10px;" id="tbl_data" >
				<thead>
					<tr style="text-align: center;">
						<th colspan="12" style="border-top: 1px solid rgba(34,36,38,.1); border-left: 1px solid rgba(34,36,38,.1);">Production Details</th>
				...
				if($springtube_extrusion_production_master==FALSE){
					echo "<tr><td colspan='22'>No Active Records Found</td></tr>";
					    	...
					    	if($rowspan>0){					    		
								...
								<td style='border-left: 1px solid rgba(34,36,38,.1);text-align:center;' rowspan='".$rowspan."'>".$i."</td>
									...
									foreach ($result as $details_row){
										...
										<td class='positive right aligned'>".($details_row->qc_check ==1? $details_row->total_ok_meters." MTRS":"<i>Qc Pending</i>")."</td>
										...
										-->
										<td class='positive right aligned'>".($details_row->total_meters_produced!=0? number_format($details_row->total_meters_produced,2,'.',',')."</b><i> MTRS</i>" :$details_row->total_meters_produced)."
										</td>
										...
										echo ($total_ok_meters!=0? number_format($total_ok_meters,2,'.',',')."</b><i> MTRS</i>" :"<i>Qc Pending</i>");

										echo"
										</td>

										<td style='text-align:right' class='negative'><b>".($details_row->total_waste!=''? number_format($details_row->total_waste,2,'.',',')."</b><i> KGS</i>":"")."</td>
										...
										<td style='text-align:right;' class='negative'><b>".($details_row->total_setup_weight!='' ? number_format($details_row->total_setup_weight,2,'.',',')." </b> <i>KGS</i>":"")."</td>
										...
										<td style='text-align:right;' class='negative'><b>".($details_row->total_purging_weight!=''?number_format($details_row->total_purging_weight,2,'.',',')." </b> <i>KGS</i>":"")."</td>
										<td>";
						...
						echo"
						<thead>
						<tr style='font-weight:bold;'><td colspan='10' style='text-align:right;'><b>TOTAL</b></th>
