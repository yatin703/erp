...
<form name="<?php echo $this->router->fetch_class();?>" action="<?php echo base_url('index.php/'.$this->router->fetch_class().'/search_result');?>" method="POST"  >
	<div class="form_design">
		...
		<legend><b>Film Exrusion Search</b></legend>
				...
				<td>
					<table>
						...
						<tr>
							...
							<td colspan="3"><input type="text" name="film_code" id="film_code"  value="<?php echo set_value('film_code');?>" maxlength="200" size="60"/></td>
