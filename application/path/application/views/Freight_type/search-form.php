			...
			<tr>
				<td>
					<table class="form_table_inner">
									...
									<tr>
										<td class="label">Freight Type Description   :</td>
										<td><input type="text" name="lang_freight_type" maxlength="50" size="20" value="<?php echo set_value('lang_freight_type');?>" /></td>
									</tr>
