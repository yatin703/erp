...
<?php foreach ($specification as $specification_row):?>
    ...
    <table cellpadding="0" cellspacing="0" style="border:1px solid #D9d9d9;">
        ...
        <tr class="heading">
            ...
            <td width="5%"></td>
            <td width="35%"><?php echo $specification_row->article_name; ?>//<?php echo $specification_row->article_no;?></td>
            
        </tr>
        <tr class="item">
            <td><b>Customer</b></td>
            <td></td>
            <td colspan="4"><?php if(!empty($specification_row->customer_name)){ echo $specification_row->customer_name;}else{ echo "Generel Cap";} ?></td>
        </tr>
        <tr class="item">
