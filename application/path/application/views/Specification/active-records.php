	...
	<div class="record_inner_design" style="overflow: scroll;white-space: nowrap;">
			<table class="record_table_design_without_fixed">
				<tr>
					...
					<th>Dia</th>
					<th>Length</th>
					<th>SLEEVE GUAGE 1</th>
					<th>SLEEVE GUAGE 2</th>
					<th>SLEEVE GUAGE 3</th>
					<th>SLEEVE GUAGE 4</th>
					<th>SLEEVE GUAGE 5</th>
					<th>Shoulder</th>
				...
				if($specification==FALSE){
					echo "<tr><td colspan='12'>No Active Records Found</td></tr>";
							...
							foreach($specification as $row){
								...
								//print_r($data['sleeve_specs_details']);

								foreach($data['sleeve_specs_details'] as $sleeve_specs_details_row){
									$SLEEVE_GUAGE=$sleeve_specs_details_row->SLEEVE_GUAGE;
									$SLEEVE_GUAGE_2=$sleeve_specs_details_row->SLEEVE_GUAGE_2;
									$SLEEVE_GUAGE_3=$sleeve_specs_details_row->SLEEVE_GUAGE_3;
									$SLEEVE_GUAGE_4=$sleeve_specs_details_row->SLEEVE_GUAGE_4;
									$SLEEVE_GUAGE_5=$sleeve_specs_details_row->SLEEVE_GUAGE_5;
								...
								echo "<tr>
									...
									<td>".$SLEEVE_LENGTH."</td>
									<td>".$SLEEVE_GUAGE."</td>
									<td>".$SLEEVE_GUAGE_2."</td>
									<td>".$SLEEVE_GUAGE_3."</td>
									<td>".$SLEEVE_GUAGE_4."</td>
									<td>".$SLEEVE_GUAGE_5."</td>
