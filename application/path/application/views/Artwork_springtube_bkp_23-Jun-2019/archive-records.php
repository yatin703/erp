								...
								echo "<tr>
									...
									if($result_cold_foil_two==TRUE){
										...
										foreach($result_cold_foil_two as $cold_foil_two_row){
											echo $cold_foil_two_row->parameter_value;											
										}
									...
									<td>";
										...
										if($result_pre_lacquer_one==TRUE){
											...
											echo $pre_lacquer_one_row->parameter_value;
									...
									<td>";
										...
										if($result_pre_lacquer_two==TRUE){
											...
											foreach($result_pre_lacquer_two as $pre_lacquer_two_row){
												echo $pre_lacquer_two_row->parameter_value;
										...
										if($result_post_lacquer_one==TRUE){
											...
											echo $post_lacquer_one_row->parameter_value;
									...
									<td>";
										...
										if($result_post_lacquer_two==TRUE){
											...
											foreach($result_post_lacquer_two as $post_lacquer_two_row){
												echo $post_lacquer_two_row->parameter_value;
									...
									foreach($formrights as $formrights_row){ 
										...
										echo ($row->archive==1 && $formrights_row->dearchive==1 ? '<a title="Dearchive" href="'.base_url('index.php/'.$this->router->fetch_class().'/dearchive/'.$row->ad_id.'/'.$row->version_no).'"><i class="recycle icon"></i></a> ' : '');
