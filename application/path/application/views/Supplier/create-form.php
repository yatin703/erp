				...
				<td>
					<table class="form_table_inner">
									...
									<tr>
										...
										<td><input type="text" name="city_code" maxlength="6" size="20" value="<?php echo set_value('city_code');?>"  /></td>
									</tr>
									...
									<tr>
										...
										<?php if($bank==FALSE){
												...
												foreach($bank as $bank_row){
													echo "<option value='".$bank_row->bank_id."'  ".set_select('bank',''.$bank_row->bank_id.'').">".$bank_row->bank_id." ".$bank_row->bank_name." (".$bank_row->bank_code.")</option>";
												}
										}?>
										</select></td>
									</tr>
