				...
				<?php foreach($supplier as $row):?>
					<table class="form_table_inner">
									...
									<tr>
										...
										<td><input type="text" name="email" maxlength="200" size="20" value="<?php echo set_value('email',$row->email);?>" /></td>
									</tr>

									

									<tr>
										<td class="label">Telephone 1 <span style="color:red;">*</span> :</td>
									...
									<tr>
										...
										<?php if($payment_term==FALSE){
												...
												foreach($payment_term as $payment_term_row){
													...
													echo "<option value='".$payment_term_row->id."' $selected ".set_select('payment_term',''.$payment_term_row->id.'').">".$payment_term_row->lang_description." (".$payment_term_row->net_days." days)</option>";
												}
										}?>
										</select></td>
									</tr>
									...
									<tr>
										...
										<?php if($bank==FALSE){
												...
												foreach($bank as $bank_row){
													...
													echo "<option value='".$bank_row->bank_id."' $selected ".set_select('bank',''.$bank_row->bank_id.'').">".$bank_row->bank_id." ".$bank_row->bank_name." (".$bank_row->bank_code.")</option>";
												}
										}?>
										</select></td>
									</tr>
