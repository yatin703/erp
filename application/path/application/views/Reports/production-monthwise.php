		...
		<div class="row">
			<div class="column">
					<span id="check">
						...
						<?php
							setlocale(LC_MONETARY, 'en_IN');
							if($spring_extrusion==FALSE){

							}else{
								echo '<table class="ui sortable selectable celled table" style="font-size:10px;">
							        	<thead>
										   <tr>
										    	<th colspan="6"><a class="ui orange label">SPRING EXTRUSION</a>';
										    	if($account_periods_master==FALSE){
										    	}else{
										    		foreach ($account_periods_master as $account_periods_master_row ){
										    			echo '<a class="ui olive label"><i class="calendar icon"></i>'.$this->common_model->view_date($account_periods_master_row->fin_year_start,$this->session->userdata['logged_in']['company_id']).' TO '.$this->common_model->view_date(date('Y-m-d'),$this->session->userdata['logged_in']['company_id']).'</a><br/><br/>';
										  	...
										  	<tr>
							        			<th colspan="2"></th>
							        			<th class="center aligned">SPRING EXTRUSION</th>
							        			<th colspan="1" class="center aligned">TOTAL</th>
							        		</tr>

							        		<tr>
							        			<th colspan="2"></th>
							        			<th class="right aligned">SPRING-BREYER</th>
							        			<th class="right aligned">MONTHWISE TOTAL</th>
							        		</tr>
							        		<tr>
							        			<th> SR NO </th>
							        			<th>YEAR- MONTH</th>
							        			<th class="right aligned">QUANTITY (Meters)</th>
							        			<th class="right aligned">QUANTITY (Meters)</th>
							...
							foreach($spring_extrusion as $row){
								 
								$grand_total_ex+=$row->SPRING_EXTRUSION;
								echo "<tr title='$row->PRODUCTION_MONTH'>
										<td><b>".$count."</b></td>
										<td><b>".$row->PRODUCTION_YEAR."-".strtoupper($row->PRODUCTION_MONTH)."</b></td>
										<td class='right aligned'>".money_format('%!.0n',$row->SPRING_EXTRUSION)."</td>
							    ...
							    echo "<thead>
									    <tr>
									    	<th colspan='2'>GRAND TOTAL</th>
									    	<th class='right aligned'>".money_format('%!.0n',$grand_total_ex)."</th>
									    	<th class='right aligned'>".money_format('%!.0n',$grand_total_ex)."</th>
						...
						<?php
							...
							foreach($spring_printing as $row){
								...
								$grand_total_pr+=$row->SPRING_PRINTING;
								echo "<tr title='$row->PRODUCTION_MONTH'>
										<td><b>".$count."</b></td>
										<td><b>".$row->PRODUCTION_YEAR."-".strtoupper($row->PRODUCTION_MONTH)."</b></td>
							    ...
							    echo "<thead>
									    <tr>
									    	<th colspan='2'>GRAND TOTAL</th>
									    	<th class='right aligned'>".money_format('%!.0n',$grand_total_pr)."</th>
									    	<th class='right aligned'>".money_format('%!.0n',$grand_total_pr)."</th>
						...
						<?php
							setlocale(LC_MONETARY, 'en_IN');
							if($spring_bodymaking==FALSE){

							}else{
								echo '<table class="ui sortable selectable celled table" style="font-size:10px;">
							        	<thead>
										   <tr>
										    	<th colspan="6"><a class="ui orange label">SPRING BODYMAKING</a>';
										    	if($account_periods_master==FALSE){
										    	}else{
										    		foreach ($account_periods_master as $account_periods_master_row ){
										    			echo '<a class="ui olive label"><i class="calendar icon"></i>'.$this->common_model->view_date($account_periods_master_row->fin_year_start,$this->session->userdata['logged_in']['company_id']).' TO '.$this->common_model->view_date(date('Y-m-d'),$this->session->userdata['logged_in']['company_id']).'</a><br/><br/>';
										  	...
										  	<tr>
							        			<th colspan="2"></th>
							        			<th class="center aligned">SPRING BODYMAKING</th>
							        			<th colspan="1" class="center aligned">TOTAL</th>
							        		</tr>

							        		<tr>
							        			<th colspan="2"></th>
							        			<th class="right aligned">SPRING-SEASA</th>
							        			<th class="right aligned">MONTHWISE TOTAL</th>
							        		</tr>
							        		<tr>
							        			<th> SR NO </th>
							...
							foreach($spring_bodymaking as $row){
								 
								$grand_total_bm+=$row->SPRING_BODYMAKING;
								echo "<tr title='$row->PRODUCTION_MONTH'>
										<td><b>".$count."</b></td>
										<td><b>".$row->PRODUCTION_YEAR."-".strtoupper($row->PRODUCTION_MONTH)."</b></td>
										<td class='right aligned'>".money_format('%!.0n',$row->SPRING_BODYMAKING)."</td>
										<td class='right aligned'>".money_format('%!.0n',$row->SPRING_BODYMAKING)."</td>
									</tr>";
							    ...
							    echo "<thead>
									    <tr>
									    	<th colspan='2'>GRAND TOTAL</th>
									    	<th class='right aligned'>".money_format('%!.0n',$grand_total_bm)."</th>
									    	<th class='right aligned'>".money_format('%!.0n',$grand_total_bm)."</th>
