				...
				<td >
					<table class="form_table_inner">
						...
						<tr id="tr_article">
							...
							<td><input type="text" name="article_no" id="article_no" maxlength="200" size="60" value="<?php echo set_value('article_no',$this->common_model->get_article_name($row->article_no,$this->session->userdata['logged_in']['company_id']).'//'.$row->article_no);?>" required >
							</td>
