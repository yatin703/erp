			...
			<tr>
				<td>
					<table class="form_table_inner">
							...
							<?php foreach($cap_orifice_master as $row):?>
									<tr>
										<td class="label">Cap orifice <span style="color:red;">*</span> :</td>
										<td>
											<input type="hidden" name="cap_orifice_id"  value="<?php echo set_value('cap_orifice_id',$row->cap_orifice_id);?>" />
											<input type="text" name="cap_orifice"  value="<?php echo set_value('cap_orifice',$row->cap_orifice);?>" />
										</td>
									</tr>
