					...
					echo "<tr><td colspan='4'>No Active Records Found</td></tr>";
							...
							foreach($cap_orifice_master as $row){
								echo "<tr>
									...
									<td><a href=".base_url('index.php/'.$this->router->fetch_class().'/modify/'.$row->cap_orifice_id.'').">Modify</a><a href=".base_url('index.php/'.$this->router->fetch_class().'/delete/'.$row->cap_orifice_id.'')."> | Delete</a>
