    ...
    <table cellpadding="0" cellspacing="0" style="border:1px solid #D9d9d9;">
        ...
        <?php 
            ...
            for($i=1;$i<=$layers;$i++):
                ...
                $specification_sheet_details_FILM=$this->common_model->select_active_records_where_order_by('specification_sheet_details',$this->session->userdata['logged_in']['company_id'],$search,$order_by,$sequence);
                //echo $this->db->last_query();
                $count=count($specification_sheet_details_FILM);
        ?>
                <tr class="item">
                    <td width="15%"><b>FILM LAYER (<?php echo $i;?>)</b></td>
                    <td width="85%">
                        <table cellpadding="0" cellspacing="0" style="border:1px solid #D9d9d9;">
                            <?php
                                foreach($specification_sheet_details_FILM as $row){
