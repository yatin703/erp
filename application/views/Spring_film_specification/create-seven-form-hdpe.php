					...
					<table class="form_table_inner">
                           ...
                           <tr><td class="label"><b>2 Layer</b></td></tr>
                                 ...
                                 <tr>
                                    ...
                                    <td><input type="number" name="film_mb_per_two" min="0"  max="25" step="0.1" maxlength="4" size="4" value="<?php echo set_value('film_mb_per_two');?>" placeholder="%" required></td>
                                 </tr>
                           ...
                           <tr>
                              ...
                              <td>
                              <input type="number" name="film_mb_per_six" min="0"  max="25" step="0.1" maxlength="4" size="4" value="<?php echo set_value('film_mb_per_six');?>" placeholder="%" required>
