					...
					<table class="form_table_inner">
                                 ...
                                 <option value="42">FILM</option>
									...
									<tr>
										...
										}?></select>&nbsp;Length <span style="color:red;">*</span> : <input type="number" name="sleeve_length" min="85"  max="200" step="0.1"  id="sleeve_length" size="5" maxlength="6" value="<?php echo set_value('sleeve_length');?>" required></td>
									</tr>
                           ...
                           <tr><td class="label"><b>1 Outer Layer</b></td></tr>
									...
									<tr>
										...
										<td><input type="number" min="10" max="20" step="10" name="gauge_one" id="gauge_one" maxlength="5" size="5" value="<?php echo set_value('gauge_one','20');?>" required></td>
									</tr>
                           ...
                           <tr><td class="label"><b>2 Layer</b></td></tr>
                                 ...
                                 <tr>
                                 <td class="label">Gauge <span style="color:red;">*</span> :</td>
                                 <td><input type="number" name="gauge_two" min="155" max="155" step="1" maxlength="5" size="5" value="<?php echo set_value('gauge_two','155');?>" required></td>
                                 </tr>
                                 ...
                                 <tr>
                                    ...
                                    <td><input type="number" name="film_mb_per_two" min="0"  max="25" step="0.5" maxlength="4" size="4" value="<?php echo set_value('film_mb_per_two');?>" placeholder="%" required></td>
                                 </tr>
                           ...
                           <tr><td class="label"><b>3 Admer Layer</b></td></tr>
                              ...
                              <tr>
											<td class="label">Gauge <span style="color:red;">*</span> :</td>
											<td><input type="number" name="gauge_three" min="10"  max="20" step="1" id="gauge_three" maxlength="2" size="2" value="<?php echo set_value('gauge_three','10');?>" required></td>
										</tr>

                              <tr>
                              <td class="label">Admer  <span style="color:red;">*</span> :</td>
                              <td><select name="film_admer_three" required>
                              ...
                              <td>
                              <input type="number" name="film_admer_per_three" min="100"  max="100" step="any"  maxlength="3" size="3" value="<?php echo set_value('film_admer_per_three');?>" placeholder="%" required></td>
                              </tr>
                           ...
                           <tr><td class="label"><b>&nbsp;</b></td><td class="label"><b>&nbsp;</b></td></tr>
                              ...
                              <tr>
                                 <td class="label">Gauge <span style="color:red;">*</span> :</td>
                                 <td><input type="number" name="gauge_four" min="25"  max="25" step="1" maxlength="2" size="2" value="<?php echo set_value('gauge_four','25');?>" required></td>
                              </tr>

                              <tr>
                              <td class="label">Evoh <span style="color:red;">*</span> :</td>
                              <td><select name="film_evoh_four" required>
                              ...
                              <td>
                              <input type="number" name="film_evoh_per_four"  min="100" max="100" step="any"  maxlength="3" size="3" value="<?php echo set_value('film_evoh_per_four');?>" placeholder="%" required></td>
                              </tr>
                           ...
                           <tr><td class="label"><b>&nbsp;</b></td><td class="label"><b>&nbsp;</b></td></tr>
                              ...
                              <tr>
                                 <td class="label">Gauge <span style="color:red;">*</span> :</td>
                                 <td><input type="number" name="gauge_five" min="10"  max="20" step="10" maxlength="2" size="2" value="<?php echo set_value('gauge_five','10');?>" required></td>
                              </tr>

                              <tr>
                              <td class="label">Admer <span style="color:red;">*</span> :</td>
                              <td><select name="film_admer_five" required>
                              <option value=''>--Select Admer--</option>
                              <?php
                              foreach ($admer as $admer_row) {
                              ...
                              <td>
                              <input type="number" name="film_admer_per_five" min="100" max="100" step="any" maxlength="3" size="3" value="<?php echo set_value('film_admer_per_five');?>" placeholder="%" required></td>
                              </tr>
                            ...
                            <tr>
                                 <td class="label">Gauge <span style="color:red;">*</span> :</td>
                                 <td><input type="number" name="gauge_six" id="gauge_six" min="210" max="210" step="1" maxlength="5" size="5" value="<?php echo set_value('gauge_six','210');?>" required></td>
                              </tr>
                           ...
                           <tr>
                              ...
                              <td>
                              <input type="number" name="film_mb_per_six" min="0"  max="25" step="0.5" maxlength="4" size="4" value="<?php echo set_value('film_mb_per_six');?>" placeholder="%" required>
                           ...
                           <tr>
                              <td class="label">Gauge <span style="color:red;">*</span> :</td>
                              <td><input type="number" min="10" max="20" step="10" name="gauge_seven"  maxlength="5" size="5" value="<?php echo set_value('gauge_seven','20');?>" required></td>
                           </tr>
