					...
					echo "<tr><td colspan='12'>No Active Records Found</td></tr>";
							...
							$this->db->last_query();
								...
								echo "<tr>
									...
									<td>".$FILM_GUAGE_1." ".$this->common_model->get_article_name($FILM_LDPE_1,$this->session->userdata['logged_in']['company_id'])." ".$FILM_LDPE_PERC_1." ".$this->common_model->get_article_name($FILM_LLDPE_1,$this->session->userdata['logged_in']['company_id'])." ".$FILM_LLDPE_PERC_1."</td>
									...
									<td>".$FILM_GUAGE_5." ".$this->common_model->get_article_name($FILM_ADMER_5,$this->session->userdata['logged_in']['company_id'])." ".$FILM_ADMER_PERC_5."</td>
									...
									<td>".$FILM_GUAGE_7." ".$this->common_model->get_article_name($FILM_LDPE_7,$this->session->userdata['logged_in']['company_id'])." ".$FILM_LDPE_PERC_7." ".$this->common_model->get_article_name($FILM_LLDPE_1,$this->session->userdata['logged_in']['company_id'])." ".$FILM_LLDPE_PERC_7."</td>
