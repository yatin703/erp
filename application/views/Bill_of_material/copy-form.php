					...
					<table class="form_table_inner">
						...
						<?php foreach($bill_of_material as $row):?>	
									...
									<tr>
										...
										<td><input type="text" name="article_no" id="article_no" size="60" value="<?php echo set_value('article_no',$row->article_description.'//'.$row->article_no);?>" /></td>
									</tr>

									<tr><td class="label"><b>&nbsp;</b></td><td class="label"><b>+</b></td></tr>

									<tr>
										<td class="label"><b>Print Type</b> <span style="color:red;">*</span> :</td>
									...
									<tr>
											...
											<td><input type="text" name="cap_code" id="cap_code" size="60" value="<?php echo set_value('cap_code',$row->cap.'//'.$row->cap_code);?>" /></td>
									</tr>
