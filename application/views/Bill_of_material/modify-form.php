			...
			<tr>
				<td>
					<table class="form_table_inner">
						...
						<?php foreach($bill_of_material as $row):?>	

									<tr>
										<td class="label"><b>BOM No</b>  <span style="color:red;">*</span> :</td>
										<td><input type="text" name="bom_no"  size="60" value="<?php echo $row->bom_no;?>" readonly /></td>
									</tr>

									<tr>
										<td class="label"><b>BOM Version No</b>  <span style="color:red;">*</span> :</td>
										<td><input type="text" name="bom_version_no"  size="60" value="<?php echo $row->bom_version_no;?>" readonly /></td>
									</tr>
									...
									<tr>
										<input type="hidden" name="bom_id" value="<?php echo $row->bom_id;?>" />	
										<input type="hidden" name="record_no" value="<?php echo $row->bom_no.'@@@'.$row->bom_version_no;?>" />
										<td class="label"><b>PSM/PSP NO</b>  <span style="color:red;">*</span> :</td>
										<td><input type="text" name="article_no" id="article_no" size="60" value="<?php echo set_value('article_no',$row->article_description.'//'.$row->article_no);?>" readonly /></td>
									</tr>
									...
									<tr>
											...
											<td><input type="text" name="sleeve_code" id="sleeve_code" size="60" value="<?php echo set_value('sleeve_code',$row->sleeve.'//'.$row->sleeve_code);?>" /></td>
									</tr>
									...
									<tr>
											...
											<td><input type="text" name="shoulder_code" id="shoulder_code" size="60" value="<?php echo set_value('shoulder_code',$row->shoulder.'//'.$row->shoulder_code);?>" /></td>
									</tr>
									<tr><td class="label"><b>&nbsp;</b></td><td class="label"><b>+</b></td></tr>

									<tr>
											<td class="label"><b>Label Code</b></td>
											<td><input type="text" name="label_code" id="label_code" size="60" value="<?php echo set_value('label_code',($row->label_code!=''?$row->label.'//'.$row->label_code:''));?>" /></td>
									</tr>
									<tr><td class="label"><b>&nbsp;</b></td><td class="label"><b>+</b></td></tr>

									<tr>
											<td class="label"><b>Cap Code <span style="color:red;">*</span></b></td>
											<td><input type="text" name="cap_code" id="cap_code" size="60" value="<?php echo set_value('cap_code',($row->cap_code!=''?$row->cap.'//'.$row->cap_code:''));?>" /></td>
									</tr>
									...
									<tr>
										...
										<td><select name="for_export">
											...
											<option value="0" <?php echo  set_select('for_export', '0', $row->for_export==0 ? TRUE : FALSE); ?>>DOMESTIC</option>
											<option value="1" <?php echo  set_select('for_export', '1', $row->for_export==1 ? TRUE : FALSE); ?>>EXPORT</option>
								          </select>
								      </td>
								    </tr>
									...
									<tr>
											<td class="label"><b>Comment<span style="color:red;">*</span></b></td>
											<td><textarea name="comment" value="<?php echo set_value('comment',$row->comment);?>" rows="3" cols="60"><?php echo set_value('comment',$row->comment);?></textarea></td>
									</tr>
