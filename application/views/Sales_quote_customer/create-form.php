			...
			<td width="50%">
				<table class="form_table_inner">
					...
					<tr>							
						...
						<td colspan="3"><input type="text" name="customer_category"  size="40" value="<?php echo set_value('customer_category');?>"/></td>							
					</tr>
			...
			<td width="50%">
				<table class="form_table_inner"> 								 
					<tr>							
						...
						<td colspan="3"><input type="text" readonly id="primary_contact" class="primary_contact" name="primary_contact" size="40" value="<?php echo set_value('primary_contact');?>"/></td>							
					</tr>
			...
			<td width="50%">				
				<table class="form_table_inner">
					<tr>							
						...
						<td colspan="3"><input type="text" readonly id="secondary_contact" class="secondary_contact" name="secondary_contact" size="40" value="<?php echo set_value('secondary_contact');?>"/></td>							
					</tr>
				...
				<?php
					if(!empty($this->input->post('buying_potential_sr_no[]'))){
						...
						for($i=0;$i<count($this->input->post('buying_potential_sr_no[]'));$i++){										 
							...
							<td><input type="text" name="three_d_volume[]" value="'.set_value('three_d_volume['.$i.']').'"/>
							</td>';
