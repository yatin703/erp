...
foreach ($sales_quote_customer_master as $sales_quote_customer_master_row):?>
 ...
 -->
        ...
        <?php 
        $i=1;
        foreach ($customer_contact_details as $key => $sales_quote_customer_contact_details_row):?>
        <table cellpadding="10" cellspacing="0" style="border:1px solid #D9d9d9;">
            <tr class="heading">
                <td width="55%" colspan="4" style="border-bottom:1px solid #D9d9d9;"><b><?php echo $i."] ";?>CONTACT DETAILS</td>
