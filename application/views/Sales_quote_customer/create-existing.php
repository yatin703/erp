...
<form name="<?php echo $this->router->fetch_class();?>" action="<?php echo base_url('index.php/'.$this->router->fetch_class().'/save_existing');?>" method="POST" enctype="multipart/form-data">
		...
		<fieldset>	
			...
			<td width="50%">
				<table class="form_table_inner">
					...
					<tr>							
						<td class="label"> Existing Customer Name<span style="color:red;">*</span></td>
