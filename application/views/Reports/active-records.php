...
<div class="record_form_design">
	...
	<div class="ui equal width grid">
	  ...
	  <div class="column ui label">
	  	<h4 class="ui image header">
	  		<i class="file outline icon"></i>
	  		<div class="content">
	  			<a href="<?php echo base_url('index.php/'.$this->router->fetch_class().'/sales_report_pcb');?>" target="_blank">SALES REPORT FOR PCB</a>
	  			<div class="sub header">Invoice as Row | Customer & GST as Column</div>
			</div>
		</h4>
	  </div>
		...
		<div class="ui equal width grid">
			...
			<div class="column ui label">
		  	...
		  	<h4 class="ui image header">
		  		<i class="file outline icon"></i>
		  		<div class="content">
		  			<a href="<?php echo base_url('index.php/'.$this->router->fetch_class().'/total_order_received_by_customer_on_order_date');?>" target="_blank">TOTAL ORDERS  RECEIVED BY CUSTOMER ON ORDER DATE</a>
	...
	<h3 class="ui top attached header">
  		PENDING ORDER REPORT ON OC DATE
	</h3>
		...
		<div class="ui equal width grid">
			<div class="column ui label">
		  	<h4 class="ui image header">
		  		<i class="file outline icon"></i>
		  		<div class="content">
		  			<a href="<?php echo base_url('index.php/'.$this->router->fetch_class().'/pending_sales_order_on_oc_date');?>" target="_blank">APPROVED PENDING ORDERS BY PRINT TYPE</a>
					<div class="sub header">Month as Row | Print Type as Column </div>
				</div>
			</h4>
		  	</div>		  	
	...
	<h3 class="ui top attached header">
  		PENDING ORDER REPORT ON DELIVERY DATE
	</h3>
		...
		<div class="ui equal width grid">
			<div class="column ui label">
		  	<h4 class="ui image header">
		  		<i class="file outline icon"></i>
		  		<div class="content">
		  			<a href="<?php echo base_url('index.php/'.$this->router->fetch_class().'/pending_sales_order_on_delivery_date');?>" target="_blank">APPROVED PENDING ORDERS BY PRINT TYPE</a>
					<div class="sub header">Month as Row | Print Type as Column </div>
				</div>
			</h4>
		  	</div>
		  	...
		  	<h4 class="ui image header">
		  		<i class="file outline icon"></i>
		  		<div class="content">
		  			<a href="<?php echo base_url('index.php/'.$this->router->fetch_class().'/approved_unapproved_pending_sales_order_on_delivery_date');?>" target="_blank">APPROVED & UNAPPROVED PENDING ORDERS BY PRINT TYPE</a>
					<div class="sub header">Month as Row | Print Type as Column</div>
				</div>
			</h4>
		  	</div>	
	...
	<div class="ui attached segment">
	 <div class="ui equal width grid">
	  	...
	  	<h4 class="ui image header">
	  		<i class="file outline icon"></i>
	  		<div class="content">
	  			<a href="http://192.168.0.33:8181/3dtechnopack/projects/twerp/ready-for-dispatch.php" target="_blank">Coex R F D</a>
			</div>
		</h4>
	  	</div>
	  	...
	  	<h4 class="ui image header">
	  		<i class="file outline icon"></i>
	  		<div class="content">
	  			<a href="<?php echo base_url('index.php/'.$this->router->fetch_class().'/capa_report');?>" target="_blank">CAPA MIS</a>
	  			
				<div class="sub header">ANY DATE</div>
			</div>
		</h4>
	  	</div>
	...
	<div class="ui attached segment">
	 <div class="ui equal width grid">
	  	...
	  	<h4 class="ui image header">
	  		<i class="file outline icon"></i>
	  		<div class="content">
	  			<a href="<?php echo base_url('index.php/Costsheet/Contribution_by_print_type');?>" target="_blank">CONTRIBUTION BY PRINT TYPE</a>

	  			<div class="ui green horizontal label" class="blink">NEW</div>
				<div class="sub header">Month as Row | Print Type as Column</div>
			</div>
		</h4>
	  	</div>
	  	...
	  	<h4 class="ui image header">
	  		<i class="file outline icon"></i>
	  		<div class="content">
	  			<a href="<?php echo base_url('index.php/Costsheet/Contribution_by_big_dia_small_dia_with_print_type');?>" target="_blank">CONTRIBUTION BY BIG DIA & SMALL DIA</a>
	  			<div class="ui green horizontal label" class="blink">NEW</div>
				<div class="sub header">Month as Row | Print Type as Column</div>
			</div>
		</h4>
	  	...
	  	<h4 class="ui image header">
	  		<i class="file outline icon"></i>
	  		<div class="content">
	  			<a href="<?php echo base_url('index.php/Costsheet/Contribution_by_customer');?>" target="_blank">CONTRIBUTION BY CUSTOMER</a>
	  			<div class="ui green horizontal label" class="blink">(WORKING)</div>
				<div class="sub header">Customer as Row | Print Type as Column</div>
			</div>
		</h4>
	  	</div>
