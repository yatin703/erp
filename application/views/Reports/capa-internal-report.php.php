				...
				<span id="check">
					...
					if($capa==FALSE){
						...
						echo '<table class="ui sortable selectable celled table" style="font-size:12px;">
					        	<thead>
								   <tr>
								    	<th colspan="11"><a class="ui orange label">CAPA MIS</a>';
								    	if($account_periods_master==FALSE){
								    	}else{
								    		foreach ($account_periods_master as $account_periods_master_row ){
								  	...
								  	<tr>
								  		<th colspan="3"></th>
								  		<th class="center aligned" colspan="3">NO OF COMPLAINTS</th>
								  		<th class="center aligned" colspan="2">CAPA COMPLETED YTD</th>
								  	</tr>
					        		...
					        		<tr>
					        			...
					        			<th class="center aligned">'.strtoupper(date("M Y")).'</th>
					        			<th class="center aligned">YTD</th>
					        			<th class="center aligned">PREVIOUS YEAR</th>
					        			<th class="center aligned">YES</th>
