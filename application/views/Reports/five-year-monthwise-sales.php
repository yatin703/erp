			...
			<div class="column">
				...
				<span id="check">
					...
					if($sales_apr_march_yearwise==FALSE){
						...
						echo '<table class="ui selectable celled table" style="font-size:10px;">
					        	<thead>
					        	  ...
					        	  <tr>
					        			...
					        			<th colspan="3" class="center aligned">2021-22</th>
					        			<th colspan="3" class="center aligned">2022-23</th>
					        			<th colspan="3" class="center aligned">2023-24</th>
					        	  </tr>
					 ...
					 $total_quantity_twentyone_twentytwo=0;
					 $total_value_twentyone_twentytwo=0;
					 $total_avg_twentyone_twentytwo=0;
					...
					foreach($sales_apr_march_yearwise as $row){
						...
						$avg_row_twentyone_twentytwo=0;
						$avg_row_twentyone_twentytwo=($row->value_twentyone_twentytwo<>0 ? ($row->value_twentyone_twentytwo/$row->quantity_twentyone_twentytwo) : 0 );
						...
						echo "<tr>
								...
								<td class='warning right aligned'>".money_format('%!.0n',$row->quantity_twentyone_twentytwo)."</td>
								<td class='warning right aligned'>".money_format('%.0n',$row->value_twentyone_twentytwo)."</td>
								<td class='warning right aligned'>&#8377;".round($avg_row_twentyone_twentytwo,2)."</td>
					 		...
					 		$total_quantity_twentyone_twentytwo+=$row->quantity_twentyone_twentytwo;
					 		$total_value_twentyone_twentytwo+=$row->value_twentyone_twentytwo;
					 		

					 		$chart_data .= "{ y:'".$row->month_no."',
					 			...
					 			QUANTITY_21_22:".$row->quantity_twentyone_twentytwo."
					 		}, ";
							$i++;
					    }
					    ...
					    $total_avg_twentyone_twentytwo=($total_value_twentyone_twentytwo<>0 ? ($total_value_twentyone_twentytwo/$total_quantity_twentyone_twentytwo) : 0);
					    ...
					    echo "<thead>
							    <tr>
							    	...
							    	<th class='negative right aligned'>".money_format('%!.0n',$total_quantity_twentyone_twentytwo)."</th>
							    	<th class='negative right aligned'>".money_format('%.0n',$total_value_twentyone_twentytwo)."</th>
							    	<th class='negative right aligned'>&#8377;".round($total_avg_twentyone_twentytwo,2)."</th>
				...
				<div class="ui bottom attached tab segment" data-tab="second">
						...
						echo '<table class="ui selectable celled table" style="font-size:10px;">
					        	<thead>
					        	  ...
					        	  <tr>
										...
										<th colspan="3" class="center aligned">2022</th>					        			
					        	  </tr>
					...
					foreach($sales_jan_dec_yearwise as $row){
						echo "<tr>
								...
								<td class='warning right aligned'>".money_format('%!.0n',$row->quantity22)."</td>
								<td class='warning right aligned'>".money_format('%.0n',$row->value22)."</td>
								<td class='warning right aligned'>&#8377;$row->avg22</td>
						...
						$total_avg22=($total_value22<>0 ? ($total_value21/$total_quantity22) : 0);
					    ...
					    echo "<thead>
							    <tr>
							    	...
							    	<th class='negative right aligned'>".money_format('%!.0n',$total_quantity22)."</th>
							    	<th class='negative right aligned'>".money_format('%.0n',$total_value22)."</th>
							    	<th class='negative right aligned'>&#8377;".round($total_avg22,2)."</th>
				...
				<span id="check">
					...
					foreach($sales_apr_march_yearwise as $row){
						...
						echo "<tr>
								...
								<td class='negative right aligned'>".$this->common_model->read_number_million($row->quantity_twentyone_twentytwo)."</td>
								<td class='negative right aligned'>".$this->common_model->read_number_million($row->value_twentyone_twentytwo)."</td>
								<td class='negative right aligned'>&#8377;".round($avg_row_twentyone_twentytwo,2)."</td>
					    ...
					    echo "<thead>
							    <tr>
							    	...
							    	<th class='negative right aligned'>".$this->common_model->read_number_million($total_quantity_twentyone_twentytwo)."</th>
							    	<th class='negative right aligned'>".$this->common_model->read_number_million($total_value_twentyone_twentytwo)."</th>
							    	<th class='negative right aligned'>&#8377;".round($total_avg_twentyone_twentytwo,2)."</th>
				...
				<div class="ui bottom attached tab segment" data-tab="four">
					...
					foreach($sales_jan_dec_yearwise as $row){
						echo "<tr>
								...
								<td class='negative right aligned'>".$this->common_model->read_number_million($row->quantity22)."</td>
								<td class='negative right aligned'>".$this->common_model->read_number_million($row->value22)."</td>
								<td class='negative right aligned'>&#8377;$row->avg22</td>
					    ...
					    $total_avg20=($total_value20<>0 ? ($total_value20/$total_quantity20) : 0);
					    $total_avg21=($total_value21<>0 ? ($total_value21/$total_quantity21) : 0);
					    $total_avg22=($total_value22<>0 ? ($total_value22/$total_quantity22) : 0);
					    ...
					    echo "<thead>
							    <tr>
							    	...
							    	<th class='negative right aligned'>".$this->common_model->read_number_million($total_quantity22)."</th>
							    	<th class='negative right aligned'>".$this->common_model->read_number_million($total_value22)."</th>
							    	<th class='negative right aligned'>&#8377;".round($total_avg22,2)."</th>
							    </tr>
							  </thead>";
...
<script src="http://cdn.oesmith.co.uk/morris-0.4.1.min.js"></script>
	...
	Morris.Bar({
	 ...
	 ykeys:['QUANTITY_17_18','QUANTITY_18_19','QUANTITY_19_20','QUANTITY_20_21','QUANTITY_21_22'],
