			...
			<tr>
				<td>
					<table class="form_table_inner">
							...
							<?php foreach($costsheet_remark_master as $row):

								?>
									<tr>
										<td class="label">Remark <span style="color:red;">* </span> :</td>
										<td>
											<input type="hidden" name="id" value="<?php echo $row->crm_id;?>" readonly>
											<input type="text" name="remark" id="remark" step="any" value="<?php echo set_value('remark',$row->remark);?>" ></td>
									</tr>
