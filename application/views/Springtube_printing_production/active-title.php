<article class="container_title">
  ...
  <?php foreach($formrights as $formrights_row):
    ...
    echo ($formrights_row->view==1 ? '<a href="'.base_url('index.php/'.$this->router->fetch_class().'/search_scrap').'" class="ui tag label" target="_blank"><i class="search icon" ></i>Scrap Report</a> : ' : '');
