    ...
    <div class="ui teal labels" style="text-align: center;">
      <div class="ui label">
        ...
        <table cellpadding="5" cellspacing="0" style="border:1px solid #D9d9d9;">
            ...
            <tr class="item">
                <td><i class="bars icon"></i>DATE<b></b></td>
                <td style="border-right:1px solid #D9d9d9;"></td>
                <td style="border-right:1px solid #D9d9d9;"><?php echo $this->common_model->view_date($row->production_date,$this->session->userdata['logged_in']['company_id']) ;?></td>
            ...
            <tr class="item">
                ...
                <td style="border-right:1px solid #D9d9d9;"></td>
                <td style="border-right:1px solid #D9d9d9;"><?php echo $this->common_model->get_user_name($row->user_id,$this->session->userdata['logged_in']['company_id']) ;?></td>
                <td></td>                
                <td style="border-right:1px solid #D9d9d9;"></td> 
                <td></td>
            </tr>
            ...
            foreach ( $springtube_printing_production_master_result as  $master_row) {
                ...
                echo'<tr class="item">
                    ...
                    if($rowspan>0){ 
                        ...
                        echo '<tr style="font-weight:bold;"><td colspan="12" style="border-right:1px solid #D9d9d9; border-bottom:1px solid #D9d9d9;" >TOTAL</td><td style="border-right:1px solid #D9d9d9; border-bottom:1px solid #D9d9d9; text-align:left;">'.$sum_counter.'</td><td style="border-right:1px solid #D9d9d9; border-bottom:1px solid #D9d9d9;">'.$sum_printing_qty.'</td><td style="border-right:1px solid #D9d9d9; border-bottom:1px solid #D9d9d9;"></td><td style="border-right:1px solid #D9d9d9; border-bottom:1px solid #D9d9d9;"></td></tr>';
                    }else{
                        
                        echo'<td rowspan="'.$rowspan.'" style="border-right:1px solid #D9d9d9;"></td>
                        <td rowspan="'.$rowspan.'" style="border-right:1px solid #D9d9d9;"></td>
                        <td rowspan="'.$rowspan.'" style="border-right:1px solid #D9d9d9;"></td>';
                        echo '</tr>';
                        //echo '<tr><td rowspan="'.$rowspan.'" colspan="11">abc</td></tr>';
                    }                     
