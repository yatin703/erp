      ...
      <div class="ui label">
        ...
        <table cellpadding="5" cellspacing="0" style="border:1px solid #D9d9d9;">
            ...
            <tr class="heading" style="border-right:1px solid #D9d9d9;" >
                ...
                <td width="15%"><i class="cogs icon"></i>MACHINE</td>                
                <td width="5%" style="border-right:1px solid #D9d9d9;"></td>
                <td width="30%"><?php echo $master_row->machine_name ;?></td>
            </tr>
            <tr class="item">
                <td><i class="bars icon"></i><b>DATE</b></td>
                <td style="border-right:1px solid #D9d9d9;"></td>
                <td style="border-right:1px solid #D9d9d9;"><?php echo $this->common_model->view_date($master_row->production_date,$this->session->userdata['logged_in']['company_id']) ;?></td>
                <td><i class="bars icon"></i><b>SHIFT</b></td>                
                <td style="border-right:1px solid #D9d9d9;"></td> 
                <td><?php echo $master_row->shift ;?></td>
            </tr>
        
            <tr class="item">
                <td><i class="bars icon"></i> <b>JOB TYPE</b></td>
                <td style="border-right:1px solid #D9d9d9;"></td>
                <td style="border-right:1px solid #D9d9d9;"><?php
                    $springtube_printing_jobtype_master_result=$this->common_model->select_one_active_record('springtube_printing_jobtype_master',$this->session->userdata['logged_in']['company_id'],'id',$master_row->job_type);
                foreach ($springtube_printing_jobtype_master_result as $key => $springtube_printing_jobtype_master_row) {
                    echo $springtube_printing_jobtype_master_row->job_type;
                 } 
               
                 ?></td>
                <td><i class="bars icon"></i><b>JOB CATEGORY</b></td>                
                <td style="border-right:1px solid #D9d9d9;"></td> 
                <td><?php echo ($master_row->job_category!=''?($master_row->job_category==1?'NEW JOB':'REPEAT JOB'):'') ;?></td>
            </tr>
            <tr class="item">
                <td><i class="bars icon"></i> <b>JOB SPEED</b></td>
                <td style="border-right:1px solid #D9d9d9;"></td>
                <td style="border-right:1px solid #D9d9d9;"><?php echo $master_row->job_speed ;?></td>
                <td><i class="user secret icon"></i><b>OPERATOR</b></td>                
                <td style="border-right:1px solid #D9d9d9;"></td> 
        ...
        <table cellpadding="5" cellspacing="0" style="border:1px solid #D9d9d9;">
            ...
            <tr class="heading" style="border-right:1px solid #D9d9d9;" >
                ...
                <td width="7%" style="border-right:1px solid #D9d9d9;"><b>JOB CARD COUNTER</b></td>

                <td width="7%" style="border-right:1px solid #D9d9d9;"><b>PROD. COUNTER</b></td>
                ...
                <td width="7%" style="border-right:1px solid #D9d9d9;"><b>TIME</b></td>
            </tr>
            <?php
            $i=1;
            $sum_counter=0;
            ...
            echo'<tr class="item">
                    ...
                    <td style="border-right:1px solid #D9d9d9;" rowspan="'.$rowspan.'" >'.round($jobcard_qty/2).'</td>
                ...
                if($rowspan>0){ 
                    ...
                    foreach ($springtube_printing_production_details as  $details_row) {
                        ...
                        <td style="border-right:1px solid #D9d9d9; text-align:left;">'.substr($details_row->time_stamp,-8).'</td>';
                ...
                echo'<tr><td style="border-right:1px solid #D9d9d9;" colspan="11"><b>TOTAL</b></td><td style="border-right:1px solid #D9d9d9;"></td>
                <td style="border-right:1px solid #D9d9d9;"><b>'.round($jobcard_qty/2).'</b></td>
                <td style="border-right:1px solid #D9d9d9;"><b>'.$sum_counter.'</b></td>
                <td style="border-right:1px solid #D9d9d9;"><b>'.$sum_printing_qty.'</b></td></tr>';
            ?>
        </table>
        <br/>
        <br/>
