		...
		<div class="middle_form_inner_design">
		    ...
		    <?php  foreach ($springtube_extrusion_production_details as $detail_row):?>
					...
					<tr id="tr_<?php echo $detail_row->job_pos_no;?>">
						...
						<td>
							<input type="number" name="total_qc_hold_meters"  id="total_qc_hold_meters" class="quantity" value="<?php echo set_value('total_qc_hold_meters',$detail_row->total_qc_hold_meters);?>" min="0" max="20000" step="1" size="30" required/>
						</td>
						<td>
