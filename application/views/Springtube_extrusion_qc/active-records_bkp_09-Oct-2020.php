			...
			<table class="record_table_design_without_fixed">
				...
				if($springtube_extrusion_qc_master==FALSE){
					echo "<tr><td colspan='14'>No Active Records Found</td></tr>";
						...
						echo"<tr style='font-weight:bold;'><td colspan='15' style='text-align:right;'><b>TOTAL</b></td><td>".$sum_total_qc_hold_meters."</td><td>".$sum_total_qc_hold_qty."</td><td></td><td></td><td>".$sum_total_qc_release_meters."</td><td>".$sum_total_qc_release_qty."</td><td></td><td></td><td></td><td></td></tr>";	
