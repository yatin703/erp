					...
					echo "<tr><td colspan='14'>No Active Records Found</td></tr>";
						...
						foreach($springtube_extrusion_scrap_master as $master_row){
							...
							echo"<tr>
									...
									<td>".$master_row->total_scrap_meters."</td>
									<td>".$scrap_qty."</td>
						...
						echo"<tr><td colspan='15' style='text-align:right;'><b>TOTAL</b></td><td>".$sum_total_scrap_meters."</td><td>".$sum_scrap_qty."</td><td></td><td></td></tr>";	
