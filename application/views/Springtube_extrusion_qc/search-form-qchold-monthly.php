...
<form name="<?php echo $this->router->fetch_class();?>" action="<?php echo base_url('index.php/'.$this->router->fetch_class().'/search_result_wip_diawise');?>" method="POST"  >
	<div class="form_design">
		...
		<legend><b>QC Hold Monthly Search</b></legend>
	...
	<div class="record_inner_design" >
		...
		<div class="ui segments">
			<div class="ui blue segment">
			    <p><a  class="ui orange label">QC Hold</a><a  class="ui blue label"> MONTH WISE</a> 
				...
				<table class="ui very basic collapsing celled table"  style="font-size:10px;" id="tbl_data" >
				 ...
				 -->	
					...
					<tr>				
						...
						<th style="text-align: center;">QC Hold </th>
						<th style="text-align: center;">Released To WIP</th>
						<th style="text-align: center;">Released To Scrap</th>
						...
						echo "<tr><td colspan='14'>No Active Records Found</td></tr>";
							...
							foreach($springtube_extrusion_qc_master as $master_row){
								...
								echo"<tr class='tr_test'>		
										...
										<td class='negative right aligned'><b>".money_format('%!.0n',$master_row->total_qc_hold_meters)."</b><i> MTRS</i></td>
										<td class='positive right aligned'><b>".money_format('%!.0n',$master_row->wip)."</b><i> MTRS</i></td>
										<td class='negative right aligned'><b>".money_format('%!.0n',$master_row->scrap)."</b><i> MTRS</i></td>
										 ";
										 						
										 

								$sum_qc_hold_meters+=$master_row->total_qc_hold_meters;
								$sum_wip+=$master_row->wip;
								$sum_scrap+=$master_row->scrap;		

							}//master Foreach

						echo"<tr style='font-weight:bold;'><td colspan='3' style='text-align:right;'><b>TOTAL</b></td><td   style='text-align:right;'><b>".money_format('%!.0n',$sum_qc_hold_meters)."</b> <i> MTRS</i></td>
						<td   style='text-align:right;'><b>".money_format('%!.0n',$sum_wip)."</b> <i> MTRS</i></td> 
						<td   style='text-align:right;'><b>".money_format('%!.0n',$sum_scrap)."</b> <i> MTRS</i></td>
						 </tr>";	
