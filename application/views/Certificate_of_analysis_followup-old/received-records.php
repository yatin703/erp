							...
							foreach($followup_received as $followup_received_row){
								...
								echo "<tr>
									...
									foreach($formrights as $formrights_row){ 
										echo ($formrights_row->view==1 ? '<a href="'.base_url('index.php/Certificate_of_analysis/view/'.$followup_received_row->record_no).'" target="_blank"><i class="print icon"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;' : '');
									...
									/*	echo ($formrights_row->copy==1 ? 
										...
										echo ($formrights_row->new==1 ? '<a title="Approve" href="'.base_url('index.php/'.$this->router->fetch_class().'/approved/'.$followup_received_row->record_no.'/'.$followup_received_row->transaction_no).'" target="_blank"><i class="thumbs outline up icon"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;

											<a title="Disapprove" href="'.base_url('index.php/'.$this->router->fetch_class().'/notapproved/'.$followup_received_row->record_no.'/'.$followup_received_row->transaction_no).'" ><i class="thumbs outline down icon"></i>' : '');
