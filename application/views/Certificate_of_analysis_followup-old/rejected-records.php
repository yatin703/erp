							...
							foreach($followup_rejected as $followup_rejected_row){
								...
								echo "<tr>
									...
									foreach($formrights as $formrights_row){ 
										echo ($formrights_row->view==1 ? '<a href="'.base_url('index.php/certificate_of_analysis/view/'.$followup_rejected_row->record_no).'" target="_blank"><i class="print icon"></i></a> ' : '');
