...
<form name="<?php echo $this->router->fetch_class();?>" action="<?php echo base_url('index.php/'.$this->router->fetch_class().'/save_two_layer_with_cap');?>" method="POST" >
			...
			<tr>
				<td>
					<table class="form_table_inner">
									...
									Length <span style="color:red;">*</span> : <input type="text" name="sleeve_length" size="10" value="<?php echo set_value('sleeve_length');?>"></td>
									</tr>
									...
									<tr><td class="label"><b>&nbsp;</b></td><td>&nbsp;</td></tr>
									...
									<tr>
										...
										<td>
										<input type="text" name="sl_mb_per_two" maxlength="3" size="3" value="<?php echo set_value('sl_mb_per_two');?>" placeholder="%">
										<input type="text" name="sl_mb_supplier_two" class="supplier" size="60"  value="<?php echo set_value('sl_mb_supplier_two');?>" placeholder="MB Supplier">
										</td>
										</tr>
										...
										<td>
										<input type="text" name="sl_ldpe_per_two" maxlength="3" size="3" value="<?php echo set_value('sl_ldpe_per_two');?>" placeholder="%"></td>
										</tr>
										...
										<td>
										<input type="text" name="sl_lldpe_per_two" maxlength="3" size="3" value="<?php echo set_value('sl_lldpe_per_two');?>" placeholder="%"></td>
										</tr>
										...
										<td>
										<input type="text" name="sl_hdpe_per_two" maxlength="3" size="3" value="<?php echo set_value('sl_hdpe_per_two');?>" placeholder="%"></td>
										</tr>
									...
									<tr>
										...
										<td><select name="shoulder_foil_tag">
									...
									<tr>
										...
										<input type="text" name="sh_mb_supplier" class="supplier" size="60" value="<?php echo set_value('sh_mb_supplier');?>" placeholder="MB Supplier"></td>
									</tr>
									...
									<tr><td class="label"><b>&nbsp;</b></td><td class="label"><b>&nbsp;</b></td></tr>
										...
										<tr><td class="label"><b>Label Information</b></td></tr>


										<tr>
										<td class="label">Label  <span style="color:red;">*</span> :</td>
										<td><input type="text" name="label_article_no" id="label" size="60" value="<?php echo set_value('label_article_no');?>" /></td>
										</tr>
