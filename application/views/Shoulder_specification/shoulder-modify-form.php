...
<?php foreach($specification as $specification_row):?>
   ...
   $result_shoulder_hdpe_three=$this->shoulder_specification_model->select_details_record_where('specification_sheet_details',$this->session->userdata['logged_in']['company_id'],'spec_id',$specification_row->spec_id,'spec_version_no',$specification_row->spec_version_no,'srd_id','2_7_2','srd_id','asc');
	...
	foreach($result_shoulder_hdpe_three as $result_shoulder_hdpe_three_row){ $shoulder_hdpe_three=$result_shoulder_hdpe_three_row->mat_article_no; $shoulder_hdpe_three_per=$result_shoulder_hdpe_three_row->mat_info;}
	...
	?>
<form name="<?php echo $this->router->fetch_class();?>" action="<?php echo base_url('index.php/'.$this->router->fetch_class().'/update_shoulder');?>" method="POST" >
			...
			<tr>
				<td width="50%">
					<table class="form_table_inner">
								...
								<input type="hidden" name="spec_version_no"  value="<?php echo set_value('spec_version_no',$specification_row->spec_version_no);?>" />
									...
									<tr>
										<td class="label">Shoulder No <span style="color:red;">*</span> :</td>
									...
									<tr>
										...
										<td><input type="number" name="sh_hdpe_one_per" id="sh_hdpe_one_per" maxlength="3" size="3" min="0" max="100" step="1" value="<?php echo set_value('sh_hdpe_one_per',$shoulder_hdpe_one_per);?>" placeholder="%"></td>
										</tr>
										...
										<td>
										<input type="number" name="sh_hdpe_two_per" id="sh_hdpe_two_per" maxlength="3" size="3" min="0" max="100" step="1" value="<?php echo set_value('sh_hdpe_two_per',$shoulder_hdpe_two_per);?>" placeholder="%"></td>
										</tr>
										...
										<tr>
											...
											<td>
											<input type="number" name="sh_hdpe_three_per" id="sh_hdpe_three_per" maxlength="3" size="3" min="0" max="100" step="1" value="<?php echo set_value('sh_hdpe_three_per',$shoulder_hdpe_three_per);?>" placeholder="%"></td>
										</tr>
