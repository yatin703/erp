					...
					<table class="form_table_inner">
								...
								<tr>
									...
									<tr>
										...
										<td><input type="number" name="sh_hdpe_one_per" id="sh_hdpe_one_per" maxlength="3" size="3"  min="0" max="100" step="1" value="<?php echo set_value('sh_hdpe_one_per');?>" placeholder="%" ></td>
										</tr>
										...
										<td>
										<input type="number" name="sh_hdpe_two_per" id="sh_hdpe_two_per" maxlength="3" size="3" min="0" max="100" step="1" value="<?php echo set_value('sh_hdpe_two_per');?>" placeholder="%" ></td>
										</tr>
										...
										<tr>
											...
											<?php
											foreach ($hdpe as $hdpe_row) {
												echo "<option value='".$hdpe_row->article_no."' ".set_select('sh_hdpe_three',$hdpe_row->article_no).">".$hdpe_row->lang_article_description."</option>";
											}
											?>
											</select>
											...
											<td>
											<input type="number" name="sh_hdpe_three_per" id="sh_hdpe_three_per" maxlength="3" size="3" min="0" max="100" step="1" value="<?php echo set_value('sh_hdpe_three_per');?>" placeholder="%" ></td>
									   </tr>
