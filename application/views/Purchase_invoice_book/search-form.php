				...
				<td width="50%">
					<table class="form_table_inner">
									...
									<tr>
										...
										<td colspan="3"><input type="text" name="ap_invoice_no" id="ap_invoice_no" size="17" value="<?php echo set_value('ap_invoice_no');?>"/></td>
									</tr>									
									<tr>
										<td class="label">Supplier Invoice No  :</td>
										<td colspan="3"><input type="text" name="invoice_no" id="invoice_no" size="17" value="<?php echo set_value('invoice_no');?>"/></td>
									</tr>									
