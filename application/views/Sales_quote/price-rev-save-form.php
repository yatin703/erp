...
<script>
   ...
   $("#free_cost").blur(function(){
   	...
   	$("#_5k_r1_price").change(function() { 
   		
   		if($("#_5k_approved_contr").val() > $("#_5k_r1_price").val() ){
   			alert('value should be greater than HOD price');
   		}

   	});

   	$("#_10k_r1_price").change(function() { 
   		
   		if($("#_10k_approved_contr").val() > $("#_10k_r1_price").val() ){
   			alert('value should be greater than HOD price');
   		}

   	});

   	$("#_25k_r1_price").change(function() { 
   		
   		if($("#_25k_approved_contr").val() > $("#_25k_r1_price").val() ){
   			alert('value should be greater than HOD price');
   		}

   	});

   	$("#_50k_r1_price").change(function() { 
   		
   		if($("#_50k_approved_contr").val() > $("#_50k_r1_price").val() ){
   			alert('value should be greater than HOD price');
   		}

   	});

   	$("#_100k_r1_price").change(function() { 
   		
   		if($("#_100k_approved_contr").val() > $("#_100k_r1_price").val() ){
   			//alert('value should be greater than HOD price');
   		}

   	});

   	$("#_free_r1_price").change(function() { 
   		
   		if($("#_free_approved_contr").val() > $("#_free_r1_price").val() ){
   			alert('value should be greater than HOD price');
   		}
...
<form name="<?php echo $this->router->fetch_class();?>" action="<?php echo base_url('index.php/'.$this->router->fetch_class().'/price_revision_save');?>" method="POST" >
				...
				<td width="50%">
								...
								<fieldset>
									...
									<table class="form_table_inner">	
										<tr>
											...
											<td colspan="3">
												<input type="text" name="quotation_no" value="<?php echo $row->quotation_no;?>" readonly style="background-color: #ddd">
											</td>	
											<td class="label" width="20%">Version No <span style="color:red;">*</span> :</td>
											<td width="25%">

											<?php 
													$data['version']=$this->sales_quote_model->select_quote_verion_no_pts('sales_quote_master',$this->session->userdata['logged_in']['company_id'],'quotation_no',$row->quotation_no,'version_no',$row->version_no);
												...
												<input type="text" name="version_no" id="version_no" size="5" value="<?php echo set_value('version_no',$version_no);?>" readonly style="background-color: #ddd">								
										</tr>
										...
										<tr>
											...
											<td colspan="3">
												...
												<input type="hidden" name="transaction_no" value="<?php echo $this->uri->segment(4);?>" readonly>	
												<input type="hidden" name="quotation_no" value="<?php echo $row->quotation_no;?>" readonly>
												<input type="text"  readonly style="background-color: #ddd" name="customer" id="customer_category"  size="50" value="<?php echo set_value('category_name',$row->category_name.'//'.$row->customer_no.'');?>" /></td>
										...
										<tr>							
											...
											<!-- <td colspan="3"><input type="text"  name="pm_1" id="pm_1" value="<?php echo set_value('pm_1',$row->pm_1);?>" />
											 ...
											 <td colspan="3">
												...
												<select name="pm_1" id="pm_1" readonly="readonly">
										...
										<tr>							
											...
											<td colspan="3"> <input type="text" name="product_name"  size="50" value="<?php echo set_value('product_name',$row->product_name);?>" readonly style="background-color: #ddd" />
										...
										<tr>
											...
											<td colspan="3"><input type="text" readonly style="background-color: #ddd" name="credit_days" value="<?php echo set_value('credit_days',$row->credit_days	);?>" >
											</td>
									 	</tr>

									 	<tr>
											<td class="label">Date of Enquiry <span style="color:red;">*</span>  :</td>
											<td colspan="3"><input type="date" readonly style="background-color: #ddd" name="enquiry_date" value="<?php echo set_value('enquiry_date',$row->enquiry_date	);?>" >
											</td>
									 	</tr>
							...
							<td colspan="4">
								...
								<table class="form_table_inner">
									...
									<tr>
										...
										<td width="25%"><select readonly style="background-color: #ddd" name="sleeve_dia" id="sleeve_dia" ><option value=''>--Select Dia--</option>
										...
										<td width="25%"><input type="number" class="number1" readonly style="background-color: #ddd" name="sleeve_length" min="10"  max="500" step="0.1"  id="sleeve_length"  maxlength="5" value="<?php echo set_value('sleeve_length',$row->sleeve_length);?>" >
										</td>
									...
									<tr>
										...
										<td>
											<select readonly style="background-color: #ddd" name="layer" id="layer" >
									...
									<tr>
										...
										<td colspan="3"><input type="text" readonly style="background-color: #ddd" name="tube_color" id="tube_color"value="<?php echo set_value('tube_color',$row->tube_color);?>"><a href="<?php echo base_url('index.php/color_master');?>" target="_blank"><i class="edit icon"></i></a>
										</td>
									</tr>
									...
									<tr>
										...
										<td>
											<select readonly style="background-color: #ddd" name="tube_lacquer" id="tube_lacquer" >
									...
									<tr>
										...
										<td>
											<select readonly style="background-color: #ddd" name="print_type" id="print_type" >
									...
									<tr>
										...
										<td>  
											<select readonly style="background-color: #ddd" name="special_ink" id="special_ink" >
							...
							<td colspan="4">
								...
								<table class="form_table_inner">
									...
									<tr>
										...
										<td><select readonly style="background-color: #ddd" name="shoulder" id="shoulder"><option value=''>--Select Shoulder--</option>
									...
									<tr>
										...
										<td colspan="3"><select readonly style="background-color: #ddd" name="shoulder_orifice" id="shoulder_orifice"><option value=''>--Select Orifice--</option>
									...
									<tr>
										...
										<td colspan="3"><input type="text" readonly style="background-color: #ddd" name="shoulder_color" id="shoulder_color" value="<?php echo set_value('shoulder_color',$row->shoulder_color);?>" >
										</td>
									</tr>
								</table>
								</fieldset>
								...
								<table class="form_table_inner">
									...
									<tr>
										...
										<td>
											...
											<select readonly style="background-color: #ddd" name="cap_type" id="cap_type" ><option value=''>--Select Cap Type--</option>
									...
									<tr>
										...
										<td>
											...
											<select readonly style="background-color: #ddd" name="cap_finish" id="cap_finish" >
									...
									<tr>
										...
										<td><select readonly style="background-color: #ddd" name="cap_dia" id="cap_dia"><option value=''>--Select Cap Dia--</option>
									...
									<tr>
										...
										<td><select readonly style="background-color: #ddd" name="cap_orifice" id="cap_orifice">
									...
									<tr>
										...
										<td colspan="3"><input type="text" readonly style="background-color: #ddd" name="cap_color" id="cap_color" value="<?php echo set_value('cap_color',$row->cap_color);?>" >
										</td>
									</tr>
							...
							<td colspan="4">
								...
								<table class="form_table_inner">
									...
									<tr>
										...
										<td colspan="3">
											<select readonly style="background-color: #ddd" name="tube_foil" id="tube_foil" >
									...
									<tr>
										...
										<td colspan="3">
											<select readonly style="background-color: #ddd" name="shoulder_foil" id="shoulder_foil" >
												<option value="">--Select Tube Foil--</option>
									...
									<tr>
										...
										<td>
											<select readonly style="background-color: #ddd" name="cap_shrink_sleeve" id="cap_shrink_sleeve" >
                    ...
                    Finish : <select name="cap_metalization_finish" id="cap_metalization_finish">
                      ...
                      <option value="MATT" "'.set_select('cap_metalization_finish', 'MATT').'">MATT</option>
							...
							<tr>
								<td class="label">Cap Metalization :</td>
								<td><input type="checkbox" readonly style="background-color: #ddd" name="cap_metalization" id="cap_metalization" value="YES" <?php echo set_checkbox('cap_metalization','YES');?> <?php echo ($row->cap_metalization=='YES' ? 'value="YES" checked' : 'value="NO"');?> /></td>
							</tr>
                      ...
                      <option value='COCO BROWN' <?php echo  set_select('cap_metalization_color', 'COCO BROWN'); ?><?php echo($row->cap_metalization_color=='COCO BROWN'?"selected":"");?>>COCO BROWN</option>
		                    ...
		                    ?>
			                    ...
			                    <input type="number" min="0" max="20" step="any"  name="cap_foil_dist_frm_bottom" id="cap_foil_dist_frm_bottom" size="3" maxlength="3" value="'.set_value('cap_foil_dist_frm_bottom').'">
										...
										<tr>
											<td class="label">Cap Foil :</td>
											<td><input type="checkbox" readonly style="background-color: #ddd" name="cap_foil" id="cap_foil" value="YES" <?php echo set_checkbox('cap_foil','YES');?> <?php echo ($row->cap_foil=='YES' ? 'value="YES" checked' : 'value="NO"');?>/></td>
										</tr>
							...
							<td colspan="4">
								...
								<fieldset>
									...
									<tr>
										...
										<td colspan="3"><input type="text" readonly style="background-color: #ddd" name="freight" id="freight"  value="<?php echo set_value('freight',$row->freight);?>" />
										</td>
									</tr>									
									</table>
								</fieldset>
							...
							<td colspan="5" width="100%">
								...
								<table class="form_table_inner">
									...
									<tr>
										...
										<td width="10%">
											<select name="machine_type" id="machine_type" readonly>
										...
										<td width="3%">
										<input type="text" readonly="readonly" name="capacity" id="capacity"  size="4" value="<?php echo set_value('capacity',$row->machine_capacity_without_changeover);?>"  /> 
										</td>
										<td width="10%">&nbsp;&nbsp;&nbsp;&nbsp;
										...
										<td width="10%">&nbsp;&nbsp;&nbsp;&nbsp;
										<input type="text" readonly="readonly" name="job_changeover" id="job_changeover"  size="4" value="<?php echo set_value('job_changeover',$row->job_changeover_time);?>"  />
										</td>
										<td width="10%">&nbsp;&nbsp;&nbsp;&nbsp;
									...
									<tr>
										...
										<th width="10%">
											<?php 
												...
												echo "R".$this->uri->segment(4)." Price";
											?> 
									...
									<tr>
										...
										<td><input type="text" readonly="readonly" style="background-color: #ddd" class="number1" name="_5k_waste" id="_5k_waste"   value="<?php echo set_value('_5k_waste',$row->_5k_waste);?>"  size="4"/></td>
										...
										<td ><input type="text" readonly="readonly" style="background-color: #ddd" class="number1" name="_5k_approved_contr" id="_5k_approved_contr"   value="<?php echo set_value('_5k_approved_contr',$row->_5k_approval_authority_contr);?>"  />
										</td>
										<td ><input type="text" class="number1" name="_5k_r1_price" id="_5k_r1_price"   value="<?php echo set_value('_5k_r1_price',$row->_5k_rev_price);?>"  />
										</td>
									...
									<tr>
										...
										<td><input type="text" readonly="readonly" style="background-color: #ddd" class="number1" name="_10k_waste" id="_10k_waste"  value="<?php echo set_value('_10k_waste',$row->_10k_waste);?>"  /></td>
										...
										<td ><input type="text" readonly="readonly" style="background-color: #ddd"  class="number1" name="_10k_approved_contr" id="_10k_approved_contr"   value="<?php echo set_value('_10k_approved_contr',$row->_10k_approval_authority_contr);?>"  />
										</td>
										<td ><input type="text" class="number1" name="_10k_r1_price" id="_10k_r1_price"   value="<?php echo set_value('_10k_r1_price',$row->_10k_rev_price);?>"  />
										</td>
									</tr>
									<tr>
										...
										<td><input type="text" readonly="readonly" style="background-color: #ddd" class="number1" name="_25k_waste" id="_25k_waste"   value="<?php echo set_value('_25k_waste',$row->_25k_waste);?>"  /></td>
										...
										<td ><input type="text" readonly="readonly" style="background-color: #ddd" class="number1" name="_25k_approved_contr" id="_25k_approved_contr"   value="<?php echo set_value('_25k_approved_contr',$row->_25k_approval_authority_contr);?>"  />
										</td>
										<td ><input type="text" class="number1" name="_25k_r1_price" id="_25k_r1_price"   value="<?php echo set_value('_25k_r1_price',$row->_25k_rev_price);?>"  />
										</td>
									</tr>
									<tr>
										...
										<td><input type="text" readonly="readonly" style="background-color: #ddd" class="number1" name="_50k_waste" id="_50k_waste"   value="<?php echo set_value('_50k_waste',$row->_50k_waste);?>"  /></td>										
										...
										<td ><input type="text" readonly="readonly"	style="background-color: #ddd" class="number1" name="_50k_approved_contr" id="_50k_approved_contr"   value="<?php echo set_value('_50k_approved_contr',$row->_50k_approval_authority_contr);?>"  />
										</td>
										<td ><input type="text" class="number1" name="_50k_r1_price" id="_50k_r1_price"   value="<?php echo set_value('_50k_r1_price',$row->_50k_rev_price);?>"  />
										</td>
									</tr>
									<tr>
										...
										<td><input type="text" readonly="readonly" style="background-color: #ddd" class="number1" name="_100k_waste" id="_100k_waste"   value="<?php echo set_value('_100k_waste',$row->_100k_waste);?>"  /></td>
										...
										<td ><input type="text" readonly="readonly" style="background-color: #ddd" class="number1" name="_100k_approved_contr" id="_100k_approved_contr"   value="<?php echo set_value('_100k_approved_contr',$row->_100k_approval_authority_contr);?>"  />
										</td>
										<td ><input type="text" class="number1" name="_100k_r1_price" id="_100k_r1_price"   value="<?php echo set_value('_100k_r1_price',$row->_100k_rev_price);?>"  />
										</td>
									</tr>
									<tr>
										...
										<td><input type="text" readonly="readonly" class="number1" style="background-color: #ddd" name="_free_quantity_waste" id="_free_quantity_waste"   value="<?php echo set_value('_free_quantity_waste',$row->_free_quantity_waste);?>"  /></td>
										...
										<td ><input type="text" readonly="readonly" style="background-color: #ddd" class="number1" name="_free_approved_contr" id="_free_approved_contr"   value="<?php echo set_value('_free_approved_contr',$row->_free_approval_authority_contr);?>"  />
										</td>
										<td ><input type="text"  class="number1" name="_free_r1_price" id="_free_r1_price"   value="<?php echo set_value('_free_r1_price',$row->_free_rev_price);?>"  />
										</td>
									</tr>
  ...
  <div class="modal-content" style="width:600px;">
	...
	<div class="form_design">
		<div class="ui buttons">
	  		...
	  		<div class="or"></div>
	  		<button class="ui positive button" onClick="return confirm('Are you sure to update Record?');">Save</button>
		</div>
	</div>	
</form>
