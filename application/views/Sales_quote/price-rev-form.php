...
<script>
   ...
   $("#free_cost").blur(function(){
   	...
   	$("#_5k_r1_price").change(function() { 
   		...
   		if(parseFloat($("#_5k_approved_contr").val()) > parseFloat($("#_5k_r1_price").val()) ){
...
<form name="<?php echo $this->router->fetch_class();?>" action="<?php echo base_url('index.php/'.$this->router->fetch_class().'/price_revision_update');?>" method="POST" >
								...
								<fieldset>
									...
									<table class="form_table_inner">	
										<tr>
											...
											<td colspan="3">
												<input type="text" name="quotation_no" value="<?php echo $row->quotation_no;?>" readonly disabled>
											</td>	
							...
							<td colspan="5" width="100%">
								...
								<table class="form_table_inner">
									...
									<tr>
										...
										<td width="10%">
											<select name="machine_type" id="machine_type" disabled>
