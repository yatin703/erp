...
<script>
	...
	$(document).ready(function(){
		...
		<?php if($this->input->post('layer')==1){?>
							//$('.layer_link').css('display','inline');
		<?php }?>
  ...
  //  
   ...
   // $('.ui.modal').modal();
    ...
    var offset_consumable_view;
    var screen_flexo_consumable_view;
    var spring_consumable_view ;
		<?php  if(!empty($this->input->post('offset_consumable_view')) || (!empty($this->input->post('screen_flexo_consumable_view'))) || (!empty($this->input->post('spring_consumable_view'))) ) {  ?>
 ...
 //---------------------------Shoulder POPUP BOX
  ...
  //---------------------------Lacquer Popup
    ...
    var cap_metalization_rate;
		<?php  if(!empty($this->input->post('cap_metalization_cost_view'))) {  ?>
    ...
    var cap_foil_rate;
		<?php  if(!empty($this->input->post('cap_foil_cost_view'))) {  ?>
    ...
    var cap_shrink_sleeve_cost;
		<?php  if(!empty($this->input->post('cap_shrink_sleeve_cost_view'))) {  ?>
    ...
    var shoulder_foil_cost;
		<?php  if(!empty($this->input->post('shoulder_foil_cost_view'))) {  ?>
   ...
   // Tube foil calculator
    ...
    $("#hot_foil_1").change(function(event) {
  	...
  	var total_tube_foil_cost;
		<?php  if(!empty($this->input->post('tube_foil_cost_view'))) {  ?>
   ...
   var label_cost;
		<?php  if(!empty($this->input->post('label_cost_view'))) {  ?>
   ...
   var special_ink_cost_per_tube;
	 <?php  if(!empty($this->input->post('special_ink_cost_view'))) {  ?>
   ...
   //---------Offset Calculator
    ...
    $("#offset_rm_month").change(function(event) {
  	...
  	var offset_ink_cost_per_tube;
    <?php  if(!empty($this->input->post('offset_cost_view'))) {  ?>
    ...
    $("#screen_rm_month").change(function(event) {
  	...
  	var total_screen_flexo_ink_cost;
		<?php  if(!empty($this->input->post('screen_flexo_cost_view'))) {  ?>
 ...
 //----------------------screen Plate  
    ...
    $("#screen_film_cost").click(function(event) {
  ...
  //----------------------Flexo Plate  
    ...
    $("#flexo_plate_cost").click(function(event) {
...
//----------------------cap calculator
    ...
    $("#cap_dia").change(function(event) {
  	...
  	var total_cap_weight_cost;
		<?php  if(!empty($this->input->post('cap_cost_view'))) {  ?>
...
//------------------------Layer 1 Check button---------------
		var sleeve_cost;
		<?php  if(!empty($this->input->post('sleeve_cost_view'))) {  ?>
...
//-------------------------------------LAYER 3 RM -----------------------
		...
		$("#layer3_layer_1_rm_4_code").change(function(event) {
		...
		$("#layer3_layer_3_rm_10_code").change(function(event) {
		...
		$("#layer3_sleevecost").click(function(event) {
			...
			alert("Please correct MB  % Deatils ");	
				...
				//alert(parseFloat($('#layer3_layer1_micron').val()));
...
//-------------------------------------LAYER 5 RM -----------------------
		...
		$("#layer5_layer_1_rm_4_code").change(function(event) {
		...
		$("#layer5_layer_5_rm_12_code").change(function(event) {
...
//-------------------------------------LAYER 7 RM -----------------------
		...
		$("#layer7_layer_2_rm_7_code").change(function(event) {
		...
		$("#layer7_layer_6_rm_15_code").change(function(event) {
   ...
   $("#sh_hdpe_two").change(function(event) {
	...
	//--------------------------Shoulder calculator--------------------
	var shoulder_cost;
	<?php  if(!empty($this->input->post('shoulder_cost_view'))) {  ?>
	...
	$("#shouldercost").click(function(event) {
     ...
     //-------------- Total Final cost addition
		...
		/*var sleeve_cost_view = $('#sleeve_cost_view').html(sleeve_cost.toFixed(2)) ;
   		...
   		//alert(screen_flexo_consumable_view);
   		...
   		var total_stores_cost_per_tube=0;
			...
			total_cost_per_tube = sleeve_cost_view + total_lacquer_cost + offset_ink_cost_per_tube + total_screen_flexo_ink_cost+  label_cost + special_ink_cost_per_tube + shoulder_cost + total_cap_weight_cost + total_tube_foil_cost + shoulder_foil_cost + cap_shrink_sleeve_cost + cap_metalization_rate + cap_foil_rate + screen_flexo_consumable_view + offset_consumable_view + spring_consumable_view+hygenic_consumable_view +other_consumable_view + offset_plate_cost_per_tube + screen_film_cost_per_tube + flexo_plate_cost_per_tube+ total_box_rate+ liner_gm_per_tube + customer_flag + other_packing_material + packing_stickers + packing_corrugated_sheet + packing_shrink_flim + stores_spares_local_view+ stores_spares_import_view;
		//alert(total_cost_per_tube);
			...
			//----total of RM
			total_rm_cost_per_tube = sleeve_cost_view + shoulder_cost + total_cap_weight_cost + total_lacquer_cost + total_tube_foil_cost + offset_ink_cost_per_tube + total_screen_flexo_ink_cost+ special_ink_cost_per_tube + label_cost + shoulder_foil_cost + cap_shrink_sleeve_cost + cap_metalization_rate + cap_foil_rate  ;	
			...
			//----total of Packing
			total_packing_cost_per_tube =  total_box_rate+ liner_gm_per_tube + customer_flag + other_packing_material + packing_stickers + packing_corrugated_sheet + packing_shrink_flim ;
							...
							<td colspan="5" width="100%">
								...
								<table class="form_table_inner">
									...
									<tr>
										...
										<?php if($machine_type==FALSE){
											...
											foreach($machine_type as $machine_type_row){
												echo "<option value='".$machine_type_row->machine_id."'  ".set_select('machine_type',''.$machine_type_row->machine_name.'').">".$machine_type_row->machine_name."</option>";
												}
											}?>
											</select>
											</td>
										<td width="10%">
												<input type="text" readonly="readonly" name="capacity" id="capacity"  size="10" value="<?php echo set_value('capacity');?>"  /> 
										</td>
										<td width="10%"><input type="text" readonly="readonly" name="running_speed" id="running_speed"  size="4" value="<?php echo set_value('running_speed');?>"  />
										</td>
										<td width="10%"><input type="text" readonly="readonly" name="running_speed_90" id="running_speed_90"  size="4" value="<?php echo set_value('running_speed_90');?>"  />
										</td>
										<td width="10%"><input type="text" readonly="readonly" name="job_changeover" id="job_changeover"  size="4" value="<?php echo set_value('job_changeover');?>"  />
										</td>
										<td width="10%"><input type="text" readonly="readonly" name="min_contribution" id="min_contribution" size="4" value="<?php echo set_value('min_contribution');?>"  />
										</td>
									...
									<tr>
										...
										<th width="10%">Target Contr.</th><th width="10%">Quoted Contr.</th><th width="10%">Cost</th>	<th width="10%">Quoted Price</th>
									</tr>
									<tr>
										...
										<td><input type="text" readonly="readonly" class="number1" name="_5k_waste" id="_5k_waste"   value="<?php echo set_value('_5k_waste','50');?>"  size="4"/></td>
										<td ><input type="text" class="number1" name="_5k_target_contr" id="_5k_target_contr"   value="<?php echo set_value('_5k_target_contr');?>"  />
										</td>
										<td ><input type="text" class="number1" name="_5k_quoted_contr" id="_5k_quoted_contr"  value="<?php echo set_value('_5k_quoted_contr');?>"  size="4"/>
										</td>
										<td ><input readonly="readonly" type="text" class="number1 _5k_quote_cost" name="_5k_cost" id="_5k_cost"  value="<?php echo set_value('_5k_cost');?>" size="4"/>
										</td>
										<td > <input type="text" class="number1" name="_5k_quoted_price" id="_5k_quoted_price"  value="<?php echo set_value('_5k_quoted_price');?>" size="4"/>
										</td>
									</tr>
									<tr>
										...
										<td><input type="text" readonly="readonly" class="number1" name="_10k_waste" id="_10k_waste"  value="<?php echo set_value('_10k_waste','50');?>"  /></td>
										<td><input type="text" class="number1" name="_10k_target_contr" id="_10k_target_contr"  value="<?php echo set_value('_10k_target_contr');?>" />
										</td>
										<td><input type="text" class="number1" name="_10k_quoted_contr" id="_10k_quoted_contr"  value="<?php echo set_value('_10k_quoted_contr');?>" />
										</td>
										<td><input readonly="readonly" type="text" class="number1 _10k_quote_cost" name="_10k_cost"  id="_10k_cost"   value="<?php echo set_value('_10k_cost');?>"  />
										</td>
										<td><input type="text" class="number1" name="_10k_quoted_price" id="_10k_quoted_price" value="<?php echo set_value('_10k_quoted_price');?>" />
										</td>
									</tr>
									<tr>
										...
										<td><input type="text" readonly="readonly" class="number1" name="_25k_waste" id="_25k_waste"   value="<?php echo set_value('_25k_waste','40');?>"  /></td>
										<td><input type="text" class="number1" name="_25k_target_contr" id="_25k_target_contr"  value="<?php echo set_value('_25k_target_contr');?>" />
										</td>
										<td><input type="text" class="number1" name="_25k_quoted_contr" id="_25k_quoted_contr"  value="<?php echo set_value('_25k_quoted_contr');?>" />
										</td>
										<td><input readonly="readonly" type="text" class="number1 _25k_quote_cost" name="_25k_cost" id="_25k_cost"  value="<?php echo set_value('_25k_cost');?>" />
										</td>
										<td><input type="text" class="number1" name="_25k_quoted_price" id="_25k_quoted_price"  value="<?php echo set_value('_25k_quoted_price');?>" />
										</td>
									</tr>
									<tr>
										...
										<td><input type="text" readonly="readonly" class="number1" name="_50k_waste" id="_50k_waste"   value="<?php echo set_value('_50k_waste','30');?>"  /></td>										
										<td><input type="text" class="number1" name="_50k_target_contr" id="_50k_target_contr"  value="<?php echo set_value('_50k_target_contr');?>" />
										</td>
										<td><input type="text" class="number1" name="_50k_quoted_contr" id="_50k_quoted_contr"  value="<?php echo set_value('_50k_quoted_contr');?>" />
										</td>
										<td><input readonly="readonly" type="text" class="number1 _50k_quote_cost" name="_50k_cost" id="_50k_cost"  value="<?php echo set_value('_50k_cost');?>"  />
										</td>
										<td><input type="text" class="number1" name="_50k_quoted_price" id="_50k_quoted_price"  value="<?php echo set_value('_50k_quoted_price');?>" />
										</td>
									</tr>
									<tr>
										...
										<td><input type="text" readonly="readonly" class="number1" name="_100k_waste" id="_100k_waste"   value="<?php echo set_value('_100k_waste','20');?>"  /></td>
										...
										<td><input type="text" class="number1" name="_100k_quoted_contr" id="_100k_quoted_contr"  value="<?php echo set_value('_100k_quoted_contr');?>" />
										</td>
										<td><input readonly="readonly" type="text" class="number1 _100k_quote_cost" name="_100k_cost" id="_100k_cost"  value="<?php echo set_value('_100k_cost');?>"  />
										</td>
										<td><input type="text" class="number1" name="_100k_quoted_price" id="_100k_quoted_price" value="<?php echo set_value('_100k_quoted_price');?>" />
										</td>
									</tr>
									<tr>
										...
										<td><input type="text" class="number1" name="_free_quantity_waste" id="_free_quantity_waste"   value="<?php echo set_value('_free_quantity_waste');?>"  /></td>
										<td><input type="text" class="number1" name="free_target_contr" id="free_target_contr"  value="<?php echo set_value('free_target_contr');?>"  />
										</td>
										<td><input type="text" class="number1" name="free_quoted_contr" id="free_quoted_contr"  value="<?php echo set_value('free_quoted_contr');?>" />
										</td>
										<td><input readonly="readonly" type="text" class="number1 _free_quantity_quote_cost" name="free_cost" id="free_cost"  value="<?php echo set_value('free_cost');?>" />
										</td>
										<td><input type="text" class="number1" name="free_quoted_price" id="free_quoted_price"  value="<?php echo set_value('free_quoted_price');?>"  />
										</td>
									</tr>
						...
						<tr>
							<td>
								...
								<tbody>
									<tr>
										<td>Tube </td>
										<td><input type="text" readonly="readonly" id="sleeve_cost_view" name="sleeve_cost_view" value="<?php echo set_value('sleeve_cost_view');?>" size="5"></td>
										<td>Screen Flexo </td>
										<td><input type="text" readonly="readonly" id="screen_flexo_consumable_view" name="screen_flexo_consumable_view" value="<?php echo set_value('screen_flexo_consumable_view');?>" size="5"></td>
										<td>Packing Box</td>
										<td><input type="text" readonly="readonly" id="packing_box_view" name="packing_box_view" value="<?php echo set_value('packing_box_view');?>" size="5"></td>
										<td>Local </td>
										<td id="">
										<?php
									...
									<tr>
										<td>Shoulder</td>
										<td><input type="text" readonly="readonly" id="shoulder_cost_view" name="shoulder_cost_view" value="<?php echo set_value('shoulder_cost_view');?>" size="5"></td>
										<td >Offset </td>
										<td><input type="text" readonly="readonly" id="offset_consumable_view" name="offset_consumable_view" value="<?php echo set_value('offset_consumable_view');?>" size="5"></td>
										<td>Liners</td>
										<td><input type="text" readonly="readonly" id="liners_view" name="liners_view" value="<?php echo set_value('liners_view');?>" size="5"></td>
										<td> Import</td>
										<td id="">
										<?php
									...
									<tr>
										<td>Cap </td>
										<td><input type="text" readonly="readonly" id="cap_cost_view" name="cap_cost_view" value="<?php echo set_value('cap_cost_view');?>" size="5"></td>
										<td>Decoseam </td>
										<td><input type="text" readonly="readonly" id="spring_consumable_view" name="spring_consumable_view" value="<?php echo set_value('spring_consumable_view');?>" size="5"></td>
									...
									<tr><td>Lacquer </td>
										<td><input type="text" readonly="readonly" id="lacquer_cost_view" name="lacquer_cost_view" value="<?php echo set_value('lacquer_cost_view');?>" size="5"></td>										
									...
									<tr>
										<td>Tube Foil</td>
										<td><input type="text" readonly="readonly" id="tube_foil_cost_view" name="tube_foil_cost_view" value="<?php echo set_value('tube_foil_cost_view');?>" size="5"></td>
									...
									<tr>
										<td>Offset Ink </td>
										<td><input type="text" readonly="readonly" id="offset_cost_view" name="offset_cost_view" value="<?php echo set_value('offset_cost_view');?>" size="5"></td>
										<td>Offset Plate</td>
										<td><input type="text" readonly="readonly" id="offset_plate_cost_view" name="offset_plate_cost_view" value="<?php echo set_value('offset_plate_cost_view');?>" size="5"></td>
										<td>Bopp Tape </td>
										<td id="">
										<?php
									...
									<tr>
										...
										<td><input type="text" readonly="readonly" id="screen_flexo_cost_view" name="screen_flexo_cost_view" value="<?php echo set_value('screen_flexo_cost_view');?>" size="5"></td>
										<td>Screen +ve Film</td>
										<td><input type="text" readonly="readonly" id="screen_plate_cost_view" name="screen_plate_cost_view" value="<?php echo set_value('screen_plate_cost_view');?>" size="5"></td>
										<td>Stickers </td>
										<td>
										<?php
									...
									<tr>
										<td>Special Ink </td>
										<td><input type="text" readonly="readonly" id="special_ink_cost_view" name="special_ink_cost_view" value="<?php echo set_value('special_ink_cost_view');?>" size="5"></td>
										<td>Flexo Plate</td>
										<td><input type="text" readonly="readonly" id="flexo_plate_cost_view" name="flexo_plate_cost_view" value="<?php echo set_value('flexo_plate_cost_view');?>" size="5"></td>
									...
									<tr>
										<td>Label </td>
										<td><input type="text" readonly="readonly" id="label_cost_view" name="label_cost_view" value="<?php echo set_value('label_cost_view');?>" size="5"></td>
										<td></td>
										<td><span id=""></span></td>
									</tr>
									...
									<tr>
										<td>Shoulder Foil </td>
										<td><input type="text" readonly="readonly" id="shoulder_foil_cost_view" name="shoulder_foil_cost_view" value="<?php echo set_value('shoulder_foil_cost_view');?>" size="5"></td>
										<td></td>
										<td><span id=""></span></td>
									</tr>
									...
									<tr>
										<td>Shrink Sleeve </td>
										<td><input type="text" readonly="readonly" id="cap_shrink_sleeve_cost_view" name="cap_shrink_sleeve_cost_view" value="<?php echo set_value('cap_shrink_sleeve_cost_view');?>" size="5"></td>
										<td></td>
										<td><span id=""></span></td>
									</tr>
									...
									<tr>
										<td>Metalization </td>
										<td><input type="text" readonly="readonly" id="cap_metalization_cost_view" name="cap_metalization_cost_view" value="<?php echo set_value('cap_metalization_cost_view');?>" size="5"></td>
										<td></td>
										<td><span id=""></span></td>
									</tr>
									...
									<tr>
										<td>Cap foil </td>
										<td><input type="text" readonly="readonly" id="cap_foil_cost_view" name="cap_foil_cost_view" value="<?php echo set_value('cap_foil_cost_view');?>" size="5"></td>
										<td></td>
										<td><span id=""></span></td>
									</tr>
									...
									<tr class="active">
										...
										<td><b>Waste % </b></td>
										<td> <input type="text" readonly="readonly" name="waste_perc" id="waste_perc" size="5" placeholder="%" value="<?php echo set_value('waste_perc','0');?>" /></td>
										<td><b> Total Including waste </b></td>
										<td><input type="text" readonly="readonly" id="waste_total_cost_per_tube" name="waste_total_cost_per_tube" value="<?php echo set_value('waste_total_cost_per_tube');?>" size="5"></td>
										<td> </td>
										<td> <span id=""></span></td>
									</tr>
  ...
  <div class="modal-content" style="height:700px;overflow-y: scroll;">
    ...
    <tbody>
      <tr> 
        ...
        <td><input type="text" readonly="readonly" id="layer7_layer1_ldpe_rate" name="layer_7_rm_1_rate" value="<?php echo set_value('layer_7_rm_1_rate');?>" size="5"></td>
        <td rowspan="3"><input type="text" style="width: 7em;" name="layer_7_layer_1_micron" id="layer7_layer1_micron" value="<?php echo set_value('layer_7_layer_1_micron');?>"  />
        </td>
        <td><input type="number" name="layer_7_rm_1_percentage" id="layer7_layer1_ld_percentage" placeholder="%" value="<?php echo set_value('layer_7_rm_1_percentage','50');?>" />
        </td>     
      </tr>
      <tr>  
        ...
        <td><input type="text" readonly="readonly" id="layer7_layer1_lldpe_rate" name="layer_7_rm_2_rate" value="<?php echo set_value('layer_7_rm_2_rate');?>" size="5"></td>    
        <td ><input type="number" size="3" name="layer_7_rm_2_percentage" id="layer7_layer1_lld_percentage" placeholder="%"  value="<?php echo set_value('layer_7_rm_2_percentage','50');?>" />
      ...
      <tr>
        ...
        <td><input type="text" readonly="readonly" id="layer7_layer1_hdpe_rate" name="layer_7_rm_3_rate" value="<?php echo set_value('layer_7_rm_3_rate');?>" size="5"></td> 
        <td ><input type="number" size="3" name="layer_7_rm_3_percentage" id="layer7_layer1_hd_percentage" placeholder="%"  value="<?php echo set_value('layer_7_rm_3_percentage','0');?>" />
      ...
      <tr>
        ...
        <td><input type="text" readonly="readonly" id="layer7_layer2_ldpe_rate" name="layer_7_rm_4_rate" value="<?php echo set_value('layer_7_rm_4_rate');?>" size="5"></td>
        ...
        <td><input type="number" name="layer_7_rm_4_percentage" id="layer7_layer2_ld_percentage" placeholder="%" value="<?php echo set_value('layer_7_rm_4_percentage','0');?>" />
        </td>     
      </tr>
      <tr>      
        ...
        <td><input type="text" readonly="readonly" id="layer7_layer2_lldpe_rate" name="layer_7_rm_5_rate" value="<?php echo set_value('layer_7_rm_5_rate');?>" size="5"></td>    
        <td ><input type="number" size="3" name="layer_7_rm_5_percentage" id="layer7_layer2_lld_percentage" placeholder="%" value="<?php echo set_value('layer_7_rm_5_percentage','50');?>" />
      ...
      <tr>
        ...
        <td><input type="text" readonly="readonly" id="layer7_layer2_hdpe_rate" name="layer_7_rm_6_rate" value="<?php echo set_value('layer_7_rm_6_rate');?>" size="5"></td> 
        <td ><input type="number" size="3" name="layer_7_rm_6_percentage" id="layer7_layer2_hd_percentage" placeholder="%" value="<?php echo set_value('layer_7_rm_6_percentage','50');?>" />
      ...
      <tr>
				...
				<td> MB : <select name="layer_7_rm_7_code" id="layer7_layer_2_rm_7_code" ><option value=''>--Select MB--</option>
				...
				<td><input type="text" readonly="readonly" id="layer7_layer_2_rm_7_rate" name="layer_7_rm_7_rate" value="<?php echo set_value('layer_7_rm_7_rate');?>" size="5"></td>	
				<td ><input type="number" size="3" name="layer_7_rm_7_percentage" id="layer7_layer_2_rm_7_percentage" placeholder="%" value="<?php echo set_value('layer_7_rm_7_percentage','0');?>" />
			...
			<tr>
				...
				<td ><input type="number" size="3" name="layer_7_rm_8_percentage" id="layer7_layer_2_rm_8_percentage" placeholder="%" value="<?php echo set_value('layer_7_rm_8_percentage','0');?>" />
      ...
      <tr>
        ...
        <td><input type="text" readonly="readonly" id="layer7_layer3_admer_rate" name="layer_7_rm_9_rate" value="<?php echo set_value('layer_7_rm_9_rate');?>" size="5"></td>
        ...
        <td><input type="number" name="layer_7_rm_9_percentage" id="layer7_layer3_admer_percentage" placeholder="%" value="<?php echo set_value('layer_7_rm_9_percentage','100');?>" />
        </td>     
      </tr>
      ...
      <tr>
        ...
        <td><input type="text" readonly="readonly" id="layer7_layer4_evoh_rate" name="layer_7_rm_10_rate" value="<?php echo set_value('layer_7_rm_10_rate');?>" size="5"></td>
        ...
        <td><input type="number" name="layer_7_rm_10_percentage" id="layer7_layer4_evoh_percentage" placeholder="%" value="<?php echo set_value('layer_7_rm_10_percentage','100');?>" />
        </td>     
      </tr>
      ...
      <tr>
        ...
        <td><input type="text" readonly="readonly" id="layer7_layer5_admer_rate" name="layer_7_rm_11_rate" value="<?php echo set_value('layer_7_rm_11_rate');?>" size="5"></td>
        ...
        <td><input type="number" name="layer_7_rm_11_percentage" id="layer7_layer5_admer_percentage" placeholder="%" value="<?php echo set_value('layer_7_rm_11_percentage','100');?>" />
        </td>     
      </tr>
      ...
      <tr>
        ...
        <td><input type="text" readonly="readonly" id="layer7_layer6_ldpe_rate" name="layer_7_rm_12_rate" value="<?php echo set_value('layer_7_rm_12_rate');?>" size="5"></td>
        ...
        <td><input type="number" name="layer_7_rm_12_percentage" id="layer7_layer6_ld_percentage" placeholder="%" value="<?php echo set_value('layer_7_rm_12_percentage','0');?>" />
        </td>     
      </tr>
      <tr>  
        ...
        <td><input type="text" readonly="readonly" id="layer7_layer6_lldpe_rate" name="layer_7_rm_13_rate" value="<?php echo set_value('layer_7_rm_13_rate');?>" size="5"></td>    
        <td ><input type="number" size="3" name="layer_7_rm_13_percentage" id="layer7_layer6_lld_percentage" placeholder="%" value="<?php echo set_value('layer_7_rm_13_percentage','50');?>" />
      ...
      <tr>
        ...
        <td><input type="text" readonly="readonly" id="layer7_layer6_hdpe_rate" name="layer_7_rm_14_rate" value="<?php echo set_value('layer_7_rm_14_rate');?>" size="5"></td> 
        <td ><input type="number" size="3" name="layer_7_rm_14_percentage" id="layer7_layer6_hd_percentage" placeholder="%" value="<?php echo set_value('layer_7_rm_14_percentage','50');?>" />
      ...
      <tr>
				...
				<td> MB : <select name="layer_7_rm_15_code" id="layer7_layer_6_rm_15_code" ><option value=''>--Select MB--</option>
										<?php foreach ($masterbatch as $masterbatch_row) {
				...
				<td><input type="text" readonly="readonly" id="layer7_layer_6_rm_15_rate" name="layer_7_rm_15_rate" value="<?php echo set_value('layer_7_rm_15_rate');?>" size="5"></td>	
				<td ><input type="number" size="3" name="layer_7_rm_15_percentage" id="layer7_layer_6_rm_15_percentage" placeholder="%" value="<?php echo set_value('layer_7_rm_15_percentage','0');?>" />
			...
			<tr>
				...
				<td ><input type="number" size="3" name="layer_7_rm_16_percentage" id="layer7_layer_6_rm_16_percentage" placeholder="%" value="<?php echo set_value('layer_7_rm_16_percentage','0');?>" />
      ...
      <tr>
        ...
        <td><input type="text" readonly="readonly" id="layer7_layer7_ldpe_rate" name="layer_7_rm_17_rate" value="<?php echo set_value('layer_7_rm_17_rate');?>" size="5"></td>
        <td rowspan="3"><input type="text" style="width: 7em;" name="layer_7_layer_17_micron" id="layer7_layer7_micron" class="number3" value="<?php echo set_value('layer_7_layer_17_micron');?>"  />
        </td>
        <td><input type="number" name="layer_7_rm_17_percentage" id="layer7_layer7_ld_percentage" placeholder="%" value="<?php echo set_value('layer_7_rm_17_percentage','50');?>" />
        </td>     
      </tr>
      <tr>    
        ...
        <td><input type="text" readonly="readonly" id="layer7_layer7_lldpe_rate" name="layer_7_rm_18_rate" value="<?php echo set_value('layer_7_rm_18_rate');?>" size="5"></td>    
        <td ><input type="number" size="3" name="layer_7_rm_18_percentage" id="layer7_layer7_lld_percentage" placeholder="%" value="<?php echo set_value('layer_7_rm_18_percentage','50');?>" />
      ...
      <tr>
        ...
        <td><input type="text" readonly="readonly" id="layer7_layer7_hdpe_rate" name="layer_7_rm_19_rate" value="<?php echo set_value('layer_7_rm_19_rate');?>" size="5"></td> 
        <td ><input type="number" size="3" name="layer_7_rm_19_percentage" id="layer7_layer7_hd_percentage" placeholder="%" value="<?php echo set_value('layer_7_rm_19_percentage','0');?>" />
      ...
      <tr>
        ...
        <td> <input type="number" readonly="readonly" size="3" name="layer7_quantity" id="layer7_quantity" value="<?php echo set_value('layer7_quantity','1');?>" /> </td>     
      </tr>

      <tr>
        <td colspan="5"><span class="ui green label" id="layer7_sleevecost" >ADD</span></td>

        <td><input  readonly="readonly" type="number" size="3" name="layer7_sleeve_cost" id="layer7_sleeve_cost" value="<?php echo set_value('layer7_sleeve_cost');?>"  />	
				</td>
    ...
    <table class="ui celled structured table">
		...
		<tbody>
			<tr>
				...
				<td><input type="text" readonly="readonly" id="layer5_layer1_ldpe_rate" name="layer_5_rm_1_rate" value="<?php echo set_value('layer_5_rm_1_rate');?>" size="5"></td>
				...
				<td><input type="number" name="layer_5_rm_1_percentage" id="layer5_layer1_ld_percentage" placeholder="%" value="<?php echo set_value('layer_5_rm_1_percentage','70');?>" />
				</td>			
			</tr>
			<tr>
				...
				<td><input type="text" readonly="readonly" id="layer5_layer1_lldpe_rate" name="layer_5_rm_2_rate" value="<?php echo set_value('layer_5_rm_2_rate');?>" size="5"></td>		
				<td ><input type="number" size="3" name="layer_5_rm_2_percentage" id="layer5_layer1_lld_percentage" placeholder="%" value="<?php echo set_value('layer_5_rm_2_percentage','30');?>" />
			...
			<tr>
				...
				<td><input type="text" readonly="readonly" id="layer5_layer1_hdpe_rate" name="layer_5_rm_3_rate" value="<?php echo set_value('layer_5_rm_3_rate');?>" size="5"></td>	
				<td ><input type="number" size="3" name="layer_5_rm_3_percentage" id="layer5_layer1_hd_percentage" placeholder="%" value="<?php echo set_value('layer_5_rm_3_percentage','0');?>" />
			...
			<tr>
				...
				<td> MB : <select name="layer_5_rm_4_code" id="layer5_layer_1_rm_4_code" ><option value=''>--Select MB--</option>
										<?php foreach ($masterbatch as $masterbatch_row) {
				...
				<td><input type="text" readonly="readonly" id="layer5_layer_1_rm_4_rate" name="layer_5_rm_4_rate" value="<?php echo set_value('layer_5_rm_4_rate');?>" size="5"></td>	
				<td ><input type="number" size="3" name="layer_5_rm_4_percentage" id="layer5_layer_1_rm_4_percentage" placeholder="%" value="<?php echo set_value('layer_5_rm_4_percentage','0');?>" />
			...
			<tr>
				...
				<td ><input type="number" size="3" name="layer_5_rm_5_percentage" id="layer5_layer_1_rm_5_percentage" placeholder="%" value="<?php echo set_value('layer_5_rm_5_percentage','0');?>" />
			...
			<tr>
				...
				<td><input type="text" readonly="readonly" id="layer5_layer2_admer_rate" name="layer_5_rm_6_rate" value="<?php echo set_value('layer_5_rm_6_rate');?>" size="5"></td>
				...
				<td><input type="number" name="layer_5_rm_6_percentage" id="layer5_layer2_admer_percentage" placeholder="%" value="<?php echo set_value('layer_5_rm_6_percentage','100');?>" />
				</td>			
			</tr>
			...
			<tr>
				...
				<td><input type="text" readonly="readonly" id="layer5_layer3_evoh_rate" name="layer_5_rm_7_rate" value="<?php echo set_value('layer_5_rm_7_rate');?>" size="5"></td>
				...
				<td><input type="number" name="layer_5_rm_7_percentage" id="layer5_layer3_evoh_percentage" placeholder="%" value="<?php echo set_value('layer_5_rm_7_percentage','100');?>" />
				</td>			
			</tr>
			...
			<tr>
				...
				<td><input type="text" readonly="readonly" id="layer5_layer4_admer_rate" name="layer_5_rm_8_rate" value="<?php echo set_value('layer_5_rm_8_rate');?>" size="5"></td>
				...
				<td><input type="number" name="layer_5_rm_8_percentage" id="layer5_layer4_admer_percentage" placeholder="%" value="<?php echo set_value('layer_5_rm_8_percentage','100');?>" />
				</td>			
			</tr>
			...
			<tr>
				...
				<td><input type="text" readonly="readonly" id="layer5_layer5_ldpe_rate" name="layer_5_rm_9_rate" value="<?php echo set_value('layer_5_rm_9_rate');?>" size="5"></td>
				...
				<td><input type="number" name="layer_5_rm_9_percentage" id="layer5_layer5_ld_percentage" placeholder="%" value="<?php echo set_value('layer_5_rm_9_percentage','70');?>" />
				</td>			
			</tr>
			<tr>
				...
				<td><input type="text" readonly="readonly" id="layer5_layer5_lldpe_rate" name="layer_5_rm_10_rate" value="<?php echo set_value('layer_5_rm_10_rate');?>" size="5"></td>		
				<td ><input type="number" size="3" name="layer_5_rm_10_percentage" id="layer5_layer5_lld_percentage" placeholder="%" value="<?php echo set_value('layer_5_rm_10_percentage','30');?>" />
			...
			<tr>
				...
				<td><input type="text" readonly="readonly" id="layer5_layer5_hdpe_rate" name="layer_5_rm_11_rate" value="<?php echo set_value('layer_5_rm_11_rate');?>" size="5"></td>	
				<td ><input type="number" size="3" name="layer_5_rm_11_percentage" id="layer5_layer5_hd_percentage" placeholder="%" value="<?php echo set_value('layer_5_rm_11_percentage','0');?>" />
			...
			<tr>
				...
				<td> MB : <select name="layer_5_rm_12_code" id="layer5_layer_5_rm_12_code" ><option value=''>--Select MB--</option>
										<?php foreach ($masterbatch as $masterbatch_row) {
				...
				<td><input type="text" readonly="readonly" id="layer5_layer_5_rm_12_rate" name="layer_5_rm_12_rate" value="<?php echo set_value('layer_5_rm_12_rate');?>" size="5"></td>	
				<td ><input type="number" size="3" name="layer_5_rm_12_percentage" id="layer5_layer_5_rm_12_percentage" placeholder="%" value="<?php echo set_value('layer_5_rm_12_percentage','0');?>" />
			...
			<tr>
				...
				<td><input type="text" size="5" name="layer_5_rm_13_rate" id="layer5_layer_5_rm_13_rate" value="<?php echo set_value('layer_5_rm_13_rate');?>" /></td>	
				<td ><input type="number" size="3" name="layer_5_rm_13_percentage" id="layer5_layer_5_rm_13_percentage" placeholder="%" value="<?php echo set_value('layer_5_rm_13_percentage','0');?>" />
			...
			<tr>
				<td colspan="5">Quantity</td>
				<td> <input type="number" readonly="readonly" size="3" name="layer5_quantity" id="layer5_quantity" value="<?php echo set_value('layer5_quantity','1');?>" />	</td>			
			</tr>

			<tr>
				<td colspan="5"><span class="ui green label" id="layer5_sleevecost" >ADD</span></td>
				<td><input  readonly="readonly" type="number" size="3" name="layer5_sleeve_cost" id="layer5_sleeve_cost" value="<?php echo set_value('layer5_sleeve_cost');?>"  />	
				</td>
    ...
    <table class="ui celled structured table">
		...
		<tbody>
			<tr>
				...
				<td><input type="text" readonly="readonly" id="layer3_layer1_ldpe_rate" name="layer_3_rm_1_rate" value="<?php echo set_value('layer_3_rm_1_rate');?>" size="5"></td>
				...
				<td><input type="number" name="layer_3_rm_1_percentage" id="layer3_layer1_ld_percentage" placeholder="%" class="number3" value="<?php echo set_value('layer_3_rm_1_percentage','70');?>" />
				</td>			
			</tr>
			<tr>
				...
				<td><input type="text" readonly="readonly" id="layer3_layer1_lldpe_rate" name="layer_3_rm_2_rate" value="<?php echo set_value('layer_3_rm_2_rate');?>" size="5"></td>		
				<td ><input type="number" size="3" name="layer_3_rm_2_percentage" id="layer3_layer1_lld_percentage" placeholder="%"  value="<?php echo set_value('layer_3_rm_2_percentage','30');?>" />
			...
			<tr>
				...
				<td><input type="text" readonly="readonly" id="layer3_layer1_hdpe_rate" name="layer_3_rm_3_rate" value="<?php echo set_value('layer_3_rm_3_rate');?>" size="5"></td>	
				<td ><input type="number" size="3" name="layer_3_rm_3_percentage" id="layer3_layer1_hd_percentage" placeholder="%" value="<?php echo set_value('layer_3_rm_3_percentage','0');?>" />
			...
			<tr>
				...
				<td> MB : <select name="layer_3_rm_4_code" id="layer3_layer_1_rm_4_code" ><option value=''>--Select MB--</option>
										<?php foreach ($masterbatch as $masterbatch_row) {
				...
				<td><input type="text" readonly="readonly" id="layer3_layer_1_rm_4_rate" name="layer_3_rm_4_rate" value="<?php echo set_value('layer_3_rm_4_rate');?>" size="5"></td>	
				<td ><input type="number" size="3" name="layer_3_rm_4_percentage" id="layer3_layer_1_rm_4_percentage" placeholder="%" value="<?php echo set_value('layer_3_rm_4_percentage','0');?>" />
			...
			<tr>
				...
				<td ><input type="number" size="3" name="layer_3_rm_5_percentage" id="layer3_layer_1_rm_5_percentage" placeholder="%" value="<?php echo set_value('layer_3_rm_5_percentage','0');?>" />
			...
			<tr>
				...
				<td><input type="text" readonly="readonly" id="layer3_layer2_hdpe_rate" name="layer_3_rm_6_rate" value="<?php echo set_value('layer_3_rm_6_rate');?>" size="5"></td>
				<td ><input type="text" style="width: 7em;" name="layer_3_layer_6_micron" id="layer3_layer2_micron" class="number3" value="<?php echo set_value('layer_3_layer_6_micron');?>"  />
				</td>
				<td><input type="number" name="layer_3_rm_6_percentage" id="layer3_layer2_hd_percentage" placeholder="%" class="number3"  value="<?php echo set_value('layer_3_rm_6_percentage','100');?>" />
				</td>			
			</tr>
			...
			<tr>
				...
				<td><input type="text" readonly="readonly" id="layer3_layer3_ldpe_rate" name="layer_3_rm_7_rate" value="<?php echo set_value('layer_3_rm_7_rate');?>" size="5"></td>
				...
				<td><input type="number" name="layer_3_rm_7_percentage" id="layer3_layer3_ld_percentage" placeholder="%" class="number3"  value="<?php echo set_value('layer_3_rm_7_percentage','70');?>" />
				</td>			
			</tr>
			<tr>
				...
				<td><input type="text" readonly="readonly" id="layer3_layer3_lldpe_rate" name="layer_3_rm_8_rate" value="<?php echo set_value('layer_3_rm_8_rate');?>" size="5"></td>		
				<td ><input type="number" size="3" name="layer_3_rm_8_percentage" id="layer3_layer3_lld_percentage" placeholder="%"  value="<?php echo set_value('layer_3_rm_8_percentage','30');?>" />
			...
			<tr>
				...
				<td><input type="text" readonly="readonly" id="layer3_layer3_hdpe_rate" name="layer_3_rm_9_rate" value="<?php echo set_value('layer_3_rm_9_rate');?>" size="5"></td>	
				<td ><input type="number" size="3" name="layer_3_rm_9_percentage" id="layer3_layer3_hd_percentage" placeholder="%"  value="<?php echo set_value('layer_3_rm_9_percentage','0');?>" />
			...
			<tr>
				...
				<td> MB : <select name="layer_3_rm_10_code" id="layer3_layer_3_rm_10_code" ><option value=''>--Select MB--</option>
										<?php foreach ($masterbatch as $masterbatch_row) {
				...
				<td><input type="text" readonly="readonly" id="layer3_layer_3_rm_10_rate" name="layer_3_rm_10_rate" value="<?php echo set_value('layer_3_rm_10_rate');?>" size="5"></td>	
				<td ><input type="number" size="3" name="layer_3_rm_10_percentage" id="layer3_layer_3_rm_10_percentage" placeholder="%" value="<?php echo set_value('layer_3_rm_10_percentage','0');?>" />
			...
			<tr>
				...
				<td ><input type="number" size="3" name="layer_3_rm_11_percentage" id="layer3_layer_3_rm_11_percentage" placeholder="%" value="<?php echo set_value('layer_3_rm_11_percentage','0');?>" />
			...
			<tr>
				...
				<td> <input type="number" readonly="readonly" size="3" name="layer3_quantity" id="layer3_quantity" value="<?php echo set_value('layer3_quantity','1');?>" />	</td>			
			</tr>


			<tr>
				<td colspan="5"><span class="ui green label" id="layer3_sleevecost" >ADD</span></td>
				<td><input  readonly="readonly" type="number" size="3" name="layer3_sleeve_cost" id="layer3_sleeve_cost" value="<?php echo set_value('layer3_sleeve_cost');?>"  />	
				</td>
			</tr>
			</tbody>
		</table>
    ...
    <span class="close">&times;</span>
		...
		<tbody>
			<tr>
				...
				<td><input type="text" readonly="readonly" id="layer2_layer1_ldpe_rate" name="layer_2_rm_1_rate" value="<?php echo set_value('layer_2_rm_1_rate');?>" size="5"></td>
				...
				<td><input type="number" name="layer_2_rm_1_percentage" id="layer2_layer1_ld_percentage" placeholder="%" class="number3" value="<?php echo set_value('layer_2_rm_1_percentage','70');?>" />
				</td>			
			</tr>
			<tr>
				...
				<td><input type="text" readonly="readonly" id="layer2_layer1_lldpe_rate" name="layer_2_rm_2_rate" value="<?php echo set_value('layer_2_rm_2_rate');?>" size="5"></td>		
				
				<td ><input type="number" size="3" name="layer_2_rm_2_percentage" id="layer2_layer1_lld_percentage" placeholder="%" value="<?php echo set_value('layer_2_rm_2_percentage','30');?>" />
			...
			<tr>
				...
				<td><input type="text" readonly="readonly" id="layer2_layer1_hdpe_rate" name="layer_2_rm_3_rate" value="<?php echo set_value('layer_2_rm_3_rate');?>" size="5"></td>	
				<td ><input type="number" size="3" name="layer_2_rm_3_percentage" id="layer2_layer1_hd_percentage" placeholder="%"   value="<?php echo set_value('layer_2_rm_3_percentage','0');?>" />
			...
			<tr>
				...
				<td> MB : <select name="layer_2_rm_4_code" id="layer2_layer_1_rm_4_code" ><option value=''>--Select MB--</option>
										<?php foreach ($masterbatch as $masterbatch_row) {
				...
				<td><input type="text" readonly="readonly" id="layer2_layer_1_rm_4_rate" name="layer_2_rm_4_rate" value="<?php echo set_value('layer_2_rm_4_rate');?>" size="5"></td>	
				<td ><input type="number" size="3" name="layer_2_rm_4_percentage" id="layer2_layer_1_rm_4_percentage" placeholder="%" value="<?php echo set_value('layer_2_rm_4_percentage','0');?>" />
			...
			<tr>
				...
				<td ><input type="number" size="3" name="layer_2_rm_5_percentage" id="layer2_layer_1_rm_5_percentage" placeholder="%" value="<?php echo set_value('layer_2_rm_5_percentage','0');?>" />
			...
			<tr>
				...
				<td><input type="text" readonly="readonly" id="layer2_layer2_ldpe_rate" name="layer_2_rm_6_rate" value="<?php echo set_value('layer_2_rm_6_rate');?>" size="5"></td>
				...
				<td><input type="number" name="layer_2_rm_6_percentage" id="layer2_layer2_ld_percentage" placeholder="%" class="number3" value="<?php echo set_value('layer_2_rm_6_percentage','70');?>" />
				</td>			
			</tr>
			<tr>
				...
				<td><input type="text" readonly="readonly" id="layer2_layer2_lldpe_rate" name="layer_2_rm_7_rate" value="<?php echo set_value('layer_2_rm_7_rate');?>" size="5"></td>		
				<td ><input type="number" size="3" name="layer_2_rm_7_percentage" id="layer2_layer2_lld_percentage" placeholder="%"  value="<?php echo set_value('layer_2_rm_7_percentage','30');?>" />
			...
			<tr>
				...
				<td><input type="text" readonly="readonly" id="layer2_layer2_hdpe_rate" name="layer_2_rm_8_rate" value="<?php echo set_value('layer_2_rm_8_rate');?>" size="5"></td>	
				<td ><input type="number" size="3" name="layer_2_rm_8_percentage" id="layer2_layer2_hd_percentage" placeholder="%"   value="<?php echo set_value('layer_2_rm_8_percentage','0');?>" />
			...
			<tr>
				...
				<td> MB : <select name="layer_2_rm_9_code" id="layer2_layer_2_rm_9_code" ><option value=''>--Select MB--</option>
										<?php foreach ($masterbatch as $masterbatch_row) {
				...
				<td><input type="text" readonly="readonly" id="layer2_layer_2_rm_9_rate" name="layer_2_rm_9_rate" value="<?php echo set_value('layer_2_rm_9_rate');?>" size="5"></td>	
				<td ><input type="number" size="3" name="layer_2_rm_9_percentage" id="layer2_layer_2_rm_9_percentage" placeholder="%" value="<?php echo set_value('layer_2_rm_9_percentage','0');?>" />
			...
			<tr>
				...
				<td ><input type="number" size="3" name="layer_2_rm_10_percentage" id="layer2_layer_2_rm_10_percentage" placeholder="%" value="<?php echo set_value('layer_2_rm_10_percentage','0');?>" />
				</td>	
			...
			<tr>
				<td colspan="5">Quantity</td>
				<td> <input type="number" readonly="readonly" size="3" name="layer2_quantity" id="layer2_quantity"  value="<?php echo set_value('layer2_quantity','1');?>" />	</td>			
			</tr>

			<tr>
				<td colspan="5"><span class="ui green label" id="layer2_sleevecost" >ADD</span></td>
				<td><input  readonly="readonly" type="number" size="3" name="layer2_sleeve_cost" id="layer2_sleeve_cost" value="<?php echo set_value('layer2_sleeve_cost');?>"  />	
				</td>
    ...
    <span class="close">&times;</span>
		...
		<tbody>
			<tr>
				...
				<td><input type="text" readonly="readonly" id="layer1_ldpe_rate" name="layer_1_rm_1_rate" value="<?php echo set_value('layer_1_rm_1_rate');?>" size="5"></td>
				<td rowspan="5"><input type="text" style="width: 7em;" name="micron" id="micron" class="number3" value="<?php echo set_value('micron','500');?>"  />
				</td>
				<td><input type="number" name="layer_1_rm_1_percentage" id="layer1_ld_percentage" placeholder="%" class="number3" value="<?php echo set_value('layer_1_rm_1_percentage','30');?>" />
				</td>			
			</tr>
			<tr>
				...
				<td><input type="text" readonly="readonly" id="layer1_lldpe_rate" name="layer_1_rm_2_rate" value="<?php echo set_value('layer_1_rm_2_rate');?>" size="5"></td>		
				<td ><input type="number" size="3" name="layer_1_rm_2_percentage" id="layer1_lld_percentage" placeholder="%" value="<?php echo set_value('layer_1_rm_2_percentage','70');?>" />
				</td>			
			</tr>
			...
			<tr>
				...
				<td><input type="text" readonly="readonly" id="layer1_hdpe_rate" name="layer_1_rm_3_rate" value="<?php echo set_value('layer_1_rm_3_rate');?>" size="5"></td>	
				<td><input type="number" size="3" name="layer_1_rm_3_percentage" id="layer1_hd_percentage" placeholder="%" value="<?php echo set_value('layer_1_rm_3_percentage','0');?>" />
				</td>			
			</tr>

			<tr>
				<td><input type='hidden' name='sr_no[]' value='4'>4 <input type='hidden' name='layer_1_rm_4' value='MB'></td>
				<td> MB : <select name="layer_1_rm_4_code" id="sl_masterbatch" ><option value=''>--Select MB--</option>
										<?php foreach ($masterbatch as $masterbatch_row) {
				...
				<td><input type="text" readonly="readonly" id="layer1_mb_rate" name="layer_1_rm_4_rate" value="<?php echo set_value('layer_1_rm_4_rate');?>" size="5"></td>	
				<td ><input type="number" size="3" name="layer_1_rm_4_percentage" id="layer1_mb_percentage" placeholder="%" value="<?php echo set_value('layer_1_rm_4_percentage','0');?>" />
				</td>			
			</tr>
			...
			<tr>
				...
				<td><input type="text" size="5" name="layer_1_rm_5_rate" id="layer1_mb1_rate" value="<?php echo set_value('layer1_mb1_rate');?>" /></td>	
				<td ><input type="number" size="3" name="layer_1_rm_5_percentage" id="layer1_mb_percentage1" placeholder="%" value="<?php echo set_value('layer_1_rm_5_percentage','0');?>" />
				</td>			
			</tr>

			<tr>
				<td colspan="5">Quantity</td>				
				<td> <input type="number" readonly="readonly" size="3" name="quantity" id="quantity" value="<?php echo set_value('quantity','1');?>" />	</td>			
			</tr>


			<tr>
				<td colspan="5"><span class="ui green label" id="layer1_sleevecost" >ADD</span></td>
				<td><input  readonly="readonly" type="number" size="3" name="sleeve_cost" id="sleeve_cost" value="<?php echo set_value('sleeve_cost');?>"  />	
				</td>
  ...
  <div class="modal-content">
    ...
    <span class="close">&times;</span>
    	...
    	<table class="ui celled structured table">
		      ...
		      <tr>
		        <td>Cap Foil</td>
				<td><input type="text" size="3" name="cap_foil_rate" id="cap_foil_rate" value="<?php echo set_value('cap_foil_rate');?>" /></td>
		      </tr>
		     
		      <tr>
		        <td><span class="ui green label" id="cap_foil_cost" >ADD</span></td>
		        <td><input  readonly="readonly" type="number" size="3" name="cap_foil_cost_per_tube" id="cap_foil_cost_per_tube" value="<?php echo set_value('cap_foil_cost_per_tube');?>"  /></td>
		      </tr>
    		</tbody>
   		</table>	
  </div>
    ...
    <span class="close">&times;</span>
    	...
    	<table class="ui celled structured table">
		      ...
		      <tr>
				...
				<td><input type="text" size="3" name="cap_metalization_rate" id="cap_metalization_rate" value="<?php echo set_value('cap_metalization_rate');?>"/></td>
		      </tr>
		     
		      <tr>
		        <td><span class="ui green label" id="cap_metalization_cost" >ADD</span></td>
		        <td><input  readonly="readonly" type="number" size="3" name="cap_metalization_cost_per_tube" id="cap_metalization_cost_per_tube" value="<?php echo set_value('cap_metalization_cost_per_tube');?>"  /></td>
		      </tr>
    		</tbody>
   		</table>	
  </div>
  ...
  <div class="modal-content">
    ...
    <span class="close">&times;</span>
      ...
      <table class="ui celled structured table">
        ...
        <td><input type="number" name="hot_foil_1_percentage" id="hot_foil_1_percentage" placeholder="%" class="number3" value="<?php echo set_value('hot_foil_1_percentage','0');?>" /></td>    
          </tr>
        ...
        <td><input type="number" name="hot_foil_2_percentage" id="hot_foil_2_percentage" placeholder="%" class="number3"  value="<?php echo set_value('hot_foil_2_percentage','0');?>" /></td>
        </tr>

         
          <tr>
            <td colspan="2"><span class="ui green label" id="tube_foil_cost" >ADD</span></td>
            <td><input  readonly="readonly" type="number" size="3" name="tube_foil_cost_per_tube" id="tube_foil_cost_per_tube" value="<?php echo set_value('tube_foil_cost_per_tube');?>"  /></td>
          </tr>
        </tbody>
      </table>  
  </div>
    ...
    <span class="close">&times;</span>
    	...
    	<table class="ui celled structured table">
		      ...
		      <tr>
   			...
   			<tbody>
		      <tr>		        
		        <td><input type="text" readonly="readonly" size="10" name="mould_type" id="mould_type" value="<?php echo set_value('mould_type');?>"></td>     
		        <td><input type="text" readonly="readonly" size="10" name="cap_weight_rate" id="cap_weight_rate" value="<?php echo set_value('cap_weight_rate');?>"></td>  
		        <td><input type="text" size="10" maxlength="3" min="0" max="100" name="runner_waste" id="runner_waste" placeholder="%" value="<?php echo set_value('runner_waste','25');?>" />
		        </td>
		        <td ><input type="text" size="10"  name="pp_price" id="pp_price" value="<?php echo set_value('pp_price','110');?>" />
						</td>
						<td ><input type="text" size="10"  name="mb_price" id="mb_price" value="<?php echo set_value('mb_price','1200');?>" />
						</td>
						<td ><input type="text" size="10" name="mb_loading" id="mb_loading" placeholder="%" value="<?php echo set_value('mb_loading','4');?>" />
						</td>
						<td ><input type="text" size="10" name="moulding_cost" id="moulding_cost" value="<?php echo set_value('moulding_cost');?>" />
						</td>
		      </tr>
          		...
          		<td>
	          		...
	          		<select name="box_liners" id="box_liners">
	          			<option value=''>--Select Box Liners--</option>							 
									...
									<input type="text" readonly="readonly" size="10" name="liner_gm" id="liner_gm" value="<?php echo set_value('liner_gm','0.02941');?>">
          		</td>
          </tr>
          <tr>
             	
              <td><input type="text" readonly="readonly" size="10" name="top_box_rate" id="top_box_rate" value="<?php echo set_value('top_box_rate');?>"></td>
              <td><input type="text" readonly="readonly" size="10" name="bottom_box_rate" id="bottom_box_rate" value="<?php echo set_value('bottom_box_rate');?>"></td>
              
              <td><input type="text" readonly="readonly" size="10" name="box_liners_rate" id="box_liners_rate" value="<?php echo set_value('box_liners_rate');?>"></td>
          </tr>
  ...
  <div class="modal-content">
    ...
    <tbody>
      <tr>
        ...
        <td><input type="number" name="hdpe_m" id="hdpe_m" placeholder="%" class="number3" value="<?php echo set_value('hdpe_m','30');?>" /></td>     
      </tr>
      ...
      <tr>
        ...
        <td><input type="number" name="hdpe_f" id="hdpe_f" placeholder="%" class="number3" value="<?php echo set_value('hdpe_f','70');?>" /></td>     
      </tr>
       ...
       <tr>
        ...
        <td><input type="number" size="3" name="shoulder_mb_percentage" id="shoulder_mb_percentage" placeholder="%"  value="<?php echo set_value('shoulder_mb_percentage','0');?>" />
        </td>     
      </tr>
      ...
      <tr>
			...
			<td ><input type="number" size="3" name="shoulder_mb_percentage1" id="shoulder_mb_percentage1" placeholder="%"  value="<?php echo set_value('shoulder_mb_percentage1','0');?>" />
			</td>			
		</tr>

      <tr>
        <td colspan="2">Quantity</td>
        <td> <input type="number" size="3" name="sh_quantity" id="sh_quantity" value="<?php echo set_value('sh_quantity','1');?>" />  </td>     
      </tr>

      <tr>
        <td colspan="2"><span class="ui green label" id="shouldercost" >ADD</span></td>

        <td><input  readonly="readonly" type="number" size="3" name="shoulder_cost" id="shoulder_cost" value="<?php echo set_value('shoulder_cost');?>"  />	
				</td>
    	...
    	<table class="ui celled structured table">
		  ...
		  <tbody>
		      <tr>
		        ...
		        <td><input type="number" size="3" name="special_gm_per_tube" id="special_gm_per_tube" value="<?php echo set_value('special_gm_per_tube','1');?>" /></td>
		        <td><input type="number" name="special_percentage" id="special_percentage" placeholder="%" class="number3" value="<?php echo set_value('special_percentage','100');?>" /></td>     
		      </tr>
		      <tr>
		        <td colspan="3"><span class="ui green label" id="special_ink_cost" >ADD</span></td>
		        <td><b><input  readonly="readonly" type="number" size="3" name="special_ink_cost_per_tube" id="special_ink_cost_per_tube" value="<?php echo set_value('special_ink_cost_per_tube');?>" ></td>
		      </tr>
		  </tbody>
	  </table>		
  </div>
      ...
      <table class="ui celled structured table">
		  ...
		  <tbody>
		      <tr>
		        ...
		        <td><input type="text" name="offset_gm_per_tube" id="offset_gm_per_tube" value="<?php echo set_value('offset_gm_per_tube','1');?>" /></td>
		        <td><input type="number" name="offset_percentage" id="offset_percentage" placeholder="%" class="number3" value="<?php echo set_value('offset_percentage','100');?>" /></td>     
		      </tr>
		      <tr>
		        <td colspan="3"><span class="ui green label" id="offset_cost" >ADD</span></td>
		        <td><b><input  readonly="readonly" type="number" size="3" name="offset_cost_per_tube" id="offset_cost_per_tube" value="<?php echo set_value('offset_cost_per_tube');?>"  ></td>
		      </tr>
		      <!--<tr>
		      	<td>
	      ...
	      <thead>
	       <tr><th>PLATE PRICE</th><th>NO. OF COLORS</th><th>NO. OF IMPRESSION</th><th>SETS</th></tr>
		      ...
		      <tr>
		      	<td>
		      		<input type="number" size="3" name="offset_plate_cost" id="offset_plate_cost" class="number3" value="<?php echo set_value('offset_plate_cost');?>" />
		      	</td>
		      	
		      	<td>
		      		<input type="number" size="3" name="offset_color" id="offset_color" class="number3" value="<?php echo set_value('offset_color','4');?>" />
		      	</td>
		      	<td>
		      		<input type="number" size="3" name="offset_impresssion" id="offset_impresssion" class="number3" value="<?php echo set_value('offset_impresssion');?>" />
		      	</td>
		      	<td>
		      		<input type="number" size="3" name="offset_sets" id="offset_sets" class="number3" value="<?php echo set_value('offset_sets','2');?>" />
		      	</td>
		      </tr>
		      <tr>
		        <td colspan="3"><span  id="offset_cost" >Total</span></td>
		        <td><b><input  readonly="readonly" type="number" size="3" name="offset_plate_cost_per_tube" id="offset_plate_cost_per_tube" value="<?php echo set_value('offset_plate_cost_per_tube');?>" ></td>
		      </tr>
		  		</tbody>
	 			 </table>	
  </div>
      ...
      <table class="ui celled structured table">
		  ...
		  <tbody>
		      <tr>
		        ...
		        <td><input type="text"  name="screen_gm_per_tube" id="screen_gm_per_tube" value="<?php echo set_value('screen_gm_per_tube','1');?>" /></td>
		        <td><input type="number" name="screen_percentage" id="screen_percentage" placeholder="%" class="number3" value="<?php echo set_value('screen_percentage','100');?>" /></td>     
		      </tr>
		      ...
		      <tr>
		        ...
		        <td><input type="text"  name="flexo_gm_per_tube" id="flexo_gm_per_tube" value="<?php echo set_value('flexo_gm_per_tube','1');?>" /></td>		        
		        <td><input type="number" name="flexo_percentage" id="flexo_percentage" placeholder="%" class="number3" value="<?php echo set_value('flexo_percentage','0');?>" /></td>     
		      </tr>
		      <tr>
		        <td  colspan="3">Quantity</td>
		        <td><input readonly="readonly" type="number" size="3" name="screen_flexo_quantity" id="screen_flexo_quantity" value="<?php echo set_value('screen_flexo_quantity','1');?>" />
		        </td>
		      </tr>

		      <tr>
		        <td colspan="3"><span class="ui green label" id="screen_flexo_cost" >ADD</span></td>
		        <td><b><input  readonly="readonly" type="number" size="3" name="screen_flexo_cost_per_tube" id="screen_flexo_cost_per_tube" value="<?php echo set_value('screen_flexo_cost_per_tube');?>" ></td>
		      </tr>
	  ...
	  <table class="ui celled structured table">
	      <thead>
	       <tr><th>PLATE PRICE</th><th>NO. OF COLORS</th><th>NO. OF IMPRESSION</th><th>SETS</th></tr>
		      ...
		      <tr>
		      	<td>SCREEN PLATES
		      		<input type="number" size="3" name="screen_film_rate" id="screen_film_rate" class="number3" value="<?php echo set_value('screen_film_rate');?>" />
		      	</td>
		      	
		      	<td>
		      		<input type="number" size="3" name="screen_colors" id="screen_colors" class="number3" value="<?php echo set_value('screen_colors');?>" />
		      	</td>
		      	<td>
		      		<input type="number" size="3" name="screen_impresssion" id="screen_impresssion" class="number3" value="<?php echo set_value('screen_impresssion');?>" />
		      	</td>
		      	<td>
		      		<input type="number" size="3" name="screen_sets" id="screen_sets" class="number3" value="<?php echo set_value('screen_sets');?>" />
		      	</td>
		      </tr>
		      <tr>
		        <td colspan="3"><span class="ui green label"  id="screen_film_cost" >Add</span></td>
		        <td><b><input  readonly="readonly" type="number" size="3" name="screen_film_cost_per_tube" id="screen_film_cost_per_tube" value="<?php echo set_value('screen_film_cost_per_tube');?>" ></td>
		      </tr>
		      <tr>
		      	<td>FLEXO PLATES
		      		<input type="number" size="3" name="flexo_plate_rate" id="flexo_plate_rate" class="number3" value="<?php echo set_value('flexo_plate_rate');?>" />
		      	</td>
		      	
		      	<td>
		      		<input type="number" size="3" name="flexo_colors" id="flexo_colors" class="number3" value="<?php echo set_value('flexo_colors');?>" />
		      	</td>
		      	<td>
		      		<input type="number" size="3" name="flexo_impresssion" id="flexo_impresssion" class="number3" value="<?php echo set_value('flexo_impresssion');?>" />
		      	</td>
		      	<td>
		      		<input type="number" size="3" name="flexo_sets" id="flexo_sets" class="number3" value="<?php echo set_value('flexo_sets');?>" />
		      	</td>
		      </tr>

		      <tr>
		        <td colspan="3"><span class="ui green label" id="flexo_plate_cost" >Add</span></td>
		        <td><b><input  readonly="readonly" type="number" size="3" name="flexo_plate_cost_per_tube" id="flexo_plate_cost_per_tube" value="<?php echo set_value('flexo_plate_cost_per_tube');?>" ></td>
		      </tr>
		  		</tbody>
	 			 </table>	
  ...
  <div class="modal-content">
      ...
      <table class="ui celled structured table">
		  ...
		  <tbody>
		      <tr>
		        <td>LABEL : </td> 
		        <td><input type="number" name="label_rate" id="label_rate" placeholder="Rate" class="number3" value="<?php echo set_value('label_rate','0');?>" /></td>  
		      </tr>  
		      <tr>
		        <td><span class="ui green label" id="label_cost" >ADD</span></td>
		        <td><b><input  readonly="readonly" type="number" size="3" name="label_cost_per_tube" id="label_cost_per_tube" value="<?php echo set_value('label_cost_per_tube');?>" ></td>
		      </tr>
		  </tbody>
	  </table>	
  </div>
				      ...
				      <table class="ui celled structured table">
						  ...
						  <tbody>
						      <tr>
						        ...
						        <td><input type="number" name="lacquer_type_1_percentage" id="lacquer_type_1_percentage" placeholder="%" class="number3" value="<?php echo set_value('lacquer_type_1_percentage','100');?>" />
						        </td>     
						      </tr>
						      ...
						      <tr>
						        ...
						        <td><input type="number" name="lacquer_type_2_percentage" id="lacquer_type_2_percentage" placeholder="%" class="number3" value="<?php echo set_value('lacquer_type_2_percentage','0');?>" />
						        </td>     
						      </tr>
						      <tr>
						        <td  colspan="3">Quantity</td>
						        <td><input type="number" readonly="readonly" size="3" name="lacquer_quantity" id="lacquer_quantity" value="<?php echo set_value('lacquer_quantity','1');?>" />
						        </td>
						      </tr>

						      <tr>
						        <td colspan="3"><span class="ui green label" id="tube_lacquer_cost" >ADD</span></td>
						        <td><b><input  readonly="readonly" type="number" size="3" name="lacquer_cost_per_tube" id="lacquer_cost_per_tube" value="<?php echo set_value('lacquer_cost_per_tube');?>" ></td>
						      </tr>
						  </tbody>
					  </table>	
				  </div>
