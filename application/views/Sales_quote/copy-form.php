									...
									<table class="form_table_inner">	
										<tr>
											...
											<td width="25%">
												...
												<?php 
													$data['version']=$this->sales_quote_model->select_quote_verion_no_copy_fun('sales_quote_master',$this->session->userdata['logged_in']['company_id'],'quotation_no',$row->quotation_no);
												...
												<input type="text" name="version_no" id="version_no" size="5" value="<?php echo set_value('version_no',$version_no);?>" readonly>
											</td>									
										</tr>
										...
										<tr>
											...
											<td colspan="3">
												...
												<input type="text" name="customer" id="customer_category"  size="55" value="<?php echo set_value('category_name',$row->category_name.'//'.$row->customer_no.'');?>" /></td>
							...
							<td colspan="5" width="100%">
								...
								<table class="form_table_inner">
									...
									<tr>
										...
										<td width="10%">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										<input type="text" readonly="readonly" name="capacity" id="capacity"  size="10" value="<?php echo set_value('capacity',$row->machine_capacity_without_changeover);?>"  /> 
										</td>
										<td width="10%">&nbsp;&nbsp;&nbsp;&nbsp;
									...
									<tr>
										...
										<td><input type="text" class="number1" name="_5k_waste" id="_5k_waste"   value="<?php echo set_value('_5k_waste',$row->_5k_waste);?>"  size="4"/></td>
									...
									<tr>
										...
										<td><input type="text" class="number1" name="_10k_waste" id="_10k_waste"  value="<?php echo set_value('_10k_waste',$row->_10k_waste);?>"  /></td>
									...
									<tr>
										...
										<td><input type="text" class="number1" name="_25k_waste" id="_25k_waste"   value="<?php echo set_value('_25k_waste',$row->_25k_waste);?>"  /></td>
									...
									<tr>
										...
										<td><input type="text" class="number1" name="_50k_waste" id="_50k_waste"   value="<?php echo set_value('_50k_waste',$row->_50k_waste);?>"  /></td>										
									...
									<tr>
										...
										<td><input type="text" class="number1" name="_100k_waste" id="_100k_waste"   value="<?php echo set_value('_100k_waste',$row->_100k_waste);?>"  /></td>
									...
									<tr>
										...
										<td><input type="text" class="number1" name="_free_quantity_waste" id="_free_quantity_waste"   value="<?php echo set_value('_free_quantity_waste',$row->_free_quantity_waste);?>"  /></td>
							...
							<td>
								...
								<tbody>
									...
									<tr class="active">
										...
										<td><input type="text" readonly="readonly" id="waste_total_cost_per_tube" name="waste_total_cost_per_tube" value="<?php echo set_value('waste_total_cost_per_tube',$row->waste_total_cost_per_tube);?>" size="5"></td>
										<td> </td>
										<td> <span id=""></span></td>
									</tr>
    	...
    	<table class="ui celled structured table">
		      ...
		      <tr>		        
		        ...
		        <td ><input type="text" size="10"  name="pp_price" id="pp_price" value="<?php echo set_value('pp_price',$row->pp_price);?>" />
						...
						<td ><input type="text" size="10" name="moulding_cost" id="moulding_cost" value="<?php echo set_value('moulding_cost',$row->moulding_cost);?>" />
						</td>
    	...
    	<table class="ui celled structured table">
		  ...
		  <tbody>
		      <tr>
		        ...
		        <td><input type="text" style="width: 7em;" name="special_gm_per_tube" id="special_gm_per_tube" value="<?php echo set_value('special_gm_per_tube',$row->special_gm_per_tube);?>" /></td>
  ...
  <div class="modal-content" style="width:600px;">
	...
	<div class="form_design">
		<div class="ui buttons">
	  		...
	  		<div class="or"></div>
	  		<button class="ui positive button" onClick="return confirm('Are you sure to update Record?');">Save Copy</button>
		</div>
	</div>	
</form>
