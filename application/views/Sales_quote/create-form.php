...
<script>
	$(document).ready(function() {
		...
		$("#customer_category").autocomplete("<?php echo base_url('index.php/ajax/customer_category_autocomplete'); ?>", {
			selectFirst: true
		});

		$("#article_no").autocomplete("<?php echo base_url('index.php/ajax/article_no'); ?>", {
			selectFirst: true
		});
		$("#invoice_no").autocomplete("<?php echo base_url('index.php/ajax/ar_invoice_no'); ?>", {
			selectFirst: true
		});
		$("#tube_color").autocomplete("<?php echo base_url('index.php/ajax/tube_color'); ?>", {
			selectFirst: true
		});
		$("#shoulder_color").autocomplete("<?php echo base_url('index.php/ajax/tube_color'); ?>", {
			selectFirst: true
		});
		$("#cap_color").autocomplete("<?php echo base_url('index.php/ajax/tube_color'); ?>", {
			selectFirst: true
		});
		...
		$("#customer_category").blur(function() {
			...
			$.ajax({
				type: "POST",
				url: "<?php echo base_url('index.php/ajax/purchase_manager'); ?>",
				data: {
					customer: $("#customer_category").val()
				},
				cache: false,
		...
		$("#customer_category").blur(function() {
			...
			$.ajax({
				type: "POST",
				url: "<?php echo base_url('index.php/ajax/get_customer_flag'); ?>",
				data: {
					customer: $("#customer_category").val()
				},
				cache: false,
		...
		$("#print_type").change(function(event) {
			...
			$.ajax({
				type: "POST",
				url: "<?php echo base_url('index.php/ajax/machine_type'); ?>",
				data: {
		...
		$("#machine_type").change(function(event) {
			...
			$.ajax({
				type: "POST",
				url: "<?php echo base_url('index.php/ajax/machine_type_details'); ?>",
				data: {
		...
		$("#machine_type").change(function(event) {
			...
			$.ajax({
				type: "POST",
				url: "<?php echo base_url('index.php/ajax/machine_type_min_contribution'); ?>",
				data: {
					machine_type: $('#machine_type').val()
				},
				cache: false,
		...
		$("#machine_type").change(function(event) {
			...
			$.ajax({
				type: "POST",
				url: "<?php echo base_url('index.php/ajax/machine_type_jobchangeover_details'); ?>",
				data: {
					machine_type: $('#machine_type').val()
				},
				cache: false,
		...
		$("#machine_type").change(function(event) {
			...
			$.ajax({
				type: "POST",
				url: "<?php echo base_url('index.php/ajax/machine_type_capacity_details'); ?>",
				data: {
					machine_type: $('#machine_type').val()
				},
				cache: false,
		...
		$("#sleeve_dia").live('change', function() {
			...
			$.ajax({
				type: "POST",
				url: "<?php echo base_url('index.php/ajax/shoulder'); ?>",
				data: {
		...
		$("#shoulder").change(function(event) {
			...
			$.ajax({
				type: "POST",
				url: "<?php echo base_url('index.php/ajax/shoulder_orifice'); ?>",
				data: {
					sleeve_dia: $('#sleeve_dia').val(),
		...
		$("#shoulder").live('change', function() {
			...
			$.ajax({
				type: "POST",
				url: "<?php echo base_url('index.php/ajax/cap_type'); ?>",
				data: {
					sleeve_dia: $('#sleeve_dia').val(),
					shoulder: $('#shoulder').val(),
					shoulder_orifice: $('#shoulder_orifice').val()
				},
				cache: false,
				success: function(html) {
					setTimeout(function() {
		...
		$("#cap_type").live('change', function() {
			...
			$.ajax({
				type: "POST",
				url: "<?php echo base_url("index.php/ajax/spec_cap_finish"); ?>",
				data: {
		...
		$("#cap_finish").change(function(event) {
			...
			$.ajax({
				type: "POST",
				url: "<?php echo base_url('index.php/ajax/cap_dia'); ?>",
				data: {
					sleeve_dia: $('#sleeve_dia').val(),
					shoulder: $('#shoulder').val(),
					shoulder_orifice: $('#shoulder_orifice').val(),
		...
		$("#cap_dia").change(function(event) {
			...
			$.ajax({
				type: "POST",
				url: "<?php echo base_url("index.php/ajax/spec_cap_orifice"); ?>",
				data: {
					cap_type: $('#cap_type').val(),
					cap_finish: $('#cap_finish').val(),
					cap_dia: $('#cap_dia').val()
   ...
   $("#customer_category").blur(function(){		
		...
		$("#sl_ldpe").live('change', function() {
			...
			$.ajax({
				type: "POST",
				url: "<?php echo base_url('index.php/ajax/get_rm_rate'); ?>",
				data: {
					rm: $('#sl_ldpe').val()
				},
				cache: false,
		...
		$("#sleeve_dia").live('change', function() {
			...
			//alert($("#sleeve_dia").val());
			if ($('#sleeve_dia').val() == "19 MM//2") {
				micron = 400;
				//alert(micron);
				$('#micron').val(micron.toFixed());
			} else if ($('#sleeve_dia').val() == "50 MM//7") {
				micron = 550;
				//alert(micron);
				$('#micron').val(micron.toFixed());
			} else {
		...
		$("#layer2_layer_1_rm_4_code").live('change', function() {
			...
			$.ajax({
				...
				url: "<?php echo base_url(); ?>" + "index.php/ajax/get_rm_rate",
				data: {
					rm: $('#layer2_layer_1_rm_4_code').val()
				},
				cache: false,
				success: function(html) {
					setTimeout(function() {
		...
		$("#layer2_layer_2_rm_9_code").live('change', function() {
			...
			$.ajax({
				...
				url: "<?php echo base_url(); ?>" + "index.php/ajax/get_rm_rate",
				data: {
					rm: $('#layer2_layer_2_rm_9_code').val()
				},
				cache: false,
				success: function(html) {
					setTimeout(function() {
		...
		$("#sleeve_dia").live('change', function() {
			...
			//alert($("#sleeve_dia").val());
			if ($('#sleeve_dia').val() == "19 MM//2") {
				layer2_layer1_micron = 200;
				$('#layer2_layer1_micron').val(layer2_layer1_micron.toFixed());
				layer2_layer2_micron = 200;
				$('#layer2_layer2_micron').val(layer2_layer2_micron.toFixed());
			} else if ($('#sleeve_dia').val() == "50 MM//7") {
				layer2_layer1_micron = 150;
				$('#layer2_layer1_micron').val(layer2_layer1_micron.toFixed());
				layer2_layer2_micron = 400;
				$('#layer2_layer2_micron').val(layer2_layer2_micron.toFixed());
			} else {
				layer2_layer1_micron = 250;
				$('#layer2_layer1_micron').val(layer2_layer1_micron.toFixed());
				layer2_layer2_micron = 250;
				$('#layer2_layer2_micron').val(layer2_layer2_micron.toFixed());
			}
		});
		...
		$("#layer3_layer_1_rm_4_code").live('change', function() {
			...
			$.ajax({
				...
				url: "<?php echo base_url(); ?>" + "index.php/ajax/get_rm_rate",
				data: {
					rm: $('#layer3_layer_1_rm_4_code').val()
				},
				cache: false,
				success: function(html) {
					setTimeout(function() {
		...
		$("#layer3_layer_3_rm_10_code").live('change', function() {
			...
			$.ajax({
				...
				url: "<?php echo base_url(); ?>" + "index.php/ajax/get_rm_rate",
				data: {
					rm: $('#layer3_layer_3_rm_10_code').val()
				},
				cache: false,
				success: function(html) {
					setTimeout(function() {
		...
		$("#sleeve_dia").live('change', function() {
			...
			//alert($("#sleeve_dia").val());
			if ($('#sleeve_dia').val() == "19 MM//2") {
				layer3_layer1_micron = 175;
				$('#layer3_layer1_micron').val(layer3_layer1_micron.toFixed());
				layer3_layer3_micron = 175;
				$('#layer3_layer3_micron').val(layer3_layer3_micron.toFixed());
			} else if ($('#sleeve_dia').val() == "50 MM//7") {
				layer3_layer1_micron = 250;
				$('#layer3_layer1_micron').val(layer3_layer1_micron.toFixed());
				layer3_layer3_micron = 250;
				$('#layer3_layer3_micron').val(layer3_layer3_micron.toFixed());
			} else {
				layer3_layer1_micron = 225;
				$('#layer3_layer1_micron').val(layer3_layer1_micron.toFixed());
				layer3_layer3_micron = 225;
				$('#layer3_layer3_micron').val(layer3_layer3_micron.toFixed());
			}
		});
		...
		$("#layer5_layer_1_rm_4_code").live('change', function() {
			...
			$.ajax({
				...
				url: "<?php echo base_url(); ?>" + "index.php/ajax/get_rm_rate",
				data: {
					rm: $('#layer5_layer_1_rm_4_code').val()
				},
				cache: false,
				success: function(html) {
					setTimeout(function() {
		...
		$("#layer5_layer_5_rm_12_code").live('change', function() {
			...
			$.ajax({
				...
				url: "<?php echo base_url(); ?>" + "index.php/ajax/get_rm_rate",
				data: {
					rm: $('#layer5_layer_5_rm_12_code').val()
				},
				cache: false,
				success: function(html) {
					setTimeout(function() {
		...
		$("#sleeve_dia").live('change', function() {
			...
			//alert($("#sleeve_dia").val());
			if ($('#sleeve_dia').val() == "19 MM//2") {
				layer5_layer1_micron = 172;
				$('#layer5_layer1_micron').val(layer5_layer1_micron.toFixed());
				layer5_layer5_micron = 173;
				$('#layer5_layer5_micron').val(layer5_layer5_micron.toFixed());
			} else if ($('#sleeve_dia').val() == "50 MM//7") {
				layer5_layer1_micron = 247;
				$('#layer5_layer1_micron').val(layer5_layer1_micron.toFixed());
				layer5_layer5_micron = 248;
				$('#layer5_layer5_micron').val(layer5_layer5_micron.toFixed());
			} else {
				layer5_layer1_micron = 222;
				$('#layer5_layer1_micron').val(layer5_layer1_micron.toFixed());
				layer5_layer5_micron = 223;
				$('#layer5_layer5_micron').val(layer5_layer5_micron.toFixed());
			}
		});
		...
		$("#layer7_layer_2_rm_7_code").live('change', function() {
			...
			$.ajax({
				...
				url: "<?php echo base_url(); ?>" + "index.php/ajax/get_rm_rate",
				data: {
					rm: $('#layer7_layer_2_rm_7_code').val()
				},
				cache: false,
				success: function(html) {
					setTimeout(function() {
		...
		$("#layer7_layer_6_rm_15_code").live('change', function() {
			...
			$.ajax({
				...
				url: "<?php echo base_url(); ?>" + "index.php/ajax/get_rm_rate",
				data: {
					rm: $('#layer7_layer_6_rm_15_code').val()
				},
				cache: false,
				success: function(html) {
					setTimeout(function() {
		...
		$("#cap_metalization").live('click', function() {
			if ($(this).is(":checked")) {
				...
				$("#cap_metalization_cost_per_tube").val(cap_metalization_rate.toFixed(2));
		...
		$("#cap_foil").live('click', function() {
			if ($(this).is(":checked")) {
				...
				$("#cap_foil_width").val("");
				var cap_foil_rate = 0;
				$("#cap_foil_cost_per_tube").val(cap_foil_rate.toFixed(2));
		...
		if ($("#shoulder_foil").val() == "") {
			$('#shoulder_foil_link').hide();
		}
		//$('#shoulder_foil_link').hide();

		if ($("#cap_shrink_sleeve").val() == "") {
		...
		$("#lacquer_type_1").live('change', function() {
			...
			$.ajax({
				type: "POST",
				url: "<?php echo base_url('index.php/ajax/get_lacquer_consumption'); ?>",
				data: {
					rm: $('#lacquer_type_1').val(),
					sleeve_dia: $('#sleeve_dia').val(),
					sleeve_length: $('#sleeve_length').val()
		...
		$("#tube_lacquer_cost").live('click', function() {
			...
			if ($('#sleeve_dia').val() == "" || $('#sleeve_length').val() == "") {
				alert("Please enter the Diameter,Length");
			} else if ($('#lacquer_type_1').val() == "" && $('#lacquer_type_2').val() == "") {
				alert("Enter Lacquer Code & %");
				// }else if($('#lacquer_type_2').val()=="" && $('#lacquer_type_2_percentage').val()==""){
				// 	alert("Enter Lacquer Code & %");	
				...
				if (isNaN(lacquer_1_cost_per_tube)) {
					lacquer_1_cost_per_tube = 0;
				}
				...
				//alert(lacquer_1_cost_per_tube);
				//alert(lacquer_2_cost_per_tube);
		...
		$("#print_type").live('change', function() {
			...
			switch (print_type) {
				...
				case ("SPRING"):
					...
					$.ajax({
						type: "POST",
						url: "<?php echo base_url(); ?>" + "index.php/ajax/get_consumable",
						data: {
							consumable_category_id: 6
						},
						cache: false,
						success: function(html) {
							setTimeout(function() {
				...
				case ("SCREEN+FLEXO"):
					...
					$.ajax({
						type: "POST",
						url: "<?php echo base_url(); ?>" + "index.php/ajax/get_screen_flexo_consumable",
						data: {
							screen: 5,
							flexo: 3
						},
		...
		$("#offset_rm_month").live('change', function() {
			...
			$.ajax({
				type: "POST",
				url: "<?php echo base_url(); ?>" + "index.php/ajax/get_ink_rate",
				data: {
					ink_id: $('#offset_rm_month').val(),
					ink_id: 2
				},
				cache: false,
				success: function(html) {
		...
		$("#offset_rm_month").live('change', function() {
			...
			$.ajax({
				type: "POST",
				url: "<?php echo base_url(); ?>" + "index.php/ajax/get_consumption_rate",
				data: {
					lacquer_type_id: $('#offset_rm_month').val(),
					lacquer_type_id: 2
				},
				cache: false,
				success: function(html) {
		...
		$("#offset_rm_month").live('change', function() {
			...
			$.ajax({
				type: "POST",
				url: "<?php echo base_url(); ?>" + "index.php/ajax/get_offset_plate_rate",
				data: {
					lacquer_type_id: 2
				},
				cache: false,
		...
		$("#screen_rm_month").live('change', function() {
			...
			$.ajax({
				type: "POST",
				url: "<?php echo base_url(); ?>" + "index.php/ajax/get_screen_plate_rate",
				data: {
					lacquer_type_id: 3
				},
				cache: false,
		...
		$("#flexo_rm_month").live('change', function() {
			...
			$.ajax({
				type: "POST",
				url: "<?php echo base_url(); ?>" + "index.php/ajax/get_flexo_plate_rate",
				data: {
					lacquer_type_id: 6
				},
				cache: false,
		...
		$("#shouldercost").live('click', function() {
			...
			if ($('#sleeve_dia').val() == "" || $('#Shoulder').val() == "") {
				...
				$.ajax({
					type: "POST",
					url: "<?php echo base_url(); ?>" + "index.php/ajax/get_shoulder_weight",
					data: {
						sleeve_id: $('#sleeve_dia').val(),
						shld_type_id: $('#shoulder').val(),
						shld_orifice_id: $('#shoulder_orifice').val(),
						sh_rejection: $('#sh_rejection').val()
					},
					cache: false,
					success: function(html) {
						setTimeout(function() {
		...
		$("#cap_dia").live('change', function() {
			...
			$.ajax({
				type: "POST",
				url: "<?php echo base_url(); ?>" + "index.php/ajax/get_cap_height",
				data: {
					sleeve_id: $('#sleeve_dia').val(),
					shld_type_id: $('#shoulder').val(),
					shld_orifice_id: $('#shoulder_orifice').val(),
					cap_type_id: $('#cap_type').val(),
					cap_finish_id: $('#cap_finish').val(),
					cap_dia_id: $('#cap_dia').val(),
					sleeve_length: $('#sleeve_length').val()
				},
				cache: false,
				success: function(html) {
		...
		$("#cap_dia").live('change', function() {
			...
			$.ajax({
				type: "POST",
				url: "<?php echo base_url(); ?>" + "index.php/ajax/get_cap_weight",
				data: {
					sleeve_id: $('#sleeve_dia').val(),
					shld_type_id: $('#shoulder').val(),
					shld_orifice_id: $('#shoulder_orifice').val(),
		...
		$("#cap_dia").live('change', function() {
			...
			$.ajax({
				type: "POST",
				url: "<?php echo base_url(); ?>" + "index.php/ajax/get_moulding_cost",
				data: {
					cap_type: $('#cap_type').val(),
					cap_finish: $('#cap_finish').val(),
					sleeve_dia: $('#sleeve_dia').val()
		...
		$("#cap_dia").live('change', function() {
			...
			$.ajax({
				type: "POST",
				url: "<?php echo base_url(); ?>" + "index.php/ajax/get_mould_type",
				data: {
					cap_type_id: $('#cap_type').val()
				},
				cache: false,
		...
		$("#cap_dia").live('change', function() {
			...
			$.ajax({
				type: "POST",
				url: "<?php echo base_url(); ?>" + "index.php/ajax/get_runner_waste",
				data: {
					cap_type_id: $('#cap_type').val()
				},
				cache: false,
		...
		$("#total_box").live('click', function() {
			...
			if ($('#top_box').val() == "" || $('#bottom_box').val() == "" || $('#box_liners').val() == "") {
				...
				$.ajax({
					type: "POST",
					url: "<?php echo base_url('index.php/ajax/get_packing_box_tubes'); ?>",
					data: {
						sleeve_id: $('#sleeve_dia').val()
					},
					cache: false,
		...
		$("#shoulder_foil_tag").live('change', function() {
			...
			$.ajax({
				type: "POST",
				url: "<?php echo base_url(); ?>" + "index.php/ajax/get_shoulder_per_tube",
				data: {
					rm: $('#shoulder_foil_tag').val(),
					sleeve_id: $('#sleeve_dia').val()
				},
		...
		$("#cap_shrink_sleeve").live('change', function() {
			...
			if ($("#cap_shrink_sleeve").val() == 'YES') {
				...
				$("#cap_shrink_sleeve_cost_per_tube").val(cap_shrink_sleeve_cost.toFixed(2));
		...
		$("#tblflag").click(function() {

			var checked = $("#tblflag input[type=checkbox]:checked").length;
		...
		$("#abc").live('mouseover', function(event) {
   		...
   		var cap_foil_cost_view = parseFloat($("#cap_foil_cost_view").text()) ;*/
			...
			//----total of Packing
			total_packing_cost_per_tube = total_box_rate + liner_gm_per_tube + customer_flag + other_packing_material + packing_bopp_tape + packing_stickers + packing_corrugated_sheet + packing_shrink_flim;
			//alert(packing_bopp_tape);
			...
			<tr>
								...
								<fieldset>
									...
									<table class="form_table_inner">
										<tr>
											...
											<input type="hidden" name="version_no" id="version_no" value="<?php echo set_value('version_no', '1'); ?>" readonly>
										</tr>
										<tr>
												...
												<select name="pm_1" id="pm_1">
													<?php if ($purchase_manager == FALSE) {
														...
														foreach ($purchase_manager as $purchase_manager_row) {
															...
															echo "<option value='" . $purchase_manager_row->address_category_contact_id . "' " . set_select('pm_1', '' . $purchase_manager_row->address_category_contact_id . '') . ">" . $purchase_manager_row->contact_name . "</option>";
														}
													} ?>

												</select>
											</td>
											<!-- <td colspan="3"><input type="text" name="pm_1" id="pm_1" value="<?php echo set_value('pm_1'); ?>"  /></td>	 -->
										</tr>
								...
								<fieldset>
									...
									<table class="form_table_inner">
										...
										<tr>
											...
											<td width="25%">
												<select name="sleeve_dia" id="sleeve_dia">
								...
								<fieldset>
									...
									<table class="form_table_inner">
										...
										<tr>
											...
											<td><select name="shoulder" id="shoulder">
										...
										<tr>
											...
											<td colspan="3"><select name="shoulder_orifice" id="shoulder_orifice">
													<option value=''>--Select Orifice--</option>
								...
								<fieldset>
									...
									<table class="form_table_inner">
										...
										<tr>
											...
											<td>
												<select name="cap_type" id="cap_type">
								...
								<fieldset>
									...
									<table class="form_table_inner">
										<tr>
											...
											<td colspan="3"><input type="text" name="freight" id="freight" value="<?php echo set_value('freight', '0'); ?>" />
											</td>
										</tr>
										<!--<tr>
				...
				<td width="40%">
					<table class="form_table_inner">
								...
								<fieldset>
									...
									<table class="form_table_inner" id="tblflag">
										...
										<tr>
											...
											<td width="10%">&nbsp;&nbsp;&nbsp;&nbsp;
												<input type="text" name="job_changeover" id="job_changeover" size="4" value="<?php echo set_value('job_changeover'); ?>" />
											</td>
											<td width="10%">&nbsp;&nbsp;&nbsp;&nbsp;
										...
										<tr>
											...
											<th width="3%">Waste %</th>
											<!-- <th width="10%">Target Contr.</th> -->
											<th width="12%">Contr.</th>
											<th width="12%">Cost</th>
											<th width="12%">Quoted Price</th>
										</tr>
										<tr>
											...
											<td><input type="text" size="3" name="_5k_waste" id="_5k_waste" value="<?php echo set_value('_5k_waste', '0'); ?>" /></td>
										...
										<tr>
											...
											<td><input type="text" size="3" name="_10k_waste" id="_10k_waste" value="<?php echo set_value('_10k_waste', '0'); ?>" /></td>
										...
										<tr>
											...
											<td><input type="text" size="3" name="_25k_waste" id="_25k_waste" value="<?php echo set_value('_25k_waste', '0'); ?>" /></td>
										...
										<tr>
											...
											<td><input type="text" size="3" name="_50k_waste" id="_50k_waste" value="<?php echo set_value('_50k_waste', '0'); ?>" /></td>
										...
										<tr>
											...
											<td><input type="text" size="3" name="_100k_waste" id="_100k_waste" value="<?php echo set_value('_100k_waste', '0'); ?>" /></td>
								...
								<fieldset>
									...
									<table class="form_table_inner">
										...
										<tr>
											...
											<td><input type="file" multiple="" name="userfile"></td>
										</tr>
								...
								<div class="ui red segment">
									<table class="ui very basic collapsing celled table" style="font-size:12px">
										...
										<tbody>
											<tr>
												<td>Tube </td>
												<td><input type="text" readonly="readonly" id="sleeve_cost_view" name="sleeve_cost_view" value="<?php echo set_value('sleeve_cost_view', '0.00'); ?>" size="5"></td>
												<td>Screen Flexo </td>
												<td><input type="text" readonly="readonly" id="screen_flexo_consumable_view" name="screen_flexo_consumable_view" value="<?php echo set_value('screen_flexo_consumable_view', '0.00'); ?>" size="5"></td>
												<td>Packing Box</td>
												<td><input type="text" readonly="readonly" id="packing_box_view" name="packing_box_view" value="<?php echo set_value('packing_box_view', '0.00'); ?>" size="5"></td>
												<td>Local </td>
												<td id="">
													<?php

													$data = array(
														'apply_from_date' => date('Y-m-01', strtotime('-1 year', strtotime(date("Y-m-d")))),
														'apply_to_date' => date('Y-m-t', strtotime('-1 year', strtotime(date("Y-m-d")))),
													...
													if ($result_stores_spares_local) {
														foreach ($result_stores_spares_local as $row) {
															echo "<input type='text' readonly='readonly' id='stores_spares_local_view' name='stores_spares_local_view' value='$row->cost_per_tube' size='5'>";
														}
													} else {
											...
											<tr>
												<td>Shoulder</td>
												<td><input type="text" id="shoulder_cost_view" name="shoulder_cost_view" value="<?php echo set_value('shoulder_cost_view', '0.00'); ?>" size="5"></td>
												<td>Offset </td>
												<td><input type="text" id="offset_consumable_view" name="offset_consumable_view" value="<?php echo set_value('offset_consumable_view', '0.00'); ?>" size="5"></td>
												<td>Liners</td>
												<td><input type="text" readonly="readonly" id="liners_view" name="liners_view" value="<?php echo set_value('liners_view', '0.00'); ?>" size="5"></td>
												<td> Import</td>
												<td id="">
													<?php
													...
													if ($result_stores_spares_import) {
														foreach ($result_stores_spares_import as $row) {
															echo "<input type='text' readonly='readonly' id='stores_spares_import_view' name='stores_spares_import_view' value='$row->cost_per_tube' size='5'>";
														}
													} else {
														echo "Contact to Admin";
													}
											...
											<tr>
												<td>Cap </td>
												<td><input type="text" readonly="readonly" id="cap_cost_view" name="cap_cost_view" value="<?php echo set_value('cap_cost_view', '0.00'); ?>" size="5"></td>
												<td>Decoseam </td>
												<td><input type="text" readonly="readonly" id="spring_consumable_view" name="spring_consumable_view" value="<?php echo set_value('spring_consumable_view', '0.00'); ?>" size="5"></td>
												<td>Export Packing </td>
												<td id="customer_flag_view"><span id=""></span><input type="text" readonly="readonly" id="customer_flag" name="customer_flag" value="<?php echo set_value('customer_flag'); ?>" size="5"></td>
											</tr>


											<tr>
												<td>Lacquer </td>
												<td><input type="text" readonly="readonly" id="lacquer_cost_view" name="lacquer_cost_view" value="<?php echo set_value('lacquer_cost_view', '0.00'); ?>" size="5"></td>
												...
												<td id=""><span id=""></span>
													...
													if ($result_hygenic_consumable) {
														foreach ($result_hygenic_consumable as $row) {
															echo "<input type='text' readonly='readonly' id='hygenic_consumable_view' name='hygenic_consumable_view' value='$row->cost_per_tube' size='5'>";
														}
													} else {
														echo "Contact to Admin";
													}
							...
							<td id=""><span id=""></span>
								...
								if ($result_shrink_flim) {
									foreach ($result_shrink_flim as $row) {
										echo "<input type='text' readonly='readonly' id='packing_shrink_flim' name='packing_shrink_flim' value='$row->cost_per_tube' size='5'>";
									}
								} else {
									echo "Contact to Admin";
								}
						...
						<tr>
							<td>Tube Foil</td>
							<td><input type="text" readonly="readonly" id="tube_foil_cost_view" name="tube_foil_cost_view" value="<?php echo set_value('tube_foil_cost_view', '0.00'); ?>" size="5"></td>
							...
							<td id=""><span id=""></span>
								...
								if ($result_other_consumable) {
									foreach ($result_other_consumable as $row) {
										echo "<input type='text' readonly='readonly' id='other_consumable_view' name='other_consumable_view' value='$row->cost_per_tube' size='5'>";
									}
								} else {
									echo "Contact to Admin";
								}
							...
							<td id=""><span id=""></span>
								...
								if ($result_corrugated_sheet) {
									foreach ($result_corrugated_sheet as $row) {
										echo "<input type='text' readonly='readonly' id='packing_corrugated_sheet' name='packing_corrugated_sheet' value='$row->cost_per_tube' size='5'>";
									}
								} else {
									echo "Contact to Admin";
								}
						...
						<tr>
							<td>Offset Ink </td>
							<td><input type="text" readonly="readonly" id="offset_cost_view" name="offset_cost_view" value="<?php echo set_value('offset_cost_view', '0.00'); ?>" size="5"></td>
							<td>Offset Plate</td>
							<td><input type="text" readonly="readonly" id="offset_plate_cost_view" name="offset_plate_cost_view" value="<?php echo set_value('offset_plate_cost_view', '0.00'); ?>" size="5"></td>
							<td>Bopp Tape </td>
							<td id="">
								<?php
								...
								if ($result_bopp_tape) {
									foreach ($result_bopp_tape as $row) {
										echo "<input type='text' readonly='readonly' id='packing_bopp_tape' name='packing_bopp_tape' value='$row->cost_per_tube' size='5'>";
									}
								} else {
									echo "Contact to Admin";
								}
						...
						<tr>
							...
							<td><input type="text" readonly="readonly" id="screen_flexo_cost_view" name="screen_flexo_cost_view" value="<?php echo set_value('screen_flexo_cost_view', '0.00'); ?>" size="5"></td>
							<td>Screen +ve Film</td>
							<td><input type="text" readonly="readonly" id="screen_plate_cost_view" name="screen_plate_cost_view" value="<?php echo set_value('screen_plate_cost_view', '0.00'); ?>" size="5"></td>
							<td>Stickers </td>
							<td>
								<?php
								...
								if ($result_stickers) {
									foreach ($result_stickers as $row) {
										echo "<input type='text' readonly='readonly' id='packing_stickers' name='packing_stickers' value='$row->cost_per_tube' size='5'>";
									}
								} else {
									echo "Contact to Admin";
								}
						...
						<tr>
							<td>Special Ink </td>
							<td><input type="text" readonly="readonly" id="special_ink_cost_view" name="special_ink_cost_view" value="<?php echo set_value('special_ink_cost_view', '0.00'); ?>" size="5"></td>
							<td>Flexo Plate</td>
							<td><input type="text" readonly="readonly" id="flexo_plate_cost_view" name="flexo_plate_cost_view" value="<?php echo set_value('flexo_plate_cost_view', '0.00'); ?>" size="5"></td>
							...
							<td>
								...
								if ($result_other_packing_material) {
									foreach ($result_other_packing_material as $row) {
										echo "<input type='text' readonly='readonly' id='other_packing_material' name='other_packing_material' value='$row->cost_per_tube' size='5'>";
									}
								} else {
									echo "Contact to Admin";
								}
						...
						<tr>
							<td>Label </td>
							<td><input type="text" readonly="readonly" id="label_cost_view" name="label_cost_view" value="<?php echo set_value('label_cost_view', '0.00'); ?>" size="5"></td>
							<td></td>
							<td><span id=""></span></td>
						</tr>
						...
						<tr>
							<td>Shoulder Foil </td>
							<td><input type="text" readonly="readonly" id="shoulder_foil_cost_view" name="shoulder_foil_cost_view" value="<?php echo set_value('shoulder_foil_cost_view', '0.00'); ?>" size="5"></td>
							<td></td>
							<td><span id=""></span></td>
						</tr>
						...
						<tr>
							<td>Shrink Sleeve </td>
							<td><input type="text" readonly="readonly" id="cap_shrink_sleeve_cost_view" name="cap_shrink_sleeve_cost_view" value="<?php echo set_value('cap_shrink_sleeve_cost_view', '0.00'); ?>" size="5"></td>
							<td></td>
							<td><span id=""></span></td>
						</tr>
						...
						<tr>
							<td>Metalization </td>
							<td><input type="text" readonly="readonly" id="cap_metalization_cost_view" name="cap_metalization_cost_view" value="<?php echo set_value('cap_metalization_cost_view', '0.00'); ?>" size="5"></td>
							<td></td>
							<td><span id=""></span></td>
						</tr>
						...
						<tr>
							<td>Cap foil </td>
							<td><input type="text" readonly="readonly" id="cap_foil_cost_view" name="cap_foil_cost_view" value="<?php echo set_value('cap_foil_cost_view', '0.00'); ?>" size="5"></td>
							<td></td>
							<td><span id=""></span></td>
						</tr>
						...
						<tr>
							<td><b>Total</b></td>
							<td><input type="text" readonly="readonly" name="total_rm_cost_per_tube" id="total_rm_cost_per_tube" value="<?php echo set_value('total_rm_cost_per_tube'); ?>" size="5"></td>
							<td> </td>
							<td><input type="text" readonly="readonly" id="total_consummable_cost_per_tube" name="total_consummable_cost_per_tube" value="<?php echo set_value('total_consummable_cost_per_tube'); ?>" size="5"></td>
							<td> </td>
							<td><input type="text" readonly="readonly" id="total_packing_cost_per_tube" name="total_packing_cost_per_tube" value="<?php echo set_value('total_packing_cost_per_tube'); ?>" size="5"></td>
							<td> </td>
							<td><input type="text" readonly="readonly" id="total_stores_cost_per_tube" name="total_stores_cost_per_tube" value="<?php echo set_value('total_stores_cost_per_tube'); ?>" size="5"></td>
						</tr>

						<tr class="active">
							<td><b>Total</b></td>
							<td><input type="text" readonly="readonly" id="total_cost_per_tube" name="total_cost_per_tube" value="<?php echo set_value('total_cost_per_tube'); ?>" size="5"></td>
							<td><!-- <b>Waste % </b> --></td>
							<td> <input type="text" hidden="hidden" readonly="readonly" name="waste_perc" id="waste_perc" size="5" placeholder="%" value="<?php echo set_value('waste_perc', '0'); ?>" /></td>
							<td><!-- <b> Total Including waste </b> --></td>
							<td><input type="text" readonly="readonly" hidden="hidden" id="waste_total_cost_per_tube" name="waste_total_cost_per_tube" value="<?php echo set_value('waste_total_cost_per_tube'); ?>" size="5"></td>
							<td> </td>
							<td> <span id=""></span></td>
						</tr>
				...
				<tbody>
					<tr>
						<td>
							...
							<input type='hidden' name='layer_7_rm_1' value='LDPE'>
						</td>
						<td rowspan="3">LAYER 1</td>

						<td> LD : <select name="layer_7_rm_1_code" id="layer7_layer1_sl_ldpe">
								<option value='RM-LDPE-000-0009'><?php echo $this->common_model->get_article_name('RM-LDPE-000-0009', $this->session->userdata['logged_in']['company_id']); ?></option>
								<?php
								foreach ($ldpe as $ldpe_row) {
									echo "<option value='" . $ldpe_row->article_no . "' " . set_select('layer_7_rm_1_code', $ldpe_row->article_no) . ">" . $ldpe_row->lang_article_description . "</option>";
								}
								?>
							</select>

						</td>
						<td><input type="text" readonly="readonly" style="background-color: #ddd" id="layer7_layer1_ldpe_rate" name="layer_7_rm_1_rate" value="<?php echo set_value('layer_7_rm_1_rate', ($this->input->post('layer_7_rm_1_code') == 'RM-LDPE-000-0009' ? '' : $this->common_model->get_default_material_rate('RM-LDPE-000-0009'))); ?>" size="5"></td>
						<td rowspan="3"><input type="text" style="width: 7em;" name="layer_7_layer_1_micron" id="layer7_layer1_micron" value="<?php echo set_value('layer_7_layer_1_micron', '20'); ?>" />
						</td>
						<td><input type="number" style="width: 7em;" name="layer_7_rm_1_percentage" id="layer7_layer1_ld_percentage" placeholder="%" value="<?php echo set_value('layer_7_rm_1_percentage', '50'); ?>" />
						</td>
					</tr>
					<tr>
						<td><input type='hidden' name='sr_no[]' value='2'>2 <input type='hidden' name='layer_7_rm_2' value='LLDPE'></td>
						<td> LLD : <select name="layer_7_rm_2_code" id="layer7_layer1_sl_lldpe">
								<option value='RM-LLDPE-000-0008'><?php echo $this->common_model->get_article_name('RM-LLDPE-000-0008', $this->session->userdata['logged_in']['company_id']); ?></option>
								<?php
								foreach ($lldpe as $lldpe_row) {
									echo "<option value='" . $lldpe_row->article_no . "' " . set_select('layer_7_rm_2_code', $lldpe_row->article_no) . ">" . $lldpe_row->lang_article_description . "</option>";
								}
								?>
							</select>

						</td>
						<td><input type="text" readonly="readonly" style="background-color: #ddd" id="layer7_layer1_lldpe_rate" name="layer_7_rm_2_rate" value="<?php echo set_value('layer_7_rm_2_rate', ($this->input->post('layer_7_rm_2_code') == 'RM-LLDPE-000-0008' ? '' : $this->common_model->get_default_material_rate('RM-LLDPE-000-0008'))); ?>" size="5"></td>
						<td><input type="number" style="width: 7em;" name="layer_7_rm_2_percentage" id="layer7_layer1_lld_percentage" placeholder="%" value="<?php echo set_value('layer_7_rm_2_percentage', '50'); ?>" />
					...
					<tr>
						...
						<td> HD : <select name="layer_7_rm_3_code" id="layer7_layer1_sl_hdpe">
								<option value=''>--Select HDPE--</option>
								<?php
								foreach ($hdpe as $hdpe_row) {
									echo "<option value='" . $hdpe_row->article_no . "' " . set_select('layer_7_rm_3_code', $hdpe_row->article_no) . ">" . $hdpe_row->lang_article_description . "</option>";
								}
								?>
							</select>

						</td>
						<td><input type="text" readonly="readonly" style="background-color: #ddd" id="layer7_layer1_hdpe_rate" name="layer_7_rm_3_rate" value="<?php echo set_value('layer_7_rm_3_rate'); ?>" size="5"></td>
						<td><input type="number" style="width: 7em;" name="layer_7_rm_3_percentage" id="layer7_layer1_hd_percentage" placeholder="%" value="<?php echo set_value('layer_7_rm_3_percentage', '0'); ?>" />
					...
					<tr>
						...
						<td> LD : <select name="layer_7_rm_4_code" id="layer7_layer2_sl_ldpe">
								<option value=''>--Select LDPE--</option>
								<?php
								foreach ($ldpe as $ldpe_row) {
									echo "<option value='" . $ldpe_row->article_no . "' " . set_select('layer_7_rm_4_code', $ldpe_row->article_no) . ">" . $ldpe_row->lang_article_description . "</option>";
								}
								?>
							</select>

						</td>
						<td><input type="text" readonly="readonly" style="background-color: #ddd" id="layer7_layer2_ldpe_rate" name="layer_7_rm_4_rate" value="<?php echo set_value('layer_7_rm_4_rate'); ?>" size="5"></td>
						<td rowspan="5"><input type="text" style="width: 7em;" name="layer_7_layer_4_micron" id="layer7_layer2_micron" value="<?php echo set_value('layer_7_layer_4_micron'); ?>" />
						</td>
						<td><input type="number" style="width: 7em;" name="layer_7_rm_4_percentage" id="layer7_layer2_ld_percentage" placeholder="%" value="<?php echo set_value('layer_7_rm_4_percentage', '0'); ?>" />
						</td>
					</tr>
					<tr>
						<td><input type='hidden' name='sr_no[]' value='5'>5 <input type='hidden' name='layer_7_rm_5' value='LLDPE'></td>
						<td> LLD : <select name="layer_7_rm_5_code" id="layer7_layer2_sl_lldpe">
								<option value='RM-LLDPE-000-0008'><?php echo $this->common_model->get_article_name('RM-LLDPE-000-0008', $this->session->userdata['logged_in']['company_id']); ?></option>
								<?php
								foreach ($lldpe as $lldpe_row) {
									echo "<option value='" . $lldpe_row->article_no . "' " . set_select('layer_7_rm_5_code', $lldpe_row->article_no) . ">" . $lldpe_row->lang_article_description . "</option>";
								}
								?>
							</select>

						</td>
						<td><input type="text" readonly="readonly" style="background-color: #ddd" id="layer7_layer2_lldpe_rate" name="layer_7_rm_5_rate" value="<?php echo set_value('layer_7_rm_5_rate', ($this->input->post('layer_7_rm_5_code') == 'RM-LLDPE-000-0008' ? '' : $this->common_model->get_default_material_rate('RM-LLDPE-000-0008'))); ?>" size="5"></td>
						<td><input type="number" style="width: 7em;" name="layer_7_rm_5_percentage" id="layer7_layer2_lld_percentage" placeholder="%" value="<?php echo set_value('layer_7_rm_5_percentage', '50'); ?>" />
					...
					<tr>
						...
						<td> HD : <select name="layer_7_rm_6_code" id="layer7_layer2_sl_hdpe">
								<option value='RM-HDPE-000-0008'><?php echo $this->common_model->get_article_name('RM-HDPE-000-0008', $this->session->userdata['logged_in']['company_id']); ?></option>
								<?php
								foreach ($hdpe as $hdpe_row) {
									echo "<option value='" . $hdpe_row->article_no . "' " . set_select('layer_7_rm_6_code', $hdpe_row->article_no) . ">" . $hdpe_row->lang_article_description . "</option>";
								}
								?>
							</select>

						</td>
						<td><input type="text" readonly="readonly" style="background-color: #ddd" id="layer7_layer2_hdpe_rate" name="layer_7_rm_6_rate" value="<?php echo set_value('layer_7_rm_6_rate', ($this->input->post('layer_7_rm_6_code') == 'RM-HDPE-000-0008' ? '' : $this->common_model->get_default_material_rate('RM-HDPE-000-0008'))); ?>" size="5"></td>
						<td><input type="number" style="width: 7em;" name="layer_7_rm_6_percentage" id="layer7_layer2_hd_percentage" placeholder="%" value="<?php echo set_value('layer_7_rm_6_percentage', '50'); ?>" />
					...
					<tr>
						...
						<td> MB : <select name="layer_7_rm_7_code" id="layer7_layer_2_rm_7_code">
								<option value=''>--Select MB--</option>
								<?php foreach ($masterbatch as $masterbatch_row) {
									echo "<option value='" . $masterbatch_row->article_no . "' " . set_select('layer_7_rm_7_code', $masterbatch_row->article_no) . ">" . $masterbatch_row->lang_article_description . "</option>";
								} ?>
							</select>

						</td>
						<td><input type="text" readonly="readonly" style="background-color: #ddd" id="layer7_layer_2_rm_7_rate" name="layer_7_rm_7_rate" value="<?php echo set_value('layer_7_rm_7_rate'); ?>" size="5"></td>
						<td><input type="number" style="width: 7em;" name="layer_7_rm_7_percentage" id="layer7_layer_2_rm_7_percentage" placeholder="%" value="<?php echo set_value('layer_7_rm_7_percentage', '0'); ?>" />
					...
					<tr>
						...
						<td> MB : <input type="text" size="25" name="layer_7_rm_8_code" id="layer7_layer_2_rm_8_code" placeholder="If MB is not in system" value="<?php echo set_value('layer_7_rm_8_code'); ?>" />

						</td>
						<td><input type="text" size="5" name="layer_7_rm_8_rate" id="layer7_layer_2_rm_8_rate" value="<?php echo set_value('layer_7_rm_8_rate'); ?>" /></td>
						<td><input type="number" style="width: 7em;" name="layer_7_rm_8_percentage" id="layer7_layer_2_rm_8_percentage" placeholder="%" value="<?php echo set_value('layer_7_rm_8_percentage', '0'); ?>" />
					...
					<tr>
						...
						<td> ADMER : <select name="layer_7_rm_9_code" id="layer7_layer3_admer">
								<option value='RM-TL-000-0009'><?php echo $this->common_model->get_article_name('RM-TL-000-0009', $this->session->userdata['logged_in']['company_id']); ?></option>
								<?php
								foreach ($admer as $admer_row) {
									echo "<option value='" . $admer_row->article_no . "' " . set_select('layer_7_rm_9_code', $admer_row->article_no) . ">" . $admer_row->lang_article_description . "</option>";
								}
								?>
							</select>

						</td>
						<td><input type="text" readonly="readonly" style="background-color: #ddd" id="layer7_layer3_admer_rate" name="layer_7_rm_9_rate" value="<?php echo set_value('layer_7_rm_9_rate', ($this->input->post('layer_7_rm_9_code') == 'RM-TL-000-0009' ? '' : $this->common_model->get_default_material_rate('RM-TL-000-0009'))); ?>" size="5"></td>
						<td><input type="text" style="width: 7em;" name="layer_7_layer_9_micron" id="layer7_layer3_micron" value="<?php echo set_value('layer_7_layer_9_micron', '10'); ?>" />
						</td>
						<td><input type="number" style="width: 7em;" name="layer_7_rm_9_percentage" id="layer7_layer3_admer_percentage" placeholder="%" value="<?php echo set_value('layer_7_rm_9_percentage', '100'); ?>" />
						</td>
					</tr>
					...
					<tr>
						...
						<td> EVOH : <select name="layer_7_rm_10_code" id="layer7_layer4_evoh">
								<option value='000-RM-EV-0008'><?php echo $this->common_model->get_article_name('000-RM-EV-0008', $this->session->userdata['logged_in']['company_id']); ?></option>
								<?php
								foreach ($evoh as $evoh_row) {
									echo "<option value='" . $evoh_row->article_no . "' " . set_select('layer_7_rm_10_code', $evoh_row->article_no) . ">" . $evoh_row->lang_article_description . "</option>";
								}
								?>
							</select>

						</td>
						<td><input type="text" readonly="readonly" style="background-color: #ddd" id="layer7_layer4_evoh_rate" name="layer_7_rm_10_rate" value="<?php echo set_value('layer_7_rm_10_rate', ($this->input->post('layer_7_rm_10_code') == '000-RM-EV-0008' ? '' : $this->common_model->get_default_material_rate('000-RM-EV-0008'))); ?>" size="5"></td>
						<td><input type="text" style="width: 7em;" name="layer_7_layer_10_micron" id="layer7_layer4_micron" value="<?php echo set_value('layer_7_layer_10_micron', '25'); ?>" />
						</td>
						<td><input type="number" style="width: 7em;" name="layer_7_rm_10_percentage" id="layer7_layer4_evoh_percentage" placeholder="%" value="<?php echo set_value('layer_7_rm_10_percentage', '100'); ?>" />
						</td>
					</tr>
					...
					<tr>
						...
						<td> ADMER : <select name="layer_7_rm_11_code" id="layer7_layer5_admer">
								<option value='RM-TL-000-0009'><?php echo $this->common_model->get_article_name('RM-TL-000-0009', $this->session->userdata['logged_in']['company_id']); ?></option>
								<?php
								foreach ($admer as $admer_row) {
									echo "<option value='" . $admer_row->article_no . "' " . set_select('layer_7_rm_11_code', $admer_row->article_no) . ">" . $admer_row->lang_article_description . "</option>";
								}
								?>
							</select>

						</td>
						<td><input type="text" readonly="readonly" style="background-color: #ddd" id="layer7_layer5_admer_rate" name="layer_7_rm_11_rate" value="<?php echo set_value('layer_7_rm_11_rate', ($this->input->post('layer_7_rm_11_code') == 'RM-TL-000-0009' ? '' : $this->common_model->get_default_material_rate('RM-TL-000-0009'))); ?>" size="5"></td>
						<td><input type="text" style="width: 7em;" name="layer_7_layer_11_micron" id="layer7_layer5_micron" value="<?php echo set_value('layer_7_layer_11_micron', '10'); ?>" />
						</td>
						<td><input type="number" style="width: 7em;" name="layer_7_rm_11_percentage" id="layer7_layer5_admer_percentage" placeholder="%" value="<?php echo set_value('layer_7_rm_11_percentage', '100'); ?>" />
						</td>
					</tr>
					...
					<tr>
						...
						<td> LD : <select name="layer_7_rm_12_code" id="layer7_layer6_sl_ldpe">
								<option value=''>--Select LDPE--</option>
								<?php
								foreach ($ldpe as $ldpe_row) {
									echo "<option value='" . $ldpe_row->article_no . "' " . set_select('layer_7_rm_12_code', $ldpe_row->article_no) . ">" . $ldpe_row->lang_article_description . "</option>";
								}
								?>
							</select>

						</td>
						<td><input type="text" readonly="readonly" style="background-color: #ddd" id="layer7_layer6_ldpe_rate" name="layer_7_rm_12_rate" value="<?php echo set_value('layer_7_rm_12_rate'); ?>" size="5"></td>
						<td rowspan="5"><input type="text" style="width: 7em;" name="layer_7_layer_12_micron" id="layer7_layer6_micron" class="number3" value="<?php echo set_value('layer_7_layer_12_micron'); ?>" />
						</td>
						<td><input type="number" style="width: 7em;" name="layer_7_rm_12_percentage" id="layer7_layer6_ld_percentage" placeholder="%" value="<?php echo set_value('layer_7_rm_12_percentage', '0'); ?>" />
						</td>
					</tr>
					<tr>
						<td><input type='hidden' name='sr_no[]' value='13'>13 <input type='hidden' name='layer_7_rm_13' value='LLDPE'></td>
						<td> LLD : <select name="layer_7_rm_13_code" id="layer7_layer6_sl_lldpe">
								<option value='RM-LLDPE-000-0008'><?php echo $this->common_model->get_article_name('RM-LLDPE-000-0008', $this->session->userdata['logged_in']['company_id']); ?></option>
								<?php
								foreach ($lldpe as $lldpe_row) {
									echo "<option value='" . $lldpe_row->article_no . "' " . set_select('layer_7_rm_13_code', $lldpe_row->article_no) . ">" . $lldpe_row->lang_article_description . "</option>";
								}
								?>
							</select>

						</td>
						<td><input type="text" readonly="readonly" style="background-color: #ddd" id="layer7_layer6_lldpe_rate" name="layer_7_rm_13_rate" value="<?php echo set_value('layer_7_rm_13_rate', ($this->input->post('layer_7_rm_13_code') == 'RM-LLDPE-000-0008' ? '' : $this->common_model->get_default_material_rate('RM-LLDPE-000-0008'))); ?>" size="5"></td>
						<td><input type="number" style="width: 7em;" name="layer_7_rm_13_percentage" id="layer7_layer6_lld_percentage" placeholder="%" value="<?php echo set_value('layer_7_rm_13_percentage', '50'); ?>" />
					...
					<tr>
						...
						<td> HD : <select name="layer_7_rm_14_code" id="layer7_layer6_sl_hdpe">
								<option value='RM-HDPE-000-0008'><?php echo $this->common_model->get_article_name('RM-HDPE-000-0008', $this->session->userdata['logged_in']['company_id']); ?></option>
								<?php
								foreach ($hdpe as $hdpe_row) {
									echo "<option value='" . $hdpe_row->article_no . "' " . set_select('layer_7_rm_14_code', $hdpe_row->article_no) . ">" . $hdpe_row->lang_article_description . "</option>";
								}
								?>
							</select>

						</td>
						<td><input type="text" readonly="readonly" style="background-color: #ddd" id="layer7_layer6_hdpe_rate" name="layer_7_rm_14_rate" value="<?php echo set_value('layer_7_rm_14_rate', ($this->input->post('layer_7_rm_14_code') == 'RM-HDPE-000-0008' ? '' : $this->common_model->get_default_material_rate('RM-HDPE-000-0008'))); ?>" size="5"></td>
						<td><input type="number" style="width: 7em;" name="layer_7_rm_14_percentage" id="layer7_layer6_hd_percentage" placeholder="%" value="<?php echo set_value('layer_7_rm_14_percentage', '50'); ?>" />
					...
					<tr>
						...
						<td> MB : <select name="layer_7_rm_15_code" id="layer7_layer_6_rm_15_code">
								<option value=''>--Select MB--</option>
								<?php foreach ($masterbatch as $masterbatch_row) {
									echo "<option value='" . $masterbatch_row->article_no . "' " . set_select('layer_7_rm_15_code', $masterbatch_row->article_no) . ">" . $masterbatch_row->lang_article_description . "</option>";
								} ?>
							</select>

						</td>
						<td><input type="text" readonly="readonly" style="background-color: #ddd" id="layer7_layer_6_rm_15_rate" name="layer_7_rm_15_rate" value="<?php echo set_value('layer_7_rm_15_rate'); ?>" size="5"></td>
						<td><input type="number" style="width: 7em;" name="layer_7_rm_15_percentage" id="layer7_layer_6_rm_15_percentage" placeholder="%" value="<?php echo set_value('layer_7_rm_15_percentage', '0'); ?>" />
					...
					<tr>
						...
						<td> MB : <input type="text" size="25" name="layer_7_rm_16_code" id="layer7_layer_6_rm_16_code" placeholder="If MB is not in system" value="<?php echo set_value('layer_7_rm_16_code'); ?>" />

						</td>
						<td><input type="text" size="5" name="layer_7_rm_16_rate" id="layer7_layer_6_rm_16_rate" value="<?php echo set_value('layer_7_rm_16_rate'); ?>" /></td>
						<td><input type="number" style="width: 7em;" name="layer_7_rm_16_percentage" id="layer7_layer_6_rm_16_percentage" placeholder="%" value="<?php echo set_value('layer_7_rm_16_percentage', '0'); ?>" />
					...
					<tr>
						...
						<td> LD : <select name="layer_7_rm_17_code" id="layer7_layer7_sl_ldpe">
								<option value='RM-LDPE-000-0009'><?php echo $this->common_model->get_article_name('RM-LDPE-000-0009', $this->session->userdata['logged_in']['company_id']); ?></option>
								<?php
								foreach ($ldpe as $ldpe_row) {
									echo "<option value='" . $ldpe_row->article_no . "' " . set_select('layer_7_rm_17_code', $ldpe_row->article_no) . ">" . $ldpe_row->lang_article_description . "</option>";
								}
								?>
							</select>

						</td>
						<td><input type="text" readonly="readonly" style="background-color: #ddd" id="layer7_layer7_ldpe_rate" name="layer_7_rm_17_rate" value="<?php echo set_value('layer_7_rm_17_rate', ($this->input->post('layer_7_rm_17_code') == 'RM-LDPE-000-0009' ? '' : $this->common_model->get_default_material_rate('RM-LDPE-000-0009'))); ?>" size="5"></td>
						<td rowspan="3"><input type="text" style="width: 7em;" name="layer_7_layer_17_micron" id="layer7_layer7_micron" class="number3" value="<?php echo set_value('layer_7_layer_17_micron', '20'); ?>" />
						</td>
						<td><input type="number" style="width: 7em;" name="layer_7_rm_17_percentage" id="layer7_layer7_ld_percentage" placeholder="%" value="<?php echo set_value('layer_7_rm_17_percentage', '50'); ?>" />
						</td>
					</tr>
					<tr>
						<td><input type='hidden' name='sr_no[]' value='18'>18 <input type='hidden' name='layer_7_rm_18' value='LLDPE'></td>
						<td> LLD : <select name="layer_7_rm_18_code" id="layer7_layer7_sl_lldpe">
								<option value='RM-LLDPE-000-0008'><?php echo $this->common_model->get_article_name('RM-LLDPE-000-0008', $this->session->userdata['logged_in']['company_id']); ?></option>
								<?php
								foreach ($lldpe as $lldpe_row) {
									echo "<option value='" . $lldpe_row->article_no . "' " . set_select('layer_7_rm_18_code', $lldpe_row->article_no) . ">" . $lldpe_row->lang_article_description . "</option>";
								}
								?>
							</select>

						</td>
						<td><input type="text" readonly="readonly" style="background-color: #ddd" id="layer7_layer7_lldpe_rate" name="layer_7_rm_18_rate" value="<?php echo set_value('layer_7_rm_18_rate', ($this->input->post('layer_7_rm_18_code') == 'RM-LLDPE-000-0008' ? '' : $this->common_model->get_default_material_rate('RM-LLDPE-000-0008'))); ?>" size="5"></td>
						<td><input type="number" style="width: 7em;" name="layer_7_rm_18_percentage" id="layer7_layer7_lld_percentage" placeholder="%" value="<?php echo set_value('layer_7_rm_18_percentage', '50'); ?>" />
					...
					<tr>
						...
						<td> HD : <select name="layer_7_rm_19_code" id="layer7_layer7_sl_hdpe">
								<option value=''>--Select HDPE--</option>
								<?php
								foreach ($hdpe as $hdpe_row) {
									echo "<option value='" . $hdpe_row->article_no . "' " . set_select('layer_7_rm_19_code', $hdpe_row->article_no) . ">" . $hdpe_row->lang_article_description . "</option>";
								}
								?>
							</select>

						</td>
						<td><input type="text" readonly="readonly" style="background-color: #ddd" id="layer7_layer7_hdpe_rate" name="layer_7_rm_19_rate" value="<?php echo set_value('layer_7_rm_19_rate'); ?>" size="5"></td>
						<td><input type="number" style="width: 7em;" name="layer_7_rm_19_percentage" id="layer7_layer7_hd_percentage" placeholder="%" value="<?php echo set_value('layer_7_rm_19_percentage', '0'); ?>" />
							<input type="hidden" name="layer_7_layer_19_micron" value="<?php echo set_value('layer_7_layer_19_micron'); ?>" />
						</td>
					</tr>

					<tr>
						<td colspan="5">Rejection %</td>
						<td> <input type="number" style="width: 7em;" name="layer7_rejection" id="layer7_rejection" value="<?php echo set_value('layer7_rejection', '15'); ?>" /> </td>
					</tr>
					...
					<tr>
						<td colspan="5"><span class="ui green label" id="layer7_sleevecost">ADD</span></td>

						<td><input readonly="readonly" type="number" style="width: 7em;" name="layer7_sleeve_cost" id="layer7_sleeve_cost" value="<?php echo set_value('layer7_sleeve_cost'); ?>" />
						</td>
				...
				<tbody>
					<tr>
						<td>
							...
							<input type='hidden' name='sr_no[]' value='1'>1
							<input type='hidden' name='layer_5_rm_1' value='LDPE'>
						</td>
						<td rowspan="5">LAYER 1</td>

						<td> LD : <select name="layer_5_rm_1_code" id="layer5_layer1_sl_ldpe">
								<option value='RM-LDPE-000-0009'><?php echo $this->common_model->get_article_name('RM-LDPE-000-0009', $this->session->userdata['logged_in']['company_id']); ?></option>
								<?php
								foreach ($ldpe as $ldpe_row) {
									echo "<option value='" . $ldpe_row->article_no . "' " . set_select('layer_5_rm_1_code', $ldpe_row->article_no) . ">" . $ldpe_row->lang_article_description . "</option>";
								}
								?>
							</select>

						</td>
						<td><input type="text" readonly="readonly" style="background-color: #ddd" id="layer5_layer1_ldpe_rate" name="layer_5_rm_1_rate" value="<?php echo set_value('layer_5_rm_1_rate', ($this->input->post('layer_5_rm_1_code') == 'RM-LDPE-000-0009' ? '' : $this->common_model->get_default_material_rate('RM-LDPE-000-0009'))); ?>" size="5"></td>
						<td rowspan="5"><input type="text" style="width: 7em;" name="layer_5_layer_1_micron" id="layer5_layer1_micron" value="<?php echo set_value('layer_5_layer_1_micron'); ?>" />
						</td>
						<td><input type="number" style="width: 7em;" name="layer_5_rm_1_percentage" id="layer5_layer1_ld_percentage" placeholder="%" value="<?php echo set_value('layer_5_rm_1_percentage', '70'); ?>" />
						</td>
					</tr>
					<tr>
						<td><input type='hidden' name='sr_no[]' value='2'>2 <input type='hidden' name='layer_5_rm_2' value='LLDPE'></td>
						<td> LLD : <select name="layer_5_rm_2_code" id="layer5_layer1_sl_lldpe">
								<option value='RM-LLDPE-000-0008'><?php echo $this->common_model->get_article_name('RM-LLDPE-000-0008', $this->session->userdata['logged_in']['company_id']); ?></option>
								<?php
								foreach ($lldpe as $lldpe_row) {
									echo "<option value='" . $lldpe_row->article_no . "' " . set_select('layer_5_rm_2_code', $lldpe_row->article_no) . ">" . $lldpe_row->lang_article_description . "</option>";
								}
								?>
							</select>

						</td>
						<td><input type="text" readonly="readonly" style="background-color: #ddd" id="layer5_layer1_lldpe_rate" name="layer_5_rm_2_rate" value="<?php echo set_value('layer_5_rm_2_rate', ($this->input->post('layer_5_rm_2_code') == 'RM-LLDPE-000-0008' ? '' : $this->common_model->get_default_material_rate('RM-LLDPE-000-0008'))); ?>" size="5"></td>
						<td><input type="number" style="width: 7em;" name="layer_5_rm_2_percentage" id="layer5_layer1_lld_percentage" placeholder="%" value="<?php echo set_value('layer_5_rm_2_percentage', '30'); ?>" />
					...
					<tr>
						...
						<td> HD : <select name="layer_5_rm_3_code" id="layer5_layer1_sl_hdpe">
								<option value=''>--Select HDPE--</option>
								<?php
								foreach ($hdpe as $hdpe_row) {
									echo "<option value='" . $hdpe_row->article_no . "' " . set_select('layer_5_rm_3_code', $hdpe_row->article_no) . ">" . $hdpe_row->lang_article_description . "</option>";
								}
								?>
							</select>

						</td>
						<td><input type="text" readonly="readonly" style="background-color: #ddd" id="layer5_layer1_hdpe_rate" name="layer_5_rm_3_rate" value="<?php echo set_value('layer_5_rm_3_rate'); ?>" size="5"></td>
						<td><input type="number" style="width: 7em;" name="layer_5_rm_3_percentage" id="layer5_layer1_hd_percentage" placeholder="%" value="<?php echo set_value('layer_5_rm_3_percentage', '0'); ?>" />
					...
					<tr>
						...
						<td> MB : <select name="layer_5_rm_4_code" id="layer5_layer_1_rm_4_code">
								<option value=''>--Select MB--</option>
								<?php foreach ($masterbatch as $masterbatch_row) {
									echo "<option value='" . $masterbatch_row->article_no . "' " . set_select('layer_5_rm_4_code', $masterbatch_row->article_no) . ">" . $masterbatch_row->lang_article_description . "</option>";
								} ?>
							</select>

						</td>
						<td><input type="text" readonly="readonly" style="background-color: #ddd" id="layer5_layer_1_rm_4_rate" name="layer_5_rm_4_rate" value="<?php echo set_value('layer_5_rm_4_rate'); ?>" size="5"></td>
						<td><input type="number" style="width: 7em;" name="layer_5_rm_4_percentage" id="layer5_layer_1_rm_4_percentage" placeholder="%" value="<?php echo set_value('layer_5_rm_4_percentage', '0'); ?>" />
					...
					<tr>
						...
						<td> MB : <input type="text" size="25" name="layer_5_rm_5_code" id="layer5_layer_1_rm_5_code" placeholder="If MB is not in system" value="<?php echo set_value('layer_5_rm_5_code'); ?>" />

						</td>
						<td><input type="text" size="5" name="layer_5_rm_5_rate" id="layer5_layer_1_rm_5_rate" value="<?php echo set_value('layer_5_rm_5_rate'); ?>" /></td>
						<td><input type="number" style="width: 7em;" name="layer_5_rm_5_percentage" id="layer5_layer_1_rm_5_percentage" placeholder="%" value="<?php echo set_value('layer_5_rm_5_percentage', '0'); ?>" />
					...
					<tr>
						...
						<td> ADMER : <select name="layer_5_rm_6_code" id="layer5_layer2_admer">
								<option value='RM-TL-000-0009'><?php echo $this->common_model->get_article_name('RM-TL-000-0009', $this->session->userdata['logged_in']['company_id']); ?></option>
								<?php
								foreach ($admer as $admer_row) {
									echo "<option value='" . $admer_row->article_no . "' " . set_select('layer_5_rm_6_code', $admer_row->article_no) . ">" . $admer_row->lang_article_description . "</option>";
								}
								?>
							</select>

						</td>
						<td><input type="text" readonly="readonly" style="background-color: #ddd" id="layer5_layer2_admer_rate" name="layer_5_rm_6_rate" value="<?php echo set_value('layer_5_rm_6_rate', ($this->input->post('layer_5_rm_6_code') == 'RM-TL-000-0009' ? '' : $this->common_model->get_default_material_rate('RM-TL-000-0009'))); ?>" size="5"></td>
						<td><input type="text" style="width: 7em;" name="layer_5_layer_6_micron" id="layer5_layer2_micron" value="<?php echo set_value('layer_5_layer_6_micron', '15'); ?>" />
						</td>
						<td><input type="number" style="width: 7em;" name="layer_5_rm_6_percentage" id="layer5_layer2_admer_percentage" placeholder="%" value="<?php echo set_value('layer_5_rm_6_percentage', '100'); ?>" />
						</td>
					</tr>
					...
					<tr>
						...
						<td> EVOH : <select name="layer_5_rm_7_code" id="layer5_layer3_evoh">
								<option value='000-RM-EV-0008'><?php echo $this->common_model->get_article_name('000-RM-EV-0008', $this->session->userdata['logged_in']['company_id']); ?></option>
								<?php
								foreach ($evoh as $evoh_row) {
									echo "<option value='" . $evoh_row->article_no . "' " . set_select('layer_5_rm_7_code', $evoh_row->article_no) . ">" . $evoh_row->lang_article_description . "</option>";
								}
								?>
							</select>

						</td>
						<td><input type="text" readonly="readonly" style="background-color: #ddd" id="layer5_layer3_evoh_rate" name="layer_5_rm_7_rate" value="<?php echo set_value('layer_5_rm_7_rate', ($this->input->post('layer_5_rm_7_code') == '000-RM-EV-0008' ? '' : $this->common_model->get_default_material_rate('000-RM-EV-0008'))); ?>" size="5"></td>
						<td><input type="text" style="width: 7em;" name="layer_5_layer_7_micron" id="layer5_layer3_micron" value="<?php echo set_value('layer_5_layer_7_micron', '25'); ?>" />
						</td>
						<td><input type="number" style="width: 7em;" name="layer_5_rm_7_percentage" id="layer5_layer3_evoh_percentage" placeholder="%" value="<?php echo set_value('layer_5_rm_7_percentage', '100'); ?>" />
						</td>
					</tr>
					...
					<tr>
						...
						<td> ADMER : <select name="layer_5_rm_8_code" id="layer5_layer4_admer">
								<option value='RM-TL-000-0009'><?php echo $this->common_model->get_article_name('RM-TL-000-0009', $this->session->userdata['logged_in']['company_id']); ?></option>
								<?php
								foreach ($admer as $admer_row) {
									echo "<option value='" . $admer_row->article_no . "' " . set_select('layer_5_rm_8_code', $admer_row->article_no) . ">" . $admer_row->lang_article_description . "</option>";
								}
								?>
							</select>

						</td>
						<td><input type="text" readonly="readonly" style="background-color: #ddd" id="layer5_layer4_admer_rate" name="layer_5_rm_8_rate" value="<?php echo set_value('layer_5_rm_8_rate', ($this->input->post('layer_5_rm_8_code') == 'RM-TL-000-0009' ? '' : $this->common_model->get_default_material_rate('RM-TL-000-0009'))); ?>" size="5"></td>
						<td><input type="text" style="width: 7em;" name="layer_5_layer_8_micron" id="layer5_layer4_micron" value="<?php echo set_value('layer_5_layer_8_micron', '15'); ?>" />
						</td>
						<td><input type="number" style="width: 7em;" name="layer_5_rm_8_percentage" id="layer5_layer4_admer_percentage" placeholder="%" value="<?php echo set_value('layer_5_rm_8_percentage', '100'); ?>" />
						</td>
					</tr>
					...
					<tr>
						...
						<td> LD : <select name="layer_5_rm_9_code" id="layer5_layer5_sl_ldpe">
								<option value='RM-LDPE-000-0009'><?php echo $this->common_model->get_article_name('RM-LDPE-000-0009', $this->session->userdata['logged_in']['company_id']); ?></option>
								<?php
								foreach ($ldpe as $ldpe_row) {
									echo "<option value='" . $ldpe_row->article_no . "' " . set_select('layer_5_rm_9_code', $ldpe_row->article_no) . ">" . $ldpe_row->lang_article_description . "</option>";
								}
								?>
							</select>

						</td>
						<td><input type="text" readonly="readonly" style="background-color: #ddd" id="layer5_layer5_ldpe_rate" name="layer_5_rm_9_rate" value="<?php echo set_value('layer_5_rm_9_rate', ($this->input->post('layer_5_rm_9_code') == 'RM-LDPE-000-0009' ? '' : $this->common_model->get_default_material_rate('RM-LDPE-000-0009'))); ?>" size="5"></td>
						<td rowspan="5"><input type="text" style="width: 7em;" name="layer_5_layer_9_micron" id="layer5_layer5_micron" value="<?php echo set_value('layer_5_layer_9_micron'); ?>" />
						</td>
						<td><input type="number" style="width: 7em;" name="layer_5_rm_9_percentage" id="layer5_layer5_ld_percentage" placeholder="%" value="<?php echo set_value('layer_5_rm_9_percentage', '70'); ?>" />
						</td>
					</tr>
					<tr>
						<td><input type='hidden' name='sr_no[]' value='10'>10 <input type='hidden' name='layer_5_rm_10' value='LLDPE'></td>
						<td> LLD : <select name="layer_5_rm_10_code" id="layer5_layer5_sl_lldpe">
								<option value='RM-LLDPE-000-0008'><?php echo $this->common_model->get_article_name('RM-LLDPE-000-0008', $this->session->userdata['logged_in']['company_id']); ?></option>
								<?php
								foreach ($lldpe as $lldpe_row) {
									echo "<option value='" . $lldpe_row->article_no . "' " . set_select('layer_5_rm_10_code', $lldpe_row->article_no) . ">" . $lldpe_row->lang_article_description . "</option>";
								}
								?>
							</select>

						</td>
						<td><input type="text" readonly="readonly" style="background-color: #ddd" id="layer5_layer5_lldpe_rate" name="layer_5_rm_10_rate" value="<?php echo set_value('layer_5_rm_10_rate', ($this->input->post('layer_5_rm_10_code') == 'RM-LLDPE-000-0008' ? '' : $this->common_model->get_default_material_rate('RM-LLDPE-000-0008'))); ?>" size="5"></td>
						<td><input type="number" style="width: 7em;" name="layer_5_rm_10_percentage" id="layer5_layer5_lld_percentage" placeholder="%" value="<?php echo set_value('layer_5_rm_10_percentage', '30'); ?>" />
					...
					<tr>
						...
						<td> HD : <select name="layer_5_rm_11_code" id="layer5_layer5_sl_hdpe">
								<option value=''>--Select HDPE--</option>
								<?php
								foreach ($hdpe as $hdpe_row) {
									echo "<option value='" . $hdpe_row->article_no . "' " . set_select('layer_5_rm_11_code', $hdpe_row->article_no) . ">" . $hdpe_row->lang_article_description . "</option>";
								}
								?>
							</select>

						</td>
						<td><input type="text" readonly="readonly" style="background-color: #ddd" id="layer5_layer5_hdpe_rate" name="layer_5_rm_11_rate" value="<?php echo set_value('layer_5_rm_11_rate'); ?>" size="5"></td>
						<td><input type="number" style="width: 7em;" name="layer_5_rm_11_percentage" id="layer5_layer5_hd_percentage" placeholder="%" value="<?php echo set_value('layer_5_rm_11_percentage', '0'); ?>" />
					...
					<tr>
						...
						<td> MB : <select name="layer_5_rm_12_code" id="layer5_layer_5_rm_12_code">
								<option value=''>--Select MB--</option>
								<?php foreach ($masterbatch as $masterbatch_row) {
									echo "<option value='" . $masterbatch_row->article_no . "' " . set_select('layer_5_rm_12_code', $masterbatch_row->article_no) . ">" . $masterbatch_row->lang_article_description . "</option>";
								} ?>
							</select>

						</td>
						<td><input type="text" readonly="readonly" style="background-color: #ddd" id="layer5_layer_5_rm_12_rate" name="layer_5_rm_12_rate" value="<?php echo set_value('layer_5_rm_12_rate'); ?>" size="5"></td>
						<td><input type="number" style="width: 7em;" name="layer_5_rm_12_percentage" id="layer5_layer_5_rm_12_percentage" placeholder="%" value="<?php echo set_value('layer_5_rm_12_percentage', '0'); ?>" />
					...
					<tr>
						...
						<td> MB : <input type="text" size="25" name="layer_5_rm_13_code" id="layer5_layer_5_rm_13_code" placeholder="If MB is not in system" value="<?php echo set_value('layer_5_rm_13_code'); ?>" />

						</td>
						<td><input type="text" name="layer_5_rm_13_rate" id="layer5_layer_5_rm_13_rate" value="<?php echo set_value('layer_5_rm_13_rate'); ?>" size="5" /></td>
						<td><input type="number" style="width: 7em;" name="layer_5_rm_13_percentage" id="layer5_layer_5_rm_13_percentage" placeholder="%" value="<?php echo set_value('layer_5_rm_13_percentage', '0'); ?>" />
					...
					<tr>
						<td colspan="5">Rejection %</td>
						<td> <input type="number" style="width: 7em;" name="layer5_rejection" id="layer5_rejection" value="<?php echo set_value('layer5_rejection', '15'); ?>" /> </td>
					</tr>
					...
					<tr>
						<td colspan="5"><span class="ui green label" id="layer5_sleevecost">ADD</span></td>
						<td><input readonly="readonly" type="number" style="width: 7em;" name="layer5_sleeve_cost" id="layer5_sleeve_cost" value="<?php echo set_value('layer5_sleeve_cost'); ?>" />
						</td>
				...
				<tbody>
					<tr>
						<td>
							...
							<input type='hidden' name='sr_no[]' value='1'>1
							<input type='hidden' name='layer_3_rm_1' value='LDPE'>
						</td>
						<td rowspan="5">LAYER 1</td>

						<td> LD : <select name="layer_3_rm_1_code" id="layer3_layer1_sl_ldpe">
								<option value='RM-LDPE-000-0009'><?php echo $this->common_model->get_article_name('RM-LDPE-000-0009', $this->session->userdata['logged_in']['company_id']); ?></option>
								<?php
								foreach ($ldpe as $ldpe_row) {
									echo "<option value='" . $ldpe_row->article_no . "' " . set_select('layer_3_rm_1_code', $ldpe_row->article_no) . ">" . $ldpe_row->lang_article_description . "</option>";
								}
								?>
							</select>

						</td>
						<td><input type="text" readonly="readonly" style="background-color: #ddd" id="layer3_layer1_ldpe_rate" name="layer_3_rm_1_rate" value="<?php echo set_value('layer_3_rm_1_rate', ($this->input->post('layer_3_rm_1_code') == 'RM-LDPE-000-0009' ? '' : $this->common_model->get_default_material_rate('RM-LDPE-000-0009'))); ?>" size="5"></td>
						<td rowspan="5"><input type="text" style="width: 7em;" name="layer_3_layer_1_micron" id="layer3_layer1_micron" class="number3" value="<?php echo set_value('layer_3_layer_1_micron'); ?>" />
						</td>
						<td><input type="number" style="width: 7em;" name="layer_3_rm_1_percentage" id="layer3_layer1_ld_percentage" placeholder="%" class="number3" value="<?php echo set_value('layer_3_rm_1_percentage', '70'); ?>" />
						</td>
					</tr>
					<tr>
						<td><input type='hidden' name='sr_no[]' value='2'>2 <input type='hidden' name='layer_3_rm_2' value='LLDPE'></td>
						<td> LLD : <select name="layer_3_rm_2_code" id="layer3_layer1_sl_lldpe">
								<option value='RM-LLDPE-000-0008'><?php echo $this->common_model->get_article_name('RM-LLDPE-000-0008', $this->session->userdata['logged_in']['company_id']); ?></option>
								<?php
								foreach ($lldpe as $lldpe_row) {
									echo "<option value='" . $lldpe_row->article_no . "' " . set_select('layer_3_rm_2_code', $lldpe_row->article_no) . ">" . $lldpe_row->lang_article_description . "</option>";
								}
								?>
							</select>

						</td>
						<td><input type="text" readonly="readonly" style="background-color: #ddd" id="layer3_layer1_lldpe_rate" name="layer_3_rm_2_rate" value="<?php echo set_value('layer_3_rm_2_rate', ($this->input->post('layer_3_rm_2_code') == 'RM-LLDPE-000-0008' ? '' : $this->common_model->get_default_material_rate('RM-LLDPE-000-0008'))); ?>" size="5"></td>
						<td><input type="number" style="width: 7em;" name="layer_3_rm_2_percentage" id="layer3_layer1_lld_percentage" placeholder="%" value="<?php echo set_value('layer_3_rm_2_percentage', '30'); ?>" />
					...
					<tr>
						...
						<td> HD : <select name="layer_3_rm_3_code" id="layer3_layer1_sl_hdpe">
								<option value=''>--Select HDPE--</option>
								<?php
								foreach ($hdpe as $hdpe_row) {
									echo "<option value='" . $hdpe_row->article_no . "' " . set_select('layer_3_rm_3_code', $hdpe_row->article_no) . ">" . $hdpe_row->lang_article_description . "</option>";
								}
								?>
							</select>

						</td>
						<td><input type="text" readonly="readonly" style="background-color: #ddd" id="layer3_layer1_hdpe_rate" name="layer_3_rm_3_rate" value="<?php echo set_value('layer_3_rm_3_rate'); ?>" size="5"></td>
						<td><input type="number" style="width: 7em;" name="layer_3_rm_3_percentage" id="layer3_layer1_hd_percentage" placeholder="%" value="<?php echo set_value('layer_3_rm_3_percentage', '0'); ?>" />
					...
					<tr>
						...
						<td> MB : <select name="layer_3_rm_4_code" id="layer3_layer_1_rm_4_code">
								<option value=''>--Select MB--</option>
								<?php foreach ($masterbatch as $masterbatch_row) {
									echo "<option value='" . $masterbatch_row->article_no . "' " . set_select('layer_3_rm_4_code', $masterbatch_row->article_no) . ">" . $masterbatch_row->lang_article_description . "</option>";
								} ?>
							</select>

						</td>
						<td><input type="text" readonly="readonly" style="background-color: #ddd" id="layer3_layer_1_rm_4_rate" name="layer_3_rm_4_rate" value="<?php echo set_value('layer_3_rm_4_rate'); ?>" size="5"></td>
						<td><input type="number" style="width: 7em;" name="layer_3_rm_4_percentage" id="layer3_layer_1_rm_4_percentage" placeholder="%" value="<?php echo set_value('layer_3_rm_4_percentage', '0'); ?>" />
					...
					<tr>
						...
						<td> MB : <input type="text" size="25" name="layer_3_rm_5_code" id="layer3_layer_1_rm_5_code" placeholder="If MB is not in system" value="<?php echo set_value('layer_3_rm_5_code'); ?>" />

						</td>
						<td><input type="text" size="5" name="layer_3_rm_5_rate" id="layer3_layer_1_rm_5_rate" value="<?php echo set_value('layer_3_rm_5_rate'); ?>" /></td>
						<td><input type="number" style="width: 7em;" name="layer_3_rm_5_percentage" id="layer3_layer_1_rm_5_percentage" placeholder="%" value="<?php echo set_value('layer_3_rm_5_percentage', '0'); ?>" />
					...
					<tr>
						...
						<td> HD : <select name="layer_3_rm_6_code" id="layer3_layer2_sl_hdpe">
								<option value='RM-HDPE-000-0008'><?php echo $this->common_model->get_article_name('RM-HDPE-000-0008', $this->session->userdata['logged_in']['company_id']); ?></option>
								<?php
								foreach ($hdpe as $hdpe_row) {
									echo "<option value='" . $hdpe_row->article_no . "' " . set_select('layer_3_rm_6_code', $hdpe_row->article_no) . ">" . $hdpe_row->lang_article_description . "</option>";
								}
								?>
							</select>

						</td>
						<td><input type="text" readonly="readonly" style="background-color: #ddd" id="layer3_layer2_hdpe_rate" name="layer_3_rm_6_rate" value="<?php echo set_value('layer_3_rm_6_rate', ($this->input->post('layer_3_rm_6_code') == 'RM-HDPE-000-0008' ? '' : $this->common_model->get_default_material_rate('RM-HDPE-000-0008'))); ?>" size="5"></td>
						<td><input type="text" style="width: 7em;" name="layer_3_layer_6_micron" id="layer3_layer2_micron" class="number3" value="<?php echo set_value('layer_3_layer_6_micron', '50'); ?>" />
						</td>
						<td><input type="number" style="width: 7em;" name="layer_3_rm_6_percentage" id="layer3_layer2_hd_percentage" placeholder="%" class="number3" value="<?php echo set_value('layer_3_rm_6_percentage', '100'); ?>" />
						</td>
					</tr>
					...
					<tr>
						...
						<td> LD : <select name="layer_3_rm_7_code" id="layer3_layer3_sl_ldpe">
								<option value='RM-LDPE-000-0009'><?php echo $this->common_model->get_article_name('RM-LDPE-000-0009', $this->session->userdata['logged_in']['company_id']); ?></option>
								<?php
								foreach ($ldpe as $ldpe_row) {
									echo "<option value='" . $ldpe_row->article_no . "' " . set_select('layer_3_rm_7_code', $ldpe_row->article_no) . ">" . $ldpe_row->lang_article_description . "</option>";
								}
								?>
							</select>

						</td>
						<td><input type="text" readonly="readonly" style="background-color: #ddd" id="layer3_layer3_ldpe_rate" name="layer_3_rm_7_rate" value="<?php echo set_value('layer_3_rm_7_rate', ($this->input->post('layer_3_rm_7_code') == 'RM-LDPE-000-0009' ? '' : $this->common_model->get_default_material_rate('RM-LDPE-000-0009'))); ?>" size="5"></td>
						<td rowspan="5"><input type="text" style="width: 7em;" name="layer_3_layer_7_micron" id="layer3_layer3_micron" class="number3" value="<?php echo set_value('layer_3_layer_7_micron'); ?>" />
						</td>
						<td><input type="number" style="width: 7em;" name="layer_3_rm_7_percentage" id="layer3_layer3_ld_percentage" placeholder="%" class="number3" value="<?php echo set_value('layer_3_rm_7_percentage', '70'); ?>" />
						</td>
					</tr>
					<tr>
						<td><input type='hidden' name='sr_no[]' value='8'>8 <input type='hidden' name='layer_3_rm_8' value='LLDPE'></td>
						<td> LLD : <select name="layer_3_rm_8_code" id="layer3_layer3_sl_lldpe">
								<option value='RM-LLDPE-000-0008'><?php echo $this->common_model->get_article_name('RM-LLDPE-000-0008', $this->session->userdata['logged_in']['company_id']); ?></option>
								<?php
								foreach ($lldpe as $lldpe_row) {
									echo "<option value='" . $lldpe_row->article_no . "' " . set_select('layer_3_rm_8_code', $lldpe_row->article_no) . ">" . $lldpe_row->lang_article_description . "</option>";
								}
								?>
							</select>

						</td>
						<td><input type="text" readonly="readonly" style="background-color: #ddd" id="layer3_layer3_lldpe_rate" name="layer_3_rm_8_rate" value="<?php echo set_value('layer_3_rm_8_rate', ($this->input->post('layer_3_rm_8_code') == 'RM-LLDPE-000-0008' ? '' : $this->common_model->get_default_material_rate('RM-LLDPE-000-0008'))); ?>" size="5"></td>
						<td><input type="number" style="width: 7em;" name="layer_3_rm_8_percentage" id="layer3_layer3_lld_percentage" placeholder="%" value="<?php echo set_value('layer_3_rm_8_percentage', '30'); ?>" />
					...
					<tr>
						...
						<td> HD : <select name="layer_3_rm_9_code" id="layer3_layer3_sl_hdpe">
								<option value=''>--Select HDPE--</option>
								<?php
								foreach ($hdpe as $hdpe_row) {
									echo "<option value='" . $hdpe_row->article_no . "' " . set_select('layer_3_rm_9_code', $hdpe_row->article_no) . ">" . $hdpe_row->lang_article_description . "</option>";
								}
								?>
							</select>

						</td>
						<td><input type="text" readonly="readonly" style="background-color: #ddd" id="layer3_layer3_hdpe_rate" name="layer_3_rm_9_rate" value="<?php echo set_value('layer_3_rm_9_rate'); ?>" size="5"></td>
						<td><input type="number" style="width: 7em;" name="layer_3_rm_9_percentage" id="layer3_layer3_hd_percentage" placeholder="%" value="<?php echo set_value('layer_3_rm_9_percentage', '0'); ?>" />
					...
					<tr>
						...
						<td> MB : <select name="layer_3_rm_10_code" id="layer3_layer_3_rm_10_code">
								<option value=''>--Select MB--</option>
								<?php foreach ($masterbatch as $masterbatch_row) {
									echo "<option value='" . $masterbatch_row->article_no . "' " . set_select('layer_3_rm_10_code', $masterbatch_row->article_no) . ">" . $masterbatch_row->lang_article_description . "</option>";
								} ?>
							</select>

						</td>
						<td><input type="text" readonly="readonly" style="background-color: #ddd" id="layer3_layer_3_rm_10_rate" name="layer_3_rm_10_rate" value="<?php echo set_value('layer_3_rm_10_rate'); ?>" size="5"></td>
						<td><input type="number" style="width: 7em;" name="layer_3_rm_10_percentage" id="layer3_layer_3_rm_10_percentage" placeholder="%" value="<?php echo set_value('layer_3_rm_10_percentage', '0'); ?>" />
					...
					<tr>
						...
						<td> MB : <input type="text" size="25" name="layer_3_rm_11_code" id="layer3_layer_3_rm_11_code" placeholder="If MB is not in system" value="<?php echo set_value('layer_3_rm_11_code'); ?>" />

						</td>
						<td><input type="text" size="5" name="layer_3_rm_11_rate" id="layer3_layer_3_rm_11_rate" value="<?php echo set_value('layer_3_rm_11_rate'); ?>" /></td>
						<td><input type="number" style="width: 7em;" name="layer_3_rm_11_percentage" id="layer3_layer_3_rm_11_percentage" placeholder="%" value="<?php echo set_value('layer_3_rm_11_percentage', '0'); ?>" />
					...
					<tr>
						<td colspan="5">Rejection %</td>
						<td> <input type="number" style="width: 7em;" name="layer3_rejection" id="layer3_rejection" value="<?php echo set_value('layer3_rejection', '15'); ?>" /> </td>
					</tr>
					...
					<tr>
						<td colspan="5"><span class="ui green label" id="layer3_sleevecost">ADD</span></td>
						<td><input readonly="readonly" type="number" style="width: 7em;" name="layer3_sleeve_cost" id="layer3_sleeve_cost" value="<?php echo set_value('layer3_sleeve_cost'); ?>" />
						</td>
					</tr>
				</tbody>
			</table>
				...
				<tbody>
					<tr>
						<td>
							...
							<input type='hidden' name='sr_no[]' value='1'>1
							<input type='hidden' name='layer_2_rm_1' value='LDPE'>
						</td>
						<td rowspan="5">LAYER 1</td>
						...
						<td> LD : <select name="layer_2_rm_1_code" id="layer2_layer1_sl_ldpe">
								...
								<?php
								foreach ($ldpe as $ldpe_row) {
									echo "<option value='" . $ldpe_row->article_no . "' " . set_select('layer_2_rm_1_code', $ldpe_row->article_no) . ">" . $ldpe_row->lang_article_description . "</option>";
								}
								?>
							</select>

						</td>
						<td><input type="text" readonly="readonly" style="background-color: #ddd" id="layer2_layer1_ldpe_rate" name="layer_2_rm_1_rate" value="<?php echo set_value('layer_2_rm_1_rate', ($this->input->post('layer_2_rm_1_code') == 'RM-LDPE-000-0009' ? '' : $this->common_model->get_default_material_rate('RM-LDPE-000-0009'))); ?>" size="5"></td>
						<td rowspan="5"><input type="text" style="width: 7em;" name="layer_2_layer_1_micron" id="layer2_layer1_micron" class="number3" value="<?php echo set_value('layer_2_layer_1_micron'); ?>" />
						</td>
						<td><input type="number" style="width: 7em;" name="layer_2_rm_1_percentage" id="layer2_layer1_ld_percentage" placeholder="%" class="number3" value="<?php echo set_value('layer_2_rm_1_percentage', '50'); ?>" />
						</td>
					</tr>
					<tr>
						<td><input type='hidden' name='sr_no[]' value='2'>2 <input type='hidden' name='layer_2_rm_2' value='LLDPE'></td>
						<td> LLD : <select name="layer_2_rm_2_code" id="layer2_layer1_sl_lldpe">
								<option value=''>--Select LLDPE--</option>
								<?php
								foreach ($lldpe as $lldpe_row) {
									echo "<option value='" . $lldpe_row->article_no . "' " . set_select('layer_2_rm_2_code', $lldpe_row->article_no) . ">" . $lldpe_row->lang_article_description . "</option>";
								}
								?>
							</select>

						</td>
						<td><input type="text" readonly="readonly" style="background-color: #ddd" id="layer2_layer1_lldpe_rate" name="layer_2_rm_2_rate" value="<?php echo set_value('layer_2_rm_2_rate'); ?>" size="5"></td>

						<td><input type="number" style="width: 7em;" name="layer_2_rm_2_percentage" id="layer2_layer1_lld_percentage" placeholder="%" value="<?php echo set_value('layer_2_rm_2_percentage', '0'); ?>" />
					...
					<tr>
						...
						<td> HD : <select name="layer_2_rm_3_code" id="layer2_layer1_sl_hdpe">
								<option value='RM-HDPE-000-0008'><?php echo $this->common_model->get_article_name('RM-HDPE-000-0008', $this->session->userdata['logged_in']['company_id']); ?></option>
								<?php
								foreach ($hdpe as $hdpe_row) {
									echo "<option value='" . $hdpe_row->article_no . "' " . set_select('layer_2_rm_3_code', $hdpe_row->article_no) . ">" . $hdpe_row->lang_article_description . "</option>";
								}
								?>
							</select>

						</td>
						<td><input type="text" readonly="readonly" style="background-color: #ddd" id="layer2_layer1_hdpe_rate" name="layer_2_rm_3_rate" value="<?php echo set_value('layer_2_rm_3_rate', ($this->input->post('layer_2_rm_3_code') == 'RM-HDPE-000-0008' ? '' : $this->common_model->get_default_material_rate('RM-HDPE-000-0008'))); ?>" size="5"></td>
						<td><input type="number" style="width: 7em;" name="layer_2_rm_3_percentage" id="layer2_layer1_hd_percentage" placeholder="%" value="<?php echo set_value('layer_2_rm_3_percentage', '50'); ?>" />
					...
					<tr>
						...
						<td> MB : <select name="layer_2_rm_4_code" id="layer2_layer_1_rm_4_code">
								<option value=''>--Select MB--</option>
								<?php foreach ($masterbatch as $masterbatch_row) {
									echo "<option value='" . $masterbatch_row->article_no . "' " . set_select('layer_2_rm_4_code', $masterbatch_row->article_no) . ">" . $masterbatch_row->lang_article_description . "</option>";
								} ?>
							</select>

						</td>
						<td><input type="text" readonly="readonly" style="background-color: #ddd" id="layer2_layer_1_rm_4_rate" name="layer_2_rm_4_rate" value="<?php echo set_value('layer_2_rm_4_rate'); ?>" size="5"></td>
						<td><input type="number" style="width: 7em;" name="layer_2_rm_4_percentage" id="layer2_layer_1_rm_4_percentage" placeholder="%" value="<?php echo set_value('layer_2_rm_4_percentage', '0'); ?>" />
					...
					<tr>
						...
						<td> MB : <input type="text" size="25" name="layer_2_rm_5_code" id="layer2_layer_1_rm_5_code" placeholder="If MB is not in system" value="<?php echo set_value('layer_2_rm_5_code'); ?>" />

						</td>
						<td><input type="text" size="5" name="layer_2_rm_5_rate" id="layer2_layer_1_rm_5_rate" value="<?php echo set_value('layer_2_rm_5_rate'); ?>" /></td>
						<td><input type="number" style="width: 7em;" name="layer_2_rm_5_percentage" id="layer2_layer_1_rm_5_percentage" placeholder="%" value="<?php echo set_value('layer_2_rm_5_percentage', '0'); ?>" />
					...
					<tr>
						...
						<td> LD : <select name="layer_2_rm_6_code" id="layer2_layer2_sl_ldpe">
								<option value='RM-LDPE-000-0009'><?php echo $this->common_model->get_article_name('RM-LDPE-000-0009', $this->session->userdata['logged_in']['company_id']); ?></option>
								<?php
								foreach ($ldpe as $ldpe_row) {
									echo "<option value='" . $ldpe_row->article_no . "' " . set_select('layer_2_rm_6_code', $ldpe_row->article_no) . ">" . $ldpe_row->lang_article_description . "</option>";
								}
								?>
							</select>

						</td>
						<td><input type="text" readonly="readonly" style="background-color: #ddd" id="layer2_layer2_ldpe_rate" name="layer_2_rm_6_rate" value="<?php echo set_value('layer_2_rm_6_rate', ($this->input->post('layer_2_rm_6_code') == 'RM-LDPE-000-0009' ? '' : $this->common_model->get_default_material_rate('RM-LDPE-000-0009'))); ?>" size="5"></td>
						<td rowspan="5"><input type="text" style="width: 7em;" name="layer_2_layer_6_micron" id="layer2_layer2_micron" class="number3" value="<?php echo set_value('layer_2_layer_6_micron'); ?>" />
						</td>
						<td><input type="number" style="width: 7em;" name="layer_2_rm_6_percentage" id="layer2_layer2_ld_percentage" placeholder="%" class="number3" value="<?php echo set_value('layer_2_rm_6_percentage', '50'); ?>" />
						</td>
					</tr>
					<tr>
						<td><input type='hidden' name='sr_no[]' value='7'>7 <input type='hidden' name='layer_2_rm_7' value='LLDPE'></td>
						<td> LLD : <select name="layer_2_rm_7_code" id="layer2_layer2_sl_lldpe">
								<option value=''>--Select LLDPE--</option>
								<?php
								foreach ($lldpe as $lldpe_row) {
									echo "<option value='" . $lldpe_row->article_no . "' " . set_select('layer_2_rm_7_code', $lldpe_row->article_no) . ">" . $lldpe_row->lang_article_description . "</option>";
								}
								?>
							</select>

						</td>
						<td><input type="text" readonly="readonly" style="background-color: #ddd" id="layer2_layer2_lldpe_rate" name="layer_2_rm_7_rate" value="<?php echo set_value('layer_2_rm_7_rate'); ?>" size="5"></td>
						<td><input type="number" style="width: 7em;" name="layer_2_rm_7_percentage" id="layer2_layer2_lld_percentage" placeholder="%" value="<?php echo set_value('layer_2_rm_7_percentage', '0'); ?>" />
					...
					<tr>
						...
						<td> HD : <select name="layer_2_rm_8_code" id="layer2_layer2_sl_hdpe">
								<option value='RM-HDPE-000-0008'><?php echo $this->common_model->get_article_name('RM-HDPE-000-0008', $this->session->userdata['logged_in']['company_id']); ?></option>
								<?php
								foreach ($hdpe as $hdpe_row) {
									echo "<option value='" . $hdpe_row->article_no . "' " . set_select('layer_2_rm_8_code', $hdpe_row->article_no) . ">" . $hdpe_row->lang_article_description . "</option>";
								}
								?>
							</select>

						</td>
						<td><input type="text" readonly="readonly" style="background-color: #ddd" id="layer2_layer2_hdpe_rate" name="layer_2_rm_8_rate" value="<?php echo set_value('layer_2_rm_8_rate', ($this->input->post('layer_2_rm_8_code') == 'RM-HDPE-000-0008' ? '' : $this->common_model->get_default_material_rate('RM-HDPE-000-0008'))); ?>" size="5"></td>
						<td><input type="number" style="width: 7em;" name="layer_2_rm_8_percentage" id="layer2_layer2_hd_percentage" placeholder="%" value="<?php echo set_value('layer_2_rm_8_percentage', '50'); ?>" />
					...
					<tr>
						...
						<td> MB : <select name="layer_2_rm_9_code" id="layer2_layer_2_rm_9_code">
								<option value=''>--Select MB--</option>
								<?php foreach ($masterbatch as $masterbatch_row) {
									echo "<option value='" . $masterbatch_row->article_no . "' " . set_select('layer_2_rm_9_code', $masterbatch_row->article_no) . ">" . $masterbatch_row->lang_article_description . "</option>";
								} ?>
							</select>

						</td>
						<td><input type="text" readonly="readonly" style="background-color: #ddd" id="layer2_layer_2_rm_9_rate" name="layer_2_rm_9_rate" value="<?php echo set_value('layer_2_rm_9_rate'); ?>" size="5"></td>
						<td><input type="number" style="width: 7em;" name="layer_2_rm_9_percentage" id="layer2_layer_2_rm_9_percentage" placeholder="%" value="<?php echo set_value('layer_2_rm_9_percentage', '0'); ?>" />
					...
					<tr>
						...
						<td> MB : <input type="text" size="25" name="layer_2_rm_10_code" id="layer2_layer_2_rm_10_code" placeholder="If MB is not in system" value="<?php echo set_value('layer_2_rm_10_code'); ?>" />

						</td>
						<td><input type="text" size="5" name="layer_2_rm_10_rate" id="layer2_layer_2_rm_10_rate" value="<?php echo set_value('layer_2_rm_10_rate'); ?>" /></td>
						<td><input type="number" style="width: 7em;" name="layer_2_rm_10_percentage" id="layer2_layer_2_rm_10_percentage" placeholder="%" value="<?php echo set_value('layer_2_rm_10_percentage', '0'); ?>" />
						</td>
						<input type="hidden" name="layer_2_layer_10_micron" value="<?php echo set_value('layer_2_layer_10_micron'); ?>" />
					</tr>
					<tr>
						<td colspan="5">Rejection %</td>
						<td> <input type="number" style="width: 7em;" name="layer2_rejection" id="layer2_rejection" value="<?php echo set_value('layer2_rejection', '15'); ?>" /> </td>
					</tr>
					...
					<tr>
						<td colspan="5"><span class="ui green label" id="layer2_sleevecost">ADD</span></td>
						<td><input readonly="readonly" type="number" style="width: 7em;" name="layer2_sleeve_cost" id="layer2_sleeve_cost" value="<?php echo set_value('layer2_sleeve_cost'); ?>" />
						</td>
				...
				<tbody>
					<tr>
						<td><input type='hidden' name='layer_1_rows' value='5'>
							<input type='hidden' name='layer_1_sr_no_1' value='1'>1
						</td>
						...
						<td> LD : <select name="layer_1_rm_1_code" id="sl_ldpe">
								...
								<?php
								foreach ($ldpe as $ldpe_row) {
									echo "<option value='" . $ldpe_row->article_no . "' " . set_select('layer_1_rm_1_code', $ldpe_row->article_no) . ">" . $ldpe_row->lang_article_description . "</option>";
								}
								?>
							</select>

						</td>
						<td><input type="text" readonly="readonly" style="background-color: #ddd" id="layer1_ldpe_rate" name="layer_1_rm_1_rate" value="<?php echo set_value('layer_1_rm_1_rate', ($this->input->post('layer_1_rm_1_code') == 'RM-LDPE-000-0009' ? '' : $this->common_model->get_default_material_rate('RM-LDPE-000-0009'))); ?>" size="5"></td>
						<td rowspan="5"><input type="text" style="width: 7em;" name="micron" id="micron" class="number3" value="<?php echo set_value('micron'); ?>" />
						</td>
						<td><input type="number" style="width: 7em;" name="layer_1_rm_1_percentage" id="layer1_ld_percentage" placeholder="%" class="number3" value="<?php echo set_value('layer_1_rm_1_percentage', '70'); ?>" />
						</td>
					</tr>
					<tr>
						<td><input type='hidden' name='layer_1_sr_no_1' value='2'>2 <input type='hidden' name='layer_1_rm_2' value='LLDPE'></td>
						<td> LLD : <select name="layer_1_rm_2_code" id="sl_lldpe">
								<option value='RM-LLDPE-000-0008'><?php echo $this->common_model->get_article_name('RM-LLDPE-000-0008', $this->session->userdata['logged_in']['company_id']); ?></option>
								<?php
								foreach ($lldpe as $lldpe_row) {
									echo "<option value='" . $lldpe_row->article_no . "' " . set_select('layer_1_rm_2_code', $lldpe_row->article_no) . ">" . $lldpe_row->lang_article_description . "</option>";
								}
								?>
							</select>

						</td>
						<td><input type="text" readonly="readonly" style="background-color: #ddd" id="layer1_lldpe_rate" name="layer_1_rm_2_rate" value="<?php echo set_value('layer_1_rm_2_rate', ($this->input->post('layer_1_rm_2_code') == 'RM-LLDPE-000-0008' ? '' : $this->common_model->get_default_material_rate('RM-LLDPE-000-0008'))); ?>" size="5"></td>
						<td><input type="number" style="width: 7em;" name="layer_1_rm_2_percentage" id="layer1_lld_percentage" placeholder="%" value="<?php echo set_value('layer_1_rm_2_percentage', '30'); ?>" />
						</td>
					</tr>

					<tr>
						<td><input type='hidden' name='sr_no[2]' value='3'>3</td>
						<td> HD <input type='hidden' name='layer_1_rm_3' value='HDPE'>: <select name="layer_1_rm_3_code" id="sl_hdpe">
								<option value=''>--Select HDPE--</option>
								<?php
								foreach ($hdpe as $hdpe_row) {
									echo "<option value='" . $hdpe_row->article_no . "' " . set_select('layer_1_rm_3_code', $hdpe_row->article_no) . ">" . $hdpe_row->lang_article_description . "</option>";
								}
								?>
							</select>

						</td>
						<td><input type="text" readonly="readonly" style="background-color: #ddd" id="layer1_hdpe_rate" name="layer_1_rm_3_rate" value="<?php echo set_value('layer_1_rm_3_rate'); ?>" size="5"></td>
						<td><input type="number" style="width: 7em;" name="layer_1_rm_3_percentage" id="layer1_hd_percentage" placeholder="%" value="<?php echo set_value('layer_1_rm_3_percentage', '0'); ?>" />
						</td>
					</tr>

					<tr>
						<td><input type='hidden' name='sr_no[]' value='4'>4 <input type='hidden' name='layer_1_rm_4' value='MB'></td>
						<td> MB : <select name="layer_1_rm_4_code" id="sl_masterbatch">
								<option value=''>--Select MB--</option>
								<?php foreach ($masterbatch as $masterbatch_row) {
									echo "<option value='" . $masterbatch_row->article_no . "' " . set_select('layer_1_rm_4_code', $masterbatch_row->article_no) . ">" . $masterbatch_row->lang_article_description . "</option>";
								} ?>
							</select>

						</td>
						<td><input type="text" readonly="readonly" style="background-color: #ddd" id="layer1_mb_rate" name="layer_1_rm_4_rate" value="<?php echo set_value('layer_1_rm_4_rate'); ?>" size="5"></td>
						<td><input type="number" style="width: 7em;" name="layer_1_rm_4_percentage" id="layer1_mb_percentage" placeholder="%" value="<?php echo set_value('layer_1_rm_4_percentage', '0'); ?>" />
						</td>
					</tr>

					<tr>
						<td><input type='hidden' name='sr_no[]' value='5'>5 <input type='hidden' name='layer_1_rm_5' value='MB'></td>
						<td> MB : <input type="text" size="25" name="layer_1_rm_5_code" id="layer1_mb1" placeholder="If MB is not in system" value="<?php echo set_value('layer_1_rm_5_code'); ?>" />

						</td>
						<td><input type="text" size="5" name="layer_1_rm_5_rate" id="layer1_mb1_rate" value="<?php echo set_value('layer_1_rm_5_rate'); ?>" /></td>
						<td><input type="number" style="width: 7em;" name="layer_1_rm_5_percentage" id="layer1_mb_percentage1" placeholder="%" value="<?php echo set_value('layer_1_rm_5_percentage', '0'); ?>" />
						</td>
					</tr>
					<tr>
						<td colspan="5">Rejection %</td>
						<td> <input type="number" style="width: 7em;" name="layer1_rejection" id="layer1_rejection" value="<?php echo set_value('layer1_rejection', '15'); ?>" /> </td>
					</tr>
					...
					<tr>
						<td colspan="5"><span class="ui green label" id="layer1_sleevecost">ADD</span></td>
						<td><input readonly="readonly" type="number" style="width: 7em;" name="sleeve_cost" id="sleeve_cost" value="<?php echo set_value('sleeve_cost'); ?>" />
						</td>
		...
		<div class="modal-content" style="width:900px;">
			...
			<table class="ui celled structured table">
				...
				<tbody>
					<tr>
						<td>Cap Foil</td>
						<td><input type="text" size="7" name="cap_foil_rate" id="cap_foil_rate" value="<?php echo set_value('cap_foil_rate'); ?>" /></td>
					</tr>

					<tr>
						<td><span class="ui green label" id="cap_foil_cost">ADD</span></td>
						<td><input readonly="readonly" type="number" style="width: 7em;" name="cap_foil_cost_per_tube" id="cap_foil_cost_per_tube" value="<?php echo set_value('cap_foil_cost_per_tube'); ?>" /></td>
					</tr>
				</tbody>
			</table>
		</div>
			...
			<table class="ui celled structured table">
				...
				<tbody>
					<tr>
						...
						<td><input type="text" size="7" name="cap_metalization_rate" id="cap_metalization_rate" value="<?php echo set_value('cap_metalization_rate'); ?>" /></td>
					</tr>

					<tr>
						<td><span class="ui green label" id="cap_metalization_cost">ADD</span></td>
						<td><input readonly="readonly" type="number" style="width: 7em;" name="cap_metalization_cost_per_tube" id="cap_metalization_cost_per_tube" value="<?php echo set_value('cap_metalization_cost_per_tube'); ?>" /></td>
					</tr>
				</tbody>
			</table>
		</div>
			...
			<table class="ui celled structured table">
				...
				<tbody>
					<tr>
						...
						<td><input type="text" readonly="readonly" style="background-color: #ddd" name="cap_shrink_sleeve_rate" id="cap_shrink_sleeve_rate" value="<?php echo set_value('cap_shrink_sleeve_rate'); ?>"></td>
					</tr>

					<tr>
						<td><span class="ui green label" id="cap_shrink_sleeve_cost">ADD</span></td>
						<td><input readonly="readonly" type="number" size="3" name="cap_shrink_sleeve_cost_per_tube" id="cap_shrink_sleeve_cost_per_tube" value="<?php echo set_value('cap_shrink_sleeve_cost_per_tube'); ?>" /></td>
					</tr>
				</tbody>
			</table>
		</div>
			...
			<table class="ui celled structured table">
				...
				<tbody>
					<tr>
						...
						<td><input type="text" readonly="readonly" style="background-color: #ddd" name="shoulder_foil_rate" id="shoulder_foil_rate" value="<?php echo set_value('shoulder_foil_rate'); ?>"></td>
						<td><input type="text" readonly="readonly" style="background-color: #ddd" name="shoulder_foil_sqm_per_tube" id="shoulder_foil_sqm_per_tube" value="<?php echo set_value('shoulder_foil_sqm_per_tube'); ?>"></td>
					</tr>

					<tr>
						<td colspan="2"><span class="ui green label" id="shoulder_foil_cost">ADD</span></td>
						<td><input readonly="readonly" type="number" size="3" name="shoulder_foil_cost_per_tube" id="shoulder_foil_cost_per_tube" value="<?php echo set_value('shoulder_foil_cost_per_tube'); ?>" /></td>
					</tr>
				</tbody>
			</table>
		</div>
			...
			<table class="ui celled structured table">
				...
				<tbody>
					<tr>
						...
						<td><input type="text" readonly="readonly" style="background-color: #ddd;width: 7em;" name="hot_foil_1_rate" id="hot_foil_1_rate" value="<?php echo set_value('hot_foil_1_rate'); ?>"></td>
						<td><input type="number" style="width: 7em;" name="hot_foil_1_percentage" id="hot_foil_1_percentage" placeholder="%" class="number3" value="<?php echo set_value('hot_foil_1_percentage', '0'); ?>" /></td>
					</tr>

					<tr>
						<td><select name="hot_foil_2" id="hot_foil_2">
								<option value=''>--Select Hot Foil--</option>
								<?php if ($hot_foil == FALSE) {
									echo "<option value=''>--Setup Required--</option>";
								} else {
						...
						<td><input type="text" readonly="readonly" style="background-color: #ddd;width: 7em;" name="hot_foil_2_rate" id="hot_foil_2_rate" value="<?php echo set_value('hot_foil_2_rate'); ?>"></td>
						<td><input type="number" style="width: 7em;" name="hot_foil_2_percentage" id="hot_foil_2_percentage" placeholder="%" class="number3" value="<?php echo set_value('hot_foil_2_percentage', '0'); ?>" /></td>
					</tr>

					<tr>
						<td colspan="2">Rejection %</td>
						<td> <input type="number" style="width: 7em;" name="tube_foil_rejection" id="tube_foil_rejection" value="<?php echo set_value('tube_foil_rejection', '2'); ?>" /> </td>
					</tr>


					<tr>
						<td colspan="2"><span class="ui green label" id="tube_foil_cost">ADD</span></td>
						<td><input readonly="readonly" type="number" style="width: 7em;" name="tube_foil_cost_per_tube" id="tube_foil_cost_per_tube" value="<?php echo set_value('tube_foil_cost_per_tube'); ?>" /></td>
					</tr>
				</tbody>
			</table>
		</div>
	...
	<div id="cap_div" class="modal" style="display:none;">
		<div class="modal-content">
			...
			<table class="ui celled structured table">
				...
				<tbody>
					<tr>
						<td><input type="text" readonly="readonly" style="background-color: #ddd" size="10" name="mould_type" id="mould_type" value="<?php echo set_value('mould_type'); ?>"></td>
						<td><input type="text" style="background-color: #ddd" size="10" name="cap_weight_rate" id="cap_weight_rate" value="<?php echo set_value('cap_weight_rate'); ?>"></td>
						<td><input type="text" readonly="readonly" style="background-color: #ddd" size="10" maxlength="3" min="0" max="100" name="runner_waste" id="runner_waste" placeholder="%" value="<?php echo set_value('runner_waste'); ?>" />
						</td>
						<td><input type="text" size="10" name="pp_price" id="pp_price" value="<?php echo set_value('pp_price', '0'); ?>" />
						</td>
						<td><input type="text" size="10" name="mb_price" id="mb_price" value="<?php echo set_value('mb_price', '0'); ?>" />
						</td>
						<td><input type="text" size="10" name="mb_loading" id="mb_loading" placeholder="%" value="<?php echo set_value('mb_loading', '4'); ?>" />
						</td>
						<td><input type="text" size="10" style="background-color: #ddd" name="moulding_cost" id="moulding_cost" value="<?php echo set_value('moulding_cost'); ?>" />
						</td>
						<td><input type="text" size="10" name="cap_rejection" id="cap_rejection" value="<?php echo set_value('cap_rejection', '2'); ?>" />
						</td>
					</tr>

					<tr>
						<td colspan="7"><span class="ui green label" id="cap_cost">ADD</span></td>
						<td><input readonly="readonly" type="text" size="10" name="cap_cost_per_tube" id="cap_cost_per_tube" value="<?php echo set_value('cap_cost_per_tube'); ?>" /></td>
					</tr>
			...
			<table class="ui celled structured table">
				...
				<tbody>
					<tr>
						...
						<td>
							<select name="bottom_box" id="bottom_box">
								<option value=''>--Select Packing Box--</option>
					...
					<tr>
						...
						<td><input type="text" readonly="readonly" style="background-color: #ddd" size="10" name="top_box_rate" id="top_box_rate" value="<?php echo set_value('top_box_rate'); ?>"></td>
						<td><input type="text" readonly="readonly" style="background-color: #ddd" size="10" name="bottom_box_rate" id="bottom_box_rate" value="<?php echo set_value('bottom_box_rate'); ?>"></td>

						<td><input type="text" readonly="readonly" style="background-color: #ddd" size="10" name="box_liners_rate" id="box_liners_rate" value="<?php echo set_value('box_liners_rate'); ?>"></td>
					</tr>


					<tr>
						<td><span class="ui green label" id="total_box">ADD</span></td>
						<td><input type="text" readonly="readonly" size="10" name="total_box_rate" id="total_box_rate" value="<?php echo set_value('total_box_rate'); ?>"></td>
						<td><input hidden="hidden" type="text" readonly="readonly" name="boxdia_per_tube" id="boxdia_per_tube">
							<input type="text" readonly="readonly" size="10" name="liner_gm_per_tube" id="liner_gm_per_tube" value="<?php echo set_value('liner_gm_per_tube'); ?>">
						</td>
					</tr>
				</tbody>
			</table>
			...
			<table class="ui celled structured table">
				...
				<tbody>
					<tr>
						<td>HD :
							<select name="sh_hdpe_one" id="sh_hdpe_one">
								<option value='RM-HDPE-000-0009'><?php echo $this->common_model->get_article_name('RM-HDPE-000-0009', $this->session->userdata['logged_in']['company_id']); ?></option>
								<?php
								foreach ($hdpe as $hdpe_row) {
						...
						<td><input type="text" readonly="readonly" style="background-color: #ddd" name="sh_hdpe_one_rate" id="sh_hdpe_one_rate" value="<?php echo set_value('sh_hdpe_one_rate', ($this->input->post('sh_hdpe_one') == 'RM-HDPE-000-0009' ? '' : $this->common_model->get_default_material_rate('RM-HDPE-000-0009'))); ?>" size="5"></td>
						<td><input type="number" style="width: 7em;" name="hdpe_m" id="hdpe_m" placeholder="%" class="number3" value="<?php echo set_value('hdpe_m', '30'); ?>" /></td>
					</tr>
					...
					<tr>
						...
						<td><input type="text" readonly="readonly" style="background-color: #ddd" name="sh_hdpe_two_rate" id="sh_hdpe_two_rate" value="<?php echo set_value('sh_hdpe_two_rate', ($this->input->post('sh_hdpe_two') == 'RM-HDPE-000-0008' ? '' : $this->common_model->get_default_material_rate('RM-HDPE-000-0008'))); ?>" size="5"></td>
						<td><input type="number" style="width: 7em;" name="hdpe_f" id="hdpe_f" placeholder="%" class="number3" value="<?php echo set_value('hdpe_f', '70'); ?>" /></td>
					</tr>
					...
					<tr>
						...
						<td><input type="text" readonly="readonly" style="background-color: #ddd" name="shoulder_mb_rate" id="shoulder_mb_rate" value="<?php echo set_value('shoulder_mb_rate'); ?>" size="5"></td>
						<td><input type="number" style="width: 7em;" name="shoulder_mb_percentage" id="shoulder_mb_percentage" placeholder="%" value="<?php echo set_value('shoulder_mb_percentage', '0'); ?>" />
						</td>
					</tr>
					...
					<tr>
						...
						<td><input type="number" style="width: 7em;" name="shoulder_mb_percentage1" id="shoulder_mb_percentage1" placeholder="%" value="<?php echo set_value('shoulder_mb_percentage1', '0'); ?>" />
						</td>
					</tr>

					<tr>
						<td colspan="2">Rejection %</td>
						<td> <input type="number" style="width: 7em;" name="sh_rejection" id="sh_rejection" value="<?php echo set_value('sh_rejection', '9'); ?>" /> </td>
					</tr>

					<tr>
						<td colspan="2">Quantity</td>
						<td> <input type="number" style="width: 7em; background-color: #ddd" name="sh_quantity" id="sh_quantity" value="<?php echo set_value('sh_quantity', '1'); ?>" /> </td>
					</tr>

					<tr>
						<td colspan="2"><span class="ui green label" id="shouldercost">ADD</span></td>

						<td><input readonly="readonly" type="number" style="width: 7em;" name="shoulder_cost" id="shoulder_cost" value="<?php echo set_value('shoulder_cost'); ?>" />
						</td>
	...
	<div id="special_ink_div" class="modal" style="display:none;">
		<div class="modal-content" style="width:1100px;">
			...
			<table class="ui celled structured table">
				...
				<tbody>
					<tr>
						<td>SPECIAL INK : <select name="special_rm_month" id="special_rm_month">
								<option value=''>--Select Special Ink--</option>
						...
						<td><input type="text" readonly="readonly" style="background-color: #ddd" name="special_ink_rate" id="special_ink_rate" value="<?php echo set_value('special_ink_rate'); ?>" size="7"></td>
						<td><input type="text" style="width: 7em;" name="special_gm_per_tube" id="special_gm_per_tube" value="<?php echo set_value('special_gm_per_tube', '1'); ?>" /></td>

						<td><input type="number" style="width: 7em;" name="specialink_rejection" id="specialink_rejection" value="<?php echo set_value('specialink_rejection', '8'); ?>" />
						</td>
						<td><input type="number" style="width: 7em;" name="special_percentage" id="special_percentage" placeholder="%" class="number3" value="<?php echo set_value('special_percentage', '100'); ?>" /></td>
					</tr>
					<tr>
						<td colspan="4"><span class="ui green label" id="special_ink_cost">ADD</span></td>
						<td><b><input readonly="readonly" type="number" style="width: 7em;" name="special_ink_cost_per_tube" id="special_ink_cost_per_tube" value="<?php echo set_value('special_ink_cost_per_tube'); ?>"></td>
					</tr>
				</tbody>
			</table>
		</div>
	...
	<div id="offset_div" class="modal" style="display:none;">
		<div class="modal-content" style="width:1100px;">
			...
			<table class="ui celled structured table">
				...
				<tbody>
					<tr>
						<td>OFFSET : <select name="offset_rm_month" id="offset_rm_month">
						...
						<td><input type="text" readonly="readonly" style="background-color: #ddd" name="offset_rate" id="offset_rate" value="<?php echo set_value('offset_rate'); ?>" size="7"></td>
						<td><input type="text" name="offset_gm_per_tube" id="offset_gm_per_tube" value="<?php echo set_value('offset_gm_per_tube', '1'); ?>" size="7" /></td>
						<td><input type="number" style="width: 7em;" name="offset_rejection" id="offset_rejection" placeholder="%" class="number3" value="<?php echo set_value('offset_rejection', '8'); ?>" /></td>
						<td><input type="number" style="width: 7em;" name="offset_percentage" id="offset_percentage" placeholder="%" class="number3" value="<?php echo set_value('offset_percentage', '100'); ?>" /></td>
					</tr>
					<tr>
						<td colspan="4"><span class="ui green label" id="offset_cost">Add</span></td>
						<td><b><input readonly="readonly" style="width: 7em;" type="number" name="offset_cost_per_tube" id="offset_cost_per_tube" value="<?php echo set_value('offset_cost_per_tube'); ?>"></td>
					</tr>
					<!--<tr>
		      	<td>
			...
			<table class="ui celled structured table">
				...
				<tbody>
					<tr>
						<td>
							<input type="text" style="width: 7em;" name="offset_plate_cost" id="offset_plate_cost" class="number3" value="<?php echo set_value('offset_plate_cost'); ?>" />
						</td>

						<td>
							<input type="number" style="width: 7em;" name="offset_color" id="offset_color" class="number3" value="<?php echo set_value('offset_color', '4'); ?>" />
						</td>
						<td>
							<input type="number" style="width: 7em;" name="offset_impresssion" id="offset_impresssion" class="number3" value="<?php echo set_value('offset_impresssion', '25000'); ?>" />
						</td>
						<td>
							<input type="number" style="width: 7em;" name="offset_sets" id="offset_sets" class="number3" value="<?php echo set_value('offset_sets', '2'); ?>" />
						</td>
					</tr>
					<tr>
						<td colspan="3"><span class="ui green label" id="offset_cost">ADD</span></td>
						<td><b><input readonly="readonly" style="width: 7em;" size="3" name="offset_plate_cost_per_tube" id="offset_plate_cost_per_tube" value="<?php echo set_value('offset_plate_cost_per_tube'); ?>"></td>
					</tr>
				</tbody>
			</table>
		</div>
	...
	<div id="screen_div" class="modal" style="display:none;">
		<div class="modal-content" style="width:1100px;">
			...
			<table class="ui celled structured table">
				...
				<tbody>
					<tr>
						<td>SCREEN : <select name="screen_rm_month" id="screen_rm_month">
						...
						<td><input type="text" readonly="readonly" style="background-color: #ddd" name="screen_rate" id="screen_rate" value="<?php echo set_value('screen_rate'); ?>" size="7"></td>
						<td><input type="text" name="screen_gm_per_tube" id="screen_gm_per_tube" value="<?php echo set_value('screen_gm_per_tube', '1'); ?>" size="7" /></td>
						<td><input type="number" style="width: 7em;" name="screen_percentage" id="screen_percentage" placeholder="%" class="number3" value="<?php echo set_value('screen_percentage', '100'); ?>" /></td>
					</tr>

					<tr>
						<td>FLEXO : <select name="flexo_rm_month" id="flexo_rm_month">
								<option value=''>--Select Lacquer--</option>
								<?php if ($flexo == FALSE) {
									echo "<option value=''>--Setup Required--</option>";
								} else {
						...
						<td><input type="text" readonly="readonly" style="background-color: #ddd" name="flexo_rate" id="flexo_rate" value="<?php echo set_value('flexo_rate'); ?>" size="7"></td>
						<td><input type="text" name="flexo_gm_per_tube" id="flexo_gm_per_tube" value="<?php echo set_value('flexo_gm_per_tube', '1'); ?>" size="7" /></td>
						<td><input type="number" style="width: 7em;" name="flexo_percentage" id="flexo_percentage" placeholder="%" class="number3" value="<?php echo set_value('flexo_percentage', '0'); ?>" /></td>
					</tr>
					<tr>
						<td colspan="3">Rejection%</td>
						<td><input type="number" style="width: 7em;" name="screen_flexo_rejection" id="screen_flexo_rejection" value="<?php echo set_value('screen_flexo_rejection', '8'); ?>" />
						</td>
					</tr>
					...
					<tr>
						...
						<td><b><input readonly="readonly" type="number" style="width: 7em;" name="screen_flexo_cost_per_tube" id="screen_flexo_cost_per_tube" value="<?php echo set_value('screen_flexo_cost_per_tube'); ?>"></td>
					</tr>
			...
			<table class="ui celled structured table">
				...
				<tbody>
					<tr>
						<td>SCREEN PLATES
							<input type="number" style="width: 7em;" name="screen_film_rate" id="screen_film_rate" class="number3" value="<?php echo set_value('screen_film_rate'); ?>" />
						</td>

						<td>
							<input type="number" style="width: 7em;" name="screen_colors" id="screen_colors" class="number3" value="<?php echo set_value('screen_colors'); ?>" />
						</td>
						<td>
							<input type="number" style="width: 7em;" name="screen_impresssion" id="screen_impresssion" class="number3" value="<?php echo set_value('screen_impresssion', '25000'); ?>" />
						</td>
						<td>
							<input type="number" style="width: 7em;" name="screen_sets" id="screen_sets" class="number3" value="<?php echo set_value('screen_sets', '2'); ?>" />
						</td>
					</tr>
					<tr>
						<td colspan="3"><span class="ui green label" id="screen_film_cost">Add</span></td>
						<td><b><input readonly="readonly" type="number" style="width: 7em;" name="screen_film_cost_per_tube" id="screen_film_cost_per_tube" value="<?php echo set_value('screen_film_cost_per_tube'); ?>"></td>
					</tr>
					<tr>
						<td>FLEXO PLATES
							<input type="number" style="width: 7em;" name="flexo_plate_rate" id="flexo_plate_rate" class="number3" value="<?php echo set_value('flexo_plate_rate'); ?>" />
						</td>

						<td>
							<input type="number" style="width: 7em;" name="flexo_colors" id="flexo_colors" class="number3" value="<?php echo set_value('flexo_colors'); ?>" />
						</td>
						<td>
							<input type="number" style="width: 7em;" name="flexo_impresssion" id="flexo_impresssion" class="number3" value="<?php echo set_value('flexo_impresssion', '100000'); ?>" />
						</td>
						<td>
							<input type="number" style="width: 7em;" name="flexo_sets" id="flexo_sets" class="number3" value="<?php echo set_value('flexo_sets', '2'); ?>" />
						</td>
					</tr>

					<tr>
						<td colspan="3"><span class="ui green label" id="flexo_plate_cost">Add</span></td>
						<td><b><input readonly="readonly" type="number" style="width: 7em;" name="flexo_plate_cost_per_tube" id="flexo_plate_cost_per_tube" value="<?php echo set_value('flexo_plate_cost_per_tube'); ?>"></td>
					</tr>
				</tbody>
			</table>
			...
			<table class="ui celled structured table">
				<thead>
					<tr>
						<th>RM</th>
						<th>REJECTION%</th>
						<th>LABEL PURCHASE PRICE</th>
					</tr>
				</thead>
				<tbody>
					<tr>
						<td>LABEL : </td>
						<td><input type="text" style="width: 7em;" name="label_rejection" id="label_rejection" placeholder="%" class="number3" value="<?php echo set_value('label_rejection', '3'); ?>" /></td>
						<td><input type="text" style="width: 7em;" name="label_rate" id="label_rate" placeholder="Rate" class="number3" value="<?php echo set_value('label_rate', '0'); ?>" /></td>
					</tr>
					<tr>
						<td colspan="2"><span class="ui green label" id="label_cost">ADD</span></td>
						<td><b><input readonly="readonly" type="text" style="width: 7em;" name="label_cost_per_tube" id="label_cost_per_tube" value="<?php echo set_value('label_cost_per_tube'); ?>"></td>
					</tr>
				</tbody>
			</table>
		</div>
			...
			<table class="ui celled structured table">
				...
				<tbody>
					<tr>
						...
						<td><input type="text" readonly="readonly" style="background-color: #ddd" name="lacquer_type_1_rate" id="lacquer_type_1_rate" value="<?php echo set_value('lacquer_type_1_rate'); ?>" size="7">
						</td>
						<td><input type="text" readonly="readonly" style="background-color: #ddd" name="lacquer_type_1_gm_per_tube" id="lacquer_type_1_gm_per_tube" value="<?php echo set_value('lacquer_type_1_gm_per_tube'); ?>" size="7">
						</td>
						<td><input type="number" style="width: 7em;" name="lacquer_type_1_percentage" id="lacquer_type_1_percentage" placeholder="%" class="number3" value="<?php echo set_value('lacquer_type_1_percentage', '100'); ?>" />
						</td>
					</tr>

					<tr>
						<td>MATT : <select name="lacquer_type_2" id="lacquer_type_2">
								<option value=''>--Select Lacquer--</option>
								<?php if ($lacquer == FALSE) {
									echo "<option value=''>--Setup Required--</option>";
								} else {
						...
						<td><input type="text" readonly="readonly" style="background-color: #ddd" name="lacquer_type_2_rate" id="lacquer_type_2_rate" value="<?php echo set_value('lacquer_type_2_rate'); ?>" size="7">
						</td>
						<td><input type="text" readonly="readonly" style="background-color: #ddd" name="lacquer_type_2_gm_per_tube" id="lacquer_type_2_gm_per_tube" value="<?php echo set_value('lacquer_type_2_gm_per_tube'); ?>" size="7">
						</td>
						<td><input type="number" style="width: 7em;" name="lacquer_type_2_percentage" id="lacquer_type_2_percentage" placeholder="%" class="number3" value="<?php echo set_value('lacquer_type_2_percentage', '0'); ?>" />
						</td>
					</tr>

					<tr>
						<td colspan="3">Rejection %</td>
						<td><input type="number" style="width: 7em;" name="lacquer_rejection" id="lacquer_rejection" value="<?php echo set_value('lacquer_rejection', '8'); ?>" />
						</td>
					</tr>
					...
					<tr>
						...
						<td><b><input readonly="readonly" type="number" style="width: 7em;" name="lacquer_cost_per_tube" id="lacquer_cost_per_tube" value="<?php echo set_value('lacquer_cost_per_tube'); ?>"></td>
					</tr>
				</tbody>
			</table>
		</div>
