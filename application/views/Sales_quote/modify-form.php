    ...
    $("#cap_dia").live('change',function() {
  	...
  	$("#cap_dia").live('change',function() {
		...
		$("#loading").show();
	   	$("#cover").show();
	   	$('#loading').html('<img src="<?php echo base_url('assets/img/loading.gif');?>"> Loading...');
	   	$.ajax({type: "POST",url: "<?php echo base_url(); ?>" + "index.php/ajax/get_moulding_cost",data: {cap_type:$('#cap_type').val(),cap_finish:$('#cap_finish').val(),sleeve_dia:$('#sleeve_dia').val()},cache: false,success: function(html){
	        	setTimeout(function () {$("#loading").hide();$("#cover").hide();},200);
									...
									<table class="form_table_inner">	
										<tr>
											...
											<td width="25%">
												...
												<input type="text" name="version_no" id="version_no" size="5" value="<?php echo set_value('version_no',$row->version_no);?>" readonly>
											</td>										
										</tr>
										...
										<tr>
											...
											<td colspan="3">
												...
												<input type="text" name="customer" id="customer_category"  size="50" value="<?php echo set_value('category_name',$row->category_name.'//'.$row->customer_no.'');?>" /></td>
										...
										<tr>							
											...
											<td colspan="3"> <input type="text"  name="product_name"  size="50" value="<?php echo set_value('product_name',$row->product_name);?>" />
							...
							<td colspan="4">
								...
								<table class="form_table_inner">
									...
									<tr>
										...
										<td width="25%"><input type="number" class="number1" name="sleeve_length" min="10"  max="500" step="0.1"  id="sleeve_length"  maxlength="5" value="<?php echo set_value('sleeve_length',$row->sleeve_length);?>" >
										</td>
									...
									<tr>
										...
										<td colspan="3"><input type="text" name="tube_color" id="tube_color"value="<?php echo set_value('tube_color',$row->tube_color);?>"><a href="<?php echo base_url('index.php/color_master');?>" target="_blank"><i class="edit icon"></i></a>
										</td>
									</tr>
							...
							<td colspan="4">
								...
								<table class="form_table_inner">
									...
									<tr>
										...
										<td colspan="3"><input type="text" name="shoulder_color" id="shoulder_color" value="<?php echo set_value('shoulder_color',$row->shoulder_color);?>" >
										</td>
									</tr>
								</table>
								</fieldset>
							...
							<td colspan="4">
								...
								<table class="form_table_inner">
									...
									<tr>
										...
										<td colspan="3"><input type="text" name="cap_color" id="cap_color" value="<?php echo set_value('cap_color',$row->cap_color);?>" >
										</td>
									</tr>
							...
							<td colspan="4">
								...
								<fieldset>
									...
									<tr>
										...
										<td colspan="3"><input type="text" name="freight" id="freight"  value="<?php echo set_value('freight',$row->freight);?>" />
										</td>
									</tr>									
									</table>
								</fieldset>
							...
							<td colspan="5" width="100%">
								...
								<table class="form_table_inner" id="tblflag">
									...
									<tr>
										...
										<th width="3%">Waste %</th>
										<!-- <th width="10%">Target Contr.</th> --><th width="10%">Contr.</th><th width="10%">Cost</th>	<th width="10%">Quoted Price</th>
									</tr>
									<tr>
										...
										<td><input type="text" size="3" name="_5k_waste" id="_5k_waste"   value="<?php echo set_value('_5k_waste',$row->_5k_waste);?>" /></td>
										...
										<td ><input type="text" style="background-color: #ddd" readonly="readonly" class="number1" name="_5k_quoted_contr" id="_5k_quoted_contr"  value="<?php echo set_value('_5k_quoted_contr',$row->_5k_quoted_contr);?>"  size="4"/>
										</td>
									...
									<tr>
										...
										<td><input type="text" size="3" name="_10k_waste" id="_10k_waste"  value="<?php echo set_value('_10k_waste',$row->_10k_waste);?>"  /></td>
										...
										<td><input type="text" style="background-color: #ddd" readonly="readonly" class="number1" name="_10k_quoted_contr" id="_10k_quoted_contr"  value="<?php echo set_value('_10k_quoted_contr',$row->_10k_quoted_contr);?>" />
										</td>
										...
										<td><input type="text" style="background-color: #ddd" class="number1" name="_10k_quoted_price" id="_10k_quoted_price" value="<?php echo set_value('_10k_quoted_price',$row->_10k_quoted_price);?>" />
										</td>
									</tr>
									<tr>
										...
										<td><input type="text" size="3" name="_25k_waste" id="_25k_waste"   value="<?php echo set_value('_25k_waste',$row->_25k_waste);?>"  /></td>
										...
										<td><input type="text" style="background-color: #ddd" readonly="readonly" class="number1" name="_25k_quoted_contr" id="_25k_quoted_contr"  value="<?php echo set_value('_25k_quoted_contr',$row->_25k_quoted_contr);?>" />
										</td>
										...
										<td><input type="text" style="background-color: #ddd" class="number1" name="_25k_quoted_price" id="_25k_quoted_price"  value="<?php echo set_value('_25k_quoted_price',$row->_25k_quoted_price);?>" />
										</td>
									</tr>
									<tr>
										...
										<td><input type="text" size="3" name="_50k_waste" id="_50k_waste"   value="<?php echo set_value('_50k_waste',$row->_50k_waste);?>"  /></td>										
										...
										<td><input type="text" style="background-color: #ddd" readonly="readonly" class="number1" name="_50k_quoted_contr" id="_50k_quoted_contr"  value="<?php echo set_value('_50k_quoted_contr',$row->_50k_quoted_contr);?>" />
										</td>
										...
										<td><input type="text" style="background-color: #ddd" class="number1" name="_50k_quoted_price" id="_50k_quoted_price"  value="<?php echo set_value('_50k_quoted_price',$row->_50k_quoted_price);?>" />
										</td>
									</tr>
									<tr>
										...
										<td><input type="text" size="3" name="_100k_waste" id="_100k_waste"   value="<?php echo set_value('_100k_waste',$row->_100k_waste);?>"  /></td>
										...
										<td><input type="text" style="background-color: #ddd" readonly="readonly" class="number1" name="_100k_quoted_contr" id="_100k_quoted_contr"  value="<?php echo set_value('_100k_quoted_contr',$row->_100k_quoted_contr);?>" />
										</td>
										...
										<td><input type="text" style="background-color: #ddd" class="number1" name="_100k_quoted_price" id="_100k_quoted_price" value="<?php echo set_value('_100k_quoted_price',$row->_100k_quoted_price);?>" />
										</td>
									</tr>
									<tr>
										...
										<td><input type="text" size="3" name="_free_quantity_waste" id="_free_quantity_waste"   value="<?php echo set_value('_free_quantity_waste',$row->_free_quantity_waste);?>"  /></td>
										...
										<td><input type="text" style="background-color: #ddd" readonly="readonly" class="number1" name="free_quoted_contr" id="free_quoted_contr"  value="<?php echo set_value('free_quoted_contr',$row->free_quoted_contr);?>" />
										</td>
										...
										<td><input type="text" style="background-color: #ddd" class="number1" name="free_quoted_price" id="free_quoted_price"  value="<?php echo set_value('free_quoted_price',$row->free_quoted_price);?>"  />
										</td>
									</tr>
    ...
    <span class="close">&times;</span>   
		...
		<tbody>
			<tr>
				...
				<?php 
		    $layer_1_ldpe_data = array('quotation_no'=>$row->quotation_no,'version_no'=>$row->version_no,'archive<>'=>'1','layer'=>'1','rm'=>'LDPE');
		   ...
		   // echo $this->db->last_query();
			...
			<tr>
				...
				<td>
				<?php 
		    $layer_1_lldpe_data = array('quotation_no'=>$row->quotation_no,'version_no'=>$row->version_no,'archive<>'=>'1','layer'=>'1','rm'=>'LLDPE');
		   ...
		   // echo $this->db->last_query();
			...
			<tr>
				...
				<td> 
				<?php 
		    $layer_1_hdpe_data = array('quotation_no'=>$row->quotation_no,'version_no'=>$row->version_no,'archive<>'=>'1','layer'=>'1','rm'=>'HDPE');
			...
			<tr>
				...
				<td> 
					<?php 
		    $layer_1_mb_data = array('quotation_no'=>$row->quotation_no,'version_no'=>$row->version_no,'archive<>'=>'1','layer'=>'1','rm'=>'MB');
			...
			<tr>
				...
				<td>
				<?php 
		    $layer_1_mb1_data = array('quotation_no'=>$row->quotation_no,'version_no'=>$row->version_no,'archive<>'=>'1','layer'=>'1','rm'=>'MB');
			...
			<tr>
				<td colspan="5">
				<?php 
		    $layer_1_rejection_data = array('quotation_no'=>$row->quotation_no,'version_no'=>$row->version_no,'archive<>'=>'1','layer'=>'1');
			...
			<tr>
				<td colspan="5">
					<?php 
		    $layer_1_sleeve_cost_data = array('quotation_no'=>$row->quotation_no,'version_no'=>$row->version_no,'archive<>'=>'1','layer'=>'1');
    ...
    <span class="close">&times;</span>
		...
		<tbody>
			<tr>
				...
				<?php 
		    $layer_2_layer_1_ldpe_data = array('quotation_no'=>$row->quotation_no,'version_no'=>$row->version_no,'archive<>'=>'1','layer'=>'2','rm'=>'LDPE');
			...
			<tr>
				...
				<td>
				<?php 
				$layer_2_layer_1_lldpe_data = array('quotation_no'=>$row->quotation_no,'version_no'=>$row->version_no,'archive<>'=>'1','layer'=>'2','rm'=>'LLDPE');
			...
			<tr>
				...
				<td> 
					<?php 
				$layer_2_layer_1_hdpe_data = array('quotation_no'=>$row->quotation_no,'version_no'=>$row->version_no,'archive<>'=>'1','layer'=>'2','rm'=>'HDPE');
			...
			<tr>
				...
				<td>
				<?php 
		    $layer_2_layer_1_mb_data = array('quotation_no'=>$row->quotation_no,'version_no'=>$row->version_no,'archive<>'=>'1','layer'=>'2','rm'=>'MB');
			...
			<tr>
				...
				<td> 
					<?php 
		    $layer_2_layer_1_mb1_data = array('quotation_no'=>$row->quotation_no,'version_no'=>$row->version_no,'archive<>'=>'1','layer'=>'2','rm'=>'MB');
			...
			<tr>
				...
				<td>
				<?php 
		    $layer_2_layer_2_ldpe_data = array('quotation_no'=>$row->quotation_no,'version_no'=>$row->version_no,'archive<>'=>'1','layer'=>'2','rm'=>'LDPE');
			...
			<tr>
				...
				<td>
				<?php 
					$layer_2_layer_2_lldpe_data = array('quotation_no'=>$row->quotation_no,'version_no'=>$row->version_no,'archive<>'=>'1','layer'=>'2','rm'=>'LLDPE');
			...
			<tr>
				...
				<td>
				<?php 
		    $layer_2_layer_2_hdpe_data = array('quotation_no'=>$row->quotation_no,'version_no'=>$row->version_no,'archive<>'=>'1','layer'=>'2','rm'=>'HDPE');
			...
			<tr>
				...
				<td>
				<?php 
		    $layer_2_layer_2_mb_data = array('quotation_no'=>$row->quotation_no,'version_no'=>$row->version_no,'archive<>'=>'1','layer'=>'2','rm'=>'MB');
			...
			<tr>
				...
				<td>
				<?php 
		    $layer_2_layer_2_mb1_data = array('quotation_no'=>$row->quotation_no,'version_no'=>$row->version_no,'archive<>'=>'1','layer'=>'2','rm'=>'MB');
			...
			<tr>
				<td colspan="5">
				<?php 
		    $layer_2_rejection_data = array('quotation_no'=>$row->quotation_no,'version_no'=>$row->version_no,'archive<>'=>'1','layer'=>'2');
			...
			<tr>
				<td colspan="5">
					<?php 
		    $layer_2_sleeve_cost_data = array('quotation_no'=>$row->quotation_no,'version_no'=>$row->version_no,'archive<>'=>'1','layer'=>'2');
    ...
    <table class="ui celled structured table">
		...
		<tbody>
			<tr>
				...
				<td>
				<?php 
		    $layer_3_layer_1_ldpe_data = array('quotation_no'=>$row->quotation_no,'version_no'=>$row->version_no,'archive<>'=>'1','layer'=>'3','rm'=>'LDPE');
			...
			<tr>
				...
				<td> 
				<?php 
					$layer_3_layer_1_lldpe_data = array('quotation_no'=>$row->quotation_no,'version_no'=>$row->version_no,'archive<>'=>'1','layer'=>'3','rm'=>'LLDPE');
			...
			<tr>
				...
				<td>
				<?php 
		    $layer_3_layer_1_hdpe_data = array('quotation_no'=>$row->quotation_no,'version_no'=>$row->version_no,'archive<>'=>'1','layer'=>'3','rm'=>'HDPE');
			...
			<tr>
				...
				<td>
				<?php 
		    $layer_3_layer_1_mb_data = array('quotation_no'=>$row->quotation_no,'version_no'=>$row->version_no,'archive<>'=>'1','layer'=>'3','rm'=>'MB');
			...
			<tr>
				...
				<td>
				<?php 
		    $layer_3_layer_1_mb1_data = array('quotation_no'=>$row->quotation_no,'version_no'=>$row->version_no,'archive<>'=>'1','layer'=>'3','rm'=>'MB');
			...
			<tr>
				...
				<td>
				<?php 
		    $layer_3_layer_2_hdpe_data = array('quotation_no'=>$row->quotation_no,'version_no'=>$row->version_no,'archive<>'=>'1','layer'=>'3','rm'=>'HDPE');
			...
			<tr>
				...
				<td>
				<?php 
		    $layer_3_layer_3_ldpe_data = array('quotation_no'=>$row->quotation_no,'version_no'=>$row->version_no,'archive<>'=>'1','layer'=>'3','rm'=>'LDPE');
		   ...
		   // echo $this->db->last_query();
			...
			<tr>
				...
				<td>
				<?php 
					$layer_3_layer_3_lldpe_data = array('quotation_no'=>$row->quotation_no,'version_no'=>$row->version_no,'archive<>'=>'1','layer'=>'3','rm'=>'LLDPE');
			...
			<tr>
				...
				<td>
				<?php 
		    $layer_3_layer_3_hdpe_data = array('quotation_no'=>$row->quotation_no,'version_no'=>$row->version_no,'archive<>'=>'1','layer'=>'3','rm'=>'HDPE');
			...
			<tr>
				...
				<td>
				<?php 
		    $layer_3_layer_3_mb_data = array('quotation_no'=>$row->quotation_no,'version_no'=>$row->version_no,'archive<>'=>'1','layer'=>'3','rm'=>'MB');
			...
			<tr>
				...
				<td>
				<?php 
		    $layer_3_layer_3_mb1_data = array('quotation_no'=>$row->quotation_no,'version_no'=>$row->version_no,'archive<>'=>'1','layer'=>'3','rm'=>'MB');
			...
			<tr>
				<td colspan="5">
				<?php 
		    $layer_3_rejection_data = array('quotation_no'=>$row->quotation_no,'version_no'=>$row->version_no,'archive<>'=>'1','layer'=>'3');
			...
			<tr>
				<td colspan="5">
				<?php 
		    $layer_3_sleeve_cost_data = array('quotation_no'=>$row->quotation_no,'version_no'=>$row->version_no,'archive<>'=>'1','layer'=>'3');
    ...
    <table class="ui celled structured table">
		...
		<tbody>
			<tr>
				...
				<td> 		
				<?php 
		    $layer_5_layer_1_ldpe_data = array('quotation_no'=>$row->quotation_no,'version_no'=>$row->version_no,'archive<>'=>'1','layer'=>'5','rm'=>'LDPE');
			...
			<tr>
				...
				<td>
				<?php 
					$layer_5_layer_1_lldpe_data = array('quotation_no'=>$row->quotation_no,'version_no'=>$row->version_no,'archive<>'=>'1','layer'=>'5','rm'=>'LLDPE');
			...
			<tr>
				...
				<td>
				<?php 
		    $layer_5_layer_1_hdpe_data = array('quotation_no'=>$row->quotation_no,'version_no'=>$row->version_no,'archive<>'=>'1','layer'=>'5','rm'=>'HDPE');
			...
			<tr>
				...
				<td>
				<?php 
		    $layer_5_layer_1_mb_data = array('quotation_no'=>$row->quotation_no,'version_no'=>$row->version_no,'archive<>'=>'1','layer'=>'5','rm'=>'MB');
			...
			<tr>
				...
				<td> 
					<?php 
		    $layer_5_layer_1_mb1_data = array('quotation_no'=>$row->quotation_no,'version_no'=>$row->version_no,'archive<>'=>'1','layer'=>'5','rm'=>'MB');
			...
			<tr>
				...
				<td>
				<?php 
		    $layer_5_layer_2_admer_data = array('quotation_no'=>$row->quotation_no,'version_no'=>$row->version_no,'archive<>'=>'1','layer'=>'5','rm'=>'ADMER');
			...
			<tr>
				...
				<td> 
					<?php 
		    $layer_5_layer_3_evoh_data = array('quotation_no'=>$row->quotation_no,'version_no'=>$row->version_no,'archive<>'=>'1','layer'=>'5','rm'=>'EVOH');
			...
			<tr>
				...
				<td> 
				<?php 
		    $layer_5_layer_4_admer_data = array('quotation_no'=>$row->quotation_no,'version_no'=>$row->version_no,'archive<>'=>'1','layer'=>'5','rm'=>'ADMER');
			...
			<tr>
				...
				<td>
				<?php 
		    $layer_5_layer_5_ldpe_data = array('quotation_no'=>$row->quotation_no,'version_no'=>$row->version_no,'archive<>'=>'1','layer'=>'5','rm'=>'LDPE');
			...
			<tr>
				...
				<td>
				<?php 
					$layer_5_layer_5_lldpe_data = array('quotation_no'=>$row->quotation_no,'version_no'=>$row->version_no,'archive<>'=>'1','layer'=>'5','rm'=>'LLDPE');
			...
			<tr>
				...
				<td> 
					<?php 
		    $layer_5_layer_5_hdpe_data = array('quotation_no'=>$row->quotation_no,'version_no'=>$row->version_no,'archive<>'=>'1','layer'=>'5','rm'=>'HDPE');
			...
			<tr>
				...
				<td>
				<?php 
		    $layer_5_layer_5_mb_data = array('quotation_no'=>$row->quotation_no,'version_no'=>$row->version_no,'archive<>'=>'1','layer'=>'5','rm'=>'MB');
			...
			<tr>
				...
				<td> 
					<?php 
		    $layer_5_layer_5_mb1_data = array('quotation_no'=>$row->quotation_no,'version_no'=>$row->version_no,'archive<>'=>'1','layer'=>'5','rm'=>'MB');
			...
			<tr>
				<td colspan="5">
				<?php 
		    $layer_5_rejection_data = array('quotation_no'=>$row->quotation_no,'version_no'=>$row->version_no,'archive<>'=>'1','layer'=>'5');
			...
			<tr>
				<td colspan="5">
					<?php 
		    $layer_5_sleeve_cost_data = array('quotation_no'=>$row->quotation_no,'version_no'=>$row->version_no,'archive<>'=>'1','layer'=>'5');
  ...
  <div class="modal-content" style="height:550px;overflow-y: scroll;">
    ...
    <tbody>
      <tr> 
        ...
        <td>
        <?php 
		    $layer_7_layer_1_ldpe_data = array('quotation_no'=>$row->quotation_no,'version_no'=>$row->version_no,'archive<>'=>'1','layer'=>'7','rm'=>'LDPE');
      ...
      <tr>  
        ...
        <td>	
        <?php 
					$layer_7_layer_1_lldpe_data = array('quotation_no'=>$row->quotation_no,'version_no'=>$row->version_no,'archive<>'=>'1','layer'=>'7','rm'=>'LLDPE');
      ...
      <tr>
        ...
        <td>
        	<?php 
		    $layer_7_layer_1_hdpe_data = array('quotation_no'=>$row->quotation_no,'version_no'=>$row->version_no,'archive<>'=>'1','layer'=>'7','rm'=>'HDPE');
      ...
      <tr>
        ...
        <td>
        	<?php 
		    $layer_7_layer_2_ldpe_data = array('quotation_no'=>$row->quotation_no,'version_no'=>$row->version_no,'archive<>'=>'1','layer'=>'7','rm'=>'LDPE');
      ...
      <tr>      
        ...
        <td> 
        	<?php 
						$layer_7_layer_2_lldpe_data = array('quotation_no'=>$row->quotation_no,'version_no'=>$row->version_no,'archive<>'=>'1','layer'=>'7','rm'=>'LLDPE');
						...
						//echo $this->db->last_query();
							...
							$layer_7_layer_2_lldpe_percentage='';
								...
								foreach ($result_layer_7_layer_2_lldpe as $result_layer_7_layer_2_lldpe_row){
									...
									$layer_7_layer_2_lldpe_rate=$result_layer_7_layer_2_lldpe_row->rm_rate;
        ...
        <td>
        	...
        	<input type="text" readonly="readonly" style="background-color: #ddd" id="layer7_layer2_lldpe_rate" name="layer_7_rm_5_rate" value="<?php echo set_value('layer_7_rm_5_rate',$layer_7_layer_2_lldpe_rate);?>" size="5">
        </td>    
      ...
      <tr>
        ...
        <td> 
        	<?php 
		    $layer_7_layer_2_hdpe_data = array('quotation_no'=>$row->quotation_no,'version_no'=>$row->version_no,'archive<>'=>'1','layer'=>'7','rm'=>'HDPE');
      ...
      <tr>
		...
		<td>
		<?php 
		    $layer_7_layer_2_mb_data = array('quotation_no'=>$row->quotation_no,'version_no'=>$row->version_no,'archive<>'=>'1','layer'=>'7','rm'=>'MB');
	  ...
	  <tr>
		...
		<td>
			<?php 
		    $layer_7_layer_2_mb1_data = array('quotation_no'=>$row->quotation_no,'version_no'=>$row->version_no,'archive<>'=>'1','layer'=>'7','rm'=>'MB');
      ...
      <tr>
        ...
        <td> 
        	<?php 
		    $layer_7_layer_3_admer_data = array('quotation_no'=>$row->quotation_no,'version_no'=>$row->version_no,'archive<>'=>'1','layer'=>'7','rm'=>'ADMER');
      ...
      <tr>
        ...
        <td> 
        	<?php 
		    $layer_7_layer_4_evoh_data = array('quotation_no'=>$row->quotation_no,'version_no'=>$row->version_no,'archive<>'=>'1','layer'=>'7','rm'=>'EVOH');
      ...
      <tr>
        ...
        <td>
        	<?php 
		    $layer_7_layer_5_admer_data = array('quotation_no'=>$row->quotation_no,'version_no'=>$row->version_no,'archive<>'=>'1','layer'=>'7','rm'=>'ADMER');
      ...
      <tr>
        ...
        <td>
        	<?php 
			    $layer_7_layer_6_ldpe_data = array('quotation_no'=>$row->quotation_no,'version_no'=>$row->version_no,'archive<>'=>'1','layer'=>'7','rm'=>'LDPE');
      ...
      <tr>  
        ...
        <td>
        	<?php 
						$layer_7_layer_6_lldpe_data = array('quotation_no'=>$row->quotation_no,'version_no'=>$row->version_no,'archive<>'=>'1','layer'=>'7','rm'=>'LLDPE');
      ...
      <tr>
        ...
        <td>
        	<?php 
		    $layer_7_layer_6_hdpe_data = array('quotation_no'=>$row->quotation_no,'version_no'=>$row->version_no,'archive<>'=>'1','layer'=>'7','rm'=>'HDPE');
      ...
      <tr>
		...
		<td>
			<?php 
		    $layer_7_layer_6_mb_data = array('quotation_no'=>$row->quotation_no,'version_no'=>$row->version_no,'archive<>'=>'1','layer'=>'7','rm'=>'MB');
		...
		<tr>
			...
			<td>
				<?php 
		    $layer_7_layer_6_mb1_data = array('quotation_no'=>$row->quotation_no,'version_no'=>$row->version_no,'archive<>'=>'1','layer'=>'7','rm'=>'MB');
      ...
      <tr>
        ...
        <td>
        	<?php 
		    $layer_7_layer_7_ldpe_data = array('quotation_no'=>$row->quotation_no,'version_no'=>$row->version_no,'archive<>'=>'1','layer'=>'7','rm'=>'LDPE');
      ...
      <tr>    
        ...
        <td>
        	<?php 
						$layer_7_layer_7_lldpe_data = array('quotation_no'=>$row->quotation_no,'version_no'=>$row->version_no,'archive<>'=>'1','layer'=>'7','rm'=>'LLDPE');
      ...
      <tr>
        ...
        <td> 
        	<?php 
				    $layer_7_layer_7_hdpe_data = array('quotation_no'=>$row->quotation_no,'version_no'=>$row->version_no,'archive<>'=>'1','layer'=>'7','rm'=>'HDPE');
      ...
      <tr>
				<td colspan="5">
				<?php 
		    $layer_7_rejection_data = array('quotation_no'=>$row->quotation_no,'version_no'=>$row->version_no,'archive<>'=>'1','layer'=>'7');
      ...
      <tr>
        <td colspan="5">
        	<?php 
		    $layer_7_sleeve_cost_data = array('quotation_no'=>$row->quotation_no,'version_no'=>$row->version_no,'archive<>'=>'1','layer'=>'7');
  ...
  <div class="modal-content" style="width:600px;">
      ...
      <table class="ui celled structured table">
		  ...
		  <tbody>
		      <tr>
		        <td>LABEL : </td> 
		        <td><input type="text" style="width: 7em;" name="label_rejection" id="label_rejection" placeholder="%" class="number3" value="<?php echo set_value('label_rejection',$row->label_rejection);?>" /></td>
		        <td><input type="text" style="width: 7em;" name="label_rate" id="label_rate" placeholder="Rate" class="number3" value="<?php echo set_value('label_rate',$row->label_rate);?>" /></td>  
		      </tr>  
		      <tr>
		        <td colspan="2"><span class="ui green label" id="label_cost" >ADD</span></td>
		        <td><b><input  readonly="readonly" type="text" style="width: 7em;" name="label_cost_per_tube" id="label_cost_per_tube" value="<?php echo set_value('label_cost_per_tube',$row->label_cost_per_tube);?>" ></td>
		      </tr>
		  </tbody>
	  </table>	
  </div>
