...
<?php foreach ($springtube_extrusion_production_master as $master_row) : ?>
    ...
    <table cellpadding="5" cellspacing="0" style="border:1px solid #D9d9d9;">
        ...
        <tr class="heading" style="border-right:1px solid #D9d9d9;">
            ...
            <td width="10%"><i class="cogs icon"></i>QC INCHARGE</td>
            <td width="5%" style="border-right:1px solid #D9d9d9;"></td>
            <td width="35%" style="border-right:1px solid #D9d9d9;"><?php echo $master_row->qc_incharge; ?></td>
        </tr>
        ...
        <tr class="item">
            ...
            <td> <i class="sticky note icon"></i><b>SHIFT</b></td>
            <td style="border-right:1px solid #D9d9d9;"></td>
            <td width="35%" style="border-right:1px solid #D9d9d9;"><?php echo $master_row->shift; ?></td>
        </tr>
        ...
        <tr class="item">
            ...
            <td> <i class="sticky note icon"></i><b>SHIFT PROBLEMS</b></td>
            <td style="border-right:1px solid #D9d9d9;"></td>
            <td width="35%" style="border-right:1px solid #D9d9d9;"><?php echo $master_row->shift_issues; ?></td>
        </tr>
    ...
    <table cellpadding="5" cellspacing="0" style="border:1px solid #D9d9d9; ">
        ...
        <tr class="heading" style="border-right:1px solid #D9d9d9;">
            ...
            <td width="3%" style="border-right:1px solid #D9d9d9;"><b>OK PRODUCTION (MTRS)</b></td>
        ...
        foreach ($springtube_extrusion_production_details as  $details_row) {
            ...
            echo '<tr class="item">
                        ...
                        <td></td>
                        <td style="border-right:1px solid #D9d9d9;">' . $this->common_model->get_parent_name($details_row->article_no, $this->session->userdata['logged_in']['company_id']) . '</td>
            ...
            echo '<td style="border-right:1px solid #D9d9d9;">' . $details_row->purging_jobcard . '</td>
            ...
            echo '<td style="border-right:1px solid #D9d9d9;">';
