								...
								<?php 
									if($customer==FALSE){
										...
										foreach($customer as $customer_row){
											echo "<option value='$customer_row->adr_company_id'  ".set_select('customer',$customer_row->adr_company_id).">$customer_row->name1 - $customer_row->adr_company_id</option>";
										}
									}
								?>
								</select></td>
								...
								<?php 
									if($relate==FALSE){
										...
										foreach($relate as $relate_row){
											echo "<option value='$relate_row->adr_company_id'  ".set_select('relate',$relate_row->adr_company_id).">$relate_row->name1 - $relate_row->adr_company_id</option>";
										}
									}
								?>
								</select></td>
