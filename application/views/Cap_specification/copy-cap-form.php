			...
			<tr>
				<td width="50%">
					<table class="form_table_inner">
                      ...
                      <option value="47">CAPS-47</option>
									...
									<tr>
										...
										<td>
											<input type="number" name="cap_mb_per" maxlength="3" size="3" id="cap_mb_per" min="0" max="100" step="0.1" value="<?php echo set_value('cap_mb_per',$cap_mb_per);?>" placeholder="%">
                    ...
                    Finish : &nbsp;&nbsp;<select name="cap_metalization_finish" id="cap_metalization_finish">
                      ...
                      <option value='WOODEN' <?php echo  set_select('cap_metalization_color', 'WOODEN',$cap_metalization_color=='WOODEN' ? TRUE : FALSE); ?>>WOODEN</option>
                    ...
                    ?>
										...
										<tr>
											...
											<td><input type="text" name="cap_foil_width" min="1" max="5" step="1" value="<?php echo set_value('cap_foil_width',$cap_foil_width);?>"></td>
										</tr>

										<tr>
											<td class="label">Cap Foil Dist From Bottom <span style="color:red;">*</span> :</td>
											<td><input type="text" name="cap_foil_dist_frm_bottom" min="1" max="20" step="1"  value="<?php echo set_value('cap_foil_dist_frm_bottom',$cap_foil_dist);?>"></td>
										</tr>
