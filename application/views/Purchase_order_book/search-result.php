...
<h4>Search Records From <?php echo $this->input->post('from_date');?> TO <?php echo $this->input->post('to_date');?></h4><!-- <a href="<?php echo base_url('/index.php/purchase_order_book/get_sales_data?from_date=').''.$this->input->post('from_date').'&to_date='.$this->input->post('to_date') ;?>"> download</a>
	 --><div class="record_inner_design" style="overflow: scroll;">
				...
				else 
				{
					...
					foreach($purchase_order_master as $mrow){
						...
						$currency=($mrow->currency_id!='' ? $mrow->currency_id:'INR');
						$exchange_rate=($mrow->exchange_rate!='0' ? $ci->common_model->read_number($mrow->exchange_rate,$this->session->userdata['logged_in']['company_id']):'1');
