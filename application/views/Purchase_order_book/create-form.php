				...
				<td>
					<table class="form_table_inner">
										...
										<td>
											...
											<?php if($warehouse==FALSE){
													...
													foreach($warehouse as $warehouse_row){
														...
														echo '<option value="'.$warehouse_row->room_no.'"  '.set_select('warehouse_id',''.$warehouse_row->room_no.'').'>'.$warehouse_row->lang_warehouse_name.'</option>';
													}
											}?>
											</select>
										</td>
										...
										<td>
											...
											<?php if($freight_type==FALSE){
													...
													foreach($freight_type as $freight_type_row){
														...
														echo '<option value="'.$freight_type_row->freight_type_id.'"  '.set_select('freight_type_id',''.$freight_type_row->freight_type_id.'').'>'.$freight_type_row->lang_freight_type.'</option>';
													}
											}?>
											</select>
										</td>
									...
									<tr>
										...
										<td><input type="checkbox" name="import"  value="1" <?php echo set_checkbox('import',1);?> /></td>
									</tr>
									...
									<tr>
										...
										<td>
											<select name="currency" id="currency"><option value=''>--Select--</option>
			...
			<td>
				<table class="form_table_inner">
									<tr>
										...
										<td><input type="text" name="po_req_no" value="<?php echo set_value('po_req_no');?>"/></td>
									</tr>

									<tr>
										<td class="label">So No :</td>
										<td><input type="text" name="so_no" value="<?php echo set_value('so_no');?>"/></td>
									</tr>
...
<div class="middle_form_design">
					<div class="middle_form_inner_design">
						...
						<tr id="tr_1">
							...
							<td>
								<input type="text" name="product_name_1" id="product_name_1" size="50"  value="<?php echo set_value('product_name_1');?>" placeholder="Goods Information"/>
								</td>
							<td>
