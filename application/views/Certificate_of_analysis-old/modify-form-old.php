			...
			<tr>
		        <td>
					...
					<tr>
						...
						<td colspan="2"><input type="text" name="certificate_no"  Placeholder="Search Invoice No." id="certificate_no" size="" value="<?php echo set_value('certificate_no',$row->certificate_no);?>" size="16" maxlength="16" onchange="check_invoice_no(this.value);"  readonly required/>
                        <input type="hidden" name="record_no"  value="<?php echo $row->certificate_no;?>">

						</td> 
						<td class="label align-ctr"><b>Date</b><span style="color:red;">*</span> :</td>
						<td colspan="2"><input type="date" name="inspection_date"  size="10" id="invoice_date" value="<?php echo set_value('inspection_date',$row->inspection_date);?>" readonly required/></td>
					</tr>

					<tr> 
						<td class="label align-ctr"><b>SO NO.</b><span style="color:red;">*</span> :</td>
						<td colspan="2"><input type="text" name="so_no"  size="" Placeholder="Enter SO NO." id="order_no" readonly value="<?php echo set_value('so_no',$row->so_no);?>"  readonly required/></td>

						<td class="label align-ctr"><b>Product</b><span style="color:red;">*</span> :</td>
						<td colspan="2"><input type="text" name="product_name"  size="" Placeholder="Enter Product Name" id="aid_article_no"value="<?php echo set_value('product_name',$row->product_name);?>" readonly required/></td> 
					</tr>

					<tr>
						<td class="label align-ctr"><b>Customer Name</b><span style="color:red;">*</span> :</td>
						<td colspan="2"><input type="text" name="customer_name"  Placeholder="Enter Customer Name" size="" id="customer_name" value="<?php echo set_value('customer_name',$row->customer_name);?>" readonly required/></td> 

						<td class="label align-ctr"><b>AQL</b> <span style="color:red;">*</span> :</td>
						<td colspan="2"><input type="text" name="quality"  value="<?php echo set_value('quality',$row->quality);?>"  required/></td> 
					</tr>

					<tr>
						<td class="label align-ctr"><b>Total Qty</b> <span style="color:red;">*</span> :</td>
						<td colspan="2"><input type="text" name="total_qty"  Placeholder="NOS" value="<?php echo set_value('total_qty',$row->total_qty);?>" required/></td> 
						<td class="label align-ctr"><b>Sample Size</b> <span style="color:red;">*</span> :</td>
						<td colspan="2"><input type="text" name="sample_size"  Placeholder="NOS" value="<?php echo set_value('sample_size',$row->sample_size);?>" required/></td> 
					</tr>

					<tr>
						<td class="label align-ctr bg-parameter" colspan="6"><b><span class="span-h">Dimensional Compliance</span></b></td>
						<td class="label align-ctr bg-parameter" colspan="2"><b><span class="span-h">Multilayer</span></b></td>
					</tr>
			
					<tr>
						<td class="label align-ctr1" rowspan="9"><b>Process</b> <br><br> <i style="margin-top: 70px;" class="arrow down icon"></i></td>
						<td class="label align-ctr1" rowspan="9"><b>Parameter</b> <br><br> <i style="margin-top: 70px;" class="arrow down icon"></i></td>
						<td class="label align-ctr1" rowspan="9"><b>Specification<br>(mm)</b> <br> <i style="margin-top: 70px;" class="arrow down icon"></i></td>
						<td class="label align-ctr1" rowspan="9"><b>Tolerance<br>(mm)</b><br> <i style="margin-top: 70px;" class="arrow down icon"></i></td>
						<td class="label align-ctr1" rowspan="9"><b>Actual<br>(mm) </b><br> <i style="margin-top: 70px;" class="arrow down icon"></i></td>
						<td class="label align-ctr1" rowspan="9"><b>Raw Material<br>(Monolayer/Multilayer)</b> <br> <i class="arrow right icon"></i></td>
					</tr>
					
					<tr>
						<td class="label align-ctr">1st Layer</td>
						<td class="label align-ctr">50% LDPE +50% LLDPE</td>
					</tr>

					<tr>
						<td class="label align-ctr">2nd Layer</td>
						<td class="label align-ctr">50% LLDPE +50% HDPE</td>
					</tr>
					
					<tr>
						<td class="label align-ctr">3rd Layer</td>
						<td class="label align-ctr">100% Admer</td>
					</tr>
					
					<tr>
						<td class="label align-ctr">4th Layer</td>
						<td class="label align-ctr">100% EVOH</td>
					</tr>
					...
					<tr>
						...
						<td class="label align-ctr" rowspan="4"><b>Master Batch %</b><br>(Monolayer/Multilayer)</td>
					</tr>
					...
					<tr>
						...
						<td class="label align-ctr" rowspan="9"><b>Sleeve Thickness (Micron)</b><br>(Monolayer/Multilayer)</td>
					</tr>
					...
					<tr>
						...
						<td class="label align-ctr"><b>Master Batch Colour<span class="span-required">*</span></b></td>
					...
					<tr>
						...
						<td class="label align-ctr"><input type="text" name="specification_diameter"  Placeholder="Enter Specification Diameter" id="cap_diameter" value="<?php echo set_value('specification_diameter',$row->specification_diameter);?>"  required/></td>
					...
					<tr>
						<td class="label align-lft bg-parameter" colspan="8"><b><span class="span-h">TESTNIG PARAMETERS: COAX</span></b></td>
					</tr>
					...
					<tr>
						...
						<td class="label align-lft" colspan="2">Bar Code Test<span class="span-required">*</span></td>
					...
					<tr>
						<td class="label align-lft" colspan="8"><b><span class="span-h">TESTNIG PARAMETERS: SPRING</span></b></td>
					</tr>
					...
					<tr>
						<td class="label align-lft bg-parameter" colspan="8"><b><span class="span-h">SAMPLING PARAMETERS:</span></b></td>
					</tr>
