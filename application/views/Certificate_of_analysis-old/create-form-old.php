				...
				<td>
					<table class="form_table_inner" width="100%">
						<tr>
							...
							<td colspan="2"><input type="date" name="inspection_date"  size="10" id="invoice_date" value="<?php echo set_value('inspection_date',date('Y-m-d'));?>" readonly required/></td>
						</tr> 

						<tr>
							<td class="label align-ctr"><b>SO NO.</b><span style="color:red;">*</span> :</td>
							<td colspan="2"><input type="text" name="so_no"  size="" Placeholder="Enter SO NO." id="order_no" readonly value="<?php echo set_value('so_no');?>"  readonly required/></td>

							<td class="label align-ctr"><b>Product</b><span style="color:red;">*</span> :</td>
							<td colspan="2"><input type="text" name="product_name"  size="" Placeholder="Enter Product Name" id="aid_article_no"value="<?php echo set_value('product_name');?>" readonly required/></td> 

						</tr>

						<tr>
                            <td class="label align-ctr"><b>Customer Name</b><span style="color:red;">*</span> :</td>
							<td colspan="2"><input type="text" name="customer_name"  Placeholder="Enter Customer Name" size="" id="customer_name" value="<?php echo set_value('customer_name');?>" readonly  required/></td> 

							<td class="label align-ctr"><b>AQL</b> <span style="color:red;">*</span> :</td>
							<td colspan="2"><input type="text" name="quality"  value="AS PER SAMPLING PLAN ISO 2859-1 GENERAL INSPECTION LEVEL - II" readonly="" /></td> 
						</tr>
						...
						<tr>
							...
							<td colspan="2"><input type="text" name="total_qty"  Placeholder="NOS" value="<?php echo set_value('total_qty');?>" required/></td> 
							<td class="label align-ctr"><b>Sample Size</b> <span style="color:red;">*</span> :</td>
							<td colspan="2"><input type="text" name="sample_size"  Placeholder="NOS" value="<?php echo set_value('sample_size');?>" required/></td> 
						</tr>
						...
						<tr>
							...
							<td  class="label align-ctr" colspan=""><input type="text" Placeholder="Enter Prepared Name" name="prepared_name" value="<?php echo set_value('prepared_name');?>" required/></td> -->
