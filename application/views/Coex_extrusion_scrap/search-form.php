...
<form name="<?php echo $this->router->fetch_class();?>" action="<?php echo base_url('index.php/'.$this->router->fetch_class().'/search_result');?>" method="POST"  >
	<div class="form_design">
		...
		<legend><b>Coex Extrusion Scrap Search</b></legend>
				...
				<td width="50%">
					<table>
						...
						<tr>
							...
							<td><input type="text" name="jobcard_no"  size="" Placeholder="Search Job No" id="jobcard_no"  value="<?php echo set_value('jobcard_no');?>" style="width: 210%;"></td>							
						</tr>
					</table>
				</td>											
			</tr>
