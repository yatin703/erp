				...
				<td width="50%">
					<table class="form_table_inner">
						...
						<tr>
							...
							<td width="25%"><input type="date" name="from_date" id="from_date" value="<?php echo set_value('from_date',$account_periods_master_row->fin_year_start);?>"/></td>
						...
						<tr>
							<td class="label" width="25%">Trans Closed From Date <span style="color:red;">*</span> :</td>
							<td width="25%"><input type="date" name="cancelled_from_date" id="from_date" value="<?php echo set_value('cancelled_from_date');?>"/></td>
							<td class="label" width="25%">To Date <span style="color:red;">*</span> :</td>
							<td width="25%"><input type="date" name="cancelled_to_date" id="to_date" value="<?php echo set_value('cancelled_to_date');?>"/></td>
						</tr>
						<!--
						<tr>
							<td class="label" width="25%">Transaction Close From Date <span style="color:red;">*</span> :</td>
							<td width="25%"><input type="date" name="cancelled_from_date" id="from_date" value="<?php echo set_value('cancelled_from_date');?>"/></td>
							<td class="label" width="25%">To Date <span style="color:red;">*</span> :</td>
							<td width="25%"><input type="date" name="cancelled_to_date" id="to_date" value="<?php echo set_value('cancelled_to_date');?>"/></td>
						</tr>-->
						...
						<tr>
							...
							<td colspan="3">
								<select name="for_sampling" id="for_sampling" >
									...
									<option value="" <?php echo set_select('for_sampling','');?>>--Please Select--</option>
