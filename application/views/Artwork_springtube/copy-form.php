...
<form name="<?php echo $this->router->fetch_class();?>" action="<?php echo base_url('index.php/'.$this->router->fetch_class().'/save_copy');?>" method="POST" >
				...
				<td>
					<table class="form_table_inner" >														
						...
						<tr id="cold_foil_1">
							...
							<!--<input type="number" name='cold_foil_1_area' id="cold_foil_1_area" value='<?php echo set_value('cold_foil_1_area',$cold_foil_1_area);?>' placeholder="SQM/Tube" min="0" max="1" step="0.00001" >-->
						<!--	Length(mm): <input type="number" name="cold_foil_1_length" id="cold_foil_1_length" size="3" value="<?php echo set_value('cold_foil_1_length',$cold_foil_1_length);?>" min="1" max="100" step="0.01" placeholder="In mm">
							Width(mm): <input type="number" name="cold_foil_1_width" id="cold_foil_1_width" size="3" value="<?php echo set_value('cold_foil_1_width',$cold_foil_1_width);?>" min="1" max="100" step="0.01" placeholder="In mm">
						-->
						...
						<tr id="cold_foil_2">
							...
							<!--<input type="number" name='cold_foil_2_area' id="cold_foil_2_area" value='<?php echo set_value('cold_foil_2_area',$cold_foil_2_area);?>' placeholder="SQM/Tube"  min="0" max="1" step="0.00001">-->
						<!--	Length(mm) : <input type="number" name="cold_foil_2_length" id="cold_foil_2_length" size="3" value="<?php echo set_value('cold_foil_2_length',$cold_foil_2_length);?>" min="1" max="100" step="0.01" placeholder="In mm">
							Width(mm) : <input type="number" name="cold_foil_2_width" id="cold_foil_2_width" size="3" value="<?php echo set_value('cold_foil_2_width',$cold_foil_2_width);?>" min="1" max="100" step="0.01" placeholder="In mm">
						-->	
	...
	<div class="form_design">
	  ...
	  <div class="or"></div>
	  <button class="ui positive button" onClick="return validate_form();confirm('Are you sure to save?');">Save</button>
		</div>
	</div>
