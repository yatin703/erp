				...
				<td>
					<table class="form_table_inner" >									
						...
						<tr>
						    ...
						    Length(mm) <span style="color:red;">*</span> : <input type="number" name="sleeve_length" size="10" value="<?php echo set_value('sleeve_length');?>" required min="50" max="500" step="any" placeholder="In mm"></td>
						</tr>
