    ...
    ?>
        ...
        <table cellpadding="5" cellspacing="0" style="border:1px solid #D9d9d9;">
            ...
            <tr class="item last">
                ...
                <td></td>
                <td style="border-right:1px solid #D9d9d9;"><?php echo ($artwork_springtube_row->customer_artwork_pdf!='' ? '<a href="'.base_url('assets/'.$this->session->userdata['logged_in']['company_id'].'/artwork_springtube/'.$artwork_springtube_row->customer_artwork_pdf.'').'" target="_blank"><i class="file pdf outline icon"></i></a>' :'');?>
            ...
            <tr class="item last">
                ...
                <td></td>
                <td><?php echo $artwork_springtube_row->sleeve_type?>
             ...
             <tr class="item last">
                ...
                <td></td>
                <td style="border-right:1px solid #D9d9d9;"><?php foreach($result_non_varnish_length as $non_varnish_length_row){ echo ($non_varnish_length_row->parameter_value!='0'?$non_varnish_length_row->parameter_value.'MM':'FULL VARNISH'); }?> </td>
                <td><b>BODY MAKING TYPE</b></td>
                <td></td>
                <td><?php foreach($result_body_making_type as $body_making_type_row){ echo $body_making_type_row->parameter_value; }?>
            </tr>
                ...
                <td></td>
                <td><?php echo ($cold_foil_one_length!=''? $cold_foil_one_length.' MM':'').($cold_foil_one_width!=''?' X '.$cold_foil_one_width.' MM':'');  ?>
            ...
            <tr class="item last">
                ...
                <td></td>
                <td><?php echo ($cold_foil_two_length!=''? $cold_foil_two_length.' MM':'').($cold_foil_two_width!=''?' X '.$cold_foil_two_width.' MM':'');  ?>                             
                </td>
            </tr>
