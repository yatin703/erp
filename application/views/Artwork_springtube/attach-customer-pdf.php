						...
						<tr>
							<?php foreach($artwork_springtube as $artwork_springtube_row){
								echo'<td class="label">Artwork No * :</td>
								     <td><input type="text" name="artwork_no" value="'.set_value('artwork_no',$artwork_springtube_row->ad_id).'" readonly/>
								     </td>
								     <td class="label">Version No * :</td>
								     <td>
								  		 <input type="text" name="version_no" value="'.set_value('version_no',$artwork_springtube_row->version_no).'" readonly/>
								  	</td>';
