<script type="text/javascript">
	$(document).ready(function() {
		...
		$("#main_group").change(function(event) {
			...
			$.ajax({
				type: "POST",
				url: "<?php echo base_url(); ?>" + "index.php/ajax/sub_group",
				data: {
		...
		$("#main_group").change(function(event) {
			...
			$.ajax({
				type: "POST",
				url: "<?php echo base_url(); ?>" + "index.php/ajax/main_group_article",
				data: {
					main_group: $('#main_group').val()
				},
				cache: false,
		...
		$("#sub_group").change(function(event) {
			...
			$.ajax({
				type: "POST",
				url: "<?php echo base_url(); ?>" + "index.php/ajax/sub_group_article",
				data: {
					sub_group: $('#sub_group').val(),
					main_group: $('#main_group').val()
				},
		...
		$("#second_sub_group").change(function(event) {
			...
			$.ajax({
				type: "POST",
				url: "<?php echo base_url(); ?>" + "index.php/ajax/second_sub_group_article",
				data: {
					second_sub_group: $('#second_sub_group').val(),
					sub_group: $('#sub_group').val(),
					main_group: $('#main_group').val()
				},
				cache: false,
			...
			<tr>
				<td>
					<table class="form_table_inner">
						<tr>
							...
							<td><select name="main_group" id="main_group">
						...
						<tr>
							...
							<td><select name="sub_group" id="sub_group">
						...
						<tr>
							...
							<td><select name="second_sub_group" id="second_sub_group">
									<option value=''>--Select Sub Group--</option>
						...
						<tr>
							...
							<td colspan="3"><select name="customer_category" id="customer_category">
						...
						<tr>
							...
							<td><input type="text" name="article_name" id="article_name" maxlength="500" size="60" value="<?php echo set_value('article_name'); ?>"></td>
						</tr>
				...
				<td>
					<table class="form_table_inner">
						...
						<tr>
							<td class="label">Type of Supply * :</td>
							<td><select name="type_of_supply">
						...
						<tr>
							...
							<td><input type="text" name="igst" maxlength="20" size="10" value="<?php echo set_value('igst'); ?>"></td>
						</tr>

						<tr>
							<td class="label">CGST :</td>
							<td><input type="text" name="cgst" maxlength="20" size="10" value="<?php echo set_value('cgst'); ?>"></td>
						</tr>

						<tr>
							<td class="label">UTGST :</td>
							<td><input type="text" name="utgst" maxlength="20" size="10" value="<?php echo set_value('utgst'); ?>"></td>
						</tr>
