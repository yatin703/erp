				...
				<td>
					<table class="form_table_inner">
						...
						<tr>
							...
							<td><input type="text" name="article_no" value="<?php echo set_value('article_no');?>"></td>
						</tr>
					...
					<table class="form_table_inner">
                                  ...
                                  <option value="Service">service</option>
									...
									<tr>
										...
										<td><input type="text" name="igst" maxlength="100" size="60" value="<?php echo set_value('igst');?>"></td>
									</tr>

									<tr>
										<td class="label">CGST :</td>
										<td><input type="text" name="cgst" maxlength="100" size="60" value="<?php echo set_value('cgst');?>"></td>
									</tr>

									<tr>
										<td class="label">UTGST :</td>
										<td><input type="text" name="utgst" maxlength="100" size="60" value="<?php echo set_value('utgst');?>"></td>
									</tr>
