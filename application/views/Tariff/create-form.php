				...
				<td>
					<table class="form_table_inner">
									<tr>
										...
										<td><input type="text" name="erm_id"  value="[Auto Increment]" readonly/></td>
									</tr>
									<tr>
										<td class="label">Tariff No <span style="color:red;">*</span>  :</td>
										<td><input type="text" name="cetsh_no" maxlength="15" size="20" value="<?php echo set_value('cetsh_no');?>" /></td>
									</tr>
									<tr>
										<td class="label">Tariff Heading <span style="color:red;">*</span>  :</td>
										<td><input type="text" name="lang_tariff_heading" maxlength="50" size="50" value="<?php echo set_value('lang_tariff_heading');?>" /></td>
									</tr>
									<tr>
										<td class="label">Tariff Description  :</td>
										<td><input type="text" name="lang_tariff_descr" maxlength="200" size="50" value="<?php echo set_value('lang_tariff_descr');?>" /></td>
									</tr>
