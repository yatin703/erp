  ...
  //  		});
  	...
  	$(".bodymaking_inspection").bind('blur',function() {
		...
		if(bodymaking_wip>0){
			...
			total_rfd_qty=bodymaking_wip-total_rejected;
			remaining_wip=bodymaking_wip-(total_rejected+total_rfd_qty);
	...
	$("#rfd_qty").bind('blur',function() {
		...
		if($("#rfd_qty").val()!='' && Number($("#rfd_qty").val())>0){

			rfd_qty=Number($("#rfd_qty").val());
		...
		if(bodymaking_wip>0){
			...
			var total_rejected=(total_bodymaking+total_printing+short_fall);
			remaining_wip=bodymaking_wip-(total_rejected+rfd_qty);
				...
				<td width="50%">
					<table class="form_table_inner">
						...
						<tr>
							...
							<td><input class="bodymaking_inspection" type="number" name="seam_welding_stratup_box"  id="seam_welding_stratup_box" min="0" max="100000" step="any" value="<?php echo set_value('');?>">
							</td>
						</tr>
						<tr>
							...
							<td>
								<input class="bodymaking_inspection" type="number" name="seam_welding_ok_box"  id="seam_welding_ok_box" min="0" max="100000" step="any" value="<?php echo set_value('');?>">
							</td>
						</tr>
						<tr>
							...
							<td>
								<input  class="bodymaking_inspection" type="number" name="shoulder_welding_ok_box"  id="shoulder_welding_ok_box" min="0" max="100000" step="any" value="<?php echo set_value('');?>">
							</td>
						</tr>						
						<tr>
							<td class="label" colspan="3">
							...
							<td>
								<input class="bodymaking_inspection" type="number" name="ink_flaking"  id="ink_flaking" min="0" max="100000" step="any" value="<?php echo set_value('');?>">
							</td>
						</tr>
						<tr>
							<td class="label" colspan="3">
							...
							<td>
								<input class="bodymaking_inspection" type="number" name="cap_oriantation_alignment"  id="cap_oriantation_alignment" min="0" max="100000" step="any" value="<?php echo set_value('');?>">
							</td>
						</tr>
						<tr>
							<td class="label" colspan="3">
							...
							<td>
								<input class="bodymaking_inspection" type="number" name="wrong_position_tube_cutting"  id="wrong_position_tube_cutting" min="0" max="100000" step="any" value="<?php echo set_value('');?>">
							</td>
						</tr>
						<tr>
							<td class="label" colspan="3">
							...
							<td>
								<input class="bodymaking_inspection" type="number" name="scratch_line"  id="scratch_line" min="0" max="100000" step="any" value="<?php echo set_value('');?>">
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td>
								<input type="number" name="short_fall"  id="short_fall" min="0" max="1000000" step="any" value="<?php echo set_value('short_fall');?>">
							</td>
						</tr>
						...
						<tr>
							...
							<td>
								<input type="number" name="rfd_qty"  id="rfd_qty" min="0" max="1000000" step="any" value="<?php echo set_value('rfd_qty');?>">
							</td>
						</tr>
						<tr>
							<td class="label" colspan="3">
							...
							<td>
								<input type="number" name="remaining_wip"  id="remaining_wip" min="0" max="1000000" step="any" value="<?php echo set_value('remaining_wip');?>" readonly>
							</td>
						</tr>
						<!-- <tr>
