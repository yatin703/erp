<?php
					...
					if($dia_wise_sales==FALSE){
						...
						echo '<table class="ui sortable selectable celled table" style="font-size:10px;">
					        	<thead>
								   <tr>
								    	<th colspan="28">
								    	<a class="ui red label">ALL NUMBERS ARE IN MILLIONS</a>
								    	<a class="ui orange label">COEX SALES</a>'.($from_date!='' && $to_date!='' ? 
					...
					foreach($dia_wise_sales as $row){
						...
						echo "<tr title='$row->sales_month'>
								...
								<td class='negative right aligned'>".$this->common_model->read_number_million($row->COEX_SMALL_DIA)."</td>
								<td class='negative right aligned'>".$this->common_model->read_number_million($row->COEX_SMALL_DIA_VALUE)."</td>
								<td class='negative right aligned'>&#8377;".round($coex_small_dia_avg_price,2)."</td>
								<td class='positive right aligned'>".$this->common_model->read_number_million($row->COEX_BIG_DIA)."</td>
								<td class='positive right aligned'>".$this->common_model->read_number_million($row->COEX_BIG_DIA_VALUE)."</td>
								<td class='positive right aligned'>&#8377;".round($coex_big_dia_avg_price,2)."</td>
								<td class='warning right aligned'>".$this->common_model->read_number_million($total_coex_dia_quantity)."</td>
								<td class='warning right aligned'>".$this->common_model->read_number_million($total_coex_dia_value)."</td>
								<td class='warning right aligned'>&#8377;".round($total_coex_dia_avg_price,2)."</td>

								<td class='negative right aligned'>".$this->common_model->read_number_million($row->SPRING_SMALL_DIA)."</td>
								<td class='negative right aligned'>".$this->common_model->read_number_million($row->SPRING_SMALL_DIA_VALUE)."</td>
								<td class='negative right aligned'>&#8377;".round($spring_small_dia_avg_price,2)."</td>
								<td class='positive right aligned'>".$this->common_model->read_number_million($row->SPRING_BIG_DIA)."</td>
								<td class='positive right aligned'>".$this->common_model->read_number_million($row->SPRING_BIG_DIA_VALUE)."</td>
								<td class='positive right aligned'>&#8377;".round($spring_big_dia_avg_price,2)."</td>
								<td class='warning right aligned'>".$this->common_model->read_number_million($total_spring_dia_quantity)."</td>
								<td class='warning right aligned'>".$this->common_model->read_number_million($total_spring_dia_value)."</td>
								<td class='warning right aligned'>&#8377;".round($total_spring_dia_avg_price,2)."</td>


								<td class='negative right aligned'>".$this->common_model->read_number_million($total_sales_small_dia_quantity)."</td>
								<td class='negative right aligned'>".$this->common_model->read_number_million($total_sales_small_dia_value)."</td>
								<td class='negative right aligned'>&#8377;".round($total_sales_small_dia_avg_price,2)."</td>
								<td class='positive right aligned'>".$this->common_model->read_number_million($total_sales_big_dia_quantity)."</td>
								<td class='positive right aligned'>".$this->common_model->read_number_million($total_sales_big_dia_value)."</td>
								<td class='positive right aligned'>&#8377;".round($total_sales_big_dia_avg_price,2)."</td>
								<td class='warning right aligned'>".$this->common_model->read_number_million($total_sales_dia_quantity)."</td>
								<td class='warning right aligned'>".$this->common_model->read_number_million($total_sales_dia_value)."</td>
					    ...
					    echo "<thead>
							    <tr>
							    	<th>TOTAL</th>
							    	<th class='negative right aligned'>".$this->common_model->read_number_million($total_small_dia_coex_quantity)."</th>
							    	<th class='negative right aligned'>".$this->common_model->read_number_million($total_small_dia_coex_value)."</th>
							    	<th class='negative right aligned'>&#8377;".round($total_small_dia_coex_avg,2)."</th>
							    	<th class='positive right aligned'>".$this->common_model->read_number_million($total_big_dia_coex_quantity)."</th>
							    	<th class='positive right aligned'>".$this->common_model->read_number_million($total_big_dia_coex_value)."</th>
							    	<th class='positive right aligned'>&#8377;".round($total_big_dia_coex_avg,2)."</th>
							    	<th class='warning right aligned'>".$this->common_model->read_number_million($total_small_big_dia_coex_quantity)."</th>
							    	<th class='warning right aligned'>".$this->common_model->read_number_million($total_small_big_dia_coex_value)."</th>
							    	<th class='warning right aligned'>&#8377;".round($total_small_big_dia_coex_avg,2)."</th>

							    	<th class='negative right aligned'>".$this->common_model->read_number_million($total_small_dia_spring_quantity)."</th>
							    	<th class='negative right aligned'>".$this->common_model->read_number_million($total_small_dia_spring_value)."</th>
							    	<th class='negative right aligned'>&#8377;".round($total_small_dia_spring_avg,2)."</th>
							    	<th class='positive right aligned'>".$this->common_model->read_number_million($total_big_dia_spring_quantity)."</th>
							    	<th class='positive right aligned'>".$this->common_model->read_number_million($total_big_dia_spring_value)."</th>
							    	<th class='positive right aligned'>&#8377;".round($total_big_dia_spring_avg,2)."</th>
							    	<th class='warning right aligned'>".$this->common_model->read_number_million($total_small_big_dia_spring_quantity)."</th>
							    	<th class='warning right aligned'>".$this->common_model->read_number_million($total_small_big_dia_spring_value)."</th>
							    	<th class='warning right aligned'>&#8377;".round($total_small_big_dia_spring_avg,2)."</th>


							    	<th class='negative right aligned'>".$this->common_model->read_number_million($total_small_dia_sales_quantity)."</th>
							    	<th class='negative right aligned'>".$this->common_model->read_number_million($total_small_dia_sales_value)."</th>
							    	<th class='negative right aligned'>&#8377;".round($total_small_dia_sales_avg,2)."</th>
							    	<th class='positive right aligned'>".$this->common_model->read_number_million($total_big_dia_sales_quantity)."</th>
							    	<th class='positive right aligned'>".$this->common_model->read_number_million($total_big_dia_sales_value)."</th>
							    	<th class='positive right aligned'>&#8377;".round($total_big_dia_sales_avg,2)."</th>
							    	<th class='warning right aligned'>".$this->common_model->read_number_million($total_small_big_dia_sales_quantity)."</th>
							    	<th class='warning right aligned'>".$this->common_model->read_number_million($total_small_big_dia_sales_value)."</th>
