...
<?php
					        	...
					        	<thead>
								   <tr>
								    	<th colspan="20">
								    		...
								    		<a class="ui orange label">PENDING ORDER BY CUSTOMER</a>'.($from_date!='' && $to_date!='' ? 
					...
					foreach($pending_sales_order as $coex_order_row){
						...
						echo "<tr title ='$coex_order_row->customer' "; echo $a=($count>10 ? "class='cat1' style='display:none'" : "NO");  echo ">
								...
								<td class='active right aligned'>".$this->common_model->read_number_million($total_dia_coex_pending_quantity)."</td>
								<td class='active right aligned'>".$this->common_model->read_number_million($total_dia_coex_pending_quantity_value)."</td>
					        ...
					        if($count==10){
								...
								<th class='negative right aligned'>".$this->common_model->read_number_million($total_ten_screen_flexo_pending_quantity)."</th>
								<th class='negative right aligned'>".$this->common_model->read_number_million($total_ten_screen_flexo_pending_value)."</th>
								<th class='negative right aligned'>&#8377;".round($total_ten_screen_flexo_pending_avg_price,2)."</th>
								<th class='right aligned'>".$this->common_model->read_number_million($total_ten_offset_pending_quantity)."</th>
								<th class='right aligned'>".$this->common_model->read_number_million($total_ten_offset_pending_value)."</th>
								<th class='right aligned'>&#8377;".round($total_ten_offset_pending_avg_price,2)."</th>

								<th class='positive right aligned'>".$this->common_model->read_number_million($total_ten_label_pending_quantity)."</th>
								<th class='positive right aligned'>".$this->common_model->read_number_million($total_ten_label_pending_value)."</th>
								<th class='positive right aligned'>&#8377;".round($total_ten_label_pending_avg_price,2)."</th>

								<th class='active right aligned'>".$this->common_model->read_number_million($total_ten_coex_pending_quantity)."</th>
								<th class='active right aligned'>".$this->common_model->read_number_million($total_ten_coex_pending_value)."</th>
								<th class='active right aligned'>&#8377;".round($total_ten_coex_pending_avg_price,2)."</th>

								<th class='warning right aligned'>".$this->common_model->read_number_million($total_ten_digital_pending_quantity)."</th>
								<th class='warning right aligned'>".$this->common_model->read_number_million($total_ten_digital_pending_value)."</th>
								<th class='warning right aligned'>&#8377;".round($total_ten_digital_pending_avg_price,2)."</th>

								<th class='right aligned'>".$this->common_model->read_number_million($total_ten_coex_digital_pending_quantity)."</th>
								<th class='right aligned'>".$this->common_model->read_number_million($total_ten_coex_digital_pending_value)."</th>
					    ...
					    echo "<thead><tr>
								...
								<th class='negative right aligned'>".$this->common_model->read_number_million($total_other_screen_flexo_pending_quantity)."</th>
								<th class='negative right aligned'>".$this->common_model->read_number_million($total_other_screen_flexo_pending_value)."</th>
								<th class='negative right aligned'>&#8377;".round($total_other_screen_flexo_pending_avg_price,2)."</th>
								<th class='right aligned'>".$this->common_model->read_number_million($total_other_offset_pending_quantity)."</th>
								<th class='right aligned'>".$this->common_model->read_number_million($total_other_offset_pending_value)."</th>
								<th class='right aligned'>&#8377;".round($total_other_offset_pending_avg_price,2)."</th>

								<th class='positive right aligned'>".$this->common_model->read_number_million($total_other_label_pending_quantity)."</th>
								<th class='positive right aligned'>".$this->common_model->read_number_million($total_other_label_pending_value)."</th>
								<th class='positive right aligned'>&#8377;".round($total_other_label_pending_avg_price,2)."</th>

								<th class='active right aligned'>".$this->common_model->read_number_million($total_other_coex_pending_quantity)."</th>
								<th class='active right aligned'>".$this->common_model->read_number_million($total_other_coex_pending_value)."</th>
								<th class='active right aligned'>&#8377;".round($total_other_coex_pending_avg_price,2)."</th>

								<th class='warning right aligned'>".$this->common_model->read_number_million($total_other_digital_pending_quantity)."</th>
								<th class='warning right aligned'>".$this->common_model->read_number_million($total_other_digital_pending_value)."</th>
								<th class='warning right aligned'>&#8377;".round($total_other_digital_pending_avg_price,2)."</th>

								<th class='right aligned'>".$this->common_model->read_number_million($total_other_coex_digital_pending_quantity)."</th>
								<th class='right aligned'>".$this->common_model->read_number_million($total_other_coex_digital_pending_value)."</th>
