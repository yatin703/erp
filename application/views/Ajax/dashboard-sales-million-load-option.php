						    ...
						    <tr>
						     ...
						     <td><?php if($printing==FALSE){
								 ...
								 $total_printing=0;
						      	...
						      	echo $this->common_model->read_number_million($total_p);
						    ...
						    <tr>
						     ...
						     if($printing_last_month==FALSE){
								 ...
								 $total_printing=0;
						      	...
						      	echo $this->common_model->read_number_million($total_p_last_month);
						     ...
						     <td><?php 
						    	...
						    	if($printing_2ndlast_month==FALSE){
								 ...
								 $total_printing=0;
						      	...
						      	echo $this->common_model->read_number_million($total_p_2ndlast_month);
							...
							<tr>
						     ...
						     if($printing_3rdlast_month==FALSE){
						      ...
						      $total_p_3rdlast_month=$total_printing+$total_labeling+$total_spring_printing;
						      	echo $this->common_model->read_number_million($total_p_3rdlast_month);
							...
							<tr>
						     ...
						     if($printing_total_year==FALSE){
								 ...
								 $total_printing=0;
						      	...
						      	echo $this->common_model->read_number_million($total_p_year);
		  	...
		  	<div class="twelve wide column">
		    	...
		    	<div class="ui red segments">
					...
					foreach($print_type_wise_sales_domestic as $row_coex){
					    ...
					    $total_total_print_type_spring_to_sarl_quantity ='';
