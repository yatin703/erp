				...
				$("#check").html(html);
					...
					if($print_type_wise==FALSE){
						...
						echo '<table class="ui sortable selectable celled table" style="font-size:9px;">
					        	<thead>
								   <tr>
								    	<th colspan="32"><a class="ui orange label">CONTRIBUTION BY CUSTOMER</a>'.($from_date!='' && $to_date!='' ? 
								...
								foreach($print_type_wise as $row_coex){
									...
									if($count==10){
										...
										<th class='negative right aligned'>".$this->common_model->read_number_million($total_ten_screen_flexo_quantity)."</th>
										<th class='negative right aligned'>".$this->common_model->read_number_million($total_ten_screen_flexo_value)."</th>
										<th class='negative right aligned'>".$this->common_model->read_number_million($total_ten_screen_flexo_contribution_value)."</th>
										...
										<th class='positive right aligned'>".$this->common_model->read_number_million($total_ten_offset_quantity)."</th>
										<th class='positive right aligned'>".$this->common_model->read_number_million($total_ten_offset_value)."</th>
										<th class='positive right aligned'>".$this->common_model->read_number_million($total_ten_offset_contribution_value)."</th>
										...
										<th class='right aligned'>".$this->common_model->read_number_million($total_ten_label_quantity)."</th>
										<th class='right aligned'>".$this->common_model->read_number_million($total_ten_label_value)."</th>
										<th class='right aligned'>".$this->common_model->read_number_million($total_ten_label_contribution_value)."</th>
										...
										<th class='active right aligned'>".$this->common_model->read_number_million($total_ten_coex_quantity)."</th>

										<th class='active right aligned'>".$this->common_model->read_number_million($total_ten_coex_value)."</th>
										<th class='active right aligned'>".$this->common_model->read_number_million($total_ten_coex_contribution_value)."</th>
										...
										<th class='negative right aligned'>".$this->common_model->read_number_million($total_ten_spring_quantity)."</th>
										<th class='negative right aligned'>".$this->common_model->read_number_million($total_ten_spring_value)."</th>
										<th class='negative right aligned'>".$this->common_model->read_number_million($total_ten_spring_contribution_value)."</th>
										...
										<th class='active right aligned'>".$this->common_model->read_number_million($total_ten_grand_quantity)."</th>
										<th class='active right aligned'>".$this->common_model->read_number_million($total_ten_grand_value)."</th>
										<th class='active right aligned'>".$this->common_model->read_number_million($total_ten_grand_contribution_value)."</th>
							...
							echo "
								...
								<thead>
							    	...
							    	<th class='right aligned'>".$this->common_model->read_number_million($total_other_screen_flexo_quantity)."</th>
									<th class='right aligned'>".$this->common_model->read_number_million($total_other_screen_flexo_value)."</th>
									<th class='right aligned'>".$this->common_model->read_number_million($total_other_screen_flexo_contribution_value)."</th>
									...
									<th class='right aligned'>".$this->common_model->read_number_million($total_other_offset_quantity)."</th>
									<th class='right aligned'>".$this->common_model->read_number_million($total_other_offset_value)."</th>
									<th class='right aligned'>".$this->common_model->read_number_million($total_other_offset_contribution_value)."</th>
									...
									<th class='right aligned'>".$this->common_model->read_number_million($total_other_label_quantity)."</th>
									<th class='right aligned'>".$this->common_model->read_number_million($total_other_label_value)."</th>
									<th class='right aligned'>".$this->common_model->read_number_million($total_other_label_contribution_value)."</th>
									...
									<th class='right aligned'>".$this->common_model->read_number_million($total_other_coex_contribution_value)."</th>
									...
									<th class='right aligned'>".$this->common_model->read_number_million($total_other_spring_quantity)."</th>
									<th class='right aligned'>".$this->common_model->read_number_million($total_other_spring_value)."</th>
									<th class='right aligned'>".$this->common_model->read_number_million($total_other_spring_contribution_value)."</th>
									...
									<th class='right aligned'>".$this->common_model->read_number_million($total_other_grand_quantity)."</th>
									<th class='right aligned'>".$this->common_model->read_number_million($total_other_grand_value)."</th>
									<th class='right aligned'>".$this->common_model->read_number_million($total_other_grand_contribution_value)."</th>
							...
							<thead>
								...
								<th class='right aligned'>".$this->common_model->read_number_million($total_label_contribution_value)."</th>
