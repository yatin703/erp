					        	...
					        	<tr>
					        		...
					        		<td> 
					        			<table class="ui sortable selectable celled table">
											...
											foreach ($sales_avg_dia as $key => $row) {			
												...
												echo'<tr>																	
													...
													<td class="right aligned">'.$this->common_model->read_number_million($row->qty).'</td>
													<td class="right aligned">'.$this->common_model->read_number_million($row->dia_volume).'</td>
													</tr>';
										...
										echo'
											<tr>
												<td><b>TOTAL</b></td>
												<td class="right aligned">'.$this->common_model->read_number_million($total_qty).'</td>
												<td class="right aligned">'.$this->common_model->read_number_million($total_volume).'</td>
												</tr>
