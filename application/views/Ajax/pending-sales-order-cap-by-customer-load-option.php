				...
				<span id="check">
					...
					foreach($pending_sales_order as $coex_order_row){
						...
						<?php
							...
							$customer_wise=$this->sales_order_book_model->pending_sales_order_cap_by_customer_with_customer($from_date,$to_date,$coex_order_row->adr_category_id);
							$d=0;
							$total_d=0;
					    ...
					    echo "<thead>
							    <tr>
							    	...
							    	<th class='right aligned'>".money_format('%!.0n',$total_pending_quantity)."</th>
