							...
							<?php foreach($screen_consumption_master as $row):?>
									...
									<tr>
										...
										<td><input type="date" name="from_date" value="<?php echo set_value('from_date',$row->from_date);?>">
											<input type="hidden" name="scm_id" value="<?php echo $row->scm_id;?>"></td>
									</tr>
									...
									<tr>
										...
										<td><input type="text" name="consumption_quantity" value="<?php echo set_value('consumption_quantity',$row->consumption_quantity);?>"></td>
									</tr>

									<tr>
										<td class="label">Consumption Unit Rate <span style="color:red;">*</span> :</td>
										<td><input type="text" name="consumption_unit_rate" value="<?php echo set_value('consumption_unit_rate',$row->consumption_unit_rate);?>"></td>
									</tr>
