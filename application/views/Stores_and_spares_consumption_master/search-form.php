				...
				<td>
					<table class="form_table_inner">
								...
								<!--<tr>
										...
										<td><input type="text" name="stores_and_spares" value="<?php echo set_value('stores_and_spares');?>"></td>
									</tr>
								-->
									...
									<tr>
										<td class="label">No of Tubes Sold in Consumption Period <span style="color:red;">* (From Sales Register)</span> :</td>
