			...
			<tr>
				<td width="50%">
					<table class="form_table_inner">
									...
									<tr>
										<td class="label">Label Material <span style="color:red;">*</span>:</td>
										<td><input type="text" name="label_no" id="label_no" size="60" value="<?php echo set_value('label_no');?>" required/></td>
									</tr>
									...
									<tr>
										...
										<td><input type="number" min="0" max="100" step="1" name="non_lacquering_height_by_open_end" id="non_lacquering_height_by_open_end" size="3" value='<?php echo set_value('non_lacquering_height_by_open_end');?>' required></td>
									</tr>

									<tr>
										<td class="label">Non Labeling Height by Shoulder End <span style="color:red;">*</span>:</td>
										<td><input type="number" min="0" max="100" step="1" name="non_labeling_height_by_shoulder_end" id="non_labeling_height_by_shoulder_end" size="3" value='<?php echo set_value('non_labeling_height_by_shoulder_end');?>' required></td>
									</tr>
							...
							<td>
								<table>
									<tr>
										<td class="label">Label Component * :</td>
