...
<?php
	...
	?>
<form name="<?php echo $this->router->fetch_class();?>" action="<?php echo base_url('index.php/'.$this->router->fetch_class().'/update_label');?>" method="POST" >
			...
			<tr>
				<td width="50%">
					<table class="form_table_inner">
									...
									<input type="hidden" name="spec_version_no"  value="<?php echo set_value('spec_id',$specification_row->spec_version_no);?>" />
									...
									<tr>
										...
										<td><input type="text" name="label_no" id="label_no" size="60" value="<?php echo set_value('label_no',$label_name);?>" /></td>
									</tr>
								...
								<table>
									<tr>
										...
										<td><!--<span id="article_name" style="color:green;font-weight: bold">
											<?php echo set_value('article_name',$specification_row->article_name);?>
											<br/>
											<?php
											/*
