...
.column.report a.nav-link.active{
    color: #fff !important;
}
.column.report a.nav-link.active {
    font-size: 12px;
 ...
 <div class="ui three column grid">
  <div class="row">
    ...
    <div class="column released">
        <a class="nav-link " href="<?php echo base_url(); ?>index.php/coex_r_f_d/released" style="color:#000">R_F_D Consume</a>
    </div>
    <div class="column report">
        <a class="nav-link active" href="<?php echo base_url(); ?>index.php/coex_r_f_d/report" style="color:#000">R_F_D Report</a>
    </div>
  </div>
</div> 
<h4>Active Records</h4>
   ...
   <div class="record_inner_design" style="overflow: scroll;white-space: nowrap;">
         ...
         <tr>
             ...
             <th>Pending RFD Quantity</th>
             <th>Released RFD Quantity</th>
             <th>Status</th>
         </tr>
            ...
            echo "<tr><td colspan='11' style='text-align: center !important;'>No Active Records Found</td></tr>";
                ...
                foreach($coex_rfd as $row){
                    ...
                    echo "<tr>
                             ...
                             <td class='right aligned positive'>".number_format($row->order_quantity)."</td>
                             <td class='right aligned positive'>".$row->release_qty."</td>
                             <td></td>
                             <td></td>
                        </tr>";
                    $i++;
                    $sum_order_quantity+=$row->order_quantity;
                    $sum_release_qty+=$row->release_qty;
              
                }
                echo"<tr>
                         <td colspan='8' style='text-align:right;'><b>TOTAL</b></td>
                         <td class=' right aligned positive'><b>".number_format($sum_order_quantity,0,'.',',')." <i>QTY</i></b></td>
