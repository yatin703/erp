...
var tab_id = $(this).attr('data-tab');
		...
		$("#jobcard_no").change(function() {
		   ...
		   $("#cold_foil_1_width").bind('keyup',function() {
...
$("#cold_foil_2_width").bind('keyup',function() {
												...
												<td><select name="jobcard_no" id="jobcard_no" required >
														...
														<?php
														    if($this->input->post('jobcard_no')!=''){
														    	echo '<option value="'.$this->input->post('jobcard_no').'" selected>'.$this->input->post('jobcard_no').'</option>';
														    }
														?>
													</select>
												</td>
									...
									<td width="50%">
										...
										<table class="form_table_inner">
											...
											<tr>
												...
												<td><input type="number" name="abg1_carona_1" id="abg1_carona_1" min="0" max="200" step="1"  value="<?php echo set_value('abg1_carona_1');?>" /></td>
										...
										<table>
											...
											<tr>
												...
												<td><input type="number" name="digital_cost_in_euro" id="digital_cost_in_euro" min="0" max="1000"  size="20" step="any" value="<?php echo set_value('digital_cost_in_euro');?>" />
													TRACK(UPS)
													<input type="number" name="digital_cost_per_qty" min="1" max="2" step="1" value="<?php echo set_value('digital_cost_per_qty');?>"  /></td>
											</tr>
											<tr>
												<td class="label">Comment  <span style="color:red;">*</span> :</td>
									...
									<td width="40%">
										...
										<table class="form_table_inner" >
											<tr>
												...
												<td><input type="text" name="cold_foil_1" id="cold_foil_1"  size="50" value="<?php echo set_value('cold_foil_1');?>"  placeholder="Cold foil 1" readonly/>
												</td>
											</tr>
											<tr><td>&nbsp;</td></tr>
											...
											<tr>
												...
												<td><input type="text" name="cold_foil_2" id="cold_foil_2"  size="50" value="<?php echo set_value('cold_foil_2');?>"  placeholder="Cold foil 2" readonly/>
												</td>
											</tr>
									...
									<td width="60%">
										...
										<table class="form_table_inner" >
											<tr>
												...
												<td>
													Width=
													<input type="number" name="cold_foil_1_width" id="cold_foil_1_width"  placeholder="Width" min="0" max="100000" step="any" value="<?php echo set_value('cold_foil_1_width');?>">
													MM, Length=
													<input type="number" name="cold_foil_1_length" id="cold_foil_1_length"  placeholder="Length" min="0" max="100000" step="any" value="<?php echo set_value('cold_foil_1_length');?>">
													MTRS, Area=<input type="text" name="cold_foil_1_area" id="cold_foil_1_area"  placeholder="Area" size="10" value="<?php echo set_value('cold_foil_1_area');?>"readonly>SQMTRS
												</td>
											...
											<tr>
												...
												<td>
													Width=
													<input type="number" name="cold_foil_2_width" id="cold_foil_2_width"  placeholder="Width" min="0" max="100000" step="any" value="<?php echo set_value('cold_foil_2_width');?>">
													MM,	Length=
													<input type="number" name="cold_foil_2_length" id="cold_foil_2_length"  placeholder="Length" min="0" max="100000" step="any" value="<?php echo set_value('cold_foil_2_length');?>" >MTRS, Area=
													<input type="text" name="cold_foil_2_area" id="cold_foil_2_area"  placeholder="Area" size="10" value="<?php echo set_value('cold_foil_2_area');?>" readonly>SQMTRS
												</td>
