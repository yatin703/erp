									...
									<td width="50%">
										<table class="form_table_inner">
											...
											<tr>
												...
												<td><input type="number" name="pinning_w" id="pinning_w" min="15" max="100"  size="20" step="any" value="<?php echo set_value('pinning_w',$master_row->pinning_w);?>"  /></td>									
											</tr>
											<tr>
								...
								<tr>
									<td width="50%">
										<table class="form_table_inner">
											...
											<tr>
												<td class="label">Comment  <span style="color:red;">*</span> :</td>
												<td ><textarea name="abg2_unit_1_comment" value="<?php echo set_value('abg2_unit_1_comment',$master_row->abg2_unit_1_comment);?>"></textarea><?php echo $master_row->abg2_unit_1_comment;?></td>
											</tr>
										</table>
									</td>
									<td width="50%">
