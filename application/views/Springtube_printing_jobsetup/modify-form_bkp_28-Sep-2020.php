										...
										<table class="form_table_inner" >
											<tr>
												...
												<td>
													...
													<input type="text" name="order_no" id="order_no"  size="20" value="<?php echo set_value('order_no',$master_row->order_no);?>" required placeholder="Order No"/></td>
								...
								<tr>
									<td width="50%">
										<table class="form_table_inner">
											...
											<tr>
												<td class="label">Comment  <span style="color:red;">*</span> :</td>
												<td ><textarea name="abg1_unit_3_comment" value="<?php echo set_value('abg1_unit_3_comment',$master_row->abg1_ink_usage_3);?>"></textarea></td>
											</tr>
										</table>
									</td>
									<td width="50%">
										<table class="form_table_inner">
											...
											<tr>
												<td class="label">Comment  <span style="color:red;">*</span> :</td>
												<td ><textarea name="abg1_unit_4_comment" value="<?php echo set_value('abg1_unit_4_comment',$master_row->abg1_unit_4_comment);?>"></textarea><?php echo $master_row->abg1_unit_4_comment;?></td>
											</tr>
										</table>
									</td>
								</tr>
