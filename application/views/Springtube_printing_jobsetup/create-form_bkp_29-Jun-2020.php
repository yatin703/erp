									...
									<td width="50%">
										<table class="form_table_inner">
											...
											<tr>
												...
												<td><input type="number" name="pinning_w" id="pinning_w" min="15" max="100"  size="20" step="any" value="<?php echo set_value('pinning_w');?>"  /></td>									
											</tr>
											<tr>
								...
								<tr>
									<td width="50%">
										<table class="form_table_inner">
											...
											<tr>
												<td class="label">Carona. <span style="color:red;">*</span> :</td>
												<td><input type="number" name="abg2_carona_1" id="abg2_carona_1" min="30" max="200" step="1"  value="<?php echo set_value('abg2_carona_1');?>" /></td>
