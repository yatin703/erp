...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$("#abg1_ink_id_1").autocomplete("<?php echo base_url('index.php/ajax_springtube/springtube_ink_for_jobsetup_autocomplete');?>", {selectFirst: true});
		$("#abg1_ink_id_2").autocomplete("<?php echo base_url('index.php/ajax_springtube/springtube_ink_for_jobsetup_autocomplete');?>", {selectFirst: true});
		$("#abg1_ink_id_3").autocomplete("<?php echo base_url('index.php/ajax_springtube/springtube_ink_for_jobsetup_autocomplete');?>", {selectFirst: true});
		$("#abg1_ink_id_4").autocomplete("<?php echo base_url('index.php/ajax_springtube/springtube_ink_for_jobsetup_autocomplete');?>", {selectFirst: true});

		$("#abg2_ink_id_1").autocomplete("<?php echo base_url('index.php/ajax_springtube/springtube_ink_for_jobsetup_autocomplete');?>", {selectFirst: true});
		$("#abg2_ink_id_2").autocomplete("<?php echo base_url('index.php/ajax_springtube/springtube_ink_for_jobsetup_autocomplete');?>", {selectFirst: true});
  ...
  //  		});
		...
		//$("#abg2_extended_uv_hours_2").attr("required",false);
   		...
   		if($("#is_extended_path_radio").val()=="YES"){
   		...
   		if($("#is_extended_path_radio").val()=="NO"){
	  ...
	  //  	$("#jobcard_no").change(function() {
			...
			// 	    	var cold_foil_1_area=Number(obj.cold_foil_1_width/1000)*Number(obj.total_meters);
			// 	    	$('#cold_foil_1_area').val(cold_foil_1_area.toFixed(2));
			// 	    }
			// 	    if(obj.cold_foil_2!=''){
			// 	    	$('#cold_foil_2').val(obj.cold_foil_2);
			// 	    	$('#cold_foil_2_width').val(obj.cold_foil_2_width);
			// 	    	$('#cold_foil_2_length').val(obj.total_meters);
			// 	    	var cold_foil_2_area=Number(obj.cold_foil_2_width/1000)*Number(obj.total_meters);
...
<form name="<?php echo $this->router->fetch_class();?>" action="<?php echo base_url('index.php/'.$this->router->fetch_class().'/update');?>" method="POST"  >
										...
										<table class="form_table_inner" >
											<tr>
												...
												<td>
													...
													<input type="text" name="order_no" id="order_no"  size="20" value="<?php echo set_value('order_no',$master_row->order_no);?>" required readonly placeholder="Order No"/></td>
											...
											<tr>
												...
												<td>
													...
													<option value="<?php echo $master_row->article_no;?>"><?php echo $master_row->article_no;?></option>	
													</select>
												</td>
											</tr>
											<tr>
												...
												<td><select name="jobcard_no" id="jobcard_no" required  >
														<option value="<?php echo $master_row->jobcard_no;?>"><?php echo $master_row->jobcard_no;?></option>	
													</select>
												</td>
									...
									<td width="50%">
										...
										<table class="form_table_inner">
											...
											<tr>
												...
												<td><input type="number" name="abg1_uv_hours_1" id="abg1_uv_hours_1" min="1" max="1500" step="1"  size="20" value="<?php echo set_value('abg1_uv_hours_1',$master_row->abg1_uv_hours_1);?>" /></td>
												
											</tr>
											<tr>
												<td class="label">Total Ink Consumption (Grams) <span style="color:red;">*</span> :</td>
												<td><input type="number" name="abg1_ink_usage_1" id="abg1_ink_usage_1" min="1" max="100000"  size="20" step="any" value="<?php echo set_value('abg1_ink_usage_1',$master_row->abg1_ink_usage_1);?>" /></td>
												
											</tr>
											<tr>
												<td class="label">Comment  <span style="color:red;">*</span> :</td>
												<td><textarea name="abg1_unit_1_comment" value="<?php echo set_value('abg1_unit_1_comment',$master_row->abg1_unit_1_comment);?>"><?php echo $master_row->abg1_unit_1_comment;?></textarea></td>
											</tr>
										</table>
									</td>
									<td width="50%">
										<table class="form_table_inner">
											...
											<tr>
												<td class="label">UV Lamp Hours <span style="color:red;">*</span> :</td>
												<td><input type="number" name="abg1_uv_hours_2" id="abg1_uv_hours_2" min="1" max="1500" step="1"  size="20" value="<?php echo set_value('abg1_uv_hours_2',$master_row->abg1_uv_hours_2);?>" /></td>												
											</tr>
											<tr>
												<td class="label">Total Ink Consumption (Grams) <span style="color:red;">*</span> :</td>
												<td><input type="number" name="abg1_ink_usage_2" id="abg1_ink_usage_2" min="1" max="100000"  size="20" step="any" value="<?php echo set_value('abg1_ink_usage_2',$master_row->abg1_ink_usage_2);?>" /></td>									
											</tr>
											<tr>
												<td class="label">Comment  <span style="color:red;">*</span> :</td>
												<td ><textarea name="abg1_unit_2_comment" value="<?php echo set_value('abg1_unit_2_comment',$master_row->abg1_unit_2_comment);?>"><?php echo $master_row->abg1_unit_2_comment;?></textarea></td>
											</tr>
										</table>
									</td>
								</tr>
								...
								<tr>
									<td width="50%">
										<table class="form_table_inner">
											...
											<tr>
												<td class="label">UV Lamp Hours <span style="color:red;">*</span> :</td>
												<td><input type="number" name="abg1_uv_hours_3" id="abg1_uv_hours_3" min="1" max="1500" step="1"  size="20" value="<?php echo set_value('abg1_uv_hours_3',$master_row->abg1_uv_hours_3);?>" /></td>
												
											</tr>
											<tr>
												<td class="label">Total Ink Consumption (Grams) <span style="color:red;">*</span> :</td>
												<td><input type="number" name="abg1_ink_usage_3" id="abg1_ink_usage_3" min="1" max="100000"  size="20" step="any" value="<?php echo set_value('abg1_ink_usage_3',$master_row->abg1_ink_usage_3);?>" /></td>
												
											</tr>
											<tr>
												<td class="label">Comment  <span style="color:red;">*</span> :</td>
												<td ><textarea name="abg1_unit_3_comment" value="<?php echo set_value('abg1_unit_3_comment',$master_row->abg1_unit_3_comment);?>"><?php echo $master_row->abg1_unit_3_comment;?></textarea></td>
											</tr>
										</table>
									</td>
									<td width="50%">
										<table class="form_table_inner">
											...
											<tr>
												<td class="label">UV Lamp Hours <span style="color:red;">*</span> :</td>
												<td><input type="number" name="abg1_uv_hours_4" id="abg1_uv_hours_4" min="1" max="1500" step="1"  size="20" value="<?php echo set_value('abg1_uv_hours_4',$master_row->abg1_uv_hours_4);?>" /></td>												
											</tr>
											<tr>
												<td class="label">Total Ink Consumption (Grams) <span style="color:red;">*</span> :</td>
												<td><input type="number" name="abg1_ink_usage_4" id="abg1_ink_usage_4" min="1" max="100000"  size="20" step="any" value="<?php echo set_value('abg1_ink_usage_4',$master_row->abg1_ink_usage_4);?>" /></td>									
											</tr>
											<tr>
												<td class="label">Comment  <span style="color:red;">*</span> :</td>
												<td ><textarea name="abg1_unit_4_comment" value="<?php echo set_value('abg1_unit_4_comment',$master_row->abg1_unit_4_comment);?>"><?php echo $master_row->abg1_unit_4_comment;?></textarea></td>
											</tr>
										</table>
									</td>
								</tr>
									...
									<td width="50%">
										<table>
											...
											<tr>
												...
												<td><input type="number" name="durst_uv_lamp_hrs_1" id="durst_uv_lamp_hrs_1" min="1" max="1500"  size="20" step="any" value="<?php echo set_value('durst_uv_lamp_hrs_1',$master_row->durst_uv_lamp_hrs_1);?>"  /></td>
											</tr>
											<tr>
											...
											<tr>
												...
												<td><input type="number" name="durst_uv_lamp_hrs_2" id="durst_uv_lamp_hrs_2" min="1" max="1500"  size="20" step="any" value="<?php echo set_value('durst_uv_lamp_hrs_2',$master_row->durst_uv_lamp_hrs_2);?>" /></td>
											</tr>
											<tr>
											...
											<tr>
												...
												<td><input type="number" name="digital_cost_in_euro" id="digital_cost_in_euro" min="0" max="1000"  size="20" step="any" value="<?php echo set_value('digital_cost_in_euro',$master_row->digital_cost_in_euro);?>" />
													TRACK(UPS)
													<input type="number" name="digital_cost_per_qty" min="1" max="2" value="<?php echo set_value('digital_cost_per_qty',$master_row->digital_cost_per_qty);?>" /></td>
												</td>
											</tr>
											<tr>
												<td class="label">Comment  <span style="color:red;">*</span> :</td>
												<td ><textarea name="durst_comment" value="<?php echo set_value('durst_comment',$master_row->durst_comment);?>"><?php echo $master_row->durst_comment;?></textarea></td>
											</tr>									
								...
								<tr>
									<td width="50%">
										<table class="form_table_inner">
											...
											<tr>
												<td class="label">UV Lamp Hours <span style="color:red;">*</span> :</td>
												<td><input type="number" name="abg2_uv_hours_1" id="abg2_uv_hours_1" min="1" max="1500" step="1"  size="20" value="<?php echo set_value('abg2_uv_hours_1',$master_row->abg2_uv_hours_1);?>" /></td>
												
											</tr>
											<tr>
												<td class="label">Total Ink Consumption (Grams) <span style="color:red;">*</span> :</td>
												<td><input type="number" name="abg2_ink_usage_1" id="abg2_ink_usage_1" min="1" max="100000"  size="20" step="any" value="<?php echo set_value('abg2_ink_usage_1',$master_row->abg2_ink_usage_1);?>" /></td>
												
											</tr>
											<tr>
												<td class="label">Comment  <span style="color:red;">*</span> :</td>
												<td ><textarea name="abg2_unit_1_comment" value="<?php echo set_value('abg2_unit_1_comment',$master_row->abg2_unit_1_comment);?>"><?php echo $master_row->abg2_unit_1_comment;?> </textarea></td>
											</tr>
										</table>
									</td>
									<td width="50%">
										<table class="form_table_inner">
											...
											<tr>
												...
												<td>
													<input type="hidden" name="is_extended_path_radio" id="is_extended_path_radio" value="<?php echo set_value('is_extended_path_radio', $master_row->is_extended_path);?>">
											...
											<tr id="tr_abg2_uv_hours_2">
												<td class="label">UV Lamp Hours <span style="color:red;">*</span> :</td>
												<td><input type="number" name="abg2_uv_hours_2" id="abg2_uv_hours_2" min="1" max="1500" step="1"  size="20" value="<?php echo set_value('abg2_uv_hours_2',$master_row->abg2_uv_hours_2);?>" /></td>												
											</tr>
											...
											<tr id="tr_abg2_extended_uv_hours_2">
												...
												<td><input type="number" name="abg2_extended_uv_hours_2" id="abg2_extended_uv_hours_2" min="1" max="1500" step="1"  size="20" value="<?php echo set_value('abg2_extended_uv_hours_2',$master_row->abg2_extended_uv_hours_2);?>" /></td>												
											</tr>
											<tr>
												<td class="label">Total Ink Consumption (Grams) <span style="color:red;">*</span> :</td>
												<td><input type="number" name="abg2_ink_usage_2" id="abg2_ink_usage_2" min="1" max="100000"  size="20" step="any" value="<?php echo set_value('abg2_ink_usage_2',$master_row->abg2_ink_usage_2);?>" /></td>									
											</tr>
											<tr>
												<td class="label">Comment  <span style="color:red;">*</span> :</td>
												<td ><textarea name="abg2_unit_2_comment" value="<?php echo set_value('abg2_unit_2_comment',$master_row->abg2_unit_2_comment);?>"><?php echo $master_row->abg2_unit_2_comment;?> </textarea></td>
											</tr>
										</table>
									</td>
								</tr>
	...
	<div class="middle_form_design">
		...
		<div class="ui buttons">
		  ...
		  <div class="or"></div>
		  <button class="ui positive button" id="btnsubmit" onClick="return confirm('Are you sure to modify record!');" >Update</button>
