	...
	<div class="record_inner_design"  style="overflow: scroll; white-space: nowrap;">
			<table class="record_table_design_without_fixed">
				<tr>
					...
					<th colspan="4" style="text-align: center;">COLD FOIL 1</th>
					<th colspan="4" style="text-align: center;">COLD FOIL 2</th>
					...
					echo "<tr><td colspan='19'>No Active Records Found</td></tr>";
						...
						foreach($springtube_printing_jobsetup_master as $row){
							...
							echo"<tr>
								...
								<td>";
									$ink_1_result=$this->springtube_ink_master_model->select_one_record_for_view('springtube_ink_master',$this->session->userdata['logged_in']['company_id'],'ink_id',$row->abg1_ink_id_1);
								...
								<td>";
									$ink_2_result=$this->springtube_ink_master_model->select_one_record_for_view('springtube_ink_master',$this->session->userdata['logged_in']['company_id'],'ink_id',$row->abg1_ink_id_2);
								...
								<td>";
									$ink_3_result=$this->springtube_ink_master_model->select_one_record_for_view('springtube_ink_master',$this->session->userdata['logged_in']['company_id'],'ink_id',$row->abg1_ink_id_3);
								...
								<td>";
									$ink_4_result=$this->springtube_ink_master_model->select_one_record_for_view('springtube_ink_master',$this->session->userdata['logged_in']['company_id'],'ink_id',$row->abg1_ink_id_4);
								...
								<td>";
									$ink_5_result=$this->springtube_ink_master_model->select_one_record_for_view('springtube_ink_master',$this->session->userdata['logged_in']['company_id'],'ink_id',$row->abg2_ink_id_1);
								...
								<td>";
									$ink_6_result=$this->springtube_ink_master_model->select_one_record_for_view('springtube_ink_master',$this->session->userdata['logged_in']['company_id'],'ink_id',$row->abg2_ink_id_2);
								...
								<td>".($cold_foil_1!=''?$this->common_model->get_article_name($cold_foil_1,$this->session->userdata['logged_in']['company_id']):'')."</td>
								<td>".($cold_foil_1!=''?$cold_foil_1_width:'')."</td>
								<td>".($cold_foil_1!=''?$cold_foil_1_length:'')."</td>
								<td>".($cold_foil_1!=''?$cold_foil_1_area:'')."</td>
								

								<td>".($cold_foil_2!=''?$this->common_model->get_article_name($cold_foil_2,$this->session->userdata['logged_in']['company_id']):'')."</td>
								<td>".($cold_foil_2!=''?$cold_foil_2_width:'')."</td>
								<td>".($cold_foil_2!=''?$cold_foil_2_length:'')."</td>
								<td>".($cold_foil_2!=''?$cold_foil_2_area:'')."</td>
