<div class="record_form_design">
	...
	<div class="record_inner_design" style="overflow: scroll;white-space: nowrap;">
			...
			<tbody>
				...
				if($springtube_bodymaking_qc_master==FALSE){
					echo "<tr><td colspan='14'>No Active Records Found</td></tr>";
						...
						foreach($springtube_bodymaking_qc_master as $master_row){
							...
							echo"<tr>										
									...
									<td>";
										...
										foreach ($formrights as $formrights_row) {
											...
											echo ($formrights_row->new==1 ? '<a href="'.base_url('index.php/'.$this->router->fetch_class().'/qc_release/'.$master_row->qc_id.'').'" target="_blank" title="Release"><i class="edit icon"></i></a> ' : '');
										...
										$sum_qc_hold_qty+=$master_row->qc_hold_qty;
										$sum_release_qty+=$master_row->release_qty;


						}//master Foreach

						echo"<tr><td colspan='15' style='text-align:right;'><b>TOTAL</b></td><td>".$sum_qc_hold_qty."</td><td></td><td></td><td>".$sum_release_qty."</td><td></td><td></td><td></td></tr>";	
