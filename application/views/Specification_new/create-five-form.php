...
<form name="<?php echo $this->router->fetch_class();?>" action="<?php echo base_url('index.php/'.$this->router->fetch_class().'/save_five');?>" method="POST" >
				...
				<td>
					<table class="form_table_inner">
									...
									<tr>
										...
										<input type="text" name="cap_mb_supplier" class="supplier" value="<?php echo set_value('cap_mb_supplier');?>" placeholder="MB Supplier">
										</td>
										</tr>
