...
<?php foreach($specification as $specification_row):?>
	...
	$result_cap_foil_dist=$this->specification_model->select_details_record_where('specification_sheet_details',$this->session->userdata['logged_in']['company_id'],'spec_id',$specification_row->spec_id,'spec_version_no',$specification_row->spec_version_no,'srd_id','3_10','srd_id','asc');
				...
				<td>
					<table class="form_table_inner">
									...
									<tr>
										...
										<td><input type="text" name="spec_id"  value="<?php echo set_value('spec_id',$specification_row->spec_id);?>" readonly/></td>
									</tr>
									...
									<tr>
										...
										<td><select id="artwork_final_version_no" name="artwork_final_version_no">
											<option value="<?php echo $specification_row->ad_id."_R".$specification_row->version_no;?>"><?php echo $specification_row->ad_id."_R".$specification_row->version_no;?></option>
										</select></td>
									</tr>
									...
									<tr>
										...
										<td>
											<input type="text" name="cap_mb_per" maxlength="3" size="3" value="<?php echo set_value('cap_mb_per',$this->common_model->select_number_from_string($cap_mb_per));?>" placeholder="%">
