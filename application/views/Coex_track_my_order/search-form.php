...
<form name="<?php echo $this->router->fetch_class();?>" action="<?php echo base_url('index.php/'.$this->router->fetch_class().'/search_result');?>" method="POST"  >
	<div class="form_design">
		...
		<legend><b>Track My Order Search</b></legend>
				...
				<td width="50%">
					<table class="form_table_inner">
						<tr>
							...
							<td><input type="date" name="from_date" id="from_date" size="30" value="<?php echo set_value('from_date',date('Y-m-01'));?>" ></td>
						...
						<!-- <tr>
							...
							<td><select name="status">
									...
									<option value='0' <?php echo set_select('status',0); ?>>Not Consumed</option>
								</select>
							</td>
