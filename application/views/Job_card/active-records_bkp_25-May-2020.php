								...
								echo "<tr>
									...
									if($row->jobcard_status==0 ){
										...
										if($order_flag=='1' && $row->jobcard_status==0 && $row->jobcard_type==1){
											...
											?>		
												<a id="jobcard_close" href="#" onclick="window.open('<?php echo base_url("/index.php/".$this->router->fetch_class()."/close_jobcard/$row->mp_pos_no/$spec_id/$version");?>','Close Jobcard','height=200,width=615')" title="Close Jobcard" >CLOSE JOBCARD</a>
