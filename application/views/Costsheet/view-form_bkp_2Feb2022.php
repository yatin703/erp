                    ...
                    if($order_flag!=1){
                        ...
                        foreach ($result_production_master as $key => $production_master_row) { 
                            ...
                            if($production_master_row->jobcard_type=='0'){
                                ...
                                echo'<a href="http://192.168.0.33/3dtechnopack/projects/twerp/tracking-report.php?sono='.$this->uri->segment(4).'&psppsm_no='.$this->uri->segment(5).'&jobcardno='.$coex_jobcard_no.'" target="_blank">PRODUCTION</a>';
                                echo'&nbsp';
