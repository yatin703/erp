<script>
	$(document).ready(function(){
		...
		$("#search").click(function(){
			...
			$.ajax({type: "POST",url: "<?php echo base_url('index.php/ajax/contribution_by_big_dia_small_dia_with_print_type');?>",data: {from_date : $(".from_date").val(),to_date :$('.to_date').val(),convert:$('.convert').val()},cache: false,success: function(html){
				...
				<span id="check">
					...
					if($print_type_wise==FALSE){
						...
						echo '<table class="ui sortable selectable celled table" style="font-size:12px;">
					        	<thead>
								   <tr>
								    	<th colspan="33"><a class="ui orange label">BIG DIA & SMALL DIA CONTRIBUTION BY PRINT TYPE</a>';
								    	if($account_periods_master==FALSE){
								    	}else{
								    		foreach ($account_periods_master as $account_periods_master_row ){
								...
								foreach($print_type_wise as $row_coex){
									...
									echo "<tr>
										...
										<td></td>
										<td class='negative right aligned'><b>".money_format('%!.0n',$row_coex->SCREEN_FLEXO_QUANTITY)."</b></td>
										<td class='negative right aligned'><b>".money_format('%.0n',$row_coex->SCREEN_FLEXO_SALE_VALUE)."</b></td>
										<td class='negative right aligned'><b>".money_format('%.0n',$row_coex->SCREEN_FLEXO_CONTR_VALUE)."</b></td>
										...
										<td class='positive right aligned'><b>".money_format('%!.0n',$row_coex->OFFSET_QUANTITY)."</b></td>
										<td class='positive right aligned'><b>".money_format('%.0n',$row_coex->OFFSET_SALE_VALUE)."</b></td>
										<td class='positive right aligned'><b>".money_format('%.0n',$row_coex->OFFSET_CONTR_VALUE)."</b></td>
										...
										<td class='right aligned'><b>".money_format('%!.0n',$row_coex->LABEL_QUANTITY)."</b></td>
										<td class='right aligned'><b>".money_format('%.0n',$row_coex->LABEL_SALE_VALUE)."</b></td>
										<td class='right aligned'><b>".money_format('%.0n',$row_coex->LABEL_CONTR_VALUE)."</b></td>
										<td class='right aligned'><b>&#8377;".round($label_avg_price,2)."</b></td>										
										<td class='right aligned'><b>&#8377;".round($label_contribution_tube,2)."</b></td>


										<td class='active right aligned'><b>".money_format('%!.0n',$total_print_type_coex_quantity)."</b></td>
										<td class='active right aligned'><b>".money_format('%.0n',$total_print_type_coex_value)."</b></td>
										<td class='active right aligned'><b>".money_format('%.0n',$total_print_type_coex_contr)."</b></td>
										...
										<td class='negative right aligned'><b>".money_format('%!.0n',$row_coex->SPRING_QUANTITY)."</b></td>
										<td class='negative right aligned'><b>".money_format('%.0n',$row_coex->SPRING_SALE_VALUE)."</b></td>
										<td class='negative right aligned'><b>".money_format('%.0n',$row_coex->SPRING_CONTR_VALUE)."</b></td>
										...
										<td class='active right aligned'><b>".money_format('%!.0n',$total_print_type_quantity)."</b></td>
										<td class='active right aligned'><b>".money_format('%.0n',$total_print_type_value)."</b></td>
										<td class='active right aligned'><b>".money_format('%.0n',$total_print_type_contr)."</b></td>
										...
										echo "<tr>
												...
												<td></td>
												<td>19,25,30</td>
												<td class='negative right aligned'>".money_format('%!.0n',$monthwise_small_dia_row->SCREEN_FLEXO_SMALL_DIA)."</td>
												<td class='negative right aligned'>".money_format('%.0n',$monthwise_small_dia_row->SCREEN_FLEXO_SMALL_DIA_VALUE)."</td>
												<td class='negative right aligned'>".money_format('%.0n',$monthwise_small_dia_row->SCREEN_FLEXO_SMALL_DIA_CONTRIBUTION_VALUE)."</td>
												...
												<td class='positive right aligned'>".money_format('%!.0n',$monthwise_small_dia_row->OFFSET_SMALL_DIA)."</td>
												<td class='positive right aligned'>".money_format('%.0n',$monthwise_small_dia_row->OFFSET_SMALL_DIA_VALUE)."</td>
												<td class='positive right aligned'>".money_format('%.0n',$monthwise_small_dia_row->OFFSET_SMALL_DIA_CONTRIBUTION_VALUE)."</td>
												...
												<td class='right aligned'>".money_format('%!.0n',$monthwise_small_dia_row->LABEL_SMALL_DIA)."</td>
												<td class='right aligned'>".money_format('%.0n',$monthwise_small_dia_row->LABEL_SMALL_DIA_VALUE)."</td>
												<td class='right aligned'>".money_format('%.0n',$monthwise_small_dia_row->LABEL_SMALL_DIA_CONTRIBUTION_VALUE)."</td>
												...
												<td class='active right aligned'>".money_format('%!.0n',$TOTAL_ROW_COEX_SMALL_DIA)."</td>
												<td class='active right aligned'>".money_format('%.0n',$TOTAL_ROW_COEX_SMALL_DIA_VALUE)."</td>
												<td class='active right aligned'>".money_format('%.0n',$TOTAL_ROW_COEX_SMALL_DIA_CONTRIBUTION_VALUE)."</td>
												...
												<td class='negative right aligned'>".money_format('%!.0n',$monthwise_small_dia_row->SPRING_SMALL_DIA)."</td>
												<td class='negative right aligned'>".money_format('%.0n',$monthwise_small_dia_row->SPRING_SMALL_DIA_VALUE)."</td>
												<td class='negative right aligned'>".money_format('%.0n',$monthwise_small_dia_row->SPRING_SMALL_DIA_CONTRIBUTION_VALUE)."</td>
												...
												<td class='active right aligned'>".money_format('%!.0n',$GRAND_TOTAL_ROW_COEX_SMALL_DIA)."</td>
												<td class='active right aligned'>".money_format('%.0n',$GRAND_TOTAL_ROW_COEX_SMALL_DIA_VALUE)."</td>
												<td class='active right aligned'>".money_format('%.0n',$GRAND_TOTAL_ROW_COEX_SMALL_DIA_CONTRIBUTION_VALUE)."</td>
										...
										echo "<tr>
												...
												<td></td>
												<td>35,40,50</td>
												<td class='negative right aligned'>".money_format('%!.0n',$monthwise_BIG_dia_row->SCREEN_FLEXO_BIG_DIA)."</td>
												<td class='negative right aligned'>".money_format('%.0n',$monthwise_BIG_dia_row->SCREEN_FLEXO_BIG_DIA_VALUE)."</td>
												<td class='negative right aligned'>".money_format('%.0n',$monthwise_BIG_dia_row->SCREEN_FLEXO_BIG_DIA_CONTRIBUTION_VALUE)."</td>
												...
												<td class='positive right aligned'>".money_format('%!.0n',$monthwise_BIG_dia_row->OFFSET_BIG_DIA)."</td>
												<td class='positive right aligned'>".money_format('%.0n',$monthwise_BIG_dia_row->OFFSET_BIG_DIA_VALUE)."</td>
												<td class='positive right aligned'>".money_format('%.0n',$monthwise_BIG_dia_row->OFFSET_BIG_DIA_CONTRIBUTION_VALUE)."</td>
												...
												<td class='right aligned'>".money_format('%!.0n',$monthwise_BIG_dia_row->LABEL_BIG_DIA)."</td>
												<td class='right aligned'>".money_format('%.0n',$monthwise_BIG_dia_row->LABEL_BIG_DIA_VALUE)."</td>
												<td class='right aligned'>".money_format('%.0n',$monthwise_BIG_dia_row->LABEL_BIG_DIA_CONTRIBUTION_VALUE)."</td>
												...
												<td class='active right aligned'>".money_format('%!.0n',$TOTAL_ROW_COEX_BIG_DIA)."</td>
												<td class='active right aligned'>".money_format('%.0n',$TOTAL_ROW_COEX_BIG_DIA_VALUE)."</td>
												<td class='active right aligned'>".money_format('%.0n',$TOTAL_ROW_COEX_BIG_DIA_CONTRIBUTION_VALUE)."</td>
												...
												<td class='negative right aligned'>".money_format('%!.0n',$monthwise_BIG_dia_row->SPRING_BIG_DIA)."</td>
												<td class='negative right aligned'>".money_format('%.0n',$monthwise_BIG_dia_row->SPRING_BIG_DIA_VALUE)."</td>
												<td class='negative right aligned'>".money_format('%.0n',$monthwise_BIG_dia_row->SPRING_BIG_DIA_CONTRIBUTION_VALUE)."</td>
												...
												<td class='active right aligned'>".money_format('%!.0n',$GRAND_TOTAL_ROW_COEX_BIG_DIA)."</td>
												<td class='active right aligned'>".money_format('%.0n',$GRAND_TOTAL_ROW_COEX_BIG_DIA_VALUE)."</td>
												<td class='active right aligned'>".money_format('%.0n',$GRAND_TOTAL_ROW_COEX_BIG_DIA_CONTRIBUTION_VALUE)."</td>
							...
							<thead>
								...
								<th>".money_format('%!.0n',$total_screen_flexo_quantity)."</th>
								<th>".money_format('%.0n',$total_screen_flexo_value)."</th>
								<th>".money_format('%.0n',$total_screen_flexo_contribution_value)."</th>
								...
								<th>".money_format('%!.0n',$total_offset_quantity)."</th>
								<th>".money_format('%.0n',$total_offset_value)."</th>
								<th>".money_format('%.0n',$total_offset_contribution_value)."</th>
								...
								<th>".money_format('%!.0n',$total_label_quantity)."</th>
								<th>".money_format('%.0n',$total_label_value)."</th>
								<th>".money_format('%.0n',$total_label_contribution_value)."</th>
								<th class='right aligned'>&#8377;".round($total_label_avg_price,2)."</th>
								<th class='right aligned'>&#8377;".round($total_label_contribution_price,2)."</th>

								<th>".money_format('%!.0n',$total_coex_quantity)."</th>
								<th>".money_format('%.0n',$total_coex_value)."</th>
								<th>".money_format('%.0n',$total_coex_contribution_value)."</th>
								<th class='right aligned'>&#8377;".round($total_coex_avg_price,2)."</th>
								<th class='right aligned'>&#8377;".round($total_coex_contribution_price,2)."</th>


								<th>".money_format('%!.0n',$total_spring_quantity)."</th>
								<th>".money_format('%.0n',$total_spring_value)."</th>
								<th>".money_format('%.0n',$total_spring_contribution_value)."</th>
								...
								<th>".money_format('%!.0n',$total_grand_quantity)."</th>
								<th>".money_format('%.0n',$total_grand_value)."</th>
								<th>".money_format('%.0n',$total_grand_contribution_value)."</th>
