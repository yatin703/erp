...
<form name="<?php echo $this->router->fetch_class();?>" action="<?php echo base_url('index.php/'.$this->router->fetch_class().'/index_resultt');?>" method="POST" >

	<div class="form_design">

	<div class="ui teal labels" style="text-align: center;">
      <div class="ui label">COSTSHEET SUMMARY</div>
    </div>
    <br/>
