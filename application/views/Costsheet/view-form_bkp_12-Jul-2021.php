    ...
    -->
        ...
        <?php
            ...
            foreach($result_other_cost as $other_cost_row){
                ...
                echo "<tr class='item'><td class='label' width='10%' >OTHER COST</td>
                        <td class='label' width='5%' style='border-right:1px solid #D9d9d9;'></td>
                        <td class='label' width='35%' style='border-right:1px solid #D9d9d9;'>".$other_cost_row->other_cost."</td>
                        <td class='label' width='10%' style='border-right:1px solid #D9d9d9;text-align:right'>".$this->common_model->read_number($ar_invoice_details_row->arid_qty,$this->session->userdata['logged_in']['company_id'])." NOS</td>
                        <td width='5%' style='border-right:1px solid #D9d9d9;text-align:right'> </td>
                        <td width='10%' style='border-right:1px solid #D9d9d9;text-align:right'>&#8377; ".round($total_other_cost,2)."</td>
                        <td width='10%' style='border-right:1px solid #D9d9d9;text-align:right'>&#8377; ".round($other_cost_row->cost_per_tube,2)."</td>
                        <td width='10%' style='text-align:right'></td>
                    </tr>";
                    $total_other_cost_amount+=$total_other_cost;
                }
                }else{
                    echo "<tr><td colspan='8'>OTHER COST IS NOT ENTERED</td></tr>";
                }
