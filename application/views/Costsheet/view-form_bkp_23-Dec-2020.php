...
<!-- Purging Start -->
        ...
        <?php
        $total_ink_cost=0;
        if(strcmp($print_type_artwork, 'SCREEN') == 0 || strcmp($print_type_artwork, 'SCREEN+UPTO NECK') == 0 || strcmp($print_type_artwork, 'SCREEN + LABEL') == 0 || strcmp($print_type_artwork, 'SCREEN+FLEXO') == 0 || strcmp($print_type_artwork, 'OFFSET SCREEN') == 0 || strcmp($print_type_artwork, 'FLEXO+SCREEN') == 0){
            ...
            foreach($result_offset_ink_value as $result_offset_ink_value_row){
                ...
                foreach($result_offset_ink_value as $result_offset_ink_value_row){
                    ...
                    echo "<tr class='item'><td class='label' width='10%' >OFFSET INK</td>
                        ...
                        <td class='label' width='10%' style='border-right:1px solid #D9d9d9;text-align:right'>".$offset_ink_gm_tube*($ar_invoice_details_row->arid_qty/100)."</td>
