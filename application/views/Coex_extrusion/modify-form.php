				...
				<td width="45%">
					<table class="form_table_inner">
						...
						<tr>
							...
							<td><input type="date" name="extrusion_date"  id="extrusion_date" size="10" value="<?php echo set_value('extrusion_date',$coex_extrusion_row->extrusion_date);?>" required/>
						...
						<tr>
							...
							<td><input type="text" name="operator" size="10" value="<?php echo set_value('operator',$coex_extrusion_row->operator);?>" required>
						</tr>
