			...
			<tr>
				<td width="50%">
					<table class="form_table_inner">
						...
						<tr>
							<td class="label">SPSM/SPSP No.  * :</td>
							<td colspan="3"><input type="text" name="article_no" id="article_no"  size="58" value="<?php echo set_value('article_no');?>" placeholder="SPSM/SPSP No"/>
							</td>
						</tr>
						<tr>
				...
				<td width="50%">
					<table class="form_table_inner">									
						<tr>							
							...
							<td><input type="number" name="ups" id="ups"  size="20" value="<?php echo set_value('ups',2);?>" min="1" max="3" steps="1"/></td>
							<td class="label">Repeat  <span style="color:red;">*</span> :</td>
							<td><input type="number" name="repeat" id="repeat"  size="20" value="<?php echo set_value('repeat');?>" min="1" max="10" steps="1" /></td>
						</tr>
						<tr>
