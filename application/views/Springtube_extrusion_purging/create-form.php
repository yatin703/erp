...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		$("#article_no_2").autocomplete("<?php echo base_url('index.php/ajax/raw_material_article_no');?>", {selectFirst: true});		
		...
		$("#total_purging_weight").live('keyup',function(){	
		
			if($("#total_purging_weight").val()!='' && $("#total_purging_weight").val()!='0'){

				var total_purging_weight=parseInt($("#total_purging_weight").val())
				var ldpe_70=total_purging_weight*(70/100);
				var lldpe_30=total_purging_weight*(30/100);
				ldpe_70=ldpe_70.toFixed();
				lldpe_30=lldpe_30.toFixed();
				$("#quantity_1").val(ldpe_70);
				$("#quantity_2").val(lldpe_30);				
				...
				<td width="50%">
					<table class="form_table_inner">
						...
						<tr>
							...
							<td><input type="text" name="total_purging_weight" id="total_purging_weight" ></td>	
		...
		<div class="middle_form_design">
			...
			?>
					...
					<tr id="tr_1">
						...
						<td>
							<input type="text" name="article_no_1"  id="article_no_1" class="quantity" value="<?php echo set_value('article_no_1','LDPE LOTRENE FD0270//RM-LDPE-000-0018');?>" maxlength="50" size="60" readonly />
						</td>						
						<td>
							<input type="number" name="quantity_1"  id="quantity_1" class="quantity" value="<?php echo set_value('quantity_1');?>" size="30" min="1" max="1000" step="0.1" readonly />
						</td>
					...
					<tr id="tr_1">
						...
						<td>
							<input type="hidden" name="sr_no[]" value="2"/> 2
						</td>					
						<td>
							<input type="text" name="article_no_2"  id="article_no_2" class="quantity" value="<?php echo set_value('article_no_2','LLDPE SABIC 118NJ//RM-LLDPE-000-0008');?>" maxlength="50" size="60" readonly />
						</td>						
						<td>
							<input type="number" name="quantity_2"  id="quantity_2" class="quantity" value="<?php echo set_value('quantity_2');?>" size="30" min="1" max="1000" step="0.1" readonly />
						</td>
