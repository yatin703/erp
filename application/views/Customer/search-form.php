				...
				<td>
					<table class="form_table_inner">
									...
									<tr>
										...
										<td><input type="date" name="from_date" maxlength="10" size="10" value="<?php echo set_value('from_date');?>" /></td>
									</tr>

									<tr>
										<td class="label">To Date  :</td>
										<td><input type="date" name="to_date" maxlength="10" size="10" value="<?php echo set_value('to_date');?>" /></td>
									</tr>
									<tr>
										<td class="label">Dispacth Tolerance  :</td>
										<td>
											<input type="number" name="dispatch_tolerance" min="0" max="20" step="1">
										</td>
									</tr>
									...
									<tr>
										...
										<td><input type="text" name="adr_company_id" maxlength="10" size="10" value="<?php echo set_value('adr_company_id');?>" /></td>
									</tr>
									...
									<tr>
										...
										<td><input type="text" name="email" maxlength="200" size="20" value="<?php echo set_value('email');?>" /></td>
									</tr>
									...
									<tr>
										...
										<?php if($payment_term==FALSE){
												...
												foreach($payment_term as $payment_term_row){
													echo "<option value='".$payment_term_row->id."'  ".set_select('payment_term',''.$payment_term_row->id.'').">(".$payment_term_row->net_days." days) ".$payment_term_row->lang_description."</option>";
												}
										}?>
										</select></td>
									</tr>
