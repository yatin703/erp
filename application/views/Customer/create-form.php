				...
				<td>
					<table class="form_table_inner">
									<tr>
										...
										<td>
											<input type="number" name="dispatch_tolerance" min="0" max="20" step="1" value="<?php echo set_value('dispatch_tolerance');?>" required>
										</td>
									</tr>
									<tr>
									...
									<tr>
										<td class="label">Address Line 1 <span style="color:red;">*</span>:</td>
										<td><input type="text" name="name2" maxlength="52" size="52" value="<?php echo set_value('name2');?>" /></td>
									</tr>

									<tr>
										<td class="label">Address Line 2 <span style="color:red;">*</span> :</td>
										<td><input type="text" name="street" maxlength="52" size="52" value="<?php echo set_value('street');?>" /></td>
									</tr>

									<tr>
										<td class="label">Address Line 3 <span style="color:red;">*</span> :</td>
						...
						<table class="form_table_inner">
							...
							<tr>
									...
									<tr>
										...
										<td><input type="text" name="max_lead_time" maxlength="3" size="3" value="<?php echo set_value('max_lead_time');?>" />&nbsp;<i>No of Days</i></td>
									</tr>
