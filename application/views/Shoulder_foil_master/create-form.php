				...
				<td>
					<table class="form_table_inner">
									...
									<tr>
										...
										<td><select name="shoulder_foil">
										<option value=''>--Select Foil--</option>
										<?php
										foreach ($shoulder_foil as $shoulder_foil_row) {
											echo "<option value='".$shoulder_foil_row->article_no."' ".set_select('shoulder_foil',$shoulder_foil_row->article_no).">".$shoulder_foil_row->lang_article_description."</option>";
										}
										?>
										</select></td>
										</tr>
									...
									<tr>
										...
										<td><input type="text" name="no_of_tubes"  value="<?php echo set_value('no_of_tubes');?>" /></td>
									</tr>

									<tr>
										<td class="label">Foil Width <span style="color:red;">*</span> :</td>
										<td><input type="text" name="one_roll_width_in_meter"  value="<?php echo set_value('one_roll_width_in_meter');?>" /></td>
									</tr>

									<tr>
										<td class="label">Foil Length <span style="color:red;">*</span> :</td>
										<td><input type="text" name="one_roll_length_in_meter"  value="<?php echo set_value('one_roll_length_in_meter');?>" /></td>
									</tr>

									<tr>
										<td class="label">Area <span style="color:red;">*</span> :</td>
										<td><input type="text" name="one_roll_sqm_area"  value="<?php echo set_value('one_roll_sqm_area');?>" /></td>
									</tr>

									<tr>
										<td class="label">Area/Tube <span style="color:red;">*</span> :</td>
										<td><input type="text" name="sqm_per_tube"  value="<?php echo set_value('sqm_per_tube');?>" /></td>
									</tr>
