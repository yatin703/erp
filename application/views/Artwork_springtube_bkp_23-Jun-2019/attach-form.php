...
<script>
	$(document).ready(function(){
    	...
    	$("#btnupdate").click(function(e){
			...
			if($("#cold_foil_1").val()!="" && $("#cold_foil_1_area").val()==""){
				alert('Enter Cold Foil 1 SQMM Area.');
				$("#cold_foil_1_area").focus();
				return false;
			}
			if($("#cold_foil_2").val()!="" && $("#cold_foil_2_area").val()==""){
				alert('Enter Cold Foil 2 SQMM Area.');
				$("#cold_foil_2_area").focus();
				return false;
			}
			...
			<tr>
				<td>
					<table class="form_table_inner" >
						...
						Length <span style="color:red;">*</span> : <input type="number" name="sleeve_length" size="10" value="<?php echo set_value('sleeve_length',$length);?>"  min="50" max="500" step="any" readonly></td>
						</tr>

						<tr>
							<td class="label">Laminate Color <span style="color:red;">*</span> :</td>
							<td><input type="text" name="laminate_color" value="<?php echo set_value('laminate_color',$laminate_color);?>" readonly></td>
						</tr>
						<tr>
						...
						<tr id="cold_foil_1_txt">
							...
							<input type="number" name='cold_foil_1_area' id="cold_foil_1_area" value='<?php echo set_value('cold_foil_1_area',$cold_foil_1_area);?>' placeholder="SQM/Tube" min="0" max="1" step="0.00001" ></td>
						</tr>
						...
						<tr id="cold_foil_2_txt">
							...
							<input type="number" name='cold_foil_2_area' id="cold_foil_2_area" value='<?php echo set_value('cold_foil_2_area',$cold_foil_2_area);?>' placeholder="SQM/Tube"  min="0" max="1" step="0.00001" ></td>
						</tr>
