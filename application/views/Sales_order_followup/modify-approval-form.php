			...
			<thead>
				...
				<tr>
					...
					<table>
						...
						<tr>
							<td>Bill To <span style="color:red;">*</span> :</td>
            			...
            			echo "<option ".$selected." value='".$ship_to_row->related_company_id."' ".set_select('consin_adr_company_id',''.$ship_to_row->related_company_id.'').">".$ship_to_row->relate."//".$ship_to_row->related_company_id."//".$ship_to_row->lang_property_name."</option>";
								...
								?></td>
									...
									<tr>
										<td>Po No <span style="color:red;">*</span> :</td>
										<td><input type="text" name="po_no" value="<?php echo set_value('po_no',$order_row->cust_order_no);?>" disabled/> &nbsp;&nbsp;&nbsp;Po Date <span style="color:red;">*</span> :
										<input type="date" name="po_date" value="<?php echo set_value('po_date',$order_row->cust_order_date);?>" disabled/></td>
									</tr>
