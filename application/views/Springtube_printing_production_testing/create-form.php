			    		...
			    		//alert(data.total_counter);
			       		...
			       		if(data.status){
			       			...
			       			for(var i=0;i<obj.length;i++){
			       				...
			       				alert(obj[i].details_id);

			       				//var modify_url="<?php echo base_url('/index.php/springtube_printing_production_testing/modify_counter/');?>"+obj[i].details_id;

			       				//var modify_url="<?php echo base_url();?>/index.php/<?php echo $this->router->fetch_class();?>/modify_counter"+obj[i].details_id;

			       				//var delete_url="<?php echo base_url();?>/index.php/<?php echo $this->router->fetch_class();?>/delete_counter"+obj[i].details_id;
			       				//alert(url);
			       				...
			       				var tr='<tr><td>'+j+'</td><td>'+obj[i].counter+'</td><td>'+obj[i].stop_reason+'</td> </tr>';
