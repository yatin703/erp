					...
					echo "<tr><td colspan='4'>No Active Records Found</td></tr>";
							...
							foreach($cap_finish_master as $row){
								echo "<tr>
									...
									<td><a href=".base_url('index.php/'.$this->router->fetch_class().'/modify/'.$row->cap_finish_id.'').">Modify</a><a href=".base_url('index.php/'.$this->router->fetch_class().'/delete/'.$row->cap_finish_id.'')."> | Delete</a>
