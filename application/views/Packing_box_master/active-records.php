					...
					echo "<tr><td colspan='5'>No Active Records Found</td></tr>";
							...
							foreach($packing_box_master as $row){
								echo "<tr>
									...
									<td><a href=".base_url('index.php/'.$this->router->fetch_class().'/modify/'.$row->pbm_id.'').">Modify</a><a href=".base_url('index.php/'.$this->router->fetch_class().'/delete/'.$row->pbm_id.'')."> | Delete</a>
