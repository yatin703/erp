...
<form name="<?php echo $this->router->fetch_class();?>" action="<?php echo base_url('index.php/'.$this->router->fetch_class().'/wip_release_scrap_save');?>" method="POST" >
			...
			<tr>
				<td>
					<table class="form_table_inner">
						...
						<?php foreach($springtube_bodymaking_scrap_master as $row){ ?>

						<tr>
							<td class="label">Release Date <span style="color:red;">*</span> :</td>
							<td><input type="hidden" name="bm_wip_id" value="<?php echo set_value('scrap_id',$row->scrap_id);?>">
						...
						<tr>
							...
							<td ><input type="text" name="shortfall_qty" id="shortfall_qty"  size="20" value="<?php echo set_value('shortfall_qty',$row->scrap_qty);?>" /></td>
						</tr>
						<tr>
