	...
	<div class="record_inner_design" style="overflow: scroll; white-space: nowrap;">
			...
			<tbody>
				...
				if($springtube_bodymaking_wip_master==FALSE){
					echo "<tr><td colspan='14'>No Active Records Found</td></tr>";
						...
						foreach($springtube_bodymaking_wip_master as $master_row){
							...
							echo"<tr>
									...
									<td class='positive' style='text-align:right;'><b>".number_format($master_row->scrap_qty,0,'.',',')."</b> <i>NOS</i>
									</td>
					...
					<td class='positive right aligned'><b>".number_format($sum_scrap_qty,0,'.',',')."</b> <i>NOS</i></td></tr>";	
