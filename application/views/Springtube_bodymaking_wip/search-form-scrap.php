...
<form name="<?php echo $this->router->fetch_class();?>" action="<?php echo base_url('index.php/'.$this->router->fetch_class().'/search_result_scrap');?>" method="POST"  >
	<div class="form_design">
		...
		<legend><b>Bodymaking SCRAP Search</b></legend>
					...
					<table class="form_table_inner">
						...
						<tr>
							...
							<td><select name="status">
									...
									<option value='0' <?php echo set_select('status',0); ?>>In scrap</option>
