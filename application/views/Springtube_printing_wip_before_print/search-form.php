				...
				<td width="50%">
					<table class="form_table_inner">
						...
						<tr>
							...
							<td class="label">From Stock SO :</td>
							<td><input type="text" name="from_order_no" id="from_order_no"  value="<?php echo set_value('from_order_no');?>" maxlength="20" size="20"/></td>
						...
						<tr>
							...
							<td><select name="status">
									...
									<option value='1' <?php echo set_select('status',1); ?>>Consumed</option>
									
								</select>
							</td>

							<td class="label">Is Return :</td>
							<td><input type="checkbox" name="return_flag" id="return_flag" value="<?php echo set_value('return_flag',1);?>" <?php echo ($this->input->post('return_flag')==1?"checked":"");?> />
							</td>
