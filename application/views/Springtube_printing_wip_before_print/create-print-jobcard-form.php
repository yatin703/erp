...
<form name="<?php echo $this->router->fetch_class();?>" action="<?php echo base_url('index.php/'.$this->router->fetch_class().'/save_printing_jobcard');?>" method="POST" >
				...
				<table class="form_table_inner">
						<?php foreach($order_details as $order_details_row):?>
							...
							<?php 
								...
								if($springtube_printing_wip_master_before==TRUE){

									foreach ($springtube_printing_wip_master_before as  $springtube_printing_wip_master_before_row) {
									$total_wip_available+=$springtube_printing_wip_master_before_row->bprint_wip_meters;
									$total_qty_available+=$springtube_printing_wip_master_before_row->bprint_wip_qty;
									$total_wip_cost_per_meter+=$springtube_printing_wip_master_before_row->bwip_cost_per_meter;
							...
							<tr>
								<td class="label">Total Meters released for Printing * :</td>
								<td><input type="text" name="total_bprint_wip_meters" id="total_bprint_wip_meters" value="<?php echo set_value('total_bprint_wip_meters',$total_wip_available);?>" readonly></td>
							</tr>
							<tr>
								<td class="label">Total Qty released for Printing * :</td>
								<td><input type="text" name="total_bprint_wip_qty" id="total_bprint_wip_qty" value="<?php echo set_value('total_bprint_wip_qty',$total_qty_available);?>" readonly></td>
							</tr>
							<tr>
								<td class="label">No. of Meters taken for Printing Job Card * :</td>
								<td><input type="text" name="release_meters" id="release_meters" value="<?php echo set_value('release_meters',$total_wip_available);?>" readonly ></td>
							</tr>
							<tr>
								<td class="label"> Printing Job Card Quantity * :</td>
							...
							<tr>
								...
								<td><input type="text" name="film_code" id="film_code" value="<?php echo set_value('film_code',$film_code);?>" readonly></td>
							</tr>
							<tr>
								<td class="label"> WIP Cost Per Meter  :</td>
								<td><input type="text" name="bwip_cost_per_meter" id="bwip_cost_per_meter" value="<?php echo set_value('bwip_cost_per_meter',$avg_wip_cost_per_meter);?>" readonly></td>
							</tr>
							<tr>
								<td class="label">Comment * :</td>
								<td colspan="3"><textarea name="comment" id="comment" value="<?php echo set_value('comment');?>"  required><?php echo set_value('comment');?></textarea></td>
							</tr>
