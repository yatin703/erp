...
<?php foreach($specification as $specification_row):?>
	...
	//Layer 2
      ...
      $result_sl_mb_three=$this->sleeve_specification_model->select_details_record_where('specification_sheet_details',$this->session->userdata['logged_in']['company_id'],'spec_id',$specification_row->spec_id,'spec_version_no',$specification_row->spec_version_no,'srd_id','3_5_0','srd_id','asc');
      ...
      $result_sl_mb_supplier_three=$this->sleeve_specification_model->select_details_record_where('specification_sheet_details',$this->session->userdata['logged_in']['company_id'],'spec_id',$specification_row->spec_id,'spec_version_no',$specification_row->spec_version_no,'srd_id','3_5_0','srd_id','asc');
      ...
      $result_sl_ldpe_three=$this->sleeve_specification_model->select_details_record_where('specification_sheet_details',$this->session->userdata['logged_in']['company_id'],'spec_id',$specification_row->spec_id,'spec_version_no',$specification_row->spec_version_no,'srd_id','3_6_0','srd_id','asc');
      ...
      $result_sl_lldpe_three=$this->sleeve_specification_model->select_details_record_where('specification_sheet_details',$this->session->userdata['logged_in']['company_id'],'spec_id',$specification_row->spec_id,'spec_version_no',$specification_row->spec_version_no,'srd_id','3_6_1','srd_id','asc');
      ...
      $result_sl_hdpe_three=$this->sleeve_specification_model->select_details_record_where('specification_sheet_details',$this->session->userdata['logged_in']['company_id'],'spec_id',$specification_row->spec_id,'spec_version_no',$specification_row->spec_version_no,'srd_id','3_6_2','srd_id','asc');
	...
	?>
<form name="<?php echo $this->router->fetch_class();?>" action="<?php echo base_url('index.php/'.$this->router->fetch_class().'/update_three_layer');?>" method="POST" >
						...
						<input type="hidden" name="spec_version_no" value="<?php echo $specification_row->spec_version_no;?>">
								<!--
									...
									<tr>
										...
										}?></select>&nbsp;Length <span style="color:red;">*</span> : <input type="number" name="sleeve_length" min="10"  max="300" step="0.5" id="sleeve_length" size="5" maxlength="5" value="<?php echo set_value('sleeve_length',$length);?>" required></td>
									</tr>
                           ...
                           <tr><td class="label">&nbsp;</td><td class="label">&nbsp;</td></tr>
									...
									<tr>
										...
										<td><input type="number" name="gauge" id="gauge"  size="3" value="<?php echo set_value('gauge_one',$this->common_model->select_number_from_string($gauge));?>" required></td>
									</tr>
									...
									<tr>
										...
										<td>
										<input type="number" name="sl_mb_per" id="sl_mb_per" min="0"  max="25" step="0.1" maxlength="3" size="3" value="<?php echo set_value('sl_mb_per',$this->common_model->select_percentage_from_string($sl_mb_per));?>" placeholder="%" required>
                              ...
                              <tr><td class="label">&nbsp;</td><td class="label">&nbsp;</td></tr>
									...
									<tr>
										<td class="label">Gauge <span style="color:red;">*</span> :</td>
										<td><input type="number" name="gauge_two" id="gauge_two"  size="3" value="<?php echo set_value('gauge_two',$this->common_model->select_number_from_string($gauge_two));?>" required></td>
									</tr>
									...
									<tr>
										...
										<td>
										<input type="number" name="sl_hdpe_per_two" id="sl_hdpe_per_two" min="100" max="100" step="1"  maxlength="3" size="3" value="<?php echo set_value('sl_hdpe_per_two',$this->common_model->select_percentage_from_string($sl_hdpe_per_two));?>" placeholder="%"></td>
									</tr>
                           ...
                           <tr>
                              <td class="label">Gauge <span style="color:red;">*</span> :</td>
                              <td><input type="number" name="gauge_three" id="gauge_three"  size="3" value="<?php echo set_value('gauge_three',$this->common_model->select_number_from_string($gauge_three));?>" required></td>
                           </tr>
                           ...
                           <tr>
                              ...
                              <td>
                              <input type="number" name="sl_mb_per_three" min="0"  max="25" step="0.1"  id="sl_mb_per_three" maxlength="3" size="3" value="<?php echo set_value('sl_mb_per_three',$this->common_model->select_percentage_from_string($sl_mb_per_three));?>" placeholder="%" required>
                              </td>
                              </tr>
                              ...
                              <td>
                              <input type="number" name="sl_ldpe_per_three" id="sl_ldpe_per_three" min="0"  max="100" step="1"  maxlength="3" size="3" value="<?php echo set_value('sl_ldpe_per_three',$this->common_model->select_percentage_from_string($sl_ldpe_per_three));?>" placeholder="%"></td>
                              </tr>
                              ...
                              <td>
                              <input type="number" name="sl_lldpe_per_three" id="sl_lldpe_per_three" min="0"  max="100" step="1" maxlength="3" size="3" value="<?php echo set_value('sl_lldpe_per_three',$this->common_model->select_percentage_from_string($sl_lldpe_per_three));?>" placeholder="%"></td>
                              </tr>
                              ...
                              <td>
                              <input type="number" name="sl_hdpe_per_three" id="sl_hdpe_per_three" min="0"  max="100" step="1"  maxlength="3" size="3" value="<?php echo set_value('sl_hdpe_per_three',$this->common_model->select_percentage_from_string($sl_hdpe_per_three));?>" placeholder="%"></td>
                              </tr>
								...
								<table>
									<tr>
                                      ...
                                      if(!empty($this->input->post('sl_hdpe_two')) && !empty($this->input->post('sl_hdpe_per_two'))){
                                       ...
                                       $data['sl_hdpe_twoo']=$this->article_model->select_one_active_record('article',$this->session->userdata['logged_in']['company_id'],'article.article_no',$this->input->post('sl_hdpe_two'));
                                       if($data['sl_hdpe_twoo']==FALSE){
                                        $sl_hdpe_twoo="";
                                       }else{
                                        foreach($data['sl_hdpe_twoo'] as $sl_hdpe_row_twoo){
                                          $sl_hdpe_twoo=$sl_hdpe_row_twoo->article_name;
                                        }
                                       }
                                        $sl_hdpe_per_twoo=$this->input->post('sl_hdpe_per_two')."%";
                                        echo "<br/>+<br/><span class='ui teal label'>".$sl_hdpe_twoo." ".$sl_hdpe_per_twoo."</span>";
                                      }else{
                                        $sl_hdpe_twoo='';
                                        $sl_hdpe_per_twoo='';
                                      }
                                      ...
                                      $data['sl_masterbatch_threee']=$this->article_model->select_one_active_record('article',$this->session->userdata['logged_in']['company_id'],'article.article_no',$this->input->post('sl_masterbatch_three'));

                                       foreach($data['sl_masterbatch_threee'] as $sl_masterbatch_row_threee){
                                          $sl_mb_per_threee=$this->input->post('sl_mb_per_three')."%";
                                          $sl_masterbatch_threee=$sl_masterbatch_row_threee->article_name;
                                        echo "<br/>+<br/><span class='ui teal label'>".$sl_masterbatch_threee." ".$sl_mb_per_threee."</span>";

                                      }
                                       }else{
                                          $sl_masterbatch_threee="";
                                          $sl_mb_per_threee="";
                                       }

                                      if(!empty($this->input->post('sl_ldpe_three')) && !empty($this->input->post('sl_ldpe_per_three'))){

                                       $data['sl_ldpe_threee']=$this->article_model->select_one_active_record('article',$this->session->userdata['logged_in']['company_id'],'article.article_no',$this->input->post('sl_ldpe_three'));
                                       if($data['sl_ldpe_threee']==FALSE){
                                        $sl_ldpe_threee="";
                                       }else{
                                        foreach($data['sl_ldpe_threee'] as $sl_ldpe_row_threee){
                                          $sl_ldpe_threee=$sl_ldpe_row_threee->article_name;
                                        }
                                       }
                                        $sl_ldpe_per_threee=$this->input->post('sl_ldpe_per_three')."%";
                                        echo "<br/>+<br/><span class='ui teal label'>".$sl_ldpe_threee." ".$sl_ldpe_per_threee."</span>";
                                      }else{
                                        $sl_ldpe_threee='';
                                        $sl_ldpe_per_threee='';
                                      }
                                      ...
                                      if(!empty($this->input->post('sl_lldpe_three')) && !empty($this->input->post('sl_lldpe_per_three'))){
                                       ...
                                       $data['sl_lldpe_threee']=$this->article_model->select_one_active_record('article',$this->session->userdata['logged_in']['company_id'],'article.article_no',$this->input->post('sl_lldpe_three'));
                                       if($data['sl_lldpe_threee']==FALSE){
                                        $sl_lldpe_threee="";
                                       }else{
                                        foreach($data['sl_lldpe_threee'] as $sl_lldpe_row_threee){
                                          $sl_lldpe_threee=$sl_lldpe_row_threee->article_name;
                                        }
                                       }
                                        $sl_lldpe_per_threee=$this->input->post('sl_lldpe_per_three')."%";
                                        echo "<br/>+<br/><span class='ui teal label'>".$sl_lldpe_threee." ".$sl_lldpe_per_threee."</span>";
                                      }else{
                                        $sl_lldpe_threee='';
                                        $sl_lldpe_per_threee='';
                                      }
                                      ...
                                      if(!empty($this->input->post('sl_hdpe_three')) && !empty($this->input->post('sl_hdpe_per_three'))){
                                       ...
                                       $data['sl_hdpe_threee']=$this->article_model->select_one_active_record('article',$this->session->userdata['logged_in']['company_id'],'article.article_no',$this->input->post('sl_hdpe_three'));
                                       if($data['sl_hdpe_threee']==FALSE){
                                        $sl_hdpe_threee="";
                                       }else{
                                        foreach($data['sl_hdpe_threee'] as $sl_hdpe_row_threee){
                                          $sl_hdpe_threee=$sl_hdpe_row_threee->article_name;
                                        }
                                       }
                                        $sl_hdpe_per_threee=$this->input->post('sl_hdpe_per_three')."%";
                                        echo "<br/>+<br/><span class='ui teal label'>".$sl_hdpe_threee." ".$sl_hdpe_per_threee."</span>";
                                      }else{
                                        $sl_hdpe_threee='';
                                        $sl_hdpe_per_threee='';
                                      }
