						...
						<input type="hidden" name="spec_version_no" value="<?php echo $specification_row->spec_version_no;?>">
                           ...
                           <tr><td>&nbsp;</td><td>&nbsp;</td></tr>
									...
									<tr>
										...
										<td><input type="number" name="gauge" min="0" max="550" step="1" id="gauge" maxlength="3" size="3" value="<?php echo set_value('gauge_one',$this->common_model->select_number_from_string($gauge));?>" required></td>
									</tr>
                           ...
                           <tr><td>&nbsp;</td><td>&nbsp;</td></tr>
									...
									<tr>
										<td class="label">Gauge <span style="color:red;">*</span> :</td>
										<td><input type="number" name="gauge_two" id="gauge_two" min="0" max="550" step="1" maxlength="3" size="3" value="<?php echo set_value('gauge_two',$this->common_model->select_number_from_string($gauge_two));?>">MIC</td>
									</tr>
