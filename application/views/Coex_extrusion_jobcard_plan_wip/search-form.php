...
<form name="<?php echo $this->router->fetch_class();?>" action="<?php echo base_url('index.php/'.$this->router->fetch_class().'/search_result');?>" method="POST"  >
	<div class="form_design">
		...
		<legend><b>Jobcard Plan WIP Search</b></legend>
				...
				<td width="50%">
					<table class="form_table_inner">
						...
						<tr>
							...
							<td><input type="date" name="from_date" id="from_date" value="<?php echo set_value('from_date',$account_periods_master_row->fin_year_start);?>"/ style="width: 100%;"></td>
				...
				<td width="50%">
					<table>
						<tr>
							...
							<td><input type="text" name="order_no"  size="" Placeholder="Search Order No" id="order_no"value="<?php echo set_value('order_no');?>" ></td>
							<td class="label">Jobcard Issue :</td>
							<td>
								<select name="jobcard_issue" style="width:100%;">
									<option value=''>--Select Jobcard Issue--</option>
									<option value='1' <?php echo set_select('jobcard_issue',1); ?>>Done</option>
									<option value='0' <?php echo set_select('jobcard_issue',0); ?>>Pending</option>
								</select>
                            </td>							
						</tr>
						<tr>	
							<td class="label">Product No. :</td>
							<td><input type="text" name="article_no"  Placeholder="Search Product No" size="" id="article_no" value="<?php echo set_value('article_no');?>"></td>
							<td class="label">Next Process :</td>
							<td>
								<select name="next_process_print" style="width:100%;">
									<option value=''>--Select Next Process--</option>
									<option value='0' <?php echo set_select('next_process_print',0); ?>>Pending</option>
									<option value='5' <?php echo set_select('next_process_print',5); ?>>Heading</option>
									<option value='6' <?php echo set_select('next_process_print',6); ?>>Printing</option>
								</select>
                            </td>						
						</tr>						
						<tr>
							...
							<!-- <td class="label">Jobcard Prod. Close :</td>
							<td>
								<select name="jobcard_close" style="width:100%;">
									<option value=''>--Select Jobcard Close--</option>
									<option value='0' <?php echo set_select('open',0); ?>>Open</option>
									<option value='1' <?php echo set_select('close',1); ?>>Close</option>
								</select>
                            </td> -->		
						</tr>	
					</table>
