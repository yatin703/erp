        ...
        <table class="ui very basic collapsing celled table" style="font-size:9px;">
         ...
         <tbody>
               ...
               echo "<tr><td class='center aligned' colspan='13'>No Active Records Found</td></tr>";
                  ...
                  $total_box=$this->common_model->get_total_box('coex_extrusion_printing',$row->jobcard_no,$this->session->userdata['logged_in']['company_id']);               
               
                     $a=$row->printing_qty/$total_box;              
                     $b = (int)$a;
                     if($a>$b){
                        $box=$b+1;
                     }else{
