...
<script>
	$(document).ready(function(){
		...
		if(days>10 && $("#order_no").val()==""){
			if(confirm("You are running the report for "+days+" Days")==true){
				return true;
			}else{
				return false;	
			}
			...
			<tr>
				<td width="55%">
					<table class="form_table_inner">
									...
									<tr>
										<td class="label">Customer Product No.  :</td>
										<td colspan="3"><input type="text" name="cust_product_no" id="cust_product_no" size="65" value="<?php echo set_value('cust_product_no');?>"/></td>
									...
									<tr>
										<td class="label">Trans Closed From Date  :</td>
										<td><input type="date" name="cancelled_from_date" id="delivery_from_date" size="17" value="<?php echo set_value('cancelled_from_date');?>"/></td>
										<td class="label">To Date  :</td>
										<td><input type="date" name="cancelled_to_date" id="delivery_to_date" size="17" value="<?php echo set_value('cancelled_to_date');?>"/></td>
									</tr>

									<tr>
										<td class="label">OC From Date  :</td>
										<td><input type="date" name="oc_from_date" id="oc_from_date" size="17" value="<?php echo set_value('oc_from_date');?>"/></td>
										<td class="label">To Date  :</td>
										<td><input type="date" name="oc_to_date" id="oc_to_date" size="17" value="<?php echo set_value('oc_to_date');?>"/></td>
									</tr>
				...
				<td width="45%">
					<table class="form_table_inner">									
									...
									<tr>
										...
										<td colspan="3">
											<select name="order_flag" id="" >
												...
												<option value="4" <?php echo set_select('order_flag','4');?> >PBL</option>
									...
									<tr>
										<td class="label"> Cancel Order  :</td>
										<td>
											<select name="cancel_flag" id="cancel_flag" >
												<option value="" <?php echo set_select('cancel_flag','');?>>--Please Select--</option>									
												<option value="1" <?php echo set_select('cancel_flag','1');?> >Cancelled</option>
												<option value="0" <?php echo set_select('cancel_flag','0');?>>Not Cancelled</option>
											</select>
