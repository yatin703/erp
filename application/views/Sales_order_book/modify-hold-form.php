...
<form name="<?php echo $this->router->fetch_class();?>" action="<?php echo base_url('index.php/'.$this->router->fetch_class().'/update_hold');?>" method="POST" >
			...
			<td>
				<table>
					...
					<tr>
						...
						<td><select name="hold_flag" required>					
					...
					<tr>
						...
						<td><textarea name="hold_reason" value="<?php echo set_value('hold_reason',$order_row->hold_reason);?>"><?php echo set_value('hold_reason',$order_row->hold_reason);?></textarea></td>
					</tr>
				</table>
			</td>
		</tr>
