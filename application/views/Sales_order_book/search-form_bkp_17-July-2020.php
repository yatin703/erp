				...
				<td width="50%">
					<table class="form_table_inner">
									...
									<tr>
										...
										<td><input type="date" name="approval_date" id="approval_date" size="17" value="<?php echo set_value('approval_date');?>"/></td>
										<td class="label">Delivery Date  :</td>
										<td><input type="date" name="delivery_date" id="delivery_date" size="17" value="<?php echo set_value('delivery_date');?>"/></td>
									</tr>
