			...
			<tr>
				<td>
					<table class="form_table_inner">
									...
									<tr>
										<td class="label">Bill Address <span style="color:red;">*</span> :</td>
										<td><span id="bill_to_address" style="font-family: verdana;
    font-size: 70%;"></td>
									</tr>
            ...
            echo "<option value='".$ship_to_row->related_company_id."' ".set_select('consin_adr_company_id',''.$ship_to_row->related_company_id.'').">".$ship_to_row->relate."//".$ship_to_row->related_company_id."//".$ship_to_row->lang_property_name."</option>";
									...
									<tr>
										...
										<td><input type="text" name="po_no" value="<?php echo set_value('po_no');?>"/></td>
									</tr>
									...
									<tr>
										...
										<td><input type="checkbox" name="export"  value="1" <?php echo set_checkbox('export',1);?> /></td>
									</tr>
			...
			<td>
				<table>
					...
					<tr>
						<td class="label">For Spring tube  :</td>
						<td><input type="checkbox" name="order_flag"  value="1" <?php echo set_checkbox('order_flag',1);?> /></td>
					</tr>
					<tr>
