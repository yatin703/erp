		...
		<table class="form_table_design">
            ...
            echo "<option ".$selected." value='".$ship_to_row->related_company_id."' ".set_select('consin_adr_company_id',''.$ship_to_row->related_company_id.'').">".$ship_to_row->relate."//".$ship_to_row->related_company_id."//".$ship_to_row->lang_property_name."</option>";
									...
									<tr>
										...
										<td><input type="text" name="cust_product_no" size="30" value="<?php echo set_value('cust_product_no',$order_row->cust_product_no);?>"/></td>
									</tr>
			...
			<td>
				<table>
					...
					<tr>
						...
						<td><input type="checkbox" name="for_stock" <?php echo ($order_row->for_stock==1? 'value="1" checked' : 'value="0"');?>/></td>
					</tr>
					<tr>
						<td class="label">Referense SO. :</td>
						<td><input type="text" name="ref_order_no" id="ref_order_no" value="<?php echo set_value('ref_order_no',$order_row->ref_order_no);?>" maxlength="30"> </td>
					</tr>	
					<tr>
					...
					<tr>
						<?php if(!empty($order_row->po_file)){
							echo '<tr>
														<td>Previous File  <input type="hidden" name="po_file" value="'.$order_row->po_file.'" readonly> </td>
