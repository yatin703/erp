	...
	<div class="record_inner_design" style="overflow: scroll;">
			<table class="record_table_design_without_fixed">
				<tr>
					...
					<th>Process Name</th>
					<th>Tool ChangeOver <span style="color:red;">(min) </span></th>
					<th>Job ChangeOver <span style="color:red;">(min)</span></th>
					<th>Machine Capacity <span style="color:red;">per day </span> </th>
					<th>Machine Capacity W/O Changeover <span style="color:red;">per day </span> </th>
					<!-- <th>Machine Capacity <span style="color:red;">(min) </span> </th> -->
					<th>Machine Actual Speed</th>
					<th>Running Speed</th>
					<th>Running Time</th>
					...
					echo "<tr><td colspan='9'>No Active Records Found</td></tr>";
							...
							foreach($coex_machine_master as $row){
								echo "<tr>
									...
									<td> ".$row->machine_capacity_without_changeover."</td>
									

									<td> ".$row->actual_speed."</td>
									<td> ".$row->running_speed."</td>
									<td> ".$row->running_time."</td>
									<td> ".$row->minimum_contribution."</td>	
