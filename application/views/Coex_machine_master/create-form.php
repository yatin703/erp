				...
				<td>
					<table class="form_table_inner">				
									...
									<tr>
										...
										<td><input type="text" name="machine_capacity_without_changeover" id="machine_capacity_without_changeover" step="any" value="<?php echo set_value('machine_capacity_without_changeover');?>" ></td>
									</tr>

									<tr>
										<td class="label">Running Speed<span style="color:red;">* </span> :</td>
										<td><input type="text" name="running_speed" id="running_speed" step="any" value="<?php echo set_value('running_speed');?>" ></td>
									</tr>
