...
<form name="<?php echo $this->router->fetch_class();?>" action="<?php echo base_url('index.php/'.$this->router->fetch_class().'/save_two');?>" method="POST" >
				...
				<td>
					<table class="form_table_inner">
									...
									<tr>
										...
										<td><input type="text" name="sh_mb_supplier" class="supplier" value="<?php echo set_value('sh_mb_supplier');?>" placeholder="MB Supplier">
										<input type="text" name="sh_mb_per" maxlength="3" size="3" value="<?php echo set_value('sh_mb_per');?>" placeholder="%"></td>
									</tr>
									...
									<tr>
										...
										<td><input type="text" name="cap_mb_supplier" class="supplier" value="<?php echo set_value('cap_mb_supplier');?>" placeholder="MB Supplier">
										<input type="text" name="cap_mb_per" maxlength="3" size="3" value="<?php echo set_value('cap_mb_per');?>" placeholder="%"></td>
										</tr>
