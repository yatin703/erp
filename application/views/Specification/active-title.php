<article class="container_title">
  ...
  <?php foreach($formrights as $formrights_row):
    ...
    echo ($formrights_row->new==1 ? '<a href="'.base_url('index.php/'.$this->router->fetch_class().'/create_two_layer').'" class="ui blue tag label" ><i class="add circle icon"></i>2 Layer</a> : ' : '');

    echo ($formrights_row->new==1 ? '<a href="'.base_url('index.php/'.$this->router->fetch_class().'/create_three_layer').'" class="ui blue tag label" ><i class="add circle icon"></i>3 Layer</a> : ' : '');

    echo ($formrights_row->new==1 ? '<a href="'.base_url('index.php/'.$this->router->fetch_class().'/create_five_layer').'" class="ui blue tag label" ><i class="add circle icon"></i>5 Layer</a> : ' : '');

    echo ($formrights_row->new==1 ? '<a href="'.base_url('index.php/'.$this->router->fetch_class().'/create_cap').'" class="ui blue tag label" ><i class="add circle icon"></i>CAP</a> : ' : '');
    ...
    echo ($formrights_row->new==1 ? '<a href="'.base_url('index.php/'.$this->router->fetch_class().'/create_single_layer_with_cap').'" class="ui blue tag label" ><i class="add circle icon"></i>1 Layer</a> : ' : '');
  	?> 
  <?php endforeach;?>
  </h2>
