...
<form name="<?php echo $this->router->fetch_class();?>" action="<?php echo base_url('index.php/'.$this->router->fetch_class().'/save_setup_job_card');?>" method="POST" >
				...
				<table class="form_table_inner">
						<?php foreach($order_details as $order_details_row):?>
							...
							<tr>
										...
										<?php  echo ($order_details_row->ad_id!='' ? "<a href='".base_url()."/index.php/artwork_new/view/".$order_details_row->ad_id."/".$order_details_row->version_no."' target='_blank'>".$order_details_row->ad_id."_R".$order_details_row->version_no."</a>" : '');?></td>
							</tr>
	...
	<div class="form_design">
		<div class="ui buttons">
	  		...
	  		<div class="or"></div>
	  		<button class="ui positive button">Create Setup Job Card</button>
		</div>
	</div>
