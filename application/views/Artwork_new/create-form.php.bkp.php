				...
				<td>
					<table class="form_table_inner">
									...
									<tr id="hot_foil_1">
										...
										<td><input type="text" name="hot_foil_1" value="<?php echo set_value('hot_foil_1');?>"></td>
									</tr>
									...
									<tr id="lacquer_type_1">
										...
										<td><input type="text" name="lacquer_type_1" value="<?php echo set_value('lacquer_type_1');?>"></td>
									</tr>
									<?php } ?>
