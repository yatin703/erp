			...
			<tr>
				<td>
					<table class="form_table_inner" >
									...
									Length * : <input type="text" name="sleeve_length" size="10" value="<?php echo set_value('sleeve_length');?>" required></td>
									</tr>

									<tr>
										<td class="label">Sleeve Color * :</td>
										<td><input type="text" name="sleeve_color" value="<?php echo set_value('sleeve_color');?>" required></td>
									</tr>
									...
									<tr id="hot_foil_1">
										...
										</select><input type="number" name='hot_foil_1_per_tube' value='<?php echo set_value('hot_foil_1_per_tube');?>' placeholder="SQM/Tube" min="0" max="1" step="0.00001" ></td>
									</tr>
									...
									<tr id="hot_foil_2">
										...
										</select><input type="number" name='hot_foil_2_per_tube' value='<?php echo set_value('hot_foil_2_per_tube');?>' placeholder="SQM/Tube"  min="0" max="1" step="0.00001"></td>
									</tr>
									...
									<tr>
										...
										<td><input type="number" min="0" max="50" step="0.5" name="sealing_non_lacquering_area"  value="<?php echo set_value('sealing_non_lacquering_area');?>" required></td>
									</tr>
									...
									<tr id="lacquer_type_1">
										...
										}?></select><input type="number" name='lacquer_mixing_pc_1' size="3" value='<?php echo set_value('lacquer_mixing_pc_1');?>'  placeholder="%"  min="1" max="100" step="1" required></td>
									</tr>
									...
									<tr id="lacquer_type_2">
										...
										}?></select><input type="number" name='lacquer_mixing_pc_2' size="3" value='<?php echo set_value('lacquer_mixing_pc_2');?>'  placeholder="%" min="1" max="100" step="1" ></td>
									</tr>
