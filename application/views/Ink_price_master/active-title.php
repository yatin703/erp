<article class="container_title">
 ...
 <h2>
	<?php $table='ink_price_master';?>
		...
		<a href='<?php echo base_url('index.php/'.$this->router->fetch_class().'/archive_records');?>'>Archive (

		<?php  echo $this->common_model->archive_record_count_noncompany($table);?>) : </a>
