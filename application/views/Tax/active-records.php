					...
					echo "<tr><td colspan='12'>No Active Records Found</td></tr>";
							...
							foreach($tax_master as $row){
								echo "<tr>
									...
									<td><a href=".base_url('index.php/'.$this->router->fetch_class().'/modify/'.$row->tax_code.'').">Modify</a><a href=".base_url('index.php/'.$this->router->fetch_class().'/delete/'.$row->tax_code.'')."> | Delete</a>
