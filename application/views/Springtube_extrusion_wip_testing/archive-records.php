<div class="record_form_design">
	...
	<div class="record_inner_design" style="overflow: scroll;">
			<table class="record_table_design_without_fixed">
				...
				<?php if($springtube_extrusion_wip_master==FALSE){
							...
							echo"<tr>
									...
									<td>";
										...
										foreach ($formrights as $formrights_row) {
											...
											echo ($formrights_row->new==1 && $master_row->status==0 ? '<a href="'.base_url('index.php/'.$this->router->fetch_class().'/view/'.$master_row->wip_id.'').'" target="_blank" title="View"><i class="print icon"></i></a>' : '');
					...
					echo"<tr><td colspan='18' style='text-align:right;'><b>TOTAL</b></td><td>".$sum_total_ok_meters."</td><td>".$sum_total_ok_qty."</td><td></td><td></td><td>".$sum_total_release_meters."</td><td>".$sum_total_release_qty."</td><td></td><td></td><td></td></tr>";		
