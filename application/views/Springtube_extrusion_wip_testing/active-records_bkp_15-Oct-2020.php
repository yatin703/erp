	...
	<div class="record_inner_design" style="overflow: scroll; white-space: nowrap;">
			...
			<tbody>
				...
				if($springtube_extrusion_wip_master==FALSE){
						...
						foreach($springtube_extrusion_wip_master as $master_row){
							...
							// echo"<tr".(strpos($order_no,'SO')!=''?"style='backgroun-color:pink;'":'')." >
								echo"<tr class='tr_test'>		
									...
									<td class='positive' style='text-align:right;'><b>".money_format('%!.0n',round($master_row->total_ok_meters/$reel_length,2))."</b> <i>NOS</i></td>
									<!--<td>".$master_row->ok_qty."</td>
									-->
									<td ".($master_row->wip_cost_per_meter==0?"class='td_wip_cost'":"").">&#x20B9; ".$master_row->wip_cost_per_meter."</td>
									<td>";
									...
									<td class='positive' style='text-align:right;'><b>".($master_row->release_meters!=''? money_format('%!.0n',round($master_row->release_meters/$reel_length,2))."</b> <i>NOS</i>":"")."</td>
					...
					echo"<tr style='font-weight:bold;'><td colspan='13' style='text-align:right;'><b>TOTAL</b></td><td class='positive' style='text-align:right;'><b>".money_format('%!.0n',$sum_total_ok_meters)."</b> <i> MTRS</i></td><td class='positive' style='text-align:right;'><b>".$sum_reels."</b><i> NOS</i></td><td></td><td></td><td></td><td></td><td class='positive' style='text-align:right;'><b>".money_format('%!.0n',$sum_total_release_meters)."</b> <i>MTRS</i></td><td class='positive' style='text-align:right;'><b>".$sum_reels_release."</b> <i> NOS</i></td> <td></td><td></td></tr>";	
