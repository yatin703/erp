...
span.ui.blue.left.ribbon.label.left{
 ...
 .txt_ctr{
    ...
    <div class="doc-no" style="text-align: right;">
    ...
    <table class="form_table_inner" width="100%" cellpadding="5" cellspacing="0" style="border:1px solid #D9d9d9;">    <tr class="">
		...
		<tr>
			...
			<td width="35%" class="align-lft bbt" colspan="2"><?php echo $this->common_model->get_article_name($certificate_of_analysis['product_name'],$this->session->userdata['logged_in']['company_id']);?></td> 
	...
	<table class="form_table_inner" width="100%" cellpadding="5" cellspacing="0" style="border:1px solid #D9d9d9;">	   <tr>
	    ...
	    ?> 
              ...
              echo ($result[0]->LDPE_PC != null ? $result[0]->LDPE_PC : '-')."% LDPE"." "."+"; echo ($result[0]->LLDPE_PC != null ? $result[0]->LLDPE_PC : '-')."% LLDPE";
	            ...
	            echo ($result[0]->LLDPE_PC != null ? $result[0]->LLDPE_PC : '-')."% LLDPE"." "."+"; echo ($result[0]->HDPE_PC != null ? $result[0]->HDPE_PC : '-')."% HDPE";
					...
					?>
					<?php if($i==3){
						$parameter_data=array('ADMER','LDPE','LLDPE');	
						  if($parameter_data!=''){
	              $result=$this->certificate_of_analysis_model->get_layer_details($bom_no,$version_no,$i,$parameter_data);
	            }else{
	            	echo '-';
	            ...
	            if (!empty($result[0]->ADMER_PC)) { 
							  ...
							  echo ($result[0]->LDPE_PC != null ? $result[0]->LDPE_PC : '-')."% LDPE";
							} else {
								echo '-';
							}
						}
      ...
      <?php } ?>
						...
						<tr>
							...
							<td class="label align-ctr bbt" rowspan="3"><b>Master Batch %</b></td>
						</tr>
						...
						<tr>
							...
							<td class="label align-ctr bbt"><?php echo $certificate_of_analysis['sleeve_outer_per'] != null ? $certificate_of_analysis['sleeve_outer_per'] : '-' ?>% / <?php echo $certificate_of_analysis['sleeve_outer_layer_color'] != null ? $certificate_of_analysis['sleeve_outer_layer_color'] : '-' ?></td>
						</tr>
						...
						<tr>
							...
							<td class="label align-ctr bbt" rowspan="8"><?php echo $certificate_of_analysis['inner_tolerance'];?></td>
	    ...
	    ?> 
          ...
          <?php } ?>
						...
						<tr>
							...
							<td class="label align-ctr bbt"  rowspan=""><?php echo $certificate_of_analysis['outer_tolerance']; ?></td>
