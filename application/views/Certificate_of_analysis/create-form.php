...
<script>
	$(document).ready(function(){
        ...
        $("#certificate_no").live('keyup',function(){
		$("#loading").show(); $("#cover").show();
		$('#loading').html('<img src="<?php echo base_url('assets/img/loading.gif');?>"> Loading...');
			$.ajax({type: "POST",url: "<?php echo base_url('index.php/ajax/get_so_no');?>",data: {certificate_no : $("#certificate_no").val()},cache: false,success: function(html){
		...
		$("#order_no").live('change',function(){
		$("#loading").show(); $("#cover").show();
		$('#loading').html('<img src="<?php echo base_url('assets/img/loading.gif');?>"> Loading...');
			$.ajax({type: "POST",url: "<?php echo base_url('index.php/ajax/get_product_no');?>",data: {certificate_no : $("#certificate_no").val(),order_no : $("#order_no").val()},cache: false,success: function(html){
				setTimeout(function () {$("#loading").hide();$("#cover").hide();},200);
				...
				<td>
					<table class="form_table_inner" width="100%">
						<tr>
							...
							<td colspan="3"><input type="text" name="certificate_no"  Placeholder="Search Invoice No." id="certificate_no" size="" value="<?php echo set_value('certificate_no');?>" size="16" maxlength="16" required/></td> 
						...
						<tr>
						    ...
						    <td colspan="3">
						    	<select name="so_no" id="order_no" required/>
								    <?php	
								    		if($so_no==TRUE){	
								    		foreach($so_no as $so_no_row){
													echo "<option value='".$so_no_row->ref_ord_no."'  ".set_select('so_no',''.$so_no_row->ref_ord_no.'').">".$so_no_row->ref_ord_no."</option>";
												}
											}else{
												echo '
							...
							<td colspan="3">
                                <select name="product_name" id="article_no"  onchange="check_invoice_no(this.value);" required/>
								    <?php	
								    		if($product_name==TRUE){	
								    		foreach($product_name as $product_name_row){
													echo "<option value='".$product_name_row->article_no."'  ".set_select('product_name',''.$product_name_row->article_no.'').">".$product_name_row->article_no."</option>";
												}
											}else{
												echo '
								    <option value=""> Select Order No.</option>';
						...
						<tr>
							...
							<td class="label align-ctr" rowspan="6"><input type="text" name="inner_tolerance"  Placeholder="Enter inner tolerance" id="inner_tolerance" value="<?php echo set_value('inner_tolerance');?>" readonly required/></td>
						...
						<tr>
							...
							<td class="label align-ctr"  rowspan="3"><input type="text" name="outer_tolerance"   Placeholder="Enter outer tolerance" id="outer_tolerance" value="<?php echo set_value('outer_tolerance');?>" readonly required/></td>
						...
						<tr>
							...
							<td class="label align-ctr"><input type="text" name="specification_height"  Placeholder="Enter Specification Height" id="cap_height" value="<?php echo set_value('specification_height');?>" required/></td>
							<td class="label align-ctr">+/-0.2</td>
						...
						<tr>
							...
							<td class="label align-ctr"><input type="text" name="specification_print"  Placeholder="Enter Specification Print"  id="artwork_name" value="<?php echo set_value('specification_print');?>" readonly ></td>
							...
							<td class="label align-ctr" colspan="2"><input type="text" name="lacquer_type"  Placeholder="Enter Lacquer Type "  id="artwork_type" value="<?php echo set_value('lacquer_type');?>" readonly ></td>
						</tr>

						<tr>
							<td class="label align-ctr"><b>LABEL</b></td>
							<td class="label align-ctr"><b>Non. Lacq. Height<span class="span-required">*</span></b></td>
							<td class="label align-ctr"><input type="text" name="lbl_specification"  Placeholder="Enter Specification Height"  id="label_height" value="<?php echo set_value('lbl_specification');?>" readonly ></td>
							<td class="label align-ctr">+/-1</td>
							<td class="label align-ctr"><input type="text" name="lbl_actual_print"  Placeholder="Enter Actual Print"  value="<?php echo set_value('lbl_actual_print');?>" required/></td>
							<td class="label align-ctr"><b>Lacquer Type<span class="span-required">*</span></b></td>
							<td class="label align-ctr" colspan="2"><input type="text" name="lbl_lacquer_type"  Placeholder="Enter Lacquer Type "  id="label_type" value="<?php echo set_value('lbl_lacquer_type');?>" readonly ></td>
						</tr>
						...
						<tr>
							...
							<td class="label align-ctr"><select name="air_leakage_status" required="required">				
								...
								<option value="2" <?php echo set_select('air_leakage_status','2');?>>FAIL</option>
								<option value="0" <?php echo set_select('air_leakage_status','0');?>>N/A</option>
							</select></td>
							...
							<td class="label align-ctr"><select name="sleeve_colour_opacity_status" required="required">				
								...
								<option value="2" <?php echo set_select('sleeve_colour_opacity_status','2');?>>FAIL</option>
								<option value="0" <?php echo set_select('sleeve_colour_opacity_status','0');?>>N/A</option>
							</select></td>
						...
						<tr>
							...
							<td class="label align-ctr"><select name="water_package_status" required="required">				
								...
								<option value="2" <?php echo set_select('water_package_status','2');?>>FAIL</option>
								<option value="0" <?php echo set_select('water_package_status','0');?>>N/A</option>
							</select>
							...
							<td class="label align-ctr"><select name="gliding_test_status" required="required">				
								...
								<option value="2" <?php echo set_select('gliding_test_status','2');?>>FAIL</option>
								<option value="0" <?php echo set_select('gliding_test_status','0');?>>N/A</option>
							</select></td>
							</td>
						...
						<tr>
							...
							<td class="label align-ctr"><select name="cap_fitment_status" required="required">				
								...
								<option value="2" <?php echo set_select('cap_fitment_status','2');?>>FAIL</option>
								<option value="0" <?php echo set_select('cap_fitment_status','0');?>>N/A</option>
							</select></td>
							...
							<td class="label align-ctr"><select name="uv_test_status" required="required">				
								...
								<option value="2" <?php echo set_select('uv_test_status','2');?>>FAIL</option>
								<option value="0" <?php echo set_select('uv_test_status','0');?>>N/A</option>
							</select></td>
						</tr>
						<tr>
							...
							<td class="label align-ctr"><select name="shoulder_welding_test_status" required="required">				
								...
								<option value="2" <?php echo set_select('shoulder_welding_test_status','2');?>>FAIL</option>
								<option value="0" <?php echo set_select('shoulder_welding_test_status','0');?>>N/A</option>
							</select></td>
							...
							<td class="label align-ctr"><select name="drop_test_status" required="required">				
								...
								<option value="2" <?php echo set_select('drop_test_status','2');?>>FAIL</option>
								<option value="0" <?php echo set_select('drop_test_status','0');?>>N/A</option>
							</select></td>
						</tr>
						<tr>
							...
							<td class="label align-ctr"><select name="escr_test_status" required="required">				
								...
								<option value="2" <?php echo set_select('escr_test_status','2');?>>FAIL</option>
								<option value="0" <?php echo set_select('escr_test_status','0');?>>N/A</option>
							</select></td>
						...
						<tr>
							...
							<td class="label align-ctr"><select name="odour_test_status" required="required">				
								...
								<option value="2" <?php echo set_select('odour_test_status','2');?>>FAIL</option>
								<option value="0" <?php echo set_select('odour_test_status','0');?>>N/A</option>
							</select></td>
						...
						<tr>
							...
							<td class="label align-ctr"><select name="vertically_test_status" required="required">				
								...
								<option value="2" <?php echo set_select('vertically_test_status','2');?>>FAIL</option>
								<option value="0" <?php echo set_select('vertically_test_status','0');?>>N/A</option>
							</select></td>
							...
							<td class="label align-ctr"><select name="sealing_test_status" required="required">				
								...
								<option value="2" <?php echo set_select('sealing_test_status','2');?>>FAIL</option>
								<option value="0" <?php echo set_select('sealing_test_status','0');?>>N/A</option>
							</select></td>
						</tr>
						<tr>
							...
							<td class="label align-ctr"><select name="sleeve_colour_difference_status" required="required">				
								...
								<option value="2" <?php echo set_select('sleeve_colour_difference_status','2');?>>FAIL</option>
								<option value="0" <?php echo set_select('sleeve_colour_difference_status','0');?>>N/A</option>
							</select></td>
							...
							<td class="label align-ctr"><select name="bar_code_test_status" required>				
								...
								<option value="2" <?php echo set_select('bar_code_test_status','2');?>>FAIL</option>
								<option value="0" <?php echo set_select('bar_code_test_status','0');?>>N/A</option>
							</select></td>
						</tr>
						...
						<tr>
							...
							<td class="label align-ctr"><select name="welding_test_side_seam_status" required="required">				<option value="1" <?php echo set_select('welding_test_side_seam_status','1');?>>PASS</option>
								<option value="2" <?php echo set_select('welding_test_side_seam_status','2');?>>FAIL</option>
								<option value="0" <?php echo set_select('welding_test_side_seam_status','0');?>>N/A</option>
							</select></td>
						...
						<tr>
							...
							<td class="label align-ctr">
								<select name="coa_result_status" required>				
									...
									<option value="0" <?php echo set_select('coa_result_status','0');?>>FAIL</option>
								</select>
						    </td>
...
<script>
	function check_invoice_no(certificate_no,so_no,product_name) {
        $.ajax({
            type: 'POST',
            url: "<?php echo base_url();?>index.php/certificate_of_analysis/get_ajax_ar_invoice_no_id",
            async: false,
            dataType: 'json',
            data: {certificate_no:$("#certificate_no").val(),so_no:$("#order_no").val(),product_name:$("#article_no").val()},
           
            success: function(res) {
                if (res.status == "200") {	
				   $('#invoice_date').val(res.data['invoice_date']); 
				   //$('#article_no').val(res.data['aid_article_no']); 
				   ...
				   $('#inner_tolerance').val(res.data['inner_tolerance']);
				   $('#outer_tolerance').val(res.data['outer_tolerance']);
				   $('#cap_diameter').val(res.data['cap_diameter']);
				   $('#label_type').val(res.data['label_type']);
                   $('#label_height').val(res.data['label_height']);
                } else {
					$('#invoice_date').val('');                    
					//$('#article_no').val('');                    
					$('#customer_no').val('');  
