				...
				<td>
					<table class="form_table_inner">
						...
						<tr>
							...
							<td><input type="text" name="icon" maxlength="256" size="50" value="<?php echo set_value('icon'); ?>" /></td>
						</tr>
						...
						<tr>
							...
							<td><textarea name="toc" cols="150" rows="30"><?php echo set_value('toc'); ?></textarea></td>
						</tr>
