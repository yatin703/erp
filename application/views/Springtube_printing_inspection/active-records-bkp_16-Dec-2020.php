			...
			<table class="ui very basic collapsing celled table"  style="font-size:10px;">
				...
				if($springtube_printing_inspection_master==FALSE){
					echo "<tr><td colspan='30'>No Active Records Found</td></tr>";
					    	...
					    	if($rowspan>0){					    		
								...
								echo"<tr>
									...
									foreach ($result as $details_row){
										...
										<td class='negative right aligned'><b>".number_format(($jobcard_qty-$details_row->inspected_output_qty),0,'.',',')."</b> <i>NOS</i></td>
						...
						echo"<tr style='color:blue;'><td colspan='10' style='text-align:right;'><b>TOTAL</b></td>
