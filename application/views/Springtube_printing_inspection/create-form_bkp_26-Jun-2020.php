		...
		<div class="middle_form_inner_design">
				...
				if(!empty($this->input->post('sr_no'))){
					...
					for($i=1;$i<=count($this->input->post('sr_no[]'));$i++){?>
						...
						<tr id="tr_<?php echo $i;?>">
							...
							<td>
								<input type="number" name="printing_input_qty_<?php echo $i;?>"  id="printing_input_qty_<?php echo $i;?>" class="quantity" value="<?php echo set_value('printing_input_qty_'.$i.'');?>" min="1" max="80000" step="1" size="40" required maxlength="10"/>
							</td>
							<!-- <td>
								<input type="number" name="inspected_output_meters_<?php echo $i;?>" id="inspected_output_meters_<?php echo $i;?>" class="quantity" value="<?php echo set_value('inspected_output_meters_'.$i.'');?>" min="1" max="80000" step="1" size="40" maxlength="10" required/>
							</td> -->
							<td>
			...
			?>
					...
					<tr id="tr_1">
						...
						<td>
							<input type="number" name="printing_input_qty_1"  id="printing_input_qty_1" class="quantity" value="<?php echo set_value('printing_input_qty_1');?>" maxlength="10" min="1" max="80000" step="1" size="30" required/>
						</td>
						<!-- <td>
							<input type="number" name="inspected_output_meters_1"  id="inspected_output_meters_1" class="quantity" value="<?php echo set_value('inspected_output_meters_1');?>" maxlength="10" size="30" min="1" max="80000" step="1" required />
						</td> -->
						<td>
							<input type="number" name="inspected_output_qty_1"  id="inspected_output_qty_1" class="quantity" value="<?php echo set_value('total_wate_qtyinspected_output_qty_1');?>" size="30" maxlength="10" min="1" max="80000" step="1" required />
						</td>						
						<td>
