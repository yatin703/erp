		...
		<div class="middle_form_inner_design">
				...
				if(!empty($this->input->post('sr_no'))){
					...
					for($i=1;$i<=count($this->input->post('sr_no[]'));$i++){?>
						...
						<tr id="tr_<?php echo $i;?>">
							...
							<td>
								<input type="number" name="inspection_input_qty_<?php echo $i;?>"  id="inspection_input_qty_<?php echo $i;?>" class="quantity" value="<?php echo set_value('inspection_input_qty_'.$i.'');?>" min="1" max="80000" step="1" size="20" maxlength="10" />
							</td>							
							<td>
			...
			?>
					...
					<tr id="tr_<?php echo $detail_row->job_pos_no;?>">
						...
						<td>
							<input type="number" name="inspection_input_qty_<?php echo $detail_row->job_pos_no;?>"  id="inspection_input_qty_<?php echo $detail_row->job_pos_no;?>" class="quantity" value="<?php echo set_value('inspection_input_qty_<?php echo $detail_row->job_pos_no;?>',$detail_row->inspection_input_qty);?>" min="1" max="80000" step="1" size="30"  required maxlength="10" />
						</td>						
						<td>
						...
						<td>
							<input type="number" name="side_trim_waste_<?php echo $detail_row->job_pos_no;?>"  id="side_trim_waste_<?php echo $detail_row->job_pos_no;?>" class="quantity" value="<?php echo set_value('side_trim_waste_<?php echo $detail_row->job_pos_no;?>'.'',$detail_row->side_trim_waste);?>" min="0" max="2000" maxlength="10" step="1" size="40" required/>
						</td>
						<td>
