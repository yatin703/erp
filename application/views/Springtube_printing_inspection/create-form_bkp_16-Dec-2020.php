				...
				<td>
					<table class="form_table_inner">									
						<tr>
							...
							<td><input type="date" name="production_date"   value="<?php echo set_value('production_date');?>" required/></td>
		...
		<div class="middle_form_inner_design">
				...
				if(!empty($this->input->post('sr_no'))){
					...
					for($i=1;$i<=count($this->input->post('sr_no[]'));$i++){?>
						...
						<tr id="tr_<?php echo $i;?>">
							...
							<td>
								<input type="number" name="inspection_input_qty_<?php echo $i;?>"  id="inspection_input_qty_<?php echo $i;?>" class="quantity" value="<?php echo set_value('inspection_input_qty_'.$i.'');?>" min="1" max="10000000" step="1" size="40" required maxlength="10"/>
							</td>							 
							<td>
								<input type="number" name="inspected_output_qty_<?php echo $i;?>"  id="inspected_output_qty_<?php echo $i;?>" class="quantity" value="<?php echo set_value('inspected_output_qty_'.$i.'');?>" min="1" max="10000000" maxlength="10" step="1" size="40" required/>
							</td>
							<td>
			...
			?>
					...
					<tr id="tr_1">
						...
						<td>
							<input type="number" name="inspection_input_qty_1"  id="inspection_input_qty_1" class="quantity" value="<?php echo set_value('inspection_input_qty_1');?>" maxlength="10" min="1" max="10000000" step="1" size="30" required/>
						</td>						 
						<td>
							<input type="number" name="inspected_output_qty_1"  id="inspected_output_qty_1" class="quantity" value="<?php echo set_value('inspected_output_qty_1');?>" size="30" maxlength="10" min="1" max="10000000" step="1" required />
						</td>
						<td>
							<input type="number" name="side_trim_waste_1"  id="side_trim_waste_1" class="quantity" value="<?php echo set_value('side_trim_waste_1');?>" size="30" maxlength="10" min="0" max="50000" step="1" required />
						</td>						
						<td>
