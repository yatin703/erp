					...
					echo "<tr><td colspan='22'>No Active Records Found</td></tr>";
						...
						foreach($springtube_extrusion_control_plan_qc as $master_row){
							...
							echo"<tr>
									...
									<td>".($master_row->new_job==1?"YES":"NO")."</td>
									<td>".($master_row->shift_change==1?"YES":"NO")."</td>
									...
									foreach ($formrights as $formrights_row){
										...
										echo ($formrights_row->new==1 ? '<a href="'.base_url('index.php/'.$this->router->fetch_class().'/create_parameters/'.$master_row->cp_id.'').'" target="_blank" title="Add Parameter"><i class="edit icon"></i></a>' : '');
										...
										if($control_plan_qc_film_thickness_result==FALSE){
											...
											echo ($formrights_row->new==1 ? '<a href="'.base_url('index.php/'.$this->router->fetch_class().'/create_roll_thickness/'.$master_row->cp_id.'').'" target="_blank" title="Add Roll Thickness"><i class="edit icon"></i></a>' : '');
										}else{
