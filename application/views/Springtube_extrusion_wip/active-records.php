...
<div class="record_form_design">
	...
	<div class="record_inner_design" style="overflow: scroll; white-space: nowrap;">
			<table class="ui green sortable selectable celled table"  style="font-size:9px;" id="tbl_data" >
				...
				<tr>					
					...
					<th>Jobcard No.</th>					
					<th style="text-align: center;">WIP (Mtrs)</th>
						...
						foreach($springtube_extrusion_wip_master as $master_row){
							...
							// echo"<tr".(strpos($order_no,'SO')!=''?"style='backgroun-color:pink;'":'')." >
								echo"<tr class='tr_test'>		
									...
									<td class='positive' style='text-align:right;'><b>".money_format('%!.0n',$master_row->total_ok_meters)."</b> </td>
