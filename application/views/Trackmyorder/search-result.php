	...
	<div class="record_inner_design" style="overflow: scroll; white-space: nowrap;">
			<table class="ui green sortable celled table"  style="font-size:9px;">
				<tr>
					<thead>
						...
						<th style="text-align:center" colspan="9">Bodymaking</th>
						<th style="text-align:center" colspan="10">SQC</th>
			...
			<tbody>
				<?php 
					...
					$sum_total_inspection_input=0;
					$sum_total_inspection_qty=0;
					$sum_total_inspection_pending_qty=0;
					$sum_total_inspection_scrap_qty=0;
					$sum_total_printing_wip=0;
					// $sum_release_qty=0;
					$sum_total_bodymaking_jobcard_qty=0;
					$sum_total_bodymaking_ok_qty=0;
					$sum_total_bodymaking_qc_pending=0;
					$sum_total_bodymaking_qc_hold_qty=0;
					$sum_total_bodymaking_scrap=0;							
					$sum_total_bodymaking_wip=0;
					
					$sum_total_aql_input=0;
					$sum_total_aql_output=0;
					$sum_total_aql_rejection=0;
					$sum_total_aql_printing_rejection=0;
					$sum_total_aql_bodymaking_rejection=0;
					$sum_total_aql_counter_sample_qty=0;
					...
					echo "<tr><td colspan='14'>No Active Records Found</td></tr>";
						...
						foreach($springtube_printing_production_master as $master_row){
					       ...
					       // Printing Section-----------
							...
							$sum_total_inspection_input+=$total_inspection_input;					
							...
							echo"<tr>
									...
									<td>".$sleeve_length."</td>
									<td class='warning right aligned'><b>".number_format($order_qty,0,'.',',')."</b></td>
									...
									<!--printing-->
									<td class='positive right aligned'><b>".number_format($total_jobcard_qty,0,'.',',')."</b> </td>
									<td class='positive right aligned'><b>".number_format($total_printing_qty,0,'.',',')."</b> </td>
									<td class='negative right aligned'><b>".number_format($total_scrap_qty,0,'.',',')."</b> </td>
									...
									<!--Inspection-->									
									<td class='positive right aligned'><b>".($total_inspection_input>0 ? number_format($total_inspection_input,0,'.',',')."</b> ":"")."</td>
									<td class='positive right aligned'><b>".($total_inspection_qty>0?number_format($total_inspection_qty,0,'.',',')."</b> ":"")."</td>
									<td class='positive right aligned'><b>".($total_inspection_pending>0?number_format($total_inspection_pending,0,'.',',')."</b> ":"")."</td>
									<td class='negative right aligned'><b>".($total_inspection_scrap_qty>0?number_format($total_inspection_scrap_qty,0,'.',',')."</b> ":($total_inspection_input>0?"0 ":""))."</td>

									<td class='positive right aligned'><b>".($total_printing_wip>0?number_format($total_printing_wip,0,'.',',')."</b> ":($total_inspection_input>0?"0 ":""))."</td>
									<td></td>
									...
									<!--Bodymaking -->
									<td class='positive right aligned'><b>".($total_bodymaking_jobcard_qty!=''?number_format($total_bodymaking_jobcard_qty,0,'.',',')."</b> ":"")."</td>
									<td class='positive right aligned'><b>".($total_bodymaking_ok_qty!=''?number_format($total_bodymaking_ok_qty,0,'.',',')."</b> ":"")."</td>
									<td class='negative right aligned'><b>".($total_bodymaking_qc_pending!=''?number_format($total_bodymaking_qc_pending,0,'.',',')."</b> ":"")."</td>
									<td class='negative right aligned'><b>".($total_bodymaking_qchold_qty!=''?number_format($total_bodymaking_qchold_qty,0,'.',',')."</b> ":"")."</td>
									<td class='negative right aligned'><b>".($total_bodymaking_scrap!=''?number_format($total_bodymaking_scrap,0,'.',',')."</b> ":"")."</td>
									<td class='positive right aligned'><b>".($total_bodymaking_wip>0?number_format($total_bodymaking_wip,0,'.',',')."</b> ":($total_bodymaking_ok_qty>0?"0 ":""))."</td>
									<td></td>
									<td>".($bodymaking_done=='1' ?"<i style='color:#06c806;' class='check circle icon'></i>":"<i style='color: #f10606;' class='times circle icon'></i>")."</td>
									<td>".($bodymaking_done=='1' && $total_bodymaking_scrap>=0 && $total_bodymaking_jobcard_qty>0 ?round(($total_bodymaking_scrap/$total_bodymaking_jobcard_qty)*100)." %":"")."</td>							

									<!-- Spring AQL--->
									<td class='positive right aligned'><b>".($total_aql_input!=''?number_format($total_aql_input,0,'.',',')."</b> ":"")."</td>
									<td class='positive right aligned'><b>".($total_aql_output!=''?number_format($total_aql_output,0,'.',',')."</b> ":"")."</td>
									<td class='negative right aligned'><b>".($total_aql_rejection!=''?number_format($total_aql_rejection,0,'.',',')."</b> ":"")."</td>
									<td class='negative right aligned'><b>".($total_aql_printing_rejection!=''?number_format($total_aql_printing_rejection,0,'.',',')."</b> ":"")."</td>
									<td class='negative right aligned'><b>".($total_aql_bodymaking_rejection!=''?number_format($total_aql_bodymaking_rejection,0,'.',',')."</b> ":"")."</td>
									<td class='negative right aligned'><b>".($total_aql_counter_sample_qty!=''?number_format($total_aql_counter_sample_qty,0,'.',',')."</b> ":"")."</td>
									...
									<td class='positive right aligned'><b>".($total_rfd_qty!=''?number_format($total_rfd_qty,0,'.',',')."</b> ":"")."</td>
									<td class='positive right aligned'><b>".($supply_qty!=''?number_format($supply_qty,0,'.',',')."</b> ":"")."</td>
									...
									$sum_total_inspection_pending_qty+=$total_inspection_pending;
									$sum_total_inspection_scrap_qty+=$total_inspection_scrap_qty;
									...
									$sum_total_bodymaking_qc_pending+=$total_bodymaking_qc_pending;
									$sum_total_bodymaking_qc_hold_qty+=$total_bodymaking_qchold_qty;
									$sum_total_bodymaking_scrap+=$total_bodymaking_scrap;	
									...
									$sum_total_aql_printing_rejection+=$total_aql_printing_rejection;
									$sum_total_aql_bodymaking_rejection+=$total_aql_bodymaking_rejection;

									$sum_total_aql_counter_sample_qty+=$total_aql_counter_sample_qty;

									
									$sum_total_rfd_qty+=$total_rfd_qty;
									$sum_total_dispatch_qty+=$supply_qty;

						}//master Foreach

				echo"<tr><td colspan='8' style='text-align:right;'><b>TOTAL</b></td>
					<td class='positive right aligned' title='Order Qty'><b>".number_format($sum_order_qty,0,'.',',')."</b> <i>NOS</i></td>
					<td title='Jobcard %'></td>
					<td class='positive right aligned' title='Jobcard Qty'><b>".number_format($sum_total_jobcard_qty,0,'.',',')."</b> <i>NOS</i></td>
					<td class='positive right aligned' title='Printing Production'><b>".number_format($sum_total_printing_qty,0,'.',',')."</b> <i>NOS</i></td>
					<td class='positive right aligned' title='Printing Scrap'><b>".number_format($sum_total_scrap_qty,0,'.',',')."</b> <i>NOS</i></td>
					<td title='Printing Status'></td>
					<td title='Printing R%'> </td>
					<td class='positive right aligned' title='Inspection Input'><b>".number_format($sum_total_inspection_input,0,'.',',')."</b> <i>NOS</i></td>
					<td class='positive right aligned' title='Inspection Done'><b>".number_format($sum_total_inspection_qty,0,'.',',')."</b> <i>NOS</i></td>
					<td class='positive right aligned' title='Inspection Pending'><b>".number_format($sum_total_inspection_pending_qty,0,'.',',')."</b> <i>NOS</i></td>
					<td class='positive right aligned' title='Inspection Scrap'><b>".number_format($sum_total_inspection_scrap_qty,0,'.',',')."</b> <i>NOS</i></td>

					<td class='positive right aligned' title='Inspection WIP'><b>".number_format($sum_total_printing_wip,0,'.',',')."</b> <i>NOS</i></td>
					<td title='Inspection WIP Scrap'></td>
					<td title='Inspection Status'></td>
					<td title='Inspection R%'></td>
					<td class='positive right aligned' title='Bodymaking Jobcard Qty'><b>".number_format($sum_total_bodymaking_jobcard_qty,0,'.',',')."</b> <i>NOS</i></td>
					<td class='positive right aligned' title='Bodymaking Ok Qty'><b>".number_format($sum_total_bodymaking_ok_qty,0,'.',',')."</b> <i>NOS</i></td>
					<td title='Bodymaking QC Pending'><b>".number_format($sum_total_bodymaking_qc_pending,0,'.',',')."</b> <i>NOS</i></td>
					<td title='Bodymaking QC Hold'><b>".number_format($sum_total_bodymaking_qc_hold_qty,0,'.',',')."</b> <i>NOS</i></td>
					<td title='Bodymaking Scrap'><b>".number_format($sum_total_bodymaking_scrap,0,'.',',')."</b> <i>NOS</i></td>					
					<td class='positive right aligned' title='Bodymaking WIP'><b>".number_format($sum_total_bodymaking_wip,0,'.',',')."</b> <i>NOS</i></td>
					<td title='Bodymaking WIP Scrap'></td>
					<td title='Bodymaking Status'></td>
					<td title='Bodymaking R%'></td>
					
					<td class='positive right aligned' title='SQC Input'><b>".number_format($sum_total_aql_input,0,'.',',')."</b> <i>NOS</i></td>
					<td class='positive right aligned' title='SQC Output'><b>".number_format($sum_total_aql_output,0,'.',',')."</b> <i>NOS</i></td>
					<td class='positive right aligned' title='Total SQC Rejection'><b>".number_format($sum_total_aql_rejection,0,'.',',')."</b> <i>NOS</i></td>
					<td class='positive right aligned' title='Total SQC Printing Rejection'><b>".number_format($sum_total_aql_printing_rejection,0,'.',',')."</b> <i>NOS</i></td>
					
					<td class='positive right aligned' title='Total SQC Bodymaking Rejection'><b>".number_format($sum_total_aql_bodymaking_rejection,0,'.',',')."</b> <i>NOS</i></td>
					<td class='positive right aligned' title='Total SQC Counter Sample'><b>".number_format($sum_total_aql_counter_sample_qty,0,'.',',')."</b> <i>NOS</i></td>
					<td title='SQC Status'></td>
					<td title='SQC R%'></td>
					<td title='SQC Printing	R%'></td>
					<td title='SQC Bodymaking R%'></td>
					
					<td class='positive right aligned' title='RFD'><b>".number_format($sum_total_rfd_qty,0,'.',',')."</b> <i>NOS</i></td>
					<td class='positive right aligned' title='Dispatch QTY'><b>".number_format($sum_total_dispatch_qty,0,'.',',')."</b> <i>NOS</i></td>
					<td title='Final R%'></td>
