...
<form name="<?php echo $this->router->fetch_class();?>" action="<?php echo base_url('index.php/'.$this->router->fetch_class().'/return_scrap_wip');?>" method="POST"  >
   ...
   <div class="form_design">
      ...
      <?php foreach($coex_extrusion_wip_scrap as $row):?>

      
      
      <fieldset style="border: 1px solid #8cacbb;">
      <legend><b>Return Scrap Quantity Check </b></legend>
      <table class="form_table_design">
         <tr>
               ...
               <table class="form_table_inner">
                 ...
                 <input type="hidden" name="wip_id" value="<?php echo set_value('wip_id',$row->wip_id);?>">
                  ...
                  <tr>
                     ...
                     <td><input type="date" name="release_date"  id="release_date" size="10" value="<?php echo set_value('release_date',date('Y-m-d'));?>" readonly required style="width:168px;"></td>
               ...
               <td class="label" >Shift :</td>
                  ...
                  <tr>
                     ...
                     <th colspan="2" style="background: #dee7ec;text-align: left;">Inspector Name<span style="color:red;">*</span></th>
                           ...
                           <input type="hidden" name="ok_qty" id="ok_qty"   size="20" value="<?php echo set_value('ok_by_qc',$row->scrap_qty);?>" >
                  <tr>

                     <td><input type="number" name="ok_by_qc" id="wip_qty" class="wip_qty"  size="20" min="0" value="<?php echo set_value('ok_by_qc',$row->scrap_qty);?>" readonly/ style="font-weight: 600;"></td>
            ...
            <tr>
                     <td colspan="4">
                          <textarea id="remark" name="remark" rows="3" cols="93"></textarea>
                     </td>
                  </tr>                
               </table>                               
            </td>                               
