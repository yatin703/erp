		...
		<div class="middle_form_inner_design">
			...
			<?php foreach ($springtube_extrusion_production_details as $detail_row):?>
					...
					<tr id="tr_<?php echo $detail_row->job_pos_no;?>">
						...
						<td>
							<input type="number" name="total_meters_produced_<?php echo $detail_row->job_pos_no;?>"  id="total_meters_produced_<?php echo $detail_row->job_pos_no;?>" class="quantity" value="<?php echo set_value('total_meters_produced_<?php echo $detail_row->job_pos_no;?>',$detail_row->total_meters_produced);?>" min="0" max="20000" step="0.1" size="30"/>
						</td>
						<td>
							<input type="number" name="total_job_weight_<?php echo $detail_row->job_pos_no;?>"  id="total_job_weight_<?php echo $detail_row->job_pos_no;?>" class="quantity" value="<?php echo set_value('total_job_weight_<?php echo $detail_row->job_pos_no;?>',$detail_row->total_job_weight);?>" size="30" step="0.1" />
						</td>
						<td>
							<input type="number" name="total_waste_<?php echo $detail_row->job_pos_no;?>"  id="total_waste_<?php echo $detail_row->job_pos_no;?>" class="quantity" value="<?php echo set_value('total_waste_<?php echo $detail_row->job_pos_no;?>',$detail_row->total_waste);?>" size="30" min="0" max="10000" step="0.1" />
						</td>
