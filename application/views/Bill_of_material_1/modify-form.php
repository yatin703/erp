					...
					<table class="form_table_inner">
						...
						<?php foreach($bill_of_material as $row):?>	
									...
									<tr>
										...
										<input type="hidden" name="record_no" value="<?php echo $row->bom_no.'@@@1';?>" />
									...
									<tr>
											...
											<td><input type="text" name="sleeve_code" id="sleeve_code" size="60" value="<?php echo set_value('sleeve_code',$row->sleeve_code);?>" /></td>
									</tr>
									...
									<tr>
											...
											<td><input type="text" name="shoulder_code" id="shoulder_code" size="60" value="<?php echo set_value('shoulder_code',$row->shoulder_code);?>" /></td>
									</tr>
									<tr><td class="label"><b>&nbsp;</b></td><td class="label"><b>+</b></td></tr>

									<tr>
											<td class="label"><b>Label Code</b></td>
											<td><input type="text" name="label_code" id="label_code" size="60" value="<?php echo set_value('label_code',($row->label_code!=''?$row->label_code:''));?>" /></td>
									</tr>
									<tr><td class="label"><b>&nbsp;</b></td><td class="label"><b>+</b></td></tr>

									<tr>
											<td class="label"><b>Cap Code <span style="color:red;">*</span></b></td>
											<td><input type="text" name="cap_code" id="cap_code" size="60" value="<?php echo set_value('cap_code',$row->cap_code);?>" /></td>
									</tr>
									...
									<tr>
										...
										<td><select name="for_export">
											...
											<option value="0" <?php echo  set_select('for_export', '0', $row->for_export==0 ? TRUE : FALSE); ?>>LOCAL</option>
								          </select>
								      </td>
								    </tr>
