...
<div class="ui four column grid">
  <div class="row">
    ...
    <div class="column hold">
        <a class="nav-link active" href="<?php echo base_url(); ?>index.php/coex_extrusion_qc/pending">Qc Hold (<?php echo $total_hold;?>)</a>
    </div>
            ...
            echo "<tr><td colspan='18' style='text-align: center !important;'>No Active Records Found</td></tr>";
                ...
                $def=$this->coex_extrusion_model->get_defect_details_by_id($d_arr);
            		echo "<tr>
                        ...
                        <td>".($row->flag==1 ? '<span class="" style="font-size: 10px;color: #fff;background: #0E6EB8;padding: 4px;border-radius: 5px;font-weight: bold;"><i class="check circle outline icon"></i> Released</span>' :'<a href="'.base_url('index.php/'.$this->router->fetch_class().'/hold_qc/'.$row->qc_id).'" style="font-size: 10px;color: #fff;background: #f2711c;padding: 4px;border-radius: 5px;font-weight: bold;"><i class="plus circle icon"></i><span> QC Hold</span></a>')."</td>
                             ";
                            echo "</td>
