...
.column.pending a.nav-link.active{
    color: #fff !important;
}
.column.pending a.nav-link.active {
    font-size: 12px;
...
<div class="ui four column grid">
  <div class="row">
    <div class="column pending">
        <a class="nav-link active" href="<?php echo base_url(); ?>index.php/coex_extrusion_qc" style="color:#000">Qc Pending (<?php echo $total_pending;?>)</a>
    </div>
    ...
    <div class="column scrap">
        <a class="nav-link " href="<?php echo base_url(); ?>index.php/coex_extrusion_qc/hold_scrap" style="color:#000">Qc Scrap</a>
    </div>
  </div>
</div>
