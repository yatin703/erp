...
<form name="<?php echo $this->router->fetch_class();?>" action="<?php echo base_url('index.php/'.$this->router->fetch_class().'/search_result_pending');?>" method="POST"  >
	<div class="form_design">
		...
		<legend><b>QC Pending Search</b></legend>
