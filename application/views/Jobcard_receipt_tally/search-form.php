					...
					<table class="form_table_inner">
									...
									<td class="label">Status  :</td>
										<td><select name="status"><option value="">--Select Status--</option>
											<option value="--" <?php echo($this->input->post('status')=='--'?"selected":""); ?>>NOT POSTED</option>
											<option value="ERROR" <?php echo ($this->input->post('status')=='ERROR'?"selected":"");?>>ERROR</option>
											<option value="REPOSTED" <?php echo ($this->input->post('status')=='REPOSTED'?"selected":"");?>>POSTED</option>
										</select>
