	...
	<div class="record_inner_design" style="overflow: scroll;">
			<table class="record_table_design_without_fixed">
				...
				<?php if($springtube_printing_wip_master_after==FALSE){
					echo "<tr><td colspan='25'>No Active Records Found</td></tr>";
						...
						foreach($springtube_printing_wip_master_after as $master_row){
							...
							echo"<tr>
									...
									<td>".$master_row->aprint_wip_qty."</td>
									<td>".$master_row->status."</td>
									<td>".$master_row->body_making_jobcard_no."</td>
									<td></td>
									";
									// echo "<td>";
					...
					echo"<tr><td colspan='18' style='text-align:right;'><b>TOTAL</b></td> <td>".$sum_aprint_wip_qty."</td><td></td><td></td><td></td></tr>";	
