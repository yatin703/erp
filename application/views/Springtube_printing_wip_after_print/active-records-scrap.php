							...
							echo"<tr>
									...
									<td>";
										...
										foreach ($formrights as $formrights_row) {
											...
											echo ($formrights_row->new==1 && $master_row->status==0 ? '<a href="'.base_url('index.php/'.$this->router->fetch_class().'/wip_release_scrap/'.$master_row->aprint_wip_id.'').'" target="_blank" title="Release"><i class="edit icon"></i></a>' : '');
									...
									<td class='positive right aligned'><b>".$master_row->release_qty."</b> <i>NOS</i></td>
									<td class='positive right aligned'><b>".($master_row->aprint_wip_cost_per_qty!=0?"&#x20B9;  ".number_format($master_row->aprint_wip_cost_per_qty,2,'.',',')."</b>":"")."</td>
									<td class='positive right aligned'><b>".($master_row->aprint_wip_cost_per_qty!=0 ?"&#x20B9; ".number_format($master_row->aprint_wip_qty*$master_row->aprint_wip_cost_per_qty,2,'.',','):"")."</b></td>
								...
								$sum_amount+=$master_row->aprint_wip_qty*$master_row->aprint_wip_cost_per_qty;
								$sum_scrap+=$master_row->release_qty;


						}//master Foreach

					echo"<tr><td colspan='11' style='text-align:right;'><b>TOTAL</b></td>
					<td class='positive right aligned'><b>".number_format($sum_aprint_wip_qty,0,'.',',')."</b> <i>NOS</i>
					</td>
					<td class='positive right aligned'><b>".number_format($sum_scrap,0,'.',',')."</b> <i>NOS</i>
					</td>
					<td class='positive right aligned'></td>
					<td></td><td></td>
					</tr>";	
