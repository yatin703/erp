				...
				<?php if($springtube_printing_wip_master_after==FALSE){
					echo "<tr><td colspan='15'>No Active Records Found</td></tr>";
						...
						foreach($springtube_printing_wip_master_after as $master_row){
							...
							$production_master_result=$this->common_model->select_one_record_with_company('production_master',$this->session->userdata['logged_in']['company_id'],'mp_pos_no', $master_row->jobcard_no);
