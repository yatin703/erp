      ...
      <div class="ui label">
        ...
        <table cellpadding="5" cellspacing="0" style="border:1px solid #D9d9d9;">
            ...
            <tr class="item" style="border-right:1px solid #D9d9d9;" >
             ...
             <tr class="item" style="border-right:1px solid #D9d9d9;" >
                <td>OUTER LAYER MICRON</td>
                <td width="1%" style="border-right:1px solid #D9d9d9;"></td>
                <td style="border-right:1px solid #D9d9d9;"></td>
                <td style="border-right:1px solid #D9d9d9;"><?php echo $row->outer_layer_micron_actual;?></td>
                <td style="border-right:1px solid #D9d9d9;"><?php echo ($row->outer_layer_micron_status==1 ? "PASS" : "FAIL");?></td>
            ...
            <tr class="item" style="border-right:1px solid #D9d9d9;" >
                <td>INNER LAYER MICRON</td>
                <td width="1%" style="border-right:1px solid #D9d9d9;"></td>
                <td style="border-right:1px solid #D9d9d9;"></td>
                <td style="border-right:1px solid #D9d9d9;"><?php echo $row->inner_layer_micron_actual;?></td>
                <td style="border-right:1px solid #D9d9d9;"><?php echo ($row->inner_layer_micron_status==1 ? "PASS" : "FAIL");?></td>
            ...
            <tr class="item" style="border-right:1px solid #D9d9d9;" >
                ...
                <td width="1%" style="border-right:1px solid #D9d9d9;"></td>
                <td style="border-right:1px solid #D9d9d9;"></td>
                <td style="border-right:1px solid #D9d9d9;"><?php echo $row->admer_layer_one_micron_actual;?></td>
                <td style="border-right:1px solid #D9d9d9;"><?php echo ($row->admer_layer_one_micron_status==1 ? "PASS" : "FAIL");?></td>
            ...
            <tr class="item" style="border-right:1px solid #D9d9d9;" >
                ...
                <td width="1%" style="border-right:1px solid #D9d9d9;"></td>
                <td style="border-right:1px solid #D9d9d9;"></td>
                <td style="border-right:1px solid #D9d9d9;"><?php echo $row->evoh_layer_micron_actual;?></td>
                <td style="border-right:1px solid #D9d9d9;"><?php echo ($row->evoh_layer_micron_status==1 ? "PASS" : "FAIL");?></td>
                
                <td style="border-right:1px solid #D9d9d9;">REASON FOR SETUP APPROVAL</td>
                <td style="border-right:1px solid #D9d9d9;">
                            <input type="checkbox" name="new_job_status" value="1" <?php echo ($row->new_job_status==1 ? 'checked': '');?>>NEW JOB<br/>

                            <input type="checkbox" name="power_failure_status" value="1" <?php echo ($row->power_failure_status==1 ? 'checked': '');?>>POWER FAILURE<br/>

                            <input type="checkbox" name="change_of_rm_status" value="1" <?php echo ($row->change_of_rm_status==1 ? 'checked': '');?>>CHNAGE OF RM<br/>

                            <input type="checkbox" name="shift_change_status" value="1" <?php echo ($row->shift_change_status==1 ? 'checked': '');?>>SHIFT CHANGE<br/>

                            <input type="checkbox" name="mould_trial_status" value="1" <?php echo ($row->mould_trial_status==1 ? 'checked': '');?>>MOULD TRIAL<br/>

                            <input type="checkbox" name="machine_maintainance_status" value="1" <?php echo ($row->machine_maintainance_status==1 ? 'checked': '');?>>MACHINE MAINTAINANCE<br/></td>
            </tr>
            ...
            <tr class="item" style="border-right:1px solid #D9d9d9;" >
                ...
                <td width="1%" style="border-right:1px solid #D9d9d9;"></td>
                <td style="border-right:1px solid #D9d9d9;"></td>
                <td style="border-right:1px solid #D9d9d9;"><?php echo $row->admer_layer_two_micron_actual;?></td>
                <td style="border-right:1px solid #D9d9d9;"><?php echo ($row->admer_layer_two_micron_status==1 ? "PASS" : "FAIL");?></td>
            ...
            <tr class="item" style="border-right:1px solid #D9d9d9;" >
                <td>GRADE & % OF BLEND</td>
                <td width="1%" style="border-right:1px solid #D9d9d9;"></td>
                <td style="border-right:1px solid #D9d9d9;">JOBCARD & CUSTOMER SPECIFIC</td>
                <td style="border-right:1px solid #D9d9d9;"><?php echo $row->grade_perc_of_blend_actual;?></td>
                <td style="border-right:1px solid #D9d9d9;"><?php echo ($row->grade_perc_of_blend_status==1 ? "PASS" : "FAIL");?></td>
            ...
            <tr class="item" style="border-right:1px solid #D9d9d9;" >
                ...
                <td style="border-right:1px solid #D9d9d9;"><?php echo $row->scratch_line_actual;?></td>
                <td style="border-right:1px solid #D9d9d9;"><?php echo ($row->scratch_line_status==1 ? "PASS" : "FAIL");?></td>
            ...
            <tr class="item" style="border-right:1px solid #D9d9d9;" >
                <td>PIT/WATERMARK/FISHEYE</td>
                <td width="1%" style="border-right:1px solid #D9d9d9;"></td>
                <td style="border-right:1px solid #D9d9d9;">NO PIT/WATERMARK</td>
                <td style="border-right:1px solid #D9d9d9;"><?php echo $row->pit_watermark_actual;?></td>
                <td style="border-right:1px solid #D9d9d9;"><?php echo ($row->pit_watermark_status==1 ? "PASS" : "FAIL");?></td>
            ...
            <tr class="item" style="border-right:1px solid #D9d9d9;" >
                ...
                <td style="border-right:1px solid #D9d9d9;"><?php echo $row->contamination_actual;?></td>
                <td style="border-right:1px solid #D9d9d9;"><?php echo ($row->contamination_status==1 ? "PASS" : "FAIL");?></td>
            ...
            <tr class="item" style="border-right:1px solid #D9d9d9;" >
                <td>RINGS INSIDE & OUTSIDE</td>
                <td width="1%" style="border-right:1px solid #D9d9d9;"></td>
                <td style="border-right:1px solid #D9d9d9;">NO RINGS INSIDE & OUTSIDE</td>
                <td style="border-right:1px solid #D9d9d9;"><?php echo $row->rings_inside_outside_actual;?></td>
                <td style="border-right:1px solid #D9d9d9;"><?php echo ($row->rings_inside_outside_status==1 ? "PASS" : "FAIL");?></td>
            ...
            <tr class="item" style="border-right:1px solid #D9d9d9;" >
                ...
                <td width="1%" style="border-right:1px solid #D9d9d9;"></td>
                <td style="border-right:1px solid #D9d9d9;">SHOULD BE UNIFORM</td>
                <td style="border-right:1px solid #D9d9d9;"><?php echo $row->color_dispersion_actual;?></td>
                <td style="border-right:1px solid #D9d9d9;"><?php echo ($row->color_dispersion_status==1 ? "PASS" : "FAIL");?></td>
            ...
            <tr class="item" style="border-right:1px solid #D9d9d9;" >
                <td>OVAL TUBE</td>
                <td width="1%" style="border-right:1px solid #D9d9d9;"></td>
                <td style="border-right:1px solid #D9d9d9;">NO OVAL</td>
                <td style="border-right:1px solid #D9d9d9;"><?php echo $row->oval_tube_actual;?></td>
                <td style="border-right:1px solid #D9d9d9;"><?php echo ($row->oval_tube_status==1 ? "PASS" : "FAIL");?></td>
            ...
            <tr class="item" style="border-right:1px solid #D9d9d9;" >
                <td>MASTERBATCH COLOR & %</td>
                <td width="1%" style="border-right:1px solid #D9d9d9;"></td>
                <td style="border-right:1px solid #D9d9d9;">JOBCARD & CUSTOMER SPECIFIC</td>
                <td style="border-right:1px solid #D9d9d9;"><?php echo $row->mb_color_perc_actual;?></td>
                <td style="border-right:1px solid #D9d9d9;"><?php echo ($row->mb_color_perc_status==1 ? "PASS" : "FAIL");?></td>
