				...
				<td width="50%">
					<table class="form_table_inner">
						...
						<tr>
							...
							<td class="label"><b>REF. PROCESS SHEET</td>
				...
				<td>
					<table>
						...
						<tr>
							...
							<td></td>
							<td class="label"></td>
							<td><input type="text" name="checked_by_operator" placeholder="YES/NO" size="10" value="<?php echo set_value('checked_by_operator');?>" required></td>
						</tr>
						...
						<tr>
							...
							<td></td>
							<td class="label"></td>
							<td><input type="text" name="verified_by_qc" placeholder="YES/NO" size="10" value="<?php echo set_value('verified_by_qc');?>" required></td>
						</tr>
