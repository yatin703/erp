				...
				<td width="45%">
					<table class="form_table_inner">
						...
						<tr>
							...
							<td><input type="text" name="jobcard_no"  Placeholder="Search Jobcard No." id="jobcard_no" size="15" value="<?php echo set_value('jobcard_no');?>" onchange="check_jobcard_no(this.value);"  required/></td>
							</td>
						</tr>
                        
                        <tr>
							<td class="label"><b>Order No</b> <span style="color:red;">*</span> :</td>
							<td><input type="text" name="order_no"  Placeholder="Enter Order No" id="sales_ord_no" value="<?php echo set_value('order_no');?>" readonly required/></td>
							</td>

							<td class="label"><b>Product No</b> <span style="color:red;">*</span> :</td>
							<td><input type="text" name="article_no"  Placeholder="Enter Product No" id="article_no" value="<?php echo set_value('article_no');?>" readonly required/></td>
							</td>
						</tr>
						...
						<tr>
							...
							<td>
								<select class="select-wdt" name="masterfile_jobcard_return_status" required>		
						...
						<tr>
							...
							<td>
								<select class="select-wdt" name="rm_return_status" required>					
						...
						<tr>
							...
							<td>
								<select class="select-wdt" name="red_create_status" required>					
				...
				<td>
					<table>
						...
						<tr>
							...
							<td></td>
							<td><input type="text" name="gauge_layer_1" id="GUAGE_LAYER_1" value="<?php echo set_value('gauge_layer_1');?>" size="10" readonly required/></td>
							<td><select name="gauge_layer_one_status" required="required">							
								<option value="1" <?php echo set_select('gauge_layer_one_status','1');?>>PASS</option>
								<option value="2" <?php echo set_select('gauge_layer_one_status','2');?>>FAIL</option>
								<option value="0" <?php echo set_select('gauge_layer_one_status','0');?>>N/A</option>
								</select>
							</td>
						</tr>
						...
						<tr>
							...
							<td></td>
							<td ><input type="text" name="gauge_layer_2" id="GUAGE_LAYER_2" value="<?php echo set_value('gauge_layer_2');?>" size="10" readonly required/></td>
							<td><select name="gauge_layer_two_status">							
								<option value="1" <?php echo set_select('gauge_layer_two_status','1');?>>PASS</option>
								<option value="2" <?php echo set_select('gauge_layer_two_status','2');?>>FAIL</option>
								<option value="0" <?php echo set_select('gauge_layer_two_status','0');?>>N/A</option>
								</select>
							</td>
						</tr>
						...
						<tr>
							...
							<td></td>
							<td ><input type="text" name="gauge_layer_3" id="GUAGE_LAYER_3" value="<?php echo set_value('gauge_layer_3');?>" size="10" readonly required/></td>
							<td><select name="gauge_layer_three_status" >					
								<option value="1" <?php echo set_select('gauge_layer_three_status','1');?>>PASS</option>
								<option value="2" <?php echo set_select('gauge_layer_three_status','2');?>>FAIL</option>
								<option value="0" <?php echo set_select('gauge_layer_three_status','0');?>>N/A</option>
							</select></td>
						</tr>
						...
						<tr>
							...
							<td></td>
							<td ><input type="text" name="gauge_layer_4" id="GUAGE_LAYER_4" value="<?php echo set_value('gauge_layer_4');?>" size="10" /></td>
							<td><select name="gauge_layer_four_status" >					
								<option value="1" <?php echo set_select('gauge_layer_four_status','1');?>>PASS</option>
								<option value="2" <?php echo set_select('gauge_layer_four_status','2');?>>FAIL</option>
								<option value="0" <?php echo set_select('gauge_layer_four_status','0');?>>N/A</option>
							</select></td>
						</tr>
						...
						<tr>
							...
							<td></td>
							<td ><input type="text" name="gauge_layer_5" id="GUAGE_LAYER_5" value="<?php echo set_value('gauge_layer_5');?>" size="10" readonly required/></td>
							<td><select name="gauge_layer_five_status">							
								<option value="1" <?php echo set_select('gauge_layer_five_status','1');?>>PASS</option>
								<option value="2" <?php echo set_select('gauge_layer_five_status','2');?>>FAIL</option>
								<option value="0" <?php echo set_select('gauge_layer_five_status','0');?>>N/A</option>
							</select></td>
						</tr>
						...
						<tr>
							...
							<td></td>
							<td ><input type="text" name="layer_one" id="LDPE_LLDPE_LAYER_1"value="<?php echo set_value('layer_one');?>" size="10" readonly required/></td>
							<td><select name="layer_one_status">							
								<option value="1" <?php echo set_select('layer_one_status','1');?>>PASS</option>
								<option value="2" <?php echo set_select('layer_one_status','2');?>>FAIL</option>
								<option value="0" <?php echo set_select('layer_one_status','0');?>>N/A</option>
							</select></td>
						</tr>
						<tr>
							<td class="label">Layer 2:</td>
							<td></td>
							<td ><input type="text" name="layer_two" id="ADMER_LAYER_2" value="<?php echo set_value('layer_two');?>" size="10" readonly required/></td>
							<td><select name="layer_two_status">							
								<option value="1" <?php echo set_select('layer_two_status','1');?>>PASS</option>
								<option value="2" <?php echo set_select('layer_two_status','2');?>>FAIL</option>
								<option value="0" <?php echo set_select('layer_two_status','0');?>>N/A</option>
							</select></td>
						</tr>
						<tr>
							<td class="label">Layer 3:</td>
							<td></td>
							<td ><input type="text" name="layer_three" id="EVOH_LAYER_3" value="<?php echo set_value('layer_three');?>" size="10" readonly required/></td>
							<td><select name="layer_three_status">							
								<option value="1" <?php echo set_select('layer_three_status','1');?>>PASS</option>
								<option value="2" <?php echo set_select('layer_three_status','2');?>>FAIL</option>
								<option value="0" <?php echo set_select('layer_three_status','0');?>>N/A</option>
							</select></td>
						</tr>
						<tr>
							<td class="label">Layer 4:</td>
							<td></td>
							<td ><input type="text" name="layer_four" id="ADMER_LAYER_4" value="<?php echo set_value('layer_four');?>" size="10" readonly required/></td>
							<td><select name="layer_four_status">							
								<option value="1" <?php echo set_select('layer_four_status','1');?>>PASS</option>
								<option value="2" <?php echo set_select('layer_four_status','2');?>>FAIL</option>
								<option value="0" <?php echo set_select('layer_four_status','0');?>>N/A</option>
							</select></td>
						</tr>
						<tr>
							<td class="label">Layer 5:</td>
							<td></td>
							<td ><input type="text" name="layer_five" id="LDPE_LLDPE_LAYER_5" value="<?php echo set_value('layer_five');?>" size="10" readonly required/></td>
							<td><select name="layer_five_status">							
								<option value="1" <?php echo set_select('layer_five_status','1');?>>PASS</option>
								<option value="2" <?php echo set_select('layer_five_status','2');?>>FAIL</option>
								<option value="0" <?php echo set_select('layer_five_status','0');?>>N/A</option>
							</select></td>
						</tr>
						...
						<tr>
							...
							<td></td>
							<td ><input type="text" name="master_batch_inner_layer" id="master_batch_inner_layer" value="<?php echo set_value('master_batch_inner_layer');?>" required/></td>
							<td><select name="inner_layer_master_batch_status">							
								<option value="1" <?php echo set_select('inner_layer_master_batch_status','1');?>>PASS</option>
								<option value="2" <?php echo set_select('inner_layer_master_batch_status','2');?>>FAIL</option>
								<option value="0" <?php echo set_select('inner_layer_master_batch_status','0');?>>N/A</option>
							</select></td>
						</tr>
						...
						<tr>
							...
							<td></td>
							<td ><input type="text" name="master_batch_outer_layer" id="master_batch_outer_layer" value="<?php echo set_value('master_batch_outer_layer');?>" required/></td>
							<td><select name="outer_layer_master_batch_status">							
								<option value="1" <?php echo set_select('outer_layer_master_batch_status','1');?>>PASS</option>
								<option value="2" <?php echo set_select('outer_layer_master_batch_status','2');?>>FAIL</option>
								<option value="0" <?php echo set_select('outer_layer_master_batch_status','0');?>>N/A</option>
							</select></td>
						</tr>				
...
<script>
	function check_jobcard_no(jobcard_no) {     
        $.ajax({
            type: 'POST',
            url: "<?php echo base_url();?>index.php/coex_extrusion_qc_control_plan/get_ajax_jobcard_no_id",
            async: false,
            dataType: 'json',
           ...
           // alert(data);
            success: function(res) {
                if (res.status == "200") {	
				   $('#article_no').val(res.data['article_no']); 
				   $('#sales_ord_no').val(res.data['sales_ord_no']); 
				   $('#order_no').val(res.data['order_no']); 
				   $('#spec_order').val(res.data['spec_order']); 
				   $('#bom_no').val(res.data['bom_no']); 
				   $('#sleeve_code').val(res.data['sleeve_code']);
				   $('#LDPE_LLDPE_LAYER_1').val(res.data['LDPE_LLDPE_LAYER_1']);
				   $('#ADMER_LAYER_2').val(res.data['ADMER_LAYER_2']);
				   $('#EVOH_LAYER_3').val(res.data['EVOH_LAYER_3']);
				   $('#ADMER_LAYER_4').val(res.data['ADMER_LAYER_4']);
				   $('#LDPE_LLDPE_LAYER_5').val(res.data['LDPE_LLDPE_LAYER_5']);
				   $('#GUAGE_LAYER_1').val(res.data['GUAGE_LAYER_1']);
				   $('#GUAGE_LAYER_2').val(res.data['GUAGE_LAYER_2']);
				   $('#GUAGE_LAYER_3').val(res.data['GUAGE_LAYER_3']);
				   $('#GUAGE_LAYER_4').val(res.data['GUAGE_LAYER_4']);
				   $('#GUAGE_LAYER_5').val(res.data['GUAGE_LAYER_5']);
				   $('#master_batch_inner_layer').val(res.data['master_batch_inner_layer']);
				   $('#master_batch_outer_layer').val(res.data['master_batch_outer_layer']);
                } else {
					$('#article_no').val('');                    
					$('#sales_ord_no').val('');                    
					$('#order_no').val('');  
					...
					$('#bom_no').val('');  
					$('#sleeve_code').val('');
					$('#LDPE_LLDPE_LAYER_1').val('');
					$('#ADMER_LAYER_2').val('');
					$('#EVOH_LAYER_3').val('');
					$('#ADMER_LAYER_4').val('');
					$('#LDPE_LLDPE_LAYER_5').val('');
					$('#GUAGE_LAYER_1').val('');
					$('#GUAGE_LAYER_2').val('');
					$('#GUAGE_LAYER_3').val('');
					$('#GUAGE_LAYER_4').val('');
					$('#GUAGE_LAYER_5').val('');
					$('#master_batch_inner_layer').val('');
					$('#master_batch_outer_layer').val('');
                }
            }
        });
      return false;
