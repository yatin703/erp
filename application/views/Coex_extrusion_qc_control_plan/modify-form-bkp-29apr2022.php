				...
				<td>
					<table>
						...
						<tr>
							...
							<td></td>
							<td ><input type="text" name="outer_layer_micron_actual" value="<?php echo set_value('outer_layer_micron_actual',$row->outer_layer_micron_actual);?>" size="10" required/></td>
							<td><select name="outer_layer_micron_status" required="required">							
								<option value="1" <?php echo ($row->outer_layer_micron_status=='1' ? "selected" : "");?> <?php echo set_select('outer_layer_micron_status','1');?>>PASS</option>
								<option value="2" <?php echo ($row->outer_layer_micron_status=='2' ? "selected" : "");?> <?php echo set_select('outer_layer_micron_status','2');?>>FAIL</option>
								<option value="0" <?php echo ($row->outer_layer_micron_status=='0' ? "selected" : "");?> <?php echo set_select('outer_layer_micron_status','0');?>>N/A</option>
								</select>
							</td>
						</tr>
						...
						<tr>
							...
							<td></td>
							<td ><input type="text" name="inner_layer_micron_actual" value="<?php echo set_value('inner_layer_micron_actual',$row->inner_layer_micron_actual);?>" size="10" /></td>
							<td><select name="inner_layer_micron_status">							
								<option value="1" <?php echo ($row->inner_layer_micron_status=='1' ? "selected" : "");?> <?php echo set_select('inner_layer_micron_status','1');?>>PASS</option>
								<option value="2" <?php echo ($row->inner_layer_micron_status=='2' ? "selected" : "");?> <?php echo set_select('inner_layer_micron_status','2');?>>FAIL</option>
								<option value="0" <?php echo ($row->inner_layer_micron_status=='0' ? "selected" : "");?> <?php echo set_select('inner_layer_micron_status','0');?>>N/A</option>
								</select>
							</td>
						</tr>
						...
						<tr>
							...
							<td></td>
							<td ><input type="text" name="admer_layer_one_micron_actual" value="<?php echo set_value('admer_layer_one_micron_actual',$row->admer_layer_one_micron_actual);?>" size="10" /></td>
							<td><select name="admer_layer_one_micron_status" >					
								<option value="1" <?php echo ($row->admer_layer_one_micron_status=='1' ? "selected" : "");?> <?php echo set_select('admer_layer_one_micron_status','1');?>>PASS</option>
								<option value="2" <?php echo ($row->admer_layer_one_micron_status=='2' ? "selected" : "");?> <?php echo set_select('admer_layer_one_micron_status','2');?>>FAIL</option>
								<option value="0" <?php echo ($row->admer_layer_one_micron_status=='0' ? "selected" : "");?> <?php echo set_select('admer_layer_one_micron_status','0');?>>N/A</option>
							</select></td>
						</tr>
						...
						<tr>
							...
							<td></td>
							<td ><input type="text" name="evoh_layer_micron_actual" value="<?php echo set_value('evoh_layer_micron_actual',$row->evoh_layer_micron_actual);?>" size="10" /></td>
							<td><select name="evoh_layer_micron_status" >					
								<option value="1" <?php echo ($row->evoh_layer_micron_status=='1' ? "selected" : "");?> <?php echo set_select('evoh_layer_micron_status','1');?>>PASS</option>
								<option value="2" <?php echo ($row->evoh_layer_micron_status=='2' ? "selected" : "");?> <?php echo set_select('evoh_layer_micron_status','2');?>>FAIL</option>
								<option value="0" <?php echo ($row->evoh_layer_micron_status=='0' ? "selected" : "");?> <?php echo set_select('evoh_layer_micron_status','0');?>>N/A</option>
							</select></td>
						</tr>
						...
						<tr>
							<td class="label">Admer :</td>
							<td></td>
							<td ><input type="text" name="admer_layer_two_micron_actual" value="<?php echo set_value('admer_layer_two_micron_actual',$row->admer_layer_two_micron_actual);?>" size="10"/></td>
							<td><select name="admer_layer_two_micron_status">							
								<option value="1" <?php echo ($row->admer_layer_two_micron_status=='1' ? "selected" : "");?> <?php echo set_select('admer_layer_two_micron_status','1');?>>PASS</option>
								<option value="2" <?php echo ($row->admer_layer_two_micron_status=='2' ? "selected" : "");?> <?php echo set_select('admer_layer_two_micron_status','2');?>>FAIL</option>
								<option value="0" <?php echo ($row->admer_layer_two_micron_status=='0' ? "selected" : "");?> <?php echo set_select('admer_layer_two_micron_status','0');?>>N/A</option>
							</select></td>
						</tr>
						...
						<tr>
							...
							<td ><input type="text" name="grade_perc_of_blend_actual" size="10" value="<?php echo set_value('grade_perc_of_blend_actual',$row->grade_perc_of_blend_actual);?>" required/></td>
							<td><select name="grade_perc_of_blend_status" required="required">					
								<option value="1" <?php echo ($row->grade_perc_of_blend_status=='1' ? "selected" : "");?> <?php echo set_select('grade_perc_of_blend_status','1');?>>PASS</option>
								<option value="2" <?php echo ($row->grade_perc_of_blend_status=='2' ? "selected" : "");?> <?php echo set_select('grade_perc_of_blend_status','2');?>>FAIL</option>
								<option value="0" <?php echo ($row->grade_perc_of_blend_status=='0' ? "selected" : "");?> <?php echo set_select('grade_perc_of_blend_status','0');?>>N/A</option>
							</select></td>
						</tr>
						...
						<tr>
							...
							<td>Jobcard & Customer specific</td>
							<td><input type="text" name="mb_color_perc_actual" size="10" value="<?php echo set_value('mb_color_perc_actual',$row->mb_color_perc_actual);?>" required/></td>
