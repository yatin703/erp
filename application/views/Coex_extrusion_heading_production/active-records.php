               ...
               echo "<tr><td colspan='12'>No Active Records Found</td></tr>";
               	...
               	foreach($coex_extrusion_heading as $row){
               		...
               		echo "<tr>
                          ...
                          <td>".($row->flag==1 ? '<i style="color:#06c806" class="check circle icon"></i>' :'<a href="'.base_url('index.php/'.$this->router->fetch_class().'/create/'.$row->heading_id).'"><i class="hand paper icon"></i></a>')."</td>
